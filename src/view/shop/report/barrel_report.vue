...
//            下拉刷新
            ...
            linkToDetail(barrelId,sellerId){
                ...
                this.clicked = true;
                var _this = this;
                event.openURL(utils.locate('view/shop/report/barrel_detail.js?barrelId='+barrelId+'&sellerId='+sellerId+'&beginTime='+encodeURIComponent(this.beginTime)+'&endTime='+encodeURIComponent(this.endTime)), function (data) {
                    _this.clicked = false;
                })
            }
        },
