...
//                            开始直播
                        livePlayer.toPlayLiveRoom(data.data.liveId,false,false,data.data.title,data.data.frontcover,function(mes){});
...
//                                  开始直播
                                    livePlayer.toPlayLiveRoom(message.data.liveId,message.data.play,message.data.record,message.title,message.data.frontcover,function(mes){});
                                }
                            }
                        );
                    }else{
