        ...
        <scroller class="scroller pr20" >
            <div class="cell-row  mt0">
                <div class="cell-logo">
                    ...
                    <div>
                        <div  v-if="!logoLoading"  class="logo coverAbsoTop " ></div>
                        <image class="logo" resize="cover" @click="headLogo"  @load="logoLoad(item)"
            ...
            <div class="cell-row mt0">
                ...
                <div  class="imageBox  " v-if="hasImage()" >
                    <div v-for="(item,index) in imageList">
                        ...
                        <image class="goodsImg " resize="cover" @load="onImageLoad(item)" :src="item.thumbnailImage"></image>
                        <!--右上角关闭按钮"x"-->
