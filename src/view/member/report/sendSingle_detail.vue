...
//                获取当前点击的元素。
            ...
            open:function () {
                ...
                GET('weex/member/report/shipping_detail_report.jhtml?type=owner&beginDate='+encodeURIComponent(_this.beginTime)+'&endDate='+encodeURIComponent(_this.endTime)+'&pageStart=' + _this.pageStart +'&pageSize='+_this.pageSize+'&sellerId='+_this.sellerId,function (res) {
                    if (res.type=="success") {
