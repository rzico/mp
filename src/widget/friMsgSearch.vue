        ...
        <scroller>
            <div v-for="(item,index) in searchList.friend">
                    ...
                    <div class="contentBox">
                        <!--好友-->
                        <div class="flex-row "  v-if="item.type == 'friend'" @click="goAuthor(item.value.id)">
                        ...
                        <!--消息-->
                        <div class="friendsLine borderTop"  v-if="item.type == 'message'" @click="goChat(item.value.userId)">
                            <!--头像-->
                        ...
                        <!--文章-->
                        <div class="collectBox borderTop"  v-if="item.type == 'article'" @click="goArticle(item.value.id)">
                            <div class="flex-row">
                                <!--文章封面-->
                        ...
                        <div  v-if="isMoreRepeat(index)" class="borderTop ">
...
//            },
            ...
            isRepeat:function(index){
                var _this = this;
                if(index != 0){
//                    if(_this.watchTypeFunc(_this.searchList[index - 1].type) == 'friend' || _this.watchTypeFunc(_this.searchList[index - 1].type) == 'message' ||_this.watchTypeFunc(_this.searchList[index - 1].type) == 'article' ){
...
//            判断类型
            judgeType(dataType){
                if(dataType == 'friend' || dataType == 'message' || dataType == 'article'){
                    return true;
                }else{
                    return false;
                }
