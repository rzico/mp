...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/live/index.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-be236e64"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    filters: {
	        ...
	        watchFrontCover: function watchFrontCover(value) {
	            return _utils2.default.thumbnail(value, 369, 270);
	        }
	    },
	    ...
	    methods: {
	        adaptIosOne: function adaptIosOne() {
	        ...
	        adaptIosTwo: function adaptIosTwo() {
	            if (_utils2.default.isIosSystem()) {
	        ...
	        getLiveList: function getLiveList() {
	            var _this = this;
	            (0, _fetch.GET)('weex/live/list.jhtml?pageStart=' + this.pageStart + '&pageSize=' + this.pageSize, function (data) {
	                if (data.type == 'success') {
	        ...
	        //            封面显示出来
	        onImageAppear: function onImageAppear(item) {
	            if (_utils2.default.isNull(item.loadingImg)) {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  })], 2)])]) : _vm._e(), _c('header', [(_vm.liveList.length == 0) ? _c('noData', {
	    style: {
	  ...
	  }) : _vm._e()], 1), (_vm.liveList.length > 0) ? _c('header', [_c('div', {
	    staticClass: ["bkg-white", "pt20", "pb20", "pl20", "pr20", "flex-row"]
	  }, [_c('text', {
	  ...
	  }, [_vm._v("直播推荐")])])]) : _vm._e(), _vm._l((_vm.liveList), function(item) {
	    return _c('cell', {
	      appendAsTree: true,
	      attrs: {
	        "append": "tree"
	      ...
	      staticClass: ["bt30"]
	    }, [_c('div', [(!item.loading) ? _c('div', {
	      staticClass: ["liveCover", "coverAbsoTop"]
	    }) : _vm._e(), _c('image', {
	      staticClass: ["liveCover"],
	      attrs: {
	        "src": _vm._f("watchFrontCover")(item.frontcover),
	        "resize": "cover"
	      },
	      on: {
	        "load": function($event) {
	      ...
	      staticClass: ["tempMask"]
	    }) : _vm._e(), _c('div', {
	      staticClass: ["space-between", "coverInfo"]
	    }, [_c('text', {
	      staticClass: ["sub_title", "white"]
	    }, [_vm._v(_vm._s(_vm._f("watchAuthor")(item.nickname)))]), _c('text', {
	      staticClass: ["sub_title", "white", "fzz24"],
	      style: {
	        fontFamily: 'iconfont'
	      }
	    }, [_vm._v(" " + _vm._s(_vm._f("watchOnline")(item.viewerCount)))])])]), _c('div', {
	      staticClass: ["pl10", "pr10"]
	    }, [_c('text', {
	      staticClass: ["liveTitle", "gameTitle", "mt10"]
	    }, [_vm._v(_vm._s(item.title))])])])])
	  }), _c('header', [(_vm.adaptIosOne()) ? _c('div', {
	    staticClass: ["adaptOneHeight"]
	  }) : _vm._e()]), _c('header', [(_vm.adaptIosTwo()) ? _c('div', {
	    staticClass: ["adaptTwoHeight"]
	  }) : _vm._e()])], 2)], 1)
	},staticRenderFns: []}
	module.exports.render._withStripped = true
