...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/live/gifts.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-17c38682"
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        isRepeat: function isRepeat(index) {
	            if (index != 0) {
	                if (_utils2.default.ymdtimefmt(this.depositList[index].createDate) == _utils2.default.ymdtimefmt(this.depositList[index - 1].createDate)) {
	                    return false;
	                }
	            }
	            return true;
	        ...
	        open: function open() {
	            var _this = this;
	            (0, _fetch.GET)('weex/live/gift/data.jhtml?liveId=' + _this.liveId + '&liveTapeId=' + '&pageStart=' + _this.pageStart + '&pageSize=' + _this.pageSize, function (res) {
	                if (res.type == "success") {
	                    if (res.data.start == 0) {
	    ...
	    created: function created() {
	        ...
	        this.liveId = _utils2.default.getUrlParameter("liveId");
	        if (this.liveId == null) {
	            this.liveId = '';
	        }
	        this.open();
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    return _c('cell', {
	      ...
	      staticClass: ["title"]
	    }, [_vm._v(_vm._s(_vm._f("timeDatefmt")(deposit.createDate)))])]), _vm._m(0, true)]) : _vm._e(), _c('div', {
	    ...
	    }, [_vm._v(_vm._s(_vm._f("watchNickName")(deposit.nickname)) + "送给了你" + _vm._s(deposit.giftName))]), _c('text', {
	      staticClass: ["money"],
	      style: _vm.moneyColor(deposit.amount)
	    }, [_vm._v(_vm._s(_vm._f("currencyfmt")(deposit.price)))])]), _c('div', {
	      staticClass: ["flex-row", "space-between", "align-bottom"]
	    }, [_c('text', {
	      staticClass: ["datetime"]
	    }, [_vm._v(_vm._s(_vm._f("datetimefmt")(deposit.createDate)))])])])])])])
	  }), (_vm.noData()) ? _c('cell', {
	    appendAsTree: true,
	    attrs: {
	      "append": "tree"
