...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/live/apply.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-5557f56a"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    filters: {
	        watchAuthor: function watchAuthor(value) {
	            if (_utils2.default.isNull(value)) {
	                return value;
	            } else {
	                //              如果用户名称过长，便截取拼成名字
	                return _utils2.default.changeStrLast(value, 7, 15);
	            }
	        },
	        watchOnline: function watchOnline(value) {
	            if (_utils2.default.isNull(value)) {
	                return 0;
	            } else {
	                return value > 9999 ? parseFloat(_utils2.default.currencyfmt(value / 10000)) + "万" : value;
	            }
	        }
	    },
	    ...
	    methods: {
	        ...
	        //            是否同意条例
	        isAgreeRules: function isAgreeRules() {
	        ...
	        complete: function complete() {
	            ...
	            if (_utils2.default.isNull(this.coverThumbnail)) {
	                _weex.event.toast('请先设置封面');
	                return;
	            }
	            if (_utils2.default.isNull(this.titleWord) || _utils2.default.isAllEmpty(this.titleWord)) {
	                _weex.event.toast('请先设置标题');
	                return;
	            }
	            var _this = this;
	            if (this.clicked) {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["applyBox", "allWidth", "mtt80"]
	  }, [_c('div', {
	    ...
	    staticClass: ["checkBorder"],
	    class: [_vm.isRecord ? 'redBorder' : '']
	  }), (_vm.isRecord) ? _c('text', {
	    staticClass: ["check", "takeCheck"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	  }, [_vm._v("")]) : _vm._e()]), _c('text', {
	    staticClass: ["fzz24", "ml10"]
	  }, [_vm._v("是否")]), _c('text', {
	    staticClass: ["fzz24"]
	  }, [_vm._v("录播")])]), _c('div', {
	    staticClass: ["flex-row", "mt30"]
	  }, [_c('div', {
	    staticClass: ["checkBox"],
	    on: {
	      "click": function($event) {
	    ...
	    staticClass: ["checkBorder"],
	    class: [_vm.isAgreeRule ? 'redBorder' : '']
	  }), (_vm.isAgreeRule) ? _c('text', {
	    staticClass: ["check", "takeCheck"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	    ...
	    staticClass: ["fzz24", "redColor"]
	  }, [_vm._v("《nihtan直播管理条例》")])])])]), _c('div', {
	    staticClass: ["button", "bkg-primary", "", "mt30", "allWidth"],
	    class: [_vm.isAgreeRule ? 'bkg-primary' : 'bkg-gray'],
	    on: {
	      "click": _vm.complete
	    }
	  }, [_c('text', {
	    staticClass: ["fz32", "white"],
	    class: [_vm.isAgreeRule ? 'white' : 'redColor']
	  }, [_vm._v("下一步")])])]), (_vm.toSendArticle) ? _c('div', {
	  ...
	  }, [_vm._v(_vm._s(_vm.currentPro) + "/" + _vm._s(_vm.proTotal))])])]) : _vm._e()])
	},staticRenderFns: []}
	module.exports.render._withStripped = true
