...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/card/memberInfo.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-8884f766"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    filters: {
	        ...
	        codefmt: function codefmt(val) {
	            if (_utils2.default.isNull(val)) {
	                return val;
	            } else {
	                return val.substr(0, 11) + "  " + val.substr(11);
	            }
	        },
	        watchName: function watchName(val) {
	            if (_utils2.default.isNull(val)) {
	                return '无';
	            } else {
	                return val;
	        ...
	        watchType: function watchType(data) {
	            if (data == 'partner') {
	                return '股东';
	            } else if (data == 'team') {
	                return '团队';
	        ...
	        watchCardType: function watchCardType(data) {
	            if (data == 'family') {
	                return '个人用户';
	    ...
	    created: function created() {
	        ...
	        this.id = _utils2.default.getUrlParameter("id");
	        this.open();
	        this.permissions();
	    },
	    ...
	    methods: {
	        ...
	        goAddress: function goAddress() {
	            ...
	            event.openURL(_utils2.default.locate('view/shop/card/address.js?cardId=' + this.id + '&memberId=' + this.memberId), function (data) {
	                _this.clicked = false;
	                if (data.type == 'success') {}
	            });
	        },
	        gousers: function gousers() {
	            ...
	            event.openURL(_utils2.default.locate('view/shop/card/users.js?cardId=' + this.id + '&memberId=' + this.memberId), function (data) {
	                _this.clicked = false;
	                if (data.type == 'success') {}
	            });
	        },
	        goCouponCode: function goCouponCode() {
	            var _this = this;
	            if (!_utils2.default.isRoles("1", _this.roles)) {
	                modal.alert({
	                    message: '暂无权限',
	            ...
	            this.clicked = true;
	            event.openURL(_utils2.default.locate('view/shop/card/couponCode.js?cardId=' + this.id + '&logo=' + this.data.card.logo), function (data) {
	                _this.clicked = false;
	                if (data.type == 'success') {}
	            });
	        },
	        goBarrel: function goBarrel() {
	            var _this = this;
	            if (!_utils2.default.isRoles("1", _this.roles)) {
	                modal.alert({
	                    message: '暂无权限',
	            ...
	            this.clicked = true;
	            event.openURL(_utils2.default.locate('view/shop/card/barrel.js?cardId=' + this.id), function (data) {
	                _this.clicked = false;
	                if (data.type == 'success') {}
	            });
	        },
	        ...
	        //            结算方式
	        settlemenSetup: function settlemenSetup() {
	            var _this = this;
	            if (!_utils2.default.isRoles("1", _this.roles)) {
	                modal.alert({
	                    message: '暂无权限',
	            ...
	            picker.pick({
	                ...
	                if (e.result == 'success') {
	                    ...
	                    (0, _fetch.POST)('weex/member/card/update.jhtml?id=' + _this.id + '&cardType=' + _this.data.card.cardType).then(function (mes) {
	        ...
	        vipsetup: function vipsetup() {
	            ...
	            picker.pick({
	                ...
	                if (e.result == 'success') {
	                    ...
	                    (0, _fetch.POST)('weex/member/card/update.jhtml?id=' + _this.id + '&vip=' + vp).then(function (mes) {
	                        if (mes.type == "success") {
	        ...
	        typesetup: function typesetup() {
	            ...
	            picker.pick({
	                ...
	                if (e.result == 'success') {
	                    ...
	                    (0, _fetch.POST)('weex/member/card/update.jhtml?id=' + _this.id + '&type=' + type).then(function (mes) {
	                        if (mes.type == "success") {
	            ...
	            modal.prompt({
	                ...
	                if (value.result == '确定') {
	                    if (value.data == '' || value.data == null) {
	                        ...
	                        (0, _fetch.POST)('weex/member/card/update.jhtml?id=' + _this.id + '&name=' + encodeURI(value.data)).then(function (mes) {
	                            if (mes.type == "success") {
	                                _this.data.card.name = value.data;
	                                _utils2.default.debug(_this.data.card.name);
	                            } else {
	                                event.toast(mes.content);
	                            }
	                        }, function (err) {
	            ...
	            modal.prompt({
	                ...
	                if (value.result == '确定') {
	                    if (value.data == '' || value.data == null) {
	                        ...
	                        (0, _fetch.POST)('weex/member/card/update.jhtml?id=' + _this.id + '&mobile=' + value.data).then(function (mes) {
	                            if (mes.type == "success") {
	                                _this.data.card.mobile = value.data;
	                                _utils2.default.debug(_this.data.card.mobile);
	                            } else {
	                                event.toast(mes.content);
	                            }
	                        }, function (err) {
	        ...
	        //            设置股东比例
	        petdividend: function petdividend() {
	            var _this = this;
	            if (!_utils2.default.isRoles("1", _this.roles)) {
	                modal.alert({
	                    message: '暂无权限',
	            ...
	            modal.prompt({
	                ...
	                if (value.result == '确定') {
	                    if (value.data == '' || value.data == null) {
	                        ...
	                        (0, _fetch.POST)('weex/member/card/update.jhtml?id=' + _this.id + '&bonus=' + value.data).then(function (mes) {
	                            if (mes.type == "success") {
	        ...
	        open: function open() {
	            var _this = this;
	            (0, _fetch.GET)("weex/member/card/info.jhtml?id=" + _this.id, function (res) {
	                if (res.type == 'success') {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	  ...
	  }, [_vm._v(_vm._s(_vm.data.card.name))]), _c('text', {
	    staticClass: ["arrow"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	    ...
	    staticClass: ["sub_title"]
	  }, [_vm._v(_vm._s(_vm.data.card.mobile))]), _c('text', {
	    staticClass: ["arrow"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	    ...
	    staticClass: ["sub_title"]
	  }, [_vm._v(_vm._s(_vm.data.card.vip))]), _c('text', {
	    staticClass: ["arrow"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	    ...
	    staticClass: ["cell-panel", "space-between"],
	    class: [_vm.data.card.type == 'member' ? 'cell-clear' : '', _vm.data.card.type == 'team' ? 'cell-clear' : ''],
	    on: {
	      "click": function($event) {
	        _vm.typesetup()
	      }
	    ...
	    staticClass: ["sub_title"]
	  }, [_vm._v(_vm._s(_vm._f("watchType")(_vm.data.card.type)))]), _c('text', {
	    staticClass: ["arrow"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	  }, [_vm._v("")])])]), (_vm.data.card.type == 'partner') ? _c('div', {
	    ...
	    staticClass: ["sub_title"]
	  }, [_vm._v(_vm._s(_vm.data.card.bonus) + "%")]), _c('text', {
	    staticClass: ["arrow"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	    ...
	    staticClass: ["sub_title"]
	  }, [_vm._v(_vm._s(_vm._f("watchCardType")(_vm.data.card.cardType)))]), _c('text', {
	    staticClass: ["arrow"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	    ...
	    staticClass: ["sub_title"]
	  }, [_vm._v("NO." + _vm._s(_vm._f("codefmt")(_vm.data.card.code)))]), _c('text', {
	    staticClass: ["arrow"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	    ...
	    staticClass: ["sub_title"]
	  }, [_vm._v(_vm._s(_vm.data.card.balance) + "元")]), _c('text', {
	    staticClass: ["arrow"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	    ...
	    staticClass: ["sub_title"]
	  }, [_vm._v(_vm._s(_vm.data.card.point))]), _c('text', {
	    staticClass: ["arrow"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	    ...
	    staticClass: ["sub_title"]
	  }, [_vm._v(_vm._s(_vm._f("watchName")(_vm.data.card.promoter)))]), _c('text', {
	    staticClass: ["arrow"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	    ...
	    staticClass: ["sub_title"]
	  }, [_vm._v(_vm._s(_vm.data.card.shopName))]), _c('text', {
	    staticClass: ["arrow"],
	    style: {
	      fontFamily: 'iconfont'
	    }
