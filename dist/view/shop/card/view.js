...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/card/view.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-d0a6e06c"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    filters: {
	        ...
	        watchVip: function watchVip(data) {
	            if (data == 'vip3') {
	                return '钻石';
	            } else if (data == 'vip2') {
	                return '金卡';
	    ...
	    methods: {
	        ...
	        deposit: function deposit() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            event.openURL(_utils2.default.locate("view/shop/card/deposit.js?id=" + this.id), function (data) {
	                _this.clicked = false;
	            });
	        },
	        integral: function integral() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            event.openURL(_utils2.default.locate("view/shop/card/integral.js?id=" + this.id), function (data) {
	                _this.clicked = false;
	            });
	        },
	        ...
	        goAddress: function goAddress() {
	            ...
	            this.clicked = true;
	            event.openURL(_utils2.default.locate('view/shop/card/receiver/index.js?memberId=' + this.memberId), function (data) {
	                _this.clicked = false;
	                if (data.type == 'success') {}
	            });
	        },
	        ...
	        vipsetup: function vipsetup() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            event.openURL(_utils2.default.locate("view/shop/card/memberInfo.js?id=" + this.id), function (data) {
	                _this.load();
	                _this.clicked = false;
	            });
	        },
	        fill: function fill() {
	            ...
	            if (_utils2.default.appType() == 'water') {
	                ...
	                event.openURL(_utils2.default.locate("view/shop/card/fill.js?id=" + _this.id), function (data) {
	                    if (data.type == 'success') {
	                        _this.load();
	                    }
	                });
	            } else {
	                if (!_utils2.default.isRoles("15", _this.roles)) {
	                    modal.alert({
	                        message: '暂无权限',
	                        okTitle: 'OK'
	                    });
	        ...
	        refund: function refund() {
	            ...
	            if (_utils2.default.appType() == 'water') {
	                ...
	                event.openURL(_utils2.default.locate("view/shop/card/refund.js?id=" + _this.id), function (data) {
	                    if (data.type == 'success') {
	                        _this.load();
	                    }
	                });
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }), _c('list', [(_vm.data != null) ? _c('cell', {
	    appendAsTree: true,
	    attrs: {
	      "append": "tree"
	    }
	  }, [_c('div', {
	    staticClass: ["box", "bkg-primary"]
	  }, [_c('div', {
	    staticClass: ["flex-center"]
	  }, [_c('text', {
	    staticClass: ["name"]
	  }, [_vm._v(_vm._s(_vm.data.card.name))]), _c('div', {
	    staticClass: ["labelType"]
	  }, [_c('text', {
	    staticClass: ["labelText"]
	  }, [_vm._v(_vm._s(_vm._f("watchType")(_vm.data.card.type)))])]), _c('div', {
	    class: [_vm.vipClass(_vm.data.card.vip)],
	    staticStyle: {
	      marginTop: "60px"
	    }
	  }, [_c('text', {
	    staticClass: ["labelText"]
	  }, [_vm._v(_vm._s(_vm._f("watchVip")(_vm.data.card.vip)))])])]), _c('text', {
	    staticClass: ["code"]
	  }, [_vm._v("NO." + _vm._s(_vm._f("codefmt")(_vm.data.card.code)))]), _c('text', {
	    staticClass: ["balance"]
	  }, [_vm._v("￥" + _vm._s(_vm._f("currencyfmt")(_vm.data.card.balance)))]), _c('div', {
	    staticClass: ["flex-center"]
	  }, [_c('text', {
	    staticClass: ["button", "bw"],
	    on: {
	      "click": function($event) {
	        _vm.fill()
	      }
