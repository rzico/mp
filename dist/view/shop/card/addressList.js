...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/card/addressList.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-3db24ac6"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        open: function open() {
	            var _this = this;
	            (0, _fetch.GET)('weex/member/receiver/list.jhtml?pageStart=' + this.pageStart + '&pageSize=' + this.pageSize, function (mes) {
	                if (mes.type == 'success') {
	        ...
	        searchCard: function searchCard() {
	            var _this = this;
	            (0, _fetch.GET)('weex/member/receiver/list.jhtml?type=query&pageStart=' + this.pageStart + '&pageSize=' + this.pageSize + '&keyword=' + encodeURI(_this.keyword), function (mes) {
	                if (mes.type == 'success') {
	                    if (_this.pageStart == 0) {
	                        _this.lists = mes.data.data;
	                    } else {
	        ...
	        addCard: function addCard() {
	            ...
	            _weex.event.openURL(_utils2.default.locate("view/shop/card/receiver/amap-picker/amap-picker.js"), function (e) {
	                if (e.type == 'success') {
	                    ...
	                    _weex.event.openURL(_utils2.default.locate("view/shop/card/receiver/add/index.js?" + (0, _fetch.URIEncrypt)(ev)), function (res) {
	                        _this.pageStart = 0;
	                        _this.open();
	                    });
	                }
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    }, [_vm._v(_vm._s(c.address))]), _c('div', {
	      staticClass: ["flex-row", "mt20"]
	    }, [_c('text', {
	      staticClass: ["name", "mr30"]
	    }, [_vm._v(_vm._s(c.consignee))]), _c('text', {
	      staticClass: ["mobile"]
	    }, [_vm._v(_vm._s(c.phone))])]), _c('div', {
	      staticClass: ["flex-row", "mt20"]
	    }, [_c('text', {
	      staticClass: ["mobile"]
	    }, [_vm._v("NO." + _vm._s(c.cardNo) + "(卡主:" + _vm._s(c.cardName) + ")")])])])])
	  })], 2) : _vm._e()], 1)
	},staticRenderFns: []}
	module.exports.render._withStripped = true
