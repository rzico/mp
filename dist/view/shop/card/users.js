...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/card/users.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-58dfbd9a"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        open: function open() {
	            var _this = this;
	            (0, _fetch.GET)('weex/member/card/users.jhtml?id=' + this.cardId, function (res) {
	                if (res.type == "success") {
	                    _this.list = res.data;
	                } else {
	        ...
	        setting: function setting(id) {
	            ...
	            modal.confirm({
	                ...
	                if (value == '确定') {
	                    (0, _fetch.POST)('weex/member/card/cardowner.jhtml?cardId=' + _this.cardId + '&memberId=' + id).then(function (data) {
	                        if (data.type == 'success') {
	                            _this.open();
	                        } else {
	        ...
	        del: function del(id, index) {
	            if (id == this.memberId) {
	                _weex.event.toast('卡主不能删除');
	                return;
	            }
	            var _this = this;
	            (0, _fetch.POST)('weex/member/card/userDelete.jhtml?cardId=' + this.cardId + '&memberId=' + id).then(function (mes) {
	                if (mes.type == "success") {
	                    //                            把动画收回来。
	                    if (animationPara == null || animationPara == '' || animationPara == 'undefinded') {} else {
	                        _weex.animation.transition(animationPara, {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    return _c('cell', {
	      ...
	      staticClass: ["usersImg"],
	      attrs: {
	        "src": c.logo
	      }
	    }), _c('div', {
	      staticClass: ["ml20"]
	    }, [(c.username != '' && c.username != null) ? _c('text', {
	      staticClass: ["usersName"]
	    }, [_vm._v(_vm._s(c.username))]) : _vm._e(), (c.username == '' || c.username == null) ? _c('text', {
	      staticClass: ["usersName"]
	    }, [_vm._v(_vm._s(c.nickName))]) : _vm._e(), (c.id == _vm.memberId) ? _c('text', {
	      staticClass: ["usersMaster"]
	    }, [_vm._v("(卡主)")]) : _vm._e()])])])])
	  }))], 1)
	},staticRenderFns: []}
	module.exports.render._withStripped = true
