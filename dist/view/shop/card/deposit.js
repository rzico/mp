...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/card/deposit.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-7c979609"
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        open: function open(pageStart, callback) {
	            ...
	            var _this = this;
	            (0, _fetch.GET)('weex/member/card/bill.jhtml?id=' + this.id + '&billDate=' + this.billDate + '&pageNumber=' + this.pageStart + '&pageSize=' + this.pageSize, function (res) {
	                if (res.type == "success") {
	                    if (res.data.start == 0) {
