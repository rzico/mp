...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/card/add.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-18e8200c"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        this.load();
	        this.saveImage = _utils2.default.website("/spread/show.jhtml?id=&uid=" + event.getUId() + '&xmid=' + _utils2.default.xmid);
	    },
	    ...
	    methods: {
	        ...
	        load: function load() {
	            var _this = this;
	            (0, _fetch.GET)("weex/member/card/qrcode.jhtml", function (res) {
	                if (res.type == 'success') {
	                    _this.data = res.data;
	                    _this.qrcode = _utils2.default.website("/q/show.jhtml?url=" + encodeURI(_this.data.qrcode));
	                } else {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    staticClass: ["wrapper", "bkg-primary"]
	  }, [_c('navbar', {
	    attrs: {
	      "title": _vm.title,
	      "border": "false"
	    ...
	    staticClass: ["name"]
	  }, [_vm._v(_vm._s(_vm.data.name))]), _c('image', {
	    staticClass: ["qrcode"],
	    attrs: {
	      "resize": "cover",
	      "src": _vm.qrcode
	  ...
	  return _c('div', {
	    ...
	    staticClass: ["intro"]
	  }, [_vm._v("1.邀请好友打开微信扫一扫并授权登录，办理店铺会员，享受店内会员权益。")]), _c('text', {
	    staticClass: ["intro"]
	  }, [_vm._v("2.办卡会员可以充值，储值卡余额只能在所属商家使用，解悉权归商家所有。")]), _c('text', {
	    staticClass: ["intro"]
	  }, [_vm._v("3.拨打0592-6085128，为您寄送邀请码。")])])
	}]}
	module.exports.render._withStripped = true
