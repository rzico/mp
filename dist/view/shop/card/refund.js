...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/card/refund.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-b284f846"
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        beginTimer: function beginTimer() {
	            ...
	            (0, _fetch.POST)("refunds/query.jhtml?sn=" + _this.sn).then(function (res) {
	                if (res.type == 'success') {
	                    if (res.data == '0000') {
	                        _this.clearTimer();
	                        _this.print();
	        ...
	        submit: function submit(safeKey) {
	            ...
	            (0, _fetch.POST)("weex/member/card/refund.jhtml?id=" + _this.cardId + "&amount=" + _this.quota).then(function (res) {
	                if (res.type == 'success') {
	                    _this.id = res.data.id;
	                    _this.sn = res.data.sn;
	                    (0, _fetch.POST)("refunds/submit.jhtml?sn=" + _this.sn + "&paymentPluginId=" + _this.plugId + "&safeKey=" + safeKey).then(function (data) {
	                        if (data.type == 'success') {
	                            _this.time = 29;
	                            _this.timer = setTimeout(function () {
	                                _this.beginTimer();
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["arrival"]
	  }, [_vm._v("卡实际扣款 " + _vm._s(_vm.creditedAmount) + "元")])])])]), _c('div', {
