...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/card/couponCode.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-d093d0d0"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        this.logo = _utils2.default.getUrlParameter('logo');
	    ...
	    methods: {
	        //             设置赠送张数
	        settingNumber: function settingNumber(id) {
	            var _this = this;
	            modal.prompt({
	                message: '赠送电子券',
	                duration: 0.3,
	                ...
	                if (value.result == '确定') {
	                    if (value.data == '' || value.data == null) {
	                        ...
	                        (0, _fetch.POST)('weex/member/couponCode/add.jhtml?couponCodeId=' + id + '&quantity=' + value.data).then(function (mes) {
	                            if (mes.type == "success") {
	                                _this.open();
	                                _weex.event.toast('赠送成功');
	                            } else {
	        ...
	        linkToInfo: function linkToInfo(id) {
	            var _this = this;
	            if (this.clicked) {
	                return;
	            }
	            this.clicked = true;
	            _weex.event.openURL(_utils2.default.locate('view/shop/card/couponCodeDeposit.js?id=' + id), function (data) {
	                _this.clicked = false;
	            });
	        },
	        ...
	        open: function open() {
	            var _this = this;
	            (0, _fetch.GET)('weex/member/couponCode/list.jhtml?cardId=' + this.cardId, function (mes) {
	                if (mes.type == 'success') {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["memberLogo"],
	    attrs: {
	      "src": _vm.logo
	    }
	  }), _c('text', {
	    staticClass: ["totalNumber"]
	  }, [_vm._v("总计:" + _vm._s(_vm.total) + "（张）")])]), (_vm.lists.length == 0) ? _c('noData', {
	    attrs: {
	    ...
	    }, [_vm._v(_vm._s(c.couponName))]), _c('div', {
	      staticClass: ["infoBottomBox"]
	    }, [_c('text', {
	      staticClass: ["price"]
	    }, [_vm._v("¥ " + _vm._s(_vm._f("currencyfmt")(c.amount)))])])])]), _c('div', {
	      staticClass: ["buttonCell"]
	    }, [_c('div', {
	      staticClass: ["pickBox", "mr30"],
	      on: {
	        "click": function($event) {
	          _vm.settingNumber(c.id)
	        }
	      }
	    }, [_c('text', {
