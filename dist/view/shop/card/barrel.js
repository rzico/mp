...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/card/barrel.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-42053d0b"
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        confirm: function confirm() {
	            ...
	            this.clicked = true;
	            if (_utils2.default.isNull(this.pledge)) {
	                this.pledge = 0;
	            }if (_utils2.default.isNull(this.borrow)) {
	                this.borrow = 0;
	            }if (_utils2.default.isNull(this.mortgage)) {
	                this.mortgage = 0;
	            }
	            (0, _fetch.POST)('weex/member/barrel_stock/update.jhtml?id=' + this.barrelId + '&pledge=' + this.pledge + '&borrow=' + this.borrow + '&mortgage=' + this.mortgage).then(function (data) {
	                _this.clicked = false;
	                if (data.type == 'success') {
	                    _this.isMask = false;
	        ...
	        open: function open() {
	            var _this = this;
	            (0, _fetch.GET)('weex/member/barrel_stock/list.jhtml?cardId=' + this.cardId + '&pageStart=' + this.pageStart + '&pageSize=' + this.pageSize, function (mes) {
	                if (mes.type == 'success') {
	        ...
	        linkToShipping: function linkToShipping(barrelId) {
	            if (this.clicked == true) {
	                return;
	            }
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate("view/shop/card/shipping.js?id=" + this.cardId + "&barrelId=" + barrelId), function (data) {
	                _this.clicked = false;
	            });
	        },
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    on: {
	      "goback": _vm.goback,
	      "goComplete": _vm.setting
	    }
	  }), _c('div', {
	    staticClass: ["totalBox"]
	  }, [_c('div', {
	    staticClass: ["totalBoxLeft"]
	  }, [_c('text', {
	    staticClass: ["totalNumber"]
	  }, [_vm._v("总计:" + _vm._s(_vm.total) + "（个）")])]), _c('div', {
	    staticClass: ["totalBoxRight"]
	  }, [_c('text', {
	    staticClass: ["totalNumber"]
	  }, [_vm._v("押金:" + _vm._s(_vm.money) + "（元）")])])]), _c('list', {
	    staticClass: ["list"],
	    attrs: {
	    ...
	    return _c('div', {}, [_c('div', {
	      ...
	      staticClass: ["money"]
	    }, [_vm._v("押金:" + _vm._s(c.pledge))]), _c('text', {
	      staticClass: ["stock"]
	    }, [_vm._v("余桶:" + _vm._s(c.stock) + "   押桶:" + _vm._s(c.mortgage) + "  借桶:" + _vm._s(c.borrow))])]), _c('div', {
	      staticClass: ["iconBox"],
	      on: {
	        "click": function($event) {
	          _vm.openMask(c)
	    ...
	    staticClass: ["editorBox"]
	  }, [_c('text', {
	    staticClass: ["fz40", "mt30"]
	  }, [_vm._v("期初设置")]), _c('div', {
	    staticClass: ["editorCell"]
	  }, [_c('text', {
	    staticClass: ["fz32"]
	  }, [_vm._v("期初押金:")]), _c('input', {
	    staticClass: ["editorInput", "pl20"],
	    attrs: {
	      "type": "number",
	      "placeholder": "请输入押金",
	      "autofocus": "true",
	    ...
	    on: {
	      "input": function($event) {
	        _vm.pledge = $event.target.attr.value
	      }
	    }
	  })]), _c('div', {
	    staticClass: ["editorCell"]
	    ...
	    on: {
	      "input": function($event) {
	        _vm.mortgage = $event.target.attr.value
	      }
	    }
	  })]), _c('div', {
	    staticClass: ["editorCellTwo"]
	  }, [_c('text', {
	    staticClass: ["fz32"]
	  }, [_vm._v("期初借桶:")]), _c('input', {
	    staticClass: ["editorInput", "pl20"],
	    attrs: {
	      "type": "number",
	      "placeholder": "请输入借桶数量",
	    ...
	    on: {
	      "input": function($event) {
	        _vm.borrow = $event.target.attr.value
	      }
	    }
	  })]), _c('div', {
