...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/card/list.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-becb3d7a"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    components: {
	        navbar: _navbar2.default, search: _search2.default, noData: _noData2.default
	    },
	    data: function data() {
	        return {
	            roles: '',
	    ...
	    created: function created() {
	        ...
	        this.choose = !_utils2.default.isNull(_utils2.default.getUrlParameter('choose'));
	        this.open();
	        this.permissions();
	    },

	    filters: {
	        watchCode: function watchCode(value) {
	    ...
	    methods: {
	        ...
	        open: function open() {
	            var _this = this;
	            (0, _fetch.GET)('weex/member/card/list.jhtml?pageStart=' + this.pageStart + '&pageSize=' + this.pageSize, function (mes) {
	                if (mes.type == 'success') {
	        ...
	        searchCard: function searchCard() {
	            var _this = this;
	            (0, _fetch.GET)('weex/member/card/list.jhtml?type=query&pageStart=' + this.pageStart + '&pageSize=' + this.pageSize + '&searchValue=' + encodeURI(_this.keyword), function (mes) {
	                if (mes.type == 'success') {
	                    if (_this.pageStart == 0) {
	                        _this.lists = mes.data.data;
	                    } else {
	            ...
	            _weex.event.scan(function (message) {
	                _utils2.default.readScan(message.data, function (data) {
	                    if (data.data.type == '818801') {
	                        ...
	                        (0, _fetch.GET)('weex/member/card/infobycode.jhtml?code=' + _this.code, function (mes) {
	                            if (mes.type == 'success') {
	                                _this.id = mes.data.card.id;
	                                _weex.event.openURL(_utils2.default.locate('view/shop/card/view.js?id=' + _this.id), function (message) {});
	                            } else {
	        ...
	        jump: function jump(num) {
	            ...
	            if (_this.choose != true) {
	                _weex.event.openURL(_utils2.default.locate('view/shop/card/view.js?id=' + num.id), function () {
	                    //                    _this.onrefresh()
	                });
	            } else {
	                var E = {
	                ...
	                var backData = _utils2.default.message('success', '选择成功', E);
	                _weex.event.closeURL(backData);
	            }
	        },
	        add: function add() {
	            _weex.event.openURL(_utils2.default.locate("view/shop/card/add.js"), function (message) {});
	        },
	        addCard: function addCard() {
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate("view/shop/card/receiver/amap-picker/amap-picker.js"), function (e) {
	                if (e.type == 'success') {
	                    ...
	                    var url = _utils2.default.locate("view/shop/card/receiver/add/index.js?" + (0, _fetch.URIEncrypt)(ev));
	                    _weex.event.openURL(url, function (res) {
	                        _this.pageStart = 0;
	                        _this.open();
	                    });
	                }
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["fz32", "primary"]
	  }, [_vm._v(_vm._s(_vm.searchOrCancel))])])]), _c('div', {
	    staticStyle: {
	    ...
	    }, [_vm._v(_vm._s(num.mobile))]), _c('div', {
	      staticClass: ["label"]
	    }, [_c('text', {
	      staticClass: ["labelText"]
	    }, [_vm._v(_vm._s(_vm._f("watchType")(num.type)))])]), _c('div', {
	      class: [_vm.vipClass(num.vip)]
	    }, [_c('text', {
	      staticClass: ["labelText"]
	    }, [_vm._v(_vm._s(_vm._f("watchVip")(num.vip)))])])])]), _c('text', {
	      staticClass: ["recommendedTitle"]
	    }, [_vm._v("NO." + _vm._s(_vm._f("watchCode")(num.code)))]), (num.promoter != '') ? _c('text', {
	      staticClass: ["recommendedTitle"]
	    }, [_vm._v("推荐人:" + _vm._s(num.promoter))]) : _vm._e()])])])])
	  })) : _vm._e()], 1)
	},staticRenderFns: []}
	module.exports.render._withStripped = true
