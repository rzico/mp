...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/card/fill.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-24f0aba8"
	...
	exports.default = {
	    ...
	    computed: {
	        creditedAmount: function creditedAmount() {
	            if (_utils2.default.isNull(this.quota)) {
	                return 0;
	            } else {
	    ...
	    created: function created() {
	        ...
	        this.cardId = _utils2.default.getUrlParameter("id");
	        this.load();
	    },
	    ...
	    methods: {
	        ...
	        deposit: function deposit() {
	            event.openURL(_utils2.default.locate("view/shop/deposit/deposit.js"), function (e) {});
	        },
	        ...
	        submit: function submit(safeKey) {
	            ...
	            _this.isSubmit = true;
	            if (_utils2.default.isNull(_this.quota)) {
	            ...
	            (0, _fetch.POST)("weex/member/card/fill.jhtml?id=" + _this.cardId + "&amount=" + _this.quota).then(function (res) {
	                if (res.type == 'success') {
	                    _this.id = res.data.id;
	                    _this.sn = res.data.sn;
	                    (0, _fetch.POST)("payment/submit.jhtml?sn=" + _this.sn + "&paymentPluginId=" + _this.plugId + "&safeKey=" + safeKey).then(function (data) {
	                        if (data.type == 'success') {
	                            _this.time = 29;
	                            _this.timer = setTimeout(function () {
	                                _this.beginTimer();
	  ...
	  return _c('div', {
	    ...
	    on: {
	      "input": [function($event) {
	        _vm.quota = $event.target.attr.value
	      }, _vm.onmoney]
	    }
	  })]), _c('div', {
	    ...
	    staticClass: ["arrival"]
	  }, [_vm._v("卡实际到账 " + _vm._s(_vm.creditedAmount) + "元")])])])]), _c('div', {
	    staticClass: ["buttombox"]
	  }, [_c('div', {
	    staticClass: ["btn"],
	    on: {
	      "click": function($event) {
	        _vm.offline('bankPayPlugin')
	      }
	    }
	  }, [_c('text', {
	    staticClass: ["ico", "bank"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	  }, [_vm._v("")]), _c('text', {
	    ...
	    on: {
	      "click": function($event) {
	        _vm.offline('cashPayPlugin')
	      }
	    }
	  }, [_c('text', {
	    staticClass: ["ico", "cash"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	  }, [_vm._v("")]), _c('text', {
