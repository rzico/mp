...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/card/address.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-3a79805f"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var modal = weex.requireModule('modal');
	exports.default = (_components$props$fil = {
	    components: {
	    ...
	    created: function created() {
	        ...
	        this.cardId = _utils2.default.getUrlParameter('cardId');
	        this.memberId = _utils2.default.getUrlParameter('memberId');
	        if (_utils2.default.isNull(this.cardId)) {
	            this.cardId = '';
	            this.title = '新增会员';
	            this.getGps();
	        } else {
	        ...
	        if (_utils2.default.isNull(this.memberId)) {
	            this.memberId = '';
	        }
	    }
	}, (0, _defineProperty3.default)(_components$props$fil, 'filters', {
	...
	}), (0, _defineProperty3.default)(_components$props$fil, 'methods', {
	    //            楼层选择
	    ...
	    openView: function openView() {
	        var _this = this;
	        (0, _fetch.GET)("weex/member/receiver/view.jhtml?cardId=" + this.cardId, function (mes) {
	            if (mes.type == 'success') {
	                if (!_utils2.default.isNull(mes.data.id)) {
	                    _this.id = mes.data.id;
	                }
	                if (!_utils2.default.isNull(mes.data.consignee)) {
	                    _this.name = mes.data.consignee;
	                }
	                if (!_utils2.default.isNull(mes.data.phone)) {
	                    _this.phone = mes.data.phone;
	                }
	                if (!_utils2.default.isNull(mes.data.areaName)) {
	                    _this.addressName = mes.data.areaName;
	                }
	                if (!_utils2.default.isNull(mes.data.areaId)) {
	                    _this.areaId = mes.data.areaId;
	                }
	                if (!_utils2.default.isNull(mes.data.address)) {
	                    _this.hasChange = true;
	                    _this.detailed = mes.data.address;
	                }
	                if (!_utils2.default.isNull(mes.data.lng)) {
	                    _this.lng = mes.data.lng;
	                }
	                if (!_utils2.default.isNull(mes.data.lat)) {
	                    _this.lat = mes.data.lat;
	                }
	                if (!_utils2.default.isNull(mes.data.level)) {
	    ...
	    getGps: function getGps() {
	        ...
	        event.getLocation(function (data) {
	            if (data.type == 'success') {
	                ...
	                (0, _fetch.GET)("/lbs/get.jhtml?lng=" + data.data.lng + "&lat=" + data.data.lat, function (mes) {
	                    if (mes.type == 'success') {
	                        _this.areaId = mes.data.areaId;
	                    } else {
	                        event.toast(mes.content);
	    ...
	    location: function location() {
	        var _this = this;
	        event.openURL(_utils2.default.locate('widget/city.js'), function (data) {
	    ...
	    complete: function complete() {
	        ...
	        this.clicked = true;
	        if (_utils2.default.isNull(this.id) && !_utils2.default.isNull(this.cardId)) {
	            //                    这个是新增地址
	            if (_utils2.default.isNull(this.name)) {
	                event.toast('请输入用户姓名');
	                _this.clicked = false;
	                return;
	            } else if (_utils2.default.isNull(this.phone)) {
	                event.toast('请输入联系电话');
	                _this.clicked = false;
	                return;
	            } else if (_utils2.default.isNull(this.areaId)) {
	                event.toast('请选择区域地址');
	                _this.clicked = false;
	                return;
	            } else if (_utils2.default.isNull(this.detailed)) {
	                event.toast('请输入详细地址');
	                _this.clicked = false;
	                return;
	            }
	            (0, _fetch.POST)("weex/member/receiver/add.jhtml?isDefault=true&areaId=" + this.areaId + '&address=' + encodeURIComponent(this.detailed) + '&consignee=' + encodeURIComponent(this.name) + '&phone=' + encodeURIComponent(this.phone) + "&lat=" + this.lng + "&lat=" + this.lat + '&memberId=' + this.memberId + '&level=' + this.floor).then(function (mes) {
	                _this.clicked = false;
	                if (mes.type == 'success') {
	                    var E = _utils2.default.message('success', '添加成功', '');
	                    event.closeURL(E);
	                } else {
	                    event.toast(mes.content);
	                }
	        ...
	        } else if (_utils2.default.isNull(this.id) && _utils2.default.isNull(this.cardId)) {
	            //                    这个时候是新增会员
	            if (_utils2.default.isNull(this.name)) {
	                event.toast('请输入用户姓名');
	                _this.clicked = false;
	            ...
	            (0, _fetch.POST)("weex/member/receiver/addcard.jhtml?isDefault=true&areaId=" + this.areaId + '&address=' + encodeURIComponent(this.detailed) + '&consignee=' + encodeURIComponent(this.name) + '&phone=' + this.phone + "&lat=" + this.lng + "&lat=" + this.lat + '&level=' + this.floor).then(function (mes) {
	                _this.clicked = false;
	                if (mes.type == 'success') {
	                    var E = _utils2.default.message('success', '添加成功', '');
	                    event.closeURL(E);
	            ...
	            (0, _fetch.POST)("weex/member/receiver/update.jhtml?isDefault=true&areaId=" + this.areaId + '&id=' + this.id + '&address=' + encodeURIComponent(this.detailed) + '&consignee=' + encodeURIComponent(this.name) + '&phone=' + this.phone + "&lat=" + this.lng + "&lat=" + this.lat + '&level=' + this.floor).then(function (mes) {
	                _this.clicked = false;
	                if (mes.type == 'success') {
	                    var E = _utils2.default.message('success', '修改成功', '');
	                    event.closeURL(E);
	                } else {
	                    event.toast(mes.content);
	                }
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	  ...
	  }, [_vm._v(_vm._s(_vm._f("wacthFloor")(_vm.floor)))]), _c('text', {
	    staticClass: ["arrow"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	    ...
	    staticClass: ["sub_title"]
	  }, [_vm._v(_vm._s(_vm.addressName))]), _c('text', {
	    staticClass: ["arrow"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	    ...
	    on: {
	      "input": function($event) {
	        _vm.detailed = $event.target.attr.value
	      }
	    }
	  }), _c('text', {
	    staticClass: ["arrow"],
	    ...
	    staticClass: ["button", "mt30", "ml30", "mr30"],
	    on: {
	      "click": function($event) {
	        _vm.complete()
	      }
