...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/card/integral.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-5fbe00d1"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    methods: {
	        memoColor: function memoColor(memo) {
	            if (memo < 0) {
	                return { color: 'red' };
	            } else {
	                return { color: '#000' };
	        ...
	        open: function open(pageStart, callback) {
	            this.pageStart = pageStart;
	            var _this = this;
	            (0, _fetch.GET)('weex/member/card/point_bill.jhtml?id=' + this.id + '&billDate=' + this.billDate + '&pageNumber=' + this.pageStart + '&pageSize=' + this.pageSize, function (res) {
	                if (res.type == "success") {
	                    if (res.data.start == 0) {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	  ...
	  }, [_c('noData')], 1) : _vm._e(), _vm._l((_vm.depositList), function(deposit, index) {
	    return _c('cell', {
	      appendAsTree: true,
	      attrs: {
	        "append": "tree"
	      ...
	      staticClass: ["title", "lines-ellipsis", "memo"]
	    }, [_vm._v("积分:" + _vm._s(deposit.memo))]), _c('text', {
	      staticClass: ["money"],
	    ...
	    }, [_vm._v(_vm._s(_vm._f("hitimefmt")(deposit.createDate)))]), _c('text', {
	      staticClass: ["datetime"],
	      staticStyle: {
	        marginRight: "20px"
	      }
	    }, [_vm._v("余额:" + _vm._s(_vm._f("currencyfmt")(deposit.balance)))])])])])])])
	  }), (_vm.noLoading) ? _c('cell', {
	    appendAsTree: true,
	    attrs: {
	      "append": "tree"
	    }
	  }, [_c('div', {
	    staticClass: ["noLoading"]
	  })]) : _vm._e()], 2)], 1)
	},staticRenderFns: []}
	module.exports.render._withStripped = true
