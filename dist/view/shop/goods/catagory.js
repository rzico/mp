...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/goods/catagory.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-55577a7d"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        var catagory = _utils2.default.getUrlParameter('name');
	        if (_utils2.default.isNull(catagory)) {
	            return;
	        } else {
	            _weex.storage.getItem(catagory, function (e) {
	                if (e.data != 'undefined') {
	                ...
	                _weex.storage.removeItem(catagory);
	            });
	        }
	    },
	    ...
	    methods: (_methods = {
	            ...
	            modal.prompt({
	                ...
	                if (value.result == '确定') {
	                    if (_utils2.default.isNull(value.data)) {
	                        _weex.event.toast('请输入分类名');
	                    } else {
	                        var orders = _this.catagoryList.length + 1;
	                        value.data = encodeURI(value.data);
	                        //                            向服务器存入分类名称
	                        (0, _fetch.POST)('weex/member/product_category/add.jhtml?name=' + value.data + '&orders=' + orders).then(function (res) {
	            ...
	            modal.prompt({
	                ...
	                if (value.result == '确定') {
	                    if (value.data == '' || value.data == null) {
	                        ...
	                        (0, _fetch.POST)('weex/member/product_category/update.jhtml?id=' + id + '&name=' + encodeURI(value.data)).then(function (data) {
	                            if (data.type == 'success') {
	        ...
	        deleteCorpus: function deleteCorpus(index, id) {
	            ...
	            modal.confirm({
	                ...
	                if (value == '删除') {
	                    (0, _fetch.POST)('weex/member/product_category/delete.jhtml?id=' + id).then(function (data) {
	                        if (data.type == 'success') {
	        ...
	        var c = this.catagoryList[index].total;
