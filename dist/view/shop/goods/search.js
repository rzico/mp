...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_styles__.push(__webpack_require__(615)
	)
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/goods/search.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-e3da0e2a"
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        searchGoods: function searchGoods() {
	            (0, _fetch.GET)('weex/member/product/search.jhtml?keyword=' + _this.keyword + '&pageStart=' + this.pageStart + '&pageSize=' + this.pageSize, function (data) {
	                if (data.type == 'success') {
	        ...
	        //            通知自组件将input失去焦点
	        childSearch: function childSearch() {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	  ...
	  }), (_vm.isInput()) ? _c('div', [(!_vm.isSearch) ? _c('div', {
	    staticClass: ["confm"],
	    on: {
	      "click": function($event) {
	        _vm.childSearch()
	    ...
	    staticClass: ["title"]
	  }, [_vm._v("搜索: " + _vm._s(_vm.keyword) + " ")])]) : _vm._e()]) : _vm._e(), _c('list', {
	    staticStyle: {
	      backgroundColor: "#fff"
	    },
	    attrs: {
	    ...
	    return _c('cell', {
	      ...
	      staticClass: ["bt10", "flex1"]
	    }, [_c('text', {
	      staticClass: ["goodsPrice"]
	    }, [_vm._v("¥ " + _vm._s(_vm._f("currencyfmt")(item.price)))])]), _c('div', {
