...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* styles */
	__vue_styles__.push(__webpack_require__(582)
	)
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/goods/chooseBrand.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-f3869706"
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        getCatagory: function getCatagory() {
	            var _this = this;
	            (0, _fetch.GET)('weex/member/barrel/list.jhtml', function (data) {
	                if (data.type == "success") {
	                    if (data.data == '') {} else {
	                        _this.catagoryList = [];
	                        //                                将分类名循环插入数组中
	        ...
	        //            更改分类后
	        chooseCorpus: function chooseCorpus(id, name) {
	            var _this = this;
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }), _c('scroller', [_c('transition-group', {
	    attrs: {
	      "name": "paraTransition",
	      "tag": "div"
	    }
