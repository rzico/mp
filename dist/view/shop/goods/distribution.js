...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/goods/distribution.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-020ba787"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        this.catagory = _utils2.default.getUrlParameter('name');
	        this.open();
	    },
	    ...
	    methods: (_methods = {
	        openWebView: function openWebView() {
	            ...
	            _weex.event.openURL(_utils2.default.locate("view/webView/index.js?url=" + encodeURIComponent(data)), function () {
	                _this.clicked = false;
	            });
	        },
	        ...
	        gosetting: function gosetting() {
	            ...
	            this.clicked = true;
	            _weex.event.openURL(_utils2.default.locate("view/shop/goods/promote.js"), function (e) {
	                _this.clicked = false;
	            });
	        },
	        //            获取权限
	        ...
	        open: function open() {
	            var _this = this;
	            if (_utils2.default.isNull(this.catagory)) {
	                (0, _fetch.GET)("weex/member/distribution/list.jhtml", function (res) {
	                    if (res.type == 'success') {
	                ...
	                _weex.storage.getItem(_this.catagory, function (e) {
	                    if (e.data != 'undefined') {
	                        var catagoryData = JSON.parse(e.data);
	                    ...
	                    _weex.storage.removeItem(_this.catagory);
	                });
	            }
	        },
	        //            save:function () {
	        ...
	        //             },
	        //            修改分类名称
	        changeName: function changeName(id, name, percent1, percent2, percent3, point, tota, type) {
	            var _this = this;
	            if (!_utils2.default.isRoles("A", _this.roles)) {
	                ...
	                return;
	            } else if (!_utils2.default.isRoles("1", _this.roles)) {
	                modal.alert({
	                    message: '暂无权限',
	                    okTitle: 'OK'
	                });
	            ...
	            _weex.event.openURL(_utils2.default.locate("view/shop/goods/distributionList.js?id=" + id + '&name=' + encodeURI(name) + '&percent1=' + percent1 + '&percent2=' + percent2 + '&percent3=' + percent3 + '&point=' + point + '&tota=' + tota + '&type=' + type), function () {
	                _this.catagoryList = [];
	                _this.open();
	            });
	        },
	        ...
	        //            删除该分类
	        deleteCorpus: function deleteCorpus(index, id) {
	            var _this = this;
	            modal.confirm({
	                ...
	                if (value == '删除') {
	                    (0, _fetch.POST)('weex/member/distribution/delete.jhtml?id=' + id).then(function (data) {
	                        if (data.type == 'success') {
	        ...
	        //            点击完成时、上传排序后的数组
	        cleanbgChange: function cleanbgChange() {
	            var _this = this;
	            //                关闭所有的分类背景变化
	            this.catagoryList.forEach(function (item) {
	                if (item.bgChange == true) {
	            ...
	            if (this.isSort == 1) {
	                ...
	                //                    向服务器提交
	                (0, _fetch.POST)(url).then(function (data) {
	                    if (data.type == 'success') {
	                        _weex.event.toast('排序成功');
	                        _this.catagoryList = [];
	                        _this.open();
	                    } else {
	                        _weex.event.toast(data.content);
	    ...
	    }, (0, _defineProperty3.default)(_methods, 'lastPara', function lastPara(index) {
	        if (index != this.catagoryList.length - 1) {
	            return true;
	        } else {
	            return false;
	        }
	    }), (0, _defineProperty3.default)(_methods, 'moveUp', function moveUp(index) {
	        this.isSort = 1;
	        //         方法2
	        var a = this.catagoryList[index].name;
	        var b = this.catagoryList[index].id;
	        var c1 = this.catagoryList[index].percent1;
	        var c2 = this.catagoryList[index].percent2;
	        var c3 = this.catagoryList[index].percent3;
	        var c4 = this.catagoryList[index].tota;
	        var c5 = this.catagoryList[index].point;
	        var d = this.catagoryList[index].bgChange;
	    ...
	    }), (0, _defineProperty3.default)(_methods, 'moveBottom', function moveBottom(index) {
	        this.isSort = 1;
	        //         方法2
	        var a = this.catagoryList[index].name;
	        var b = this.catagoryList[index].id;
	        ...
	        this.catagoryList[index + 1].point = c5;
	        this.catagoryList[index + 1].bgChange = d;
	    }), (0, _defineProperty3.default)(_methods, 'jump', function jump() {
	        var _this = this;
	        if (!_utils2.default.isRoles("A", _this.roles)) {
	            modal.alert({
	                message: '请点亮专栏',
	        ...
	        _weex.event.openURL(_utils2.default.locate("view/shop/goods/distributionList.js"), function () {
	            _this.catagoryList = [];
	            _this.open();
	        });
	    }), (0, _defineProperty3.default)(_methods, 'cardSetting', function cardSetting() {
	        var _this = this;
	        ...
	        _weex.event.openURL(_utils2.default.locate('view/shop/card/setting.js'), function () {});
	    }), _methods)
	};
	module.exports = exports['default'];
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('scroller', {
	    ...
	    attrs: {
	      ...
	      "showComplete": _vm.showSort
	    },
	    on: {
	      "goback": _vm.goback,
	      "goComplete": _vm.cleanbgChange
	    }
	  }), _c('div', {
	    staticClass: ["setting"],
	    on: {
	    ...
	    staticClass: ["title"]
	  }, [_vm._v("芸打印机设置")]), _c('text', {
	    staticClass: ["ico_small", "gray"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	  }, [_vm._v("")])]), _c('div', {
	    staticClass: ["bgWhite", "addCorpus"]
	  }, [_c('div', {
	    staticClass: ["lineStyle", "pr30"],
	    on: {
	      "click": function($event) {
	        _vm.jump()
	      }
	  ...
	  }, [_vm._v("")])])]), _vm._m(0), _c('transition-group', {
	    attrs: {
	      "name": "paraTransition",
	      "tag": "div"
	    }
	    ...
	    return _c('div', {
	      key: index,
	      staticClass: ["bgWhite"],
	      class: [item.bgChange ? 'active' : 'noActive'],
	      on: {
	      ...
	      staticClass: ["lineStyle", "bottomBorder"]
	    }, [_c('div', {
	      ...
	      staticClass: ["lineText", "limitWidth"],
	      class: [item.bgChange ? 'active' : 'noActive']
	    }, [_vm._v(_vm._s(item.name))])]), (!item.bgChange) ? _c('div', {
	      staticClass: ["flex-row"],
	      staticStyle: {
	        width: "200px"
	      }
	    }, [_c('div', {
	      staticClass: ["flex-row", "btnHtight"],
	      on: {
	        "click": function($event) {
	          _vm.changeName(item.id, item.name, item.percent1, item.percent2, item.percent3, item.point, item.tota, item.type)
	        }
	      }
	    }, [_c('text', {
	      staticClass: ["gray", "fontSize30"],
	      style: {
	        fontFamily: 'iconfont'
	      }
	    }, [_vm._v("")]), _c('text', {
	      staticClass: ["gray", "fontSize30", "ml5mr10"]
	    }, [_vm._v("修改")])]), _c('div', {
	      staticClass: ["flex-row", "btnHtight"],
	      on: {
	        "click": function($event) {
	          _vm.deleteCorpus(index, item.id)
	        }
	      }
	    }, [_c('text', {
	      staticClass: ["gray", "fontSize30"],
	      ...
	      staticClass: ["white", "fontSize30"],
	      style: {
	        fontFamily: 'iconfont'
	      }
	    }, [_vm._v("")]), _c('text', {
	      staticClass: ["white", "fontSize30", "ml5mr10"]
	    }, [_vm._v("上移")])]) : _vm._e(), (_vm.lastPara(index)) ? _c('div', {
	      staticClass: ["flex-row", "btnHtight"],
	      on: {
	        "click": function($event) {
