...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/goods/distributionList.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-90fda476"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        this.item.id = _utils2.default.getUrlParameter('id');
	        this.item.name = _utils2.default.getUrlParameter('name');
	        if (_utils2.default.isNull(this.item.name)) {
	            _this.item.name = '';
	        }
	        this.item.percent1 = _utils2.default.getUrlParameter('percent1');
	        if (_utils2.default.isNull(this.item.percent1)) {
	            _this.item.percent1 = '';
	        }
	        this.item.percent2 = _utils2.default.getUrlParameter('percent2');
	        if (_utils2.default.isNull(this.item.percent2)) {
	            _this.item.percent2 = '';
	        }
	        this.item.percent3 = _utils2.default.getUrlParameter('percent3');
	        if (_utils2.default.isNull(this.item.percent3)) {
	            _this.item.percent3 = '';
	        }
	        this.begin = _utils2.default.getUrlParameter('point');
	        this.item.tota = _utils2.default.getUrlParameter('tota');
	        if (_utils2.default.isNull(this.item.tota)) {
	            _this.item.tota = '';
	        }
	        this.item.type = _utils2.default.getUrlParameter('type');
	        if (_utils2.default.isNull(this.item.type)) {
	        ...
	        if (!_utils2.default.isNull(this.begin)) {
	            if (_this.begin == 0) {
	    ...
	    methods: {
	        ...
	        //            设置提现比例
	        withdrawalsetup: function withdrawalsetup() {
	            var _this = this;
	            picker.pick({
	                index: _this.begin,
	        ...
	        goComplete: function goComplete() {
	            ...
	            if (this.item.type == 'dividend') {
	                if (_utils2.default.isNull(this.item.name)) {
	                    _weex.event.toast('请输入名称');
	                    return;
	                }
	                if (_utils2.default.isNull(this.item.tota)) {
	                    _weex.event.toast('请输入商品毛利比例');
	                    return;
	                }
	                if (this.item.percent4 == '点击设置') {
	                    _weex.event.toast('请设置提现比例');
	                    return;
	                }
	                if (_utils2.default.isNull(this.item.percent1)) {
	                    _weex.event.toast('请输入佣金比例');
	                    return;
	                }
	                if (_utils2.default.isNull(this.item.percent2)) {
	                    _weex.event.toast('请输入佣金比例');
	                ...
	                if (_utils2.default.isNull(_this.item.id)) {
	                    (0, _fetch.POST)('weex/member/distribution/add.jhtml?name=' + encodeURI(_this.item.name) + '&percent1=' + _this.item.percent1 + '&percent2=' + _this.item.percent2 + '&percent3=' + _this.item.percent3 + '&point=' + _this.begin + '&dividend=' + _this.item.tota).then(function (res) {
	                        if (res.type == 'success') {
	                            _weex.event.toast('添加成功');
	                            _weex.event.closeURL();
	                        } else {
	                            _weex.event.toast(res.content);
	                        }
	                    }, function (err) {
	                        _weex.event.toast(err);
	                    });
	                } else {
	                    var name = encodeURI(_this.item.name);
	                    (0, _fetch.POST)('weex/member/distribution/update.jhtml?id=' + _this.item.id + '&name=' + name + '&percent1=' + _this.item.percent1 + '&percent2=' + _this.item.percent2 + '&percent3=' + _this.item.percent3 + '&point=' + _this.begin + '&dividend=' + _this.item.tota).then(function (data) {
	                        if (data.type == 'success') {
	                            _weex.event.toast('修改成功');
	                            _weex.event.closeURL();
	                        } else {
	                ...
	                _this.item.tota = 0;
	                if (_utils2.default.isNull(_this.item.dividend)) {
	                    _weex.event.toast('请输入返现基数');
	                    return;
	                }
	                if (_utils2.default.isNull(_this.item.percent1)) {
	                    _weex.event.toast('请输入返现比例');
	                    return;
	                }
	                ...
	                if (_utils2.default.isNull(_this.item.id)) {
	                    (0, _fetch.POST)('weex/member/distribution/add.jhtml?name=' + encodeURI(_this.item.name) + '&percent1=' + _this.item.percent1 + '&type=' + _this.item.type + '&percent2=' + _this.item.percent2 + '&percent3=' + _this.item.percent3 + '&point=' + _this.begin + '&dividend=' + _this.item.dividend).then(function (res) {
	                        if (res.type == 'success') {
	                            _weex.event.toast('添加成功');
	                            _weex.event.closeURL();
	                        } else {
	                    ...
	                    var _name = encodeURI(_this.item.name);
	                    (0, _fetch.POST)('weex/member/distribution/update.jhtml?id=' + _this.item.id + '&name=' + _name + '&percent1=' + _this.item.percent1 + '&type=' + _this.item.type + '&percent2=' + _this.item.percent2 + '&percent3=' + _this.item.percent3 + '&point=' + _this.begin + '&dividend=' + _this.item.dividend).then(function (data) {
	                        if (data.type == 'success') {
	                            _weex.event.toast('修改成功');
	                            _weex.event.closeURL();
	                        } else {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["cell-panel", "cell-clear"]
	  }, [_c('text', {
	    staticClass: ["title"]
	  }, [_vm._v("策略名称:")]), _c('input', {
	    staticClass: ["lineContent", "pr20"],
	    attrs: {
	      "type": "text",
	      "autofocus": "true",
	      "returnKeyType": "next",
	    ...
	    on: {
	      "input": function($event) {
	        _vm.item.name = $event.target.attr.value
	      }
	    }
	  })])]), _c('div', {
	    staticClass: ["cell-row", "cell-line"],
	  ...
	  }, [_vm._v(_vm._s(_vm.typeName))])])]), (_vm.item.type == 'dividend') ? _c('div', {
	    staticClass: ["cell-row", "cell-line"]
	  }, [_c('div', {
	    staticClass: ["cell-panel", "cell-clear"]
	  }, [_c('text', {
	    staticClass: ["title"]
	  }, [_vm._v("商品毛利:")]), _c('input', {
	    staticClass: ["lineContent", "pr20"],
	    attrs: {
	      "type": "number",
	      "returnKeyType": "next",
	    ...
	    on: {
	      "input": function($event) {
	        _vm.item.tota = $event.target.attr.value
	      }
	    }
	  }), _c('text', {
	    staticClass: ["title"]
	  }, [_vm._v("%")])])]) : _vm._e(), (_vm.item.type == 'dividend') ? _c('div', {
	    staticClass: ["cell-row", "cell-line"]
	  }, [_c('div', {
	    staticClass: ["cell-panel"]
	  }, [_c('text', {
	    staticClass: ["title"]
	  }, [_vm._v("直接佣金:")]), _c('input', {
	    staticClass: ["lineContent", "pr20"],
	    attrs: {
	      "type": "number",
	      "returnKeyType": "next",
	      "placeholder": "直接佣金比例",
	      "value": (_vm.item.percent1)
	    },
	    on: {
	      "input": function($event) {
	        _vm.item.percent1 = $event.target.attr.value
	      }
	    }
	  }), _c('text', {
	    staticClass: ["title"]
	    ...
	    staticClass: ["title"]
	  }, [_vm._v("间接佣金:")]), _c('input', {
	    staticClass: ["lineContent", "pr20"],
	    attrs: {
	      "type": "number",
	      "returnKeyType": "next",
	      "placeholder": "间接佣金比例",
	      "value": (_vm.item.percent2)
	    },
	    on: {
	      "input": function($event) {
	        _vm.item.percent2 = $event.target.attr.value
	      }
	    }
	  }), _c('text', {
	    staticClass: ["title"]
	    ...
	    staticClass: ["title"]
	  }, [_vm._v("三级佣金:")]), _c('input', {
	    staticClass: ["lineContent", "pr20"],
	    attrs: {
	      "type": "number",
	      "returnKeyType": "next",
	      "placeholder": "三级佣金比例",
	      "value": (_vm.item.percent3)
	    },
	    on: {
	      "input": function($event) {
	        _vm.item.percent3 = $event.target.attr.value
	      }
	    }
	  }), _c('text', {
	    staticClass: ["title"]
	  }, [_vm._v("%")])])]) : _vm._e(), (_vm.item.type == 'global') ? _c('div', {
	    staticClass: ["cell-row", "cell-line"]
	  }, [_c('div', {
	    staticClass: ["cell-panel"]
	  }, [_c('text', {
	    staticClass: ["title"]
	  }, [_vm._v("返现基数:")]), _c('input', {
	    staticClass: ["lineContent", "pr20"],
	    attrs: {
	      "type": "number",
	      "returnKeyType": "next",
	      "placeholder": "请输入返现基数",
	      "value": (_vm.item.dividend)
	    },
	    on: {
	      "input": function($event) {
	        _vm.item.dividend = $event.target.attr.value
	      }
	    }
	  }), _c('text', {
	    staticClass: ["title"]
	    ...
	    staticClass: ["title"]
	  }, [_vm._v("可提现比例:")]), _c('text', {
	    staticClass: ["title", "ml20"]
	  }, [_vm._v(_vm._s(_vm.item.percent4))])])]), _c('div', {
	    staticClass: ["info"]
	  }, [_c('text', {
	    staticClass: ["infoText"]
	  }, [_vm._v("可提现比例为:" + _vm._s(_vm.item.percent4) + ",转换积分比例为" + _vm._s(_vm.pointProp) + "%")])])])], 1)
	},staticRenderFns: []}
	module.exports.render._withStripped = true
