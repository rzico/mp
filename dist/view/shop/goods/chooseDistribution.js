...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_styles__.push(__webpack_require__(591)
	)
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/goods/chooseDistribution.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-de8dd104"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        var urlId = _utils2.default.getUrlParameter('catagoryId');
	        //            ''值被parseInt后会变成NaN
	        if (!_utils2.default.isNull(urlId) && urlId != 'NaN') {
	    ...
	    methods: {
	        ...
	        addCatagory: function addCatagory() {
	            ...
	            //                _this.isShow  = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate("view/shop/goods/distributionList.js"), function (mes) {
	                _this.catagoryList = [];
	                (0, _fetch.GET)("weex/member/distribution/list.jhtml", function (res) {
	                    if (res.type == 'success') {
	                        res.data.forEach(function (item) {
	        ...
	        //            更改分类后
	        chooseCorpus: function chooseCorpus(id, name, itemCount) {
	            var _this = this;
	        ...
	        //            暂不用策略
	        noneDistribution: function noneDistribution(id, name) {
	            var _this = this;
	            if (_this.catagoryId == id) {
	                return;
	            };
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    on: {
	      "click": function($event) {
	        _vm.noneDistribution(0, '')
	      }
	    }
	  }, [_vm._m(0), (_vm.catagoryId == 0 || _vm.catagoryId == 'undefined' || _vm.catagoryId == '') ? _c('div', [_c('text', {
	    staticClass: ["check"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	  }, [_vm._v("")])]) : _vm._e()])]), _c('transition-group', {
	    attrs: {
	      "name": "paraTransition",
	      "tag": "div"
	    }
	    ...
	    return _c('div', {
	      ...
	      on: {
	        "click": function($event) {
	          _vm.chooseCorpus(item.id, item.name, item.count)
	        }
	      }
	    }, [_c('div', {
	      staticClass: ["lineStyle", "bottomBorder"]
	    ...
	    }, [_vm._v(_vm._s(item.name))])]), (_vm.catagoryId == item.id) ? _c('div', [_c('text', {
	      staticClass: ["check"],
	      style: {
	        fontFamily: 'iconfont'
	      }
