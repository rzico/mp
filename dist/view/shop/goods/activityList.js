...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* styles */
	__vue_styles__.push(__webpack_require__(574)
	)
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/goods/activityList.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-4d6944d0"
	...
	exports.default = {
	    ...
	    data: function data() {
	        return {
	            ...
	            roles: '',
	            activeImg: _utils2.default.locate('resources/images/active.png'),
	            loading: false
	        };
	    },
	    ...
	    created: function created() {
	        ...
	        this.goodsName = _utils2.default.getUrlParameter('goodsName');
	        this.open(function () {});
	        this.permissions();
	    },

	    filters: {
	        wacthType: function wacthType(data) {
	            if (data == 'give') {
	                return '送';
	            } else if (data == 'gift') {
	                return '赠';
	    ...
	    methods: {
	        ...
	        add: function add() {
	            ...
	            _weex.event.openURL(_utils2.default.locate("view/shop/goods/activityAdd.js?goodsId=" + this.goodsId + '&goodsName=' + encodeURIComponent(this.goodsName)), function (mes) {
	        ...
	        open: function open() {
	            ...
	            this.loading = true;
	            (0, _fetch.GET)('weex/member/promotion/list.jhtml?goodsId=' + this.goodsId + '&pageStart=' + this.pageStart + '&pageSize=' + this.pageSize, function (mes) {
	                if (mes.type == 'success') {
	        ...
	        del: function del(id, index) {
	            var _this = this;
	            (0, _fetch.POST)('weex/member/promotion/delete.jhtml?id=' + id).then(function (mes) {
	                if (mes.type == "success") {
	                    //                            把动画收回来。
	                    if (animationPara == null || animationPara == '' || animationPara == 'undefinded') {} else {
	                        _weex.animation.transition(animationPara, {
	        ...
	        modification: function modification(id) {
	            ...
	            _weex.event.openURL(_utils2.default.locate('view/shop/goods/activityAdd.js?id=' + id), function (message) {
	                if (message.type == 'success') {
	                    _this.onrefresh();
	                }
	            });
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    }, [_vm._v(_vm._s(_vm._f("wacthType")(num.type)))])]), _c('div', {
