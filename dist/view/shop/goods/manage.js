...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/goods/manage.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-4d170a28"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    data: {
	        ...
	        roles: '',
	        //            三角形图片
	        triangleImg: _utils2.default.locate('resources/images/triangle.png'),
	        //            控制标签气泡渲染
	        hasLabelBox: false,
	        //
	        //            switch 推荐状态
	    ...
	    components: {
	        navbar: _navbar2.default, noData: _noData2.default, searchNav: _searchNav2.default
	    },
	    filters: {
	    ...
	    created: function created() {
	        if (!_utils2.default.isNull(_utils2.default.getUrlParameter('from'))) {
	            this.pageFrom = _utils2.default.getUrlParameter('from');
	        }
	        if (!_utils2.default.isNull(_utils2.default.getUrlParameter('pageType'))) {
	            this.pageType = _utils2.default.getUrlParameter('pageType');
	        }
	        this.permissions();
	    ...
	    methods: {
	        ...
	        //            设置新品标签
	        settingOneLable: function settingOneLable(e) {
	            var _this = this;
	            var rc = 0;
	            ...
	            (0, _fetch.POST)('weex/member/product/tag.jhtml?id=' + this.goodsId + '&tagIds=' + nw + '&tagIds=' + rc).then(function (mes) {
	                if (mes.type == "success") {
	                    var tags = [{ id: nw, name: '新品' }, { id: rc, name: '推荐' }];
	        ...
	        //            设置推荐标签
	        settingTwoLable: function settingTwoLable(e) {
	            var _this = this;
	            var rc = 0;
	            if (e.value == true) {
	                rc = 3;
	        ...
	        getAllGoods: function getAllGoods() {
	            ...
	            if (this.pageType == false) {
	                //            获取商品列表
	                (0, _fetch.GET)('weex/member/product/list.jhtml?productCategoryId=' + this.productCategoryId + '&pageStart=' + this.pageStart + '&pageSize=' + this.pageSize, function (data) {
	                    if (data.type == 'success') {
	                ...
	                (0, _fetch.GET)('weex/member/product/list.jhtml?type=query&productCategoryId=' + this.productCategoryId + '&pageStart=' + this.pageStart + '&pageSize=' + this.pageSize, function (data) {
	                    if (data.type == 'success') {
	                        if (_this.pageStart == 0) {
	                            data.data.data.forEach(function (item) {
	                                //                             （配合懒加载）
	        ...
	        popup: function popup(item, index) {
	            var _this = this;
	            if (!_utils2.default.isNull(this.pageFrom)) {
	                var E = _utils2.default.message('success', '返回商品', item);
	                _weex.event.closeURL(E);
	            } else {
	                ...
	                var tags = this.goodsList[index].tags;
	        ...
	        addGoods: function addGoods() {
	            ...
	            _weex.event.openURL(_utils2.default.locate('view/shop/goods/edit.js?type=add'), function (res) {
	                _this.clicked = false;
	                if (res.type == 'success') {
	                    //                        res.data.sales = 0;
	        ...
	        //            分类
	        goCatagory: function goCatagory() {
	            if (this.clicked) {
	                return;
	            }
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/shop/goods/catagory.js?name=catagoryList'), function (data) {
	                _this.clicked = false;
	                _this.getCatagory();
	            });
	        },
	        ...
	        getCatagory: function getCatagory() {
	            var _this = this;
	            (0, _fetch.GET)('weex/member/product_category/list.jhtml', function (data) {
	                if (data.type == "success") {
	                    if (data.data == '') {} else {
	                        ...
	                        _weex.storage.setItem('catagoryList', data.data);
	                    }
	                } else {
	                    _weex.event.toast(data.content);
	                }
	        ...
	        doPublish: function doPublish() {
	            ...
	            (0, _fetch.GET)('weex/member/product/article.jhtml?id=' + this.goodsId, function (data) {
	                if (data.type == 'success') {
	                    if (data.data == 0) {
	                        //                        如果没有历史记录就新添加一个缓存
	                        var goodsPublish = _this.goodsList[_this.goodsIndex];
	                        goodsPublish = (0, _stringify2.default)(goodsPublish);
	                        _weex.storage.setItem('goodsPublish', goodsPublish, function (e) {
	                            if (e.result == 'success') {
	                                _weex.event.openURL(_utils2.default.locate('view/member/editor/editor.js?goodsStorageName=goodsPublish&goodsId=' + _this.goodsId), function (data) {
	                                    _this.doReset();
	                                    _this.clicked = false;
	                        ...
	                        _weex.event.openURL(_utils2.default.locate('view/member/editor/editor.js?articleId=' + data.data + '&goodsId=' + _this.goodsId), function (data) {});
	                    }
	                } else {
	                    _weex.event.toast(data.content);
	                }
	        ...
	        doEdit: function doEdit() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/shop/goods/edit.js?id=' + this.goodsId), function (res) {
	                _this.clicked = false;
	                _this.doReset();
	                if (res.type == 'success') {
	        ...
	        doDel: function doDel() {
	            ...
	            modal.confirm({
	                ...
	                if (value == '删除') {
	                    (0, _fetch.POST)('weex/member/product/delete.jhtml?ids=' + _this.goodsId).then(function (data) {
	                        if (data.type == 'success') {
	                            _this.goodsList.splice(_this.goodsIndex, 1);
	        ...
	        goAcitve: function goAcitve() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/shop/goods/activityList.js?id=' + this.goodsId + '&goodsName=' + encodeURIComponent(this.goodsName)), function (res) {
	                _this.clicked = false;
	                _this.doReset();
	                //                    if(res.type == 'success'){
	                //                        _this.goodsList.splice(_this.goodsIndex,1);
	        ...
	        searchGoods: function searchGoods() {
	            var _this = this;
	            if (this.pageType == false) {
	                (0, _fetch.GET)('weex/member/product/list.jhtml?keyword=' + encodeURI(_this.keyword) + '&productCategoryId=' + this.productCategoryId + '&pageStart=' + this.pageStart + '&pageSize=' + this.pageSize, function (data) {
	                    if (data.type == 'success') {
	                        if (_this.pageStart == 0) {
	                            _this.goodsList = data.data.data;
	                        } else {
	                ...
	                //                    查找选择模式，多传一个type参数
	                (0, _fetch.GET)('weex/member/product/list.jhtml?type=query&keyword=' + encodeURI(_this.keyword) + '&productCategoryId=' + this.productCategoryId + '&pageStart=' + this.pageStart + '&pageSize=' + this.pageSize, function (data) {
	                    if (data.type == 'success') {
	                        if (_this.pageStart == 0) {
	                            _this.goodsList = data.data.data;
	                        } else {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["fz32", "searchCancelText"]
	  }, [_vm._v(_vm._s(_vm.searchOrCancel))])])])])], 1), _c('div', {
	  ...
	  })]), (_vm.goodsList.length == 0) ? _c('cell', {
	    appendAsTree: true,
	    attrs: {
	      "append": "tree"
	    }
	  ...
	  })], 1) : _vm._l((_vm.goodsList), function(item, index) {
	    return _c('cell', {
	      appendAsTree: true,
	      attrs: {
	        "append": "tree"
	      ...
	      staticClass: ["goodsLine", "boder-bottom"],
	      class: [item.id == _vm.goodsId ? 'bgActive' : ''],
	      on: {
	        "click": function($event) {
	          _vm.popup(item, index)
	        }
	      }
	    }, [(!item.loading) ? _c('div', {
	      staticClass: ["goodsImg", "coverAbsoTop", "top20"]
	    }) : _vm._e(), _c('image', {
	      ...
	      staticClass: ["linesCtrl", "title"]
	    }, [_vm._v(_vm._s(item.name))])]), _c('div', {
	      staticClass: ["flex1"]
	    }, [_c('div', {
	      staticClass: ["bt10", "flex1", "flex-row"]
	    }, [_c('text', {
	      staticClass: ["goodsPrice"]
	    }, [_vm._v("¥ " + _vm._s(_vm._f("currencyfmt")(item.price)))]), _vm._l((item.tags), function(items, index) {
	      return _c('div', [(items.id > 0) ? _c('div', {
	        staticClass: ["listLabelBoxOne"],
	        style: _vm.addBg(items)
	      }, [_c('text', {
	        staticClass: ["listLabelBoxText"]
	      }, [_vm._v(_vm._s(items.name))])]) : _vm._e()])
	    })], 2), _c('div', {
	      staticClass: ["space-between", "bottomInfo", "flex1"]
	    }, [_c('text', {
	      staticClass: ["sub_title", "fz28"]
	    }, [_vm._v("库存: " + _vm._s(item.stock))])])])])])])
	  })], 2), (_vm.isPopup) ? _c('div', {
	    staticClass: ["mask"]
	  }, [(_vm.isPopup) ? _c('div', {
	    staticClass: ["shareBox"]
	  }, [_vm._m(0), (_vm.hasLabelBox) ? _c('div', {
	    ...
	    attrs: {
	      "checked": _vm.newSwitch
	    },
	    on: {
	      "change": _vm.settingOneLable
	    }
	  })]), _c('div', {
	    staticClass: ["switchBox"]
	  }, [_c('text', {
	    ...
	    attrs: {
	      "checked": _vm.recommendSwitch
	    },
	    on: {
	      "change": _vm.settingTwoLable
	    }
	  })]), _c('div', {
	    staticClass: ["triangle"]
	  }, [_c('image', {
	    staticClass: ["triangleImg"],
	    attrs: {
	      "src": _vm.triangleImg
	    }
	    ...
	    staticClass: ["fz32"]
	  }, [_vm._v("关闭")])])]) : _vm._e()]) : _vm._e(), (!_vm.doSearch && !_vm.pageType) ? _c('div', {
