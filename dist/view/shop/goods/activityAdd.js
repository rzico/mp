...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* styles */
	__vue_styles__.push(__webpack_require__(570)
	)
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/goods/activityAdd.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-dbcfd242"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        this.goodsId = _utils2.default.getUrlParameter('goodsId');
	        this.giveGoodsName = _utils2.default.getUrlParameter('goodsName');
	    ...
	    methods: {
	        modification: function modification() {
	            var _this = this;
	            (0, _fetch.GET)('weex/member/promotion/view.jhtml?id=' + _this.id, function (mes) {
	                _utils2.default.debug(mes);
	                if (mes.type == 'success') {
	                    ...
	                    if (_utils2.default.isNull(mes.data.giftId)) {
	        ...
	        goGoods: function goGoods() {
	            ...
	            event.openURL(_utils2.default.locate('view/shop/goods/manage.js?from=active'), function (data) {
	        ...
	        complete: function complete() {
	            ...
	            if (_utils2.default.isNull(_this.buyNumber)) {
	                event.toast('购买数量未设置');
	                return;
	            }
	            if (_utils2.default.isNull(_this.giveNumber)) {
	                event.toast('赠送数量未设置');
	                return;
	            }
	            if (_utils2.default.isNull(this.id)) {
	                (0, _fetch.POST)('weex/member/promotion/add.jhtml?type=' + _this.codeName + '&quantity=' + _this.buyNumber + '&giftQuantity=' + _this.giveNumber + '&giftId=' + _this.giveGoodsId + '&goodsId=' + _this.goodsId).then(function (mes) {
	                    _utils2.default.debug(mes);
	                    if (mes.type == "success") {
	                        event.closeURL(mes);
	                    } else {
	                ...
	                _utils2.default.debug('weex/member/promotion/update.jhtml?id=' + this.id + '&type=' + _this.codeName + '&quantity=' + _this.buyNumber + '&giftQuantity=' + _this.giveNumber + '&giftId=' + _this.giveGoodsId + '&goodsId=' + _this.goodsId);
	                (0, _fetch.POST)('weex/member/promotion/update.jhtml?id=' + this.id + '&type=' + _this.codeName + '&quantity=' + _this.buyNumber + '&giftQuantity=' + _this.giveNumber + '&giftId=' + _this.giveGoodsId + '&goodsId=' + _this.goodsId).then(function (mes) {
	                    _utils2.default.debug(mes);
	                    if (mes.type == "success") {
	                        event.closeURL(mes);
	                    } else {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    on: {
	      "input": function($event) {
	        _vm.buyNumber = $event.target.attr.value
	      }
	    }
	  })]), _c('div', {
	    staticClass: ["scope"]
	  ...
	  }, [_vm._v("赠送数量")]), _c('input', {
	    staticClass: ["inputMoneyTwo"],
	    attrs: {
	      "type": "number",
	      "placeholder": "请输入赠送数量",
	      "value": (_vm.giveNumber)
	    },
	    on: {
	      "input": function($event) {
	        _vm.giveNumber = $event.target.attr.value
	      }
	    }
	  })]), _c('div', {
	    staticClass: ["goods"],
	  ...
	  }, [_vm._v(_vm._s(_vm.giveGoodsName))])]), _c('text', {
	    staticClass: ["arrow"],
	    style: {
	      fontFamily: 'iconfont'
	    }
