...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/goods/promote.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-f84779e6"
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        getTopic: function getTopic() {
	            var _this = this;
	            (0, _fetch.GET)("weex/member/topic/option.jhtml", function (res) {
	                if (res.type == 'success') {
	        ...
	        //            设置对象
	        pickObject: function pickObject() {
	            var _this = this;
	            picker.pick({
	                index: _this.begin,
	        ...
	        complete: function complete() {
	            (0, _fetch.POST)('weex/member/topic/update.jhtml?promoterType=' + this.PromoterType + '&pattern=' + this.Pattern + '&amount=' + this.amount).then(function (data) {
	                if (data.type == 'success') {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["fz32", "color999"]
	  }, [_vm._v("开通分成推广,让推广者帮你推广商品,获得更多订单。")]), _c('text', {
	    staticClass: ["fz32", "color999"]
	  }, [_vm._v("推广者包含个人以及芸店合作渠道。")]), _c('text', {
	    staticClass: ["fz32", "color999"]
	  }, [_vm._v("你只需为因推广者而成功售出的商品付出佣金,交易不成功无需支付任何费用。")]), _c('div', {
	    staticClass: ["setting"],
	    on: {
	      "click": function($event) {
	        _vm.pickPattern()
	  ...
	  }, [_vm._v("升级VIP条件:  " + _vm._s(_vm.isPattern))])]), _c('div', {
	  ...
	  }, [_vm._v("")])])]), (_vm.isMoney()) ? _c('div', {
	    staticClass: ["setting"]
	  }, [_c('div', {
	    staticClass: ["flex-row"]
	  }, [_c('text', {
	    staticClass: ["fz32", "primary"]
	  }, [_vm._v("指定金额(元) :  ")]), _c('input', {
	    staticClass: ["input"],
	    attrs: {
	      "placeholder": "请输入金额",
	      "type": "number",
	    ...
	    staticClass: ["fz32", "primary"]
	  }, [_vm._v("谁能获得分润:  " + _vm._s(_vm.isobject))])]), _c('div', {
	    staticClass: ["flex-row", "flex-end"]
	  }, [_c('text', {
	    staticClass: ["arrow"],
	    style: {
	    ...
	    staticClass: ["completeButton", "bkg-primary"],
	    on: {
	      "click": function($event) {
	        _vm.complete()
	      }
	  ...
	  }, [_vm._v("完成")])]), _vm._m(0)], 1)
	},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    staticClass: ["warning"]
	  }, [_c('text', {
	    staticClass: ["fz32", "color999"]
	  }, [_vm._v("提示:设置完成后,请添加分销政策来设置佣金比例，系统支持返现金与积分方式。")]), _c('text', {
	    staticClass: ["fz32", "color999"]
	  }, [_vm._v("通过本平台产生的店铺积分，1分=1元可在店铺内当现金消费。")])])
	}]}
	module.exports.render._withStripped = true
