...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/goods/edit.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-9537a1e6"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        if (!_utils2.default.isNull(_utils2.default.getUrlParameter('id'))) {
	            this.title = '编辑商品';
	            this.goodsId = _utils2.default.getUrlParameter('id');
	            (0, _fetch.GET)('weex/member/product/view.jhtml?id=' + this.goodsId, function (data) {
	                if (data.type == 'success') {
	                    _this.drawData(data);
	                } else {
	            ...
	            _weex.event.find(findDelete, function (delData) {
	    ...
	    methods: {
	        ...
	        nameUnitFirstInput: function nameUnitFirstInput() {
	            //                        临时缓存起来商品数据
	            if (_utils2.default.isNull(this.goodsId)) {
	                this.saveDraft();
	            }
	        },
	        drawData: function drawData(data) {
	            var _this = this;
	            //                        商品名称
	            var goodName = data.data.name;
	            if (!_utils2.default.isNull(goodName)) {
	                _this.goodsName = goodName;
	            }
	            //                        商品单位
	            var goodUnit = data.data.unit;
	            if (!_utils2.default.isNull(goodUnit)) {
	                _this.goodsUnit = goodUnit;
	            }
	            //                配送方式
	            if (!_utils2.default.isNull(data.data.type)) {
	                _this.isobject = data.data.type;
	            }
	            //                品牌类型
	            if (!_utils2.default.isNull(data.data.barrel.id)) {
	                _this.barrelId = data.data.barrel.id;
	            }
	            if (!_utils2.default.isNull(data.data.barrel.name)) {
	                _this.barrelName = data.data.barrel.name;
	            }
	            //                        分类
	            if (!_utils2.default.isNull(data.data.productCategory.id)) {
	                _this.catagoryId = data.data.productCategory.id;
	            }
	            if (!_utils2.default.isNull(data.data.productCategory.name)) {
	                _this.catagoryName = data.data.productCategory.name;
	            }
	            //                        策略
	            if (!_utils2.default.isNull(data.data.distribution.id)) {
	                _this.distributionId = data.data.distribution.id;
	            }
	            if (!_utils2.default.isNull(data.data.distribution.name)) {
	                _this.distributionName = data.data.distribution.name;
	            }
	            if (data.data.products.length == 1 && _utils2.default.isNull(data.data.products[0].spec1) && _utils2.default.isNull(data.data.products[0].isNew)) {

	                //                        无多规格时的商品id
	                var productId = data.data.products[0].productId;
	                if (!_utils2.default.isNull(_productPrice)) {
	                    _this.firstProductId = _productPrice;
	                }

	                //                        无多规格时的原图、缩略图
	                var productParaImg = data.data.products[0].thumbnail;
	                if (!_utils2.default.isNull(productParaImg)) {
	                ...
	                //                        无多规格时的价格
	                var _productPrice = data.data.products[0].price;
	                var productCost = data.data.products[0].cost;
	                if (!_utils2.default.isNull(_productPrice)) {
	                    _this.topLinePrice = _utils2.default.currencyfmt(_productPrice);
	                    _this.cost = _utils2.default.currencyfmt(productCost);
	                }

	                //                        无多规格时的数量
	                var productNum = data.data.products[0].stock;
	                if (!_utils2.default.isNull(productNum)) {
	                ...
	                data.data.products.forEach(function (item) {
	                    ...
	                    //                        判断是否新增的
	                    if (_utils2.default.isNull(item.isNew)) {
	                        item.isNew = false;
	                    }
	                    if (_utils2.default.isNull(item.stock)) {
	                        item.stock = '';
	                    }
	                    if (!_utils2.default.isNull(item.price)) {
	                        item.price = _utils2.default.currencyfmt(item.price);
	                    }
	                    if (!_utils2.default.isNull(item.cost)) {
	                        item.cost = _utils2.default.currencyfmt(item.cost);
	                    }
	        ...
	        addLines: function addLines() {
	            if (this.list.length == 0) {
	                ...
	                //                    滑动到多行输入框,优化用户体验
	                setTimeout(function () {
	                    var el = _this.$refs.textareaRef; //跳转到相应的cell
	                    _weex.dom.scrollToElement(el, {});
	                }, 200);
	                //                        临时缓存起来商品数据
	                if (_utils2.default.isNull(_this.goodsId)) {
	                    _this.saveDraft();
	                }
	            } else {
	                var goodsIndex = this.list.length - 1;
	                ...
	                var _this2 = this;
	                setTimeout(function () {
	                    var el = _this2.$refs.goodsRef[goodsIndex]; //跳转到相应的cell
	                    _weex.dom.scrollToElement(el, {
	                        offset: 100
	                    });
	                }, 200);
	                //                        临时缓存起来商品数据
	                if (_utils2.default.isNull(_this2.goodsId)) {
	                    _this2.saveDraft();
	                }
	            }
	        },
	        ...
	        //            删除商品规格行
	        delLines: function delLines(item, index) {
	            if (item.isNew) {
	        ...
	        oninput: function oninput(item, index) {
	            //                if(index != 0){
	            var isRepeat = 0;
	            //                    规格1不能为空
	            if (item.spec1 == '') {
	        ...
	        //            新增的商品行选择图片
	        goodsImg: function goodsImg(item) {
	            var _this = this;
	            var options = {
	                isCrop: true,
	                width: 1,
	        ...
	        //            选择商品分类
	        goChooseCatagory: function goChooseCatagory() {
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/shop/goods/chooseCatagory.js?catagoryId=' + this.catagoryId), function (data) {
	        ...
	        //            选择品牌
	        goChoosebrand: function goChoosebrand() {
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/shop/goods/chooseBrand.js?catagoryId=' + this.barrelId), function (data) {
	                if (data.type == 'success' && data.data != '') {
	        ...
	        //            选择营销策略
	        goChooseDistri: function goChooseDistri() {
	            var _this = this;
	            if (!_utils2.default.isRoles("A", _this.roles)) {
	                modal.alert({
	                    message: '请点亮专栏',
	                    okTitle: 'OK'
	                });
	            ...
	            _weex.event.openURL(_utils2.default.locate('view/shop/goods/chooseDistribution.js?catagoryId=' + this.distributionId), function (data) {
	                if (data.type == 'success' && data.data != '') {
	        ...
	        moveUp: function moveUp(index) {
	            var _this = this;
	            //         方法2
	            var a = this.list[index].spec1;
	            var b = this.list[index].spec2;
	            var c = this.list[index].price;
	            var d = this.list[index].stock;
	            var e = this.list[index].isNew;
	            var f = this.list[index].thumbnail;
	            var g = this.list[index].paraImage;
	            var h = this.list[index].productId;
	            var r = this.list[index].cost;
	        ...
	        goComplete: function goComplete() {
	            ...
	            if (_utils2.default.isNull(this.goodsName)) {
	                _weex.event.toast('请完善商品名称');
	                this.clicked = false;
	                return;
	            } else if (_utils2.default.isNull(this.goodsUnit)) {
	                _weex.event.toast('单位不能为空');
	                this.clicked = false;
	                return;
	            } else if (this.goodsUnit.length > 3) {
	                _weex.event.toast('单位不能超过三个汉字');
	                this.clicked = false;
	                return;
	            }
	            ...
	            var _this = this;
	            if (this.list.length == 0) {
	                if (_utils2.default.isNull(this.topLinePrice) || _utils2.default.isNull(this.topLineNum) || _utils2.default.isNull(this.firstParaImage)) {
	                    _weex.event.toast('请完善商品信息');
	                    this.clicked = false;
	                    return;
	                }
	                var frontUrl = '';
	                if (!_utils2.default.isNull(_this.firstParaImage)) {
	                ...
	                if (frontUrl == 'http') {
	                    ...
	                    _weex.event.upload(_this.firstParaImage, function (data) {
	                        if (data.type == 'success') {
	                ...
	                if (sign > 0) {
	                    _weex.event.toast('商品规格1不能为空或重复');
	                    this.clicked = false;
	                    return;
	                }
	                //                    判断规格有没有完整
	                this.list.forEach(function (item) {
	                    if (_utils2.default.isNull(item.paraImage)) {
	                        sign++;
	                    }
	                });
	                if (sign > 0) {
	                    _weex.event.toast('请添加商品图片');
	                    this.clicked = false;
	                    return;
	                }
	                //                    判断规格有没有完整
	        ...
	        sendImage: function sendImage(sendIndex) {
	            ...
	            var _this = this;
	            //                var frontUrl;
	            var sendLength = _this.list.length; //获取图片数组总长度
	            var frontUrl = '';
	            if (!_utils2.default.isNull(_this.list[sendIndex].paraImage)) {
	            ...
	            if (frontUrl == 'http') {
	                ...
	                _weex.event.upload(_this.list[sendIndex].paraImage, function (data) {
	                    if (data.type == 'success') {
	        ...
	        realSave: function realSave() {
	            ...
	            this.savePage('real');
	            //                判断是再次编辑还是初次编辑;
	            var sendId = _utils2.default.isNull(_this.goodsId) ? '' : _this.goodsId;
	            ...
	            //                转成json字符串后上传服务器
	            productData = (0, _stringify2.default)(productData);
	            //                网络请求，保存商品
	            (0, _fetch.POST)('weex/member/product/submit.jhtml', productData).then(function (res) {
	                if (res.data != '' && res.type == 'success') {
	                    _this.currentPro = 0; //当前进度
	                    _this.proTotal = 0; //总的进度
	                    _this.processWidth = 0; //进度条宽度
	                    _this.delDraft();
	                    _weex.event.closeURL(res);
	                } else {
	        ...
	        //            将页面上的数据存储起来
	        savePage: function savePage(isReal) {
	            var _this = this;
	            //                每次保存前 将下列3个变量重新置空;
	            ...
	            if (this.list.length == 0) {
	                ...
	                this.list.forEach(function (item) {
	                    ...
	                    };if (_utils2.default.isNull(_this.goodsId) && _utils2.default.isNull(isReal)) {
	        ...
	        saveDraft: function saveDraft() {
	            ...
	            _weex.event.save(draftOptions, function (data) {
	                if (data.type == 'success' && !_utils2.default.isNull(_this.articleId)) {} else if (data.type == 'success') {} else {
	                    _weex.event.toast(data.content);
	                }
	            });
	        },
	        ...
	        delDraft: function delDraft() {
	            ...
	            _weex.event.find(findDel, function (delData) {
	                if (delData.type == 'success' && delData.data != '') {
	                    //  将临时缓存删除;
	                    _weex.event.delete(findDel, function (data) {
	                        if (data.type == 'success') {} else {
	                            _weex.event.toast(data.content);
	                        }
	                    });
	                }
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    ref: "textareaRef",
	    staticClass: ["textareaBox", "boder-bottom", "boder-top"]
	  }, [_c('textarea', {
	    ...
	    on: {
	      "input": [function($event) {
	        _vm.goodsName = $event.target.attr.value
	      }, _vm.nameUnitFirstInput],
	      "focus": _vm.onfocus,
	      "blur": _vm.onblur
	    }
	  })], 1), _c('div', {
	    staticClass: ["mt30", "boder-bottom", "boder-top"],
	    staticStyle: {
	      width: "750px",
	      backgroundColor: "#fff"
	    }
	  }, [_c('div', {
	    staticClass: ["inputLine", "flex-row"]
	  }, [_c('text', {
	    staticClass: ["title"]
	  }, [_vm._v("单位")]), _c('input', {
	    staticClass: ["lineContent", "goodsAdress"],
	    attrs: {
	      "type": "text",
	      "returnKeyType": "next",
	      "placeholder": "个、件、袋等",
	    ...
	    on: {
	      "input": [function($event) {
	        _vm.goodsUnit = $event.target.attr.value
	      }, _vm.nameUnitFirstInput]
	    }
	  })])]), _c('transition', {
	    attrs: {
	    ...
	    staticClass: ["flex-row", "topGoodsBox", "boder-top", "boder-bottom"]
	  }, [_c('div', [_c('image', {
	    staticClass: ["goodsImg"],
	    class: [_vm.firstThumbnailImg == '' ? 'goodsImgBorder' : ''],
	    attrs: {
	      "src": _vm.firstThumbnailImg
	    },
	    on: {
	      "click": function($event) {
	        _vm.firstImg()
	    ...
	    staticClass: ["topPriceNum"]
	  }, [_c('div', {
	    staticClass: ["inputLine", "flex-row", "boder-bottom"]
	  }, [_c('text', {
	    staticClass: ["title"]
	  }, [_vm._v("价格")]), _c('input', {
	    staticClass: ["lineContent", "specification", "pr10"],
	    attrs: {
	      "type": "number",
	      "returnKeyType": "next",
	      "placeholder": "商品销售价",
	      "value": (_vm.topLinePrice)
	    },
	    on: {
	      "input": [function($event) {
	        _vm.topLinePrice = $event.target.attr.value
	      }, _vm.nameUnitFirstInput]
	    }
	  }), _c('div', {
	    staticClass: ["boder-left"],
	    staticStyle: {
	      width: "1px",
	      height: "40px"
	    }
	  }), _c('input', {
	    staticClass: ["lineContent", "specification"],
	    attrs: {
	      "type": "number",
	      "returnKeyType": "next",
	      "placeholder": "商品成本价",
	    ...
	    on: {
	      "input": [function($event) {
	        _vm.cost = $event.target.attr.value
	      }, _vm.nameUnitFirstInput]
	    }
	  })]), _c('div', {
	    staticClass: ["inputLine", "flex-row"]
	    ...
	    staticClass: ["lineContent", "toplineContentHeight"],
	    attrs: {
	      "type": "number",
	      "returnKeyType": "next",
	      "placeholder": "设置合理库存避免超卖",
	      "value": (_vm.topLineNum)
	    },
	    on: {
	      "input": [function($event) {
	        _vm.topLineNum = $event.target.attr.value
	      }, _vm.nameUnitFirstInput]
	    }
	    ...
	    return _c('div', {
	      ...
	      staticClass: ["flex-row", "goodsBox", "boder-top", "boder-bottom", "boder-right"],
	      class: [item.isNew ? 'borderColor' : '']
	    }, [_c('div', [_c('image', {
	      staticClass: ["goodsImg"],
	      class: [_vm.firstThumbnailImg == '' ? 'goodsImgBorder' : ''],
	      attrs: {
	      ...
	      staticClass: ["lineContent", "specification", "pr20"],
	      attrs: {
	        "type": "text",
	        "autofocus": "true",
	        "returnKeyType": "next",
	      ...
	      on: {
	        "input": [function($event) {
	          item.spec1 = $event.target.attr.value
	        }, function($event) {
	          _vm.oninput(item, index)
	        }]
	      }
	    })]), _c('div', {
	      staticClass: ["boder-left"],
	      ...
	      on: {
	        "input": [function($event) {
	          item.spec2 = $event.target.attr.value
	        }, function($event) {
	          _vm.oninput(item, index)
	        }]
	      }
	      ...
	      on: {
	        "input": [function($event) {
	          item.price = $event.target.attr.value
	        }, function($event) {
	          _vm.oninput(item, index)
	        }]
	      }
	      ...
	      on: {
	        "input": [function($event) {
	          item.cost = $event.target.attr.value
	        }, function($event) {
	          _vm.oninput(item, index)
	        }]
	      }
	      ...
	      on: {
	        "input": [function($event) {
	          item.stock = $event.target.attr.value
	        }, function($event) {
	          _vm.oninput(item, index)
	        }]
	      }
	      ...
	      staticClass: ["delBigBox"],
	      class: [item.isNew ? 'borderColor' : '']
	    }), _c('div', {
	      staticClass: ["delBoxRight"]
	    }), _c('div', {
	      staticClass: ["delSmallBox"],
	      on: {
	        "click": function($event) {
	          _vm.delLines(item, index)
	        }
	      }
	    }, [_c('text', {
	      staticStyle: {
	    ...
	    staticClass: ["flex-row", "ml20", "pt30", "pb30"],
	    on: {
	      "click": function($event) {
	        _vm.addLines()
	      }
	    ...
	    staticClass: ["fz35", "ml10"]
	  }, [_vm._v("添加商品规格")])]), _vm._m(0), _c('div', {
	    staticClass: ["cell-row", "cell-line", "mt10"],
	    on: {
	      "click": function($event) {
	        _vm.goChooseCatagory()
	      }
	    }
	  }, [_c('div', {
	  ...
	  }, [_vm._v(_vm._s(_vm.catagoryName))]), _c('text', {
	    staticClass: ["arrow"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	    ...
	    staticClass: ["sub_title"]
	  }, [_vm._v(_vm._s(_vm.distributionName))]), _c('text', {
	    staticClass: ["arrow"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	    ...
	    staticClass: ["sub_title"]
	  }, [_vm._v(_vm._s(_vm._f("watchType")(_vm.isobject)))]), _c('text', {
	    staticClass: ["arrow"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	    ...
	    staticClass: ["sub_title"]
	  }, [_vm._v(_vm._s(_vm.barrelName))]), _c('text', {
	    staticClass: ["arrow"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	  ...
	  }, [_vm._v("保存")])]), (_vm.toSendArticle) ? _c('div', {
	  ...
	  return _c('div', {
	    staticClass: ["sub-panel", "ml20"]
	  }, [_c('text', {
	    staticClass: ["sub_title"]
	  }, [_vm._v("通过分类有效管理不同类型的商品")])])
	  ...
	  return _c('div', {
	    staticClass: ["sub-panel", "ml20", "mt10"]
	  }, [_c('text', {
	    staticClass: ["sub_title"]
	  }, [_vm._v("设置你的专属销售策略")])])
	},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
