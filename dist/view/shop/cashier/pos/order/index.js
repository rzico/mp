...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_styles__.push(__webpack_require__(629)
	)
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/cashier/pos/order/index.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-08341e50"
...
/***/ (function(module, exports) {
	...
	module.exports = {
	  ...
	  "button": {
	    ...
	    "backgroundColor:active": "#cccccc",
	    "color:active": "#5eb0fd",
	    "backgroundColor:disabled": "#5eb0fd",
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    beforeDestory: function beforeDestory() {
	        //            页面销毁时解除定时器
	        if (!_utils2.default.isNull(this.CursorTime)) {
	    ...
	    methods: {
	        ...
	        linkToEnd: function linkToEnd() {
	            ...
	            _weex.event.openURL(_utils2.default.locate("view/shop/cashier/pos/order/end.js"), function (e) {});
	        },
	        linkToMember: function linkToMember() {
	            this.isCursor = false;
	            this.inputText = '请输入优惠码';
	            //解除定时器
	            if (!_utils2.default.isNull(this.CursorTime)) {
	            ...
	            _weex.event.openURL(_utils2.default.locate("view/shop/cashier/pos/order/members.js"), function (e) {});
	        },
	        linkToConfirm: function linkToConfirm() {
	            this.isCursor = false;
	            this.inputText = '请输入优惠码';
	            //解除定时器
	            if (!_utils2.default.isNull(this.CursorTime)) {
	            ...
	            _weex.event.openURL(_utils2.default.locate("view/shop/cashier/pos/order/confirm.js"), function (e) {});
	        },
	        controlCursor: function controlCursor() {
	            var _this = this;
	            this.isCursor = true;
	            this.inputText = '';
	            //                开启定时器 模拟光标500毫秒闪一次
	        ...
	        controlPrice: function controlPrice() {
	            this.isCursor = false;
	            //解除定时器
	            if (!_utils2.default.isNull(this.CursorTime)) {
	                clearInterval(this.CursorTime);
	        ...
	        controlNumber: function controlNumber() {
	            this.isCursor = false;
	            //解除定时器
	            if (!_utils2.default.isNull(this.CursorTime)) {
	                clearInterval(this.CursorTime);
	        ...
	        controlDiscount: function controlDiscount() {
	            this.isCursor = false;
	            //解除定时器
	            if (!_utils2.default.isNull(this.CursorTime)) {
	                clearInterval(this.CursorTime);
	        ...
	        controlMoney: function controlMoney() {
	            this.isCursor = false;
	            //解除定时器
	            if (!_utils2.default.isNull(this.CursorTime)) {
	                clearInterval(this.CursorTime);
	        ...
	        controlCoupon: function controlCoupon() {
	            this.isCursor = false;
	            //解除定时器
	            if (!_utils2.default.isNull(this.CursorTime)) {
	                clearInterval(this.CursorTime);
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["couponInput"]
	  }, [_vm._v(_vm._s(_vm.inputText))]), (_vm.isCursor) ? _c('text', {
	    staticClass: ["cursor"]
	  }, [_vm._v("|")]) : _vm._e()]), _c('div', {
	    staticClass: ["couponTotal"]
	  }, [_c('div', {
	    staticClass: ["flex-end"]
	  }, [_c('div', {
	    staticClass: ["couponTotalBox", "mr20"],
	    on: {
	      "click": _vm.controlPrice
	    }
	  }, [_c('text', {
	    staticClass: ["couponTotalBoxTitle"]
	  }, [_vm._v("价格")]), _c('text', {
	    staticClass: ["couponTotalBoxSubTitle"]
	  }, [_vm._v("1000")])]), _c('div', {
	    staticClass: ["couponTotalBox"],
	    on: {
	      "click": _vm.controlNumber
	    }
	  }, [_c('text', {
	    staticClass: ["couponTotalBoxTitle"]
	  }, [_vm._v("数量")]), _c('text', {
	    ...
	    staticClass: ["buttonBoxCell"]
	  }, [_vm._m(4), _vm._m(5), _vm._m(6), _vm._m(7), _vm._m(8), _vm._m(9), _c('div', {
	    staticClass: ["buttonCellBoxBorderNull"],
	    on: {
	      "click": _vm.linkToConfirm
	    }
	  }, [_c('text', {
	    staticClass: ["buttonCellBoxText"]
	  }, [_vm._v("确定")])])]), _vm._m(10), _c('div', {
	    staticClass: ["buttonBoxCellTwo"]
	  }, [_vm._m(11), _c('div', {
	    staticClass: ["buttonCellBoxTwo"],
	    on: {
	      "click": _vm.linkToMember
	    }
	  }, [_c('text', {
	    staticClass: ["buttonCellBoxText"]
	  }, [_vm._v("会员")])]), _vm._m(12), _vm._m(13), _vm._m(14), _vm._m(15), _c('div', {
	    staticClass: ["buttonCellBoxBorderNullTwo"],
	    on: {
	      "click": _vm.linkToEnd
	    }
	  }, [_c('text', {
	  ...
	  return _c('div', {
	    staticClass: ["headerMemberInfo"]
	  }, [_c('text', {
	    staticClass: ["fz24", "mr20"],
	    staticStyle: {
	      color: "#999999"
	    }
	  }, [_vm._v("流水号:1234567890")]), _c('text', {
	    staticClass: ["fz24"],
	    staticStyle: {
	      color: "#999999"
	    }
	  ...
	  return _c('div', {
	    staticClass: ["classHeader"]
	  }, [_c('text', {
	    staticClass: ["classOne"]
	  }, [_vm._v("No")]), _c('text', {
	    staticClass: ["classTwo"]
	  }, [_vm._v("优惠码")]), _c('text', {
	    staticClass: ["classThree"]
	  }, [_vm._v("名称")]), _c('text', {
	    staticClass: ["classFour"]
	  }, [_vm._v("价格")]), _c('text', {
	    staticClass: ["classFive"]
	  }, [_vm._v("折扣")]), _c('text', {
	    staticClass: ["classSix"]
	  }, [_vm._v("数量")]), _c('text', {
	    staticClass: ["classSeven"]
	  }, [_vm._v("优惠")]), _c('text', {
	    staticClass: ["classEight"]
	  }, [_vm._v("小计")])])
	},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["orderCellOne"]
	  }, [_vm._v("99")]), _c('text', {
	    staticClass: ["orderCellTwo"]
	  }, [_vm._v("123456")]), _c('text', {
	    staticClass: ["orderCellThree"]
	  }, [_vm._v("耐克超跑嗷")]), _c('text', {
	    staticClass: ["orderCellFour"]
	  }, [_vm._v("10000")]), _c('text', {
	    staticClass: ["orderCellFive"]
	  }, [_vm._v("95")]), _c('text', {
	    staticClass: ["orderCellSix"]
	  }, [_vm._v("99")]), _c('text', {
	    staticClass: ["orderCellSeven"]
	  }, [_vm._v("50")]), _c('text', {
	    staticClass: ["orderCellEight"]
	  }, [_vm._v("95000")])])])])
	},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    staticClass: ["orderTotal"]
	  }, [_c('text', {
	    staticClass: ["orderCellFive"]
	  }, [_vm._v("合计")]), _c('text', {
	    staticClass: ["orderCellSix"]
