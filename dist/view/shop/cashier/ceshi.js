...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/cashier/ceshi.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-1fb92768"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var websiteURL = 'http://weixin.rzico.com';
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    data: {
	        memberBg: _utils2.default.locate('resources/images/memberBg.jpeg'),
	        zuanshiImg: _utils2.default.locate('resources/images/memberBg.png'),
	        vipImg: _utils2.default.locate('resources/images/memberBg.png'),
	        mes: ''
	    },
	    props: {},
	    components: {
	    ...
	    methods: {
	        // 获取会员信息
	        member_view: function member_view() {
	            var _this = this;
	            (0, _fetch.GET)("applet/member/view.jhtml?authorId=43" + '&xmid=43', function (res) {
	                console.log(res);
	                if (res.type == 'success') {
	        ...
	        linkToCard: function linkToCard() {},
	        linkToAddress: function linkToAddress(event) {},
	        linkToDistribution: function linkToDistribution() {},
	        linkToBarrel: function linkToBarrel() {},
	        linkToWebView: function linkToWebView() {
	            var _this = this;
	            //登录认证
	            ...
	            //                        console.log(res);
	            //                        if (res.type == 'success') {
	            //                            http.GET("applet/article/findByTitle.jhtml?title=" + encodeURIComponent('配送时间') + "&xmid=" + http.xmid, function (res) {
	            //                                console.log(res);
	            //                                if (res.type == 'success') {
	            //                                    wx.navigateTo({
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	  ...
	  }), (_vm.mes.type == 'team') ? _c('image', {
	    staticClass: ["vipIcon"],
	    attrs: {
	      "src": _vm.vipImg
	    }
	  }) : _vm._e(), (_vm.mes.type == 'partner') ? _c('image', {
	    staticClass: ["vipIcon"],
	    attrs: {
	      "src": _vm.zuanshiImg
	    }
	    ...
	    staticClass: ["name"]
	  }, [_vm._v(_vm._s(_vm.mes.nickName))]), (_vm.mes.promoter != null && _vm.mes.promoter != '') ? _c('text', {
	    staticClass: ["subName"]
	  }, [_vm._v("推荐人: " + _vm._s(_vm.mes.promoter))]) : _vm._e()])])]), _c('div', {
	    staticClass: ["cellBox"]
	  }, [_c('div', {
	    staticClass: ["cell"],
	    on: {
	      "click": _vm.linkToAddress
	    }
	  }, [_c('div', {
	    staticClass: ["cellLeft"]
	  }, [_c('text', {
	    staticClass: ["cellIcon", "primary"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	  }, [_vm._v("")]), _c('text', {
