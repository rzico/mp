...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/cashier/index.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-1a400fe8"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var websiteURL = 'http://weixin.xmsdar.com';
	var event = weex.requireModule('event');
	var _debug = false; //删掉该属性时请查找该页所有debug变量并删除变量
	var appName = 'water'; // app类型  water 或 yundian
	var utilsFunc = {
	    //0 标准版 1生鲜版 2桶装水
	    version: 2,
	    // app类型
	        ...
	        show: function show(e) {
	            ...
	            (0, _fetch.GET)('weex/member/view.jhtml', function (data) {
	                if (data.type == "success") {
	                    ...
	                    _this.qrcode = _utils2.default.website("/q/show.jhtml?url=" + encodeURI(_this.dataURL + "/q/865380" + (member.id + 10200) + '.jhtml'));
	                    _this.isShow = true;
	                } else {
	                    event.toast(data.content);
	                }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/include/qrcode.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-a22867a0"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _qrcode = __webpack_require__(148);
	...
	var printer = weex.requireModule('print');
	...
	exports.default = {
	    ...
	    beforeDestory: function beforeDestory() {
	        //            页面销毁时解除定时器
	        if (!_utils2.default.isNull(this.gpsTime)) {
	    ...
	    created: function created() {
	        ...
	        this.isIndex = _utils2.default.getUrlParameter("index") == 'true';
	        this.view();
	        ...
	        globalEvent.addEventListener("onMessage", function (e) {
	            if (!_utils2.default.isNull(e.data.data.id) && e.data.data.id == 'gm_10212') {
	                _this.view();
	            }
	            if (!_utils2.default.isNull(e.data.data.id) && e.data.data.id == 'gm_10200') {
	                //                   获取订单数量
	                _this.getCount();
	            }
	            if (!_utils2.default.isNull(e.data.data.id) && e.data.data.id == 'gm_10213') {
	                //                   获取运单数量
	    ...
	    methods: {
	        //            显示收银
	        contolInput: function contolInput() {
	            var _this = this;
	        ...
	        linkToFill: function linkToFill() {
	            if (this.clicked) {
	                return;
	            }
	            this.clicked = true;
	        ...
	        showQrcode: function showQrcode(e) {
	            ...
	            this.clicked = true;
	            var _this = this;
	            if (_utils2.default.isNull(_this.shopId)) {
	                _this.view();
	                if (_utils2.default.isNull(_this.shopId)) {
	                    modal.alert({
	                        message: '无店铺授权',
	            ...
	            _weex.event.openURL(_utils2.default.locate('view/shop/card/add.js'), function (data) {
	                _this.clicked = false;
	            });
	        },
	        ...
	        scanFindCard: function scanFindCard(code) {
	            (0, _fetch.GET)('weex/member/card/infobycode.jhtml?code=' + code, function (mes) {
	                if (mes.type == 'success') {
	                    ...
	                    _weex.event.openURL(_utils2.default.locate('view/shop/card/view.js?id=' + id), function (message) {});
	                } else {
	        ...
	        godistribution: function godistribution() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            if (!_utils2.default.isRoles("1", _this.roles) || _utils2.default.isNull(_this.shopId)) {
	                modal.alert({
	                    message: '暂无权限',
	                    okTitle: 'OK'
	                });
	        ...
	        goods: function goods() {
	            ...
	            _weex.event.openURL(_utils2.default.locate("view/shop/goods/manage.js"), function (e) {
	                _this.clicked = false;
	            });
	        },
	        order: function order() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            if (!_utils2.default.isRoles("12", _this.roles) || _utils2.default.isNull(_this.shopId)) {
	                modal.alert({
	                    message: '暂无权限',
	                    okTitle: 'OK'
	                });
	            ...
	            _weex.event.openURL(_utils2.default.locate("view/shop/order/list.js"), function (e) {
	                _this.clicked = false;
	                _this.getCount();
	                _this.getShippingConut();
	            });
	        },
	        objHeader: function objHeader() {
	            if (_utils2.default.device() == 'V1') {
	                return { backgroundColor: '#000' };
	            }
	        },
	        hasShop: function hasShop() {
	            var _this = this;
	            if (_utils2.default.isRoles("1", _this.roles) && !_utils2.default.isNull(_this.shopId) && _this.shopId > 0) {
	                return true;
	            } else {
	                return false;
	            }
	        ...
	        hasInput: function hasInput() {
	            if (!_utils2.default.isNull(this.amount) || this.inputShow == true) {
	                return true;
	            } else {
	                return false;
	            }
	        ...
	        view: function view() {
	            var _this = this;
	            (0, _fetch.GET)("weex/member/cashier/view.jhtml", function (res) {
	                if (res.type == "success") {
	        ...
	        goShipping: function goShipping() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            if (!_utils2.default.isRoles("123", _this.roles) || _utils2.default.isNull(_this.shopId)) {
	                modal.alert({
	                    message: '暂无权限',
	                    okTitle: 'OK'
	                });
	            ...
	            _weex.event.openURL(_utils2.default.locate("view/shop/shipping/list.js"), function (e) {
	                _this.clicked = false;
	                _this.getCount();
	                _this.getShippingConut();
	            });
	        ...
	        deposit: function deposit() {
	            ...
	            _weex.event.openURL(_utils2.default.locate("view/shop/report/index.js"), function (e) {
	                _this.clicked = false;
	            });
	        },
	        goIndex: function goIndex() {
	            (0, _fetch.GET)("weex/member/topic/owner.jhtml", function (res) {
	                if (res.type == 'success') {
	                    _weex.event.openURL(_utils2.default.locate("view/topic/index.js?id=" + res.data), function (e) {});
	                } else {
	                    _weex.event.toast(res.content);
	                }
	            }, function (err) {
	        ...
	        print: function print() {
	            (0, _fetch.GET)("weex/member/paybill/print.jhtml?id=" + this.id, function (mes) {
	                if (mes.type == 'success') {
	                    if (_utils2.default.device() == 'V1') {
	        ...
	        beginTimer: function beginTimer() {
	            ...
	            (0, _fetch.POST)("payment/query.jhtml?sn=" + _this.sn).then(function (res) {
	                if (res.type == 'success') {
	                    if (res.data == '0000') {
	                        _this.clearTimer();
	                        _this.view();
	                        if (_utils2.default.device() == 'V1') {
	                            _weex.event.toast("付款成功");
	                            _this.print();
	                        } else {
	                            modal.alert({
	                                message: '付款成功',
	        ...
	        offline: function offline(pid) {
	            this.plugId = pid;
	            this.submit("");
	        },
	        submit: function submit(safeKey) {
	            var _this = this;
	            if (_this.isSubmit == true) {
	                return;
	            }
	            _this.isSubmit = true;
	            if (_utils2.default.isNull(_this.amount)) {
	            ...
	            (0, _fetch.POST)("weex/member/cashier/submit.jhtml?shopId=" + _this.shopId + "&amount=" + _this.amount).then(function (res) {
	                if (res.type == 'success') {
	                    _this.id = res.data.id;
	                    _this.sn = res.data.sn;
	                    (0, _fetch.POST)("payment/submit.jhtml?sn=" + _this.sn + "&paymentPluginId=" + _this.plugId + "&safeKey=" + encodeURIComponent(safeKey)).then(function (data) {
	                        if (data.type == 'success') {
	                            _this.time = 29;
	                            _this.timer = setTimeout(function () {
	                                _this.beginTimer();
	        ...
	        payment: function payment(plugId) {
	            ...
	            _weex.event.scan(function (message) {
	                if (message.type == 'success') {
	                    _this.isScan = false;
	                    var c = _utils2.default.qr2scan(message.data);
	                    _this.submit(c);
	                } else {
	                    _this.isScan = false;
	                }
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["wallet-panel", "bkg-primary"],
	    style: _vm.objHeader()
	  }, [_c('div', {
	    ...
	    staticClass: ["headerText", "mt20"]
	  }, [_vm._v("扫一扫")])]), _c('div', {
	    staticClass: ["flex-column"],
	    on: {
	      "click": _vm.linkToFill
	    }
	  }, [_c('text', {
	    staticClass: ["headerIcon"],
	    style: {
	  ...
	  })]), (_vm.conutTotal != 0 && _vm.filter('order')) ? _c('div', {
	    ...
	    staticClass: ["iconfontSize", "primary"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	  }, [_vm._v("")]), _c('text', {
	    staticClass: ["iconfontText"]
	  }, [_vm._v("待付款")]), (_vm.conut.unpaid != 0) ? _c('div', {
	    staticClass: ["shippingNumberBox"]
	  }, [_c('text', {
	    staticClass: ["shippingNumber"]
	  }, [_vm._v(_vm._s(_vm.conut.unpaid))])]) : _vm._e()]), _c('div', {
	    staticClass: ["flexCol", "iconBox"],
	    on: {
	      "click": function($event) {
	        _vm.goNoDelivery()
	    ...
	    staticClass: ["iconfontText"]
	  }, [_vm._v("待发货")]), (_vm.conut.unshipped != 0) ? _c('div', {
	    staticClass: ["shippingNumberBox"]
	  }, [_c('text', {
	    staticClass: ["shippingNumber"]
	  }, [_vm._v(_vm._s(_vm.conut.unshipped))])]) : _vm._e()]), _c('div', {
	    staticClass: ["flexCol", "iconBox"],
	    on: {
	      "click": function($event) {
	        _vm.goDelivery()
	    ...
	    staticClass: ["iconfontText"]
	  }, [_vm._v("已发货")]), (_vm.conut.shipped != 0) ? _c('div', {
	    staticClass: ["shippingNumberBox"]
	  }, [_c('text', {
	    staticClass: ["shippingNumber"]
	  }, [_vm._v(_vm._s(_vm.conut.shipped))])]) : _vm._e()]), _c('div', {
	    staticClass: ["flexCol", "iconBox"],
	    on: {
	      "click": function($event) {
	        _vm.goRefund()
	    ...
	    staticClass: ["iconfontText"]
	  }, [_vm._v("待退款")]), (_vm.conut.refund != 0) ? _c('div', {
	    staticClass: ["shippingNumberBox"]
	  }, [_c('text', {
	    staticClass: ["shippingNumber"]
	  }, [_vm._v(_vm._s(_vm.conut.refund))])]) : _vm._e()])])]) : _vm._e(), (_vm.shippingConutTotal != 0 && _vm.filter('shipping')) ? _c('div', {
	    staticClass: ["contentBox"]
	  }, [_c('div', {
	    staticClass: ["boder-bottom", "pl20", "pr20", "space-between", "headTitle"],
	    on: {
	    ...
	    staticClass: ["iconfontText"]
	  }, [_vm._v("待确认")]), (_vm.shippingConut.unconfirmed != 0) ? _c('div', {
	    staticClass: ["shippingNumberBox"]
	  }, [_c('text', {
	    staticClass: ["shippingNumber"]
	  }, [_vm._v(_vm._s(_vm.shippingConut.unconfirmed))])]) : _vm._e()]), _c('div', {
	    staticClass: ["flexCol", "iconBox"],
	    on: {
	      "click": function($event) {
	        _vm.goToMask()
	    ...
	    staticClass: ["iconfontText"]
	  }, [_vm._v("预约单")]), (_vm.shippingConut.hope != 0) ? _c('div', {
	    staticClass: ["shippingNumberBox"]
	  }, [_c('text', {
	    staticClass: ["shippingNumber"]
	  }, [_vm._v(_vm._s(_vm.shippingConut.hope))])]) : _vm._e()]), _c('div', {
	    staticClass: ["flexCol", "iconBox"],
	    on: {
	      "click": function($event) {
	        _vm.goOnTheWay()
	    ...
	    staticClass: ["iconfontText"]
	  }, [_vm._v("配送中")]), (_vm.shippingConut.confirmed != 0) ? _c('div', {
	    staticClass: ["shippingNumberBox"]
	  }, [_c('text', {
	    staticClass: ["shippingNumber"]
	  }, [_vm._v(_vm._s(_vm.shippingConut.confirmed))])]) : _vm._e()]), _c('div', {
	    staticClass: ["flexCol", "iconBox"],
	    on: {
	      "click": function($event) {
	        _vm.goaArive()
	    ...
	    staticClass: ["iconfontText"]
	  }, [_vm._v("已送达")]), (_vm.shippingConut.completed != 0) ? _c('div', {
	    staticClass: ["shippingNumberBox"]
	  }, [_c('text', {
	    staticClass: ["shippingNumber"]
	  }, [_vm._v(_vm._s(_vm.shippingConut.completed))])]) : _vm._e()])])]) : _vm._e(), _c('div', {
	    staticClass: ["menubox"]
	  }, [(_vm.filter('manage')) ? _c('div', {
	    staticClass: ["menu"],
	    on: {
	      "click": function($event) {
	        _vm.goods()
	    ...
	    staticClass: ["menuBtn"]
	  }, [_vm._v("商品")])]) : _vm._e(), (_vm.filter('order')) ? _c('div', {
	    staticClass: ["menu"],
	    on: {
	      "click": function($event) {
	        _vm.order()
	    ...
	    staticClass: ["menuBtn"]
	  }, [_vm._v("订单")])]) : _vm._e(), (_vm.filter('shipping')) ? _c('div', {
	    staticClass: ["menu"],
	    on: {
	      "click": function($event) {
	        _vm.goShipping()
	    ...
	    staticClass: ["menuBtn"]
	  }, [_vm._v("送货")])]) : _vm._e(), (_vm.filter('card')) ? _c('div', {
	    staticClass: ["menu"],
	    on: {
	      "click": function($event) {
	        _vm.gocard()
	    ...
	    staticClass: ["menuBtn"]
	  }, [_vm._v("会员卡")])]) : _vm._e(), (_vm.filter('coupon')) ? _c('div', {
	    staticClass: ["menu"],
	    on: {
	      "click": function($event) {
	        _vm.gocoupon()
	    ...
	    staticClass: ["menuBtn"]
	  }, [_vm._v("电子券")])]) : _vm._e(), (_vm.filter('distribution')) ? _c('div', {
	    staticClass: ["menu"],
	    on: {
	      "click": function($event) {
	        _vm.godistribution()
	    ...
	    staticClass: ["menuBtn"]
	  }, [_vm._v("新营销")])]) : _vm._e(), (_vm.filter('money')) ? _c('div', {
	    staticClass: ["menu"],
	    on: {
	      "click": function($event) {
	        _vm.deposit()
	    ...
	    staticClass: ["menuBtn"]
	  }, [_vm._v("统计")])]) : _vm._e(), (_vm.filter('shop')) ? _c('div', {
	    staticClass: ["menu"],
	    on: {
	      "click": function($event) {
	        _vm.shop()
	    ...
	    staticClass: ["menuBtn"]
	  }, [_vm._v("店铺")])]) : _vm._e(), (_vm.filter('employee')) ? _c('div', {
	    staticClass: ["menu"],
	    on: {
	      "click": function($event) {
	        _vm.employee()
	    ...
	    staticClass: ["menuBtn"]
	  }, [_vm._v("员工")])]) : _vm._e(), _vm._m(0)])], 1), (_vm.isShow()) ? _c('div', {
	    staticClass: ["waiting"]
	  }, [_c('text', {
	    staticClass: ["ico_big"],
	    style: {
	  ...
	  }, [_vm._v("1.支持微信钱包、支付宝、店内会员卡、钱包")]), _c('text', {
	    staticClass: ["sub_title", "mt10"]
	  }, [_vm._v("2.单笔收钱金额不能超过5000元")]), _c('text', {
	    staticClass: ["sub_title", "mt10"]
	  }, [_vm._v("3.快速秒到,超过30秒没到账联系客服处理")])])
	}]}
	module.exports.render._withStripped = true
