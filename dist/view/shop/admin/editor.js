...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/admin/editor.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-17ac4ed2"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        this.shopName = _utils2.default.getUrlParameter('shopName');
	        this.roleName = _utils2.default.getUrlParameter('roleName');
	        this.mobile = _utils2.default.getUrlParameter('mobile');
	        this.roleId = _utils2.default.getUrlParameter('roleId');
	        this.name = _utils2.default.getUrlParameter('name');
	        this.open();
	        this.huoqu();
	        this.openlist();
	    },
	    ...
	    methods: {
	        ...
	        openlist: function openlist() {
	            var _this = this;
	            (0, _fetch.GET)('weex/member/admin/list.jhtml', function (mes) {
	                if (mes.type == 'success') {
	        ...
	        huoqu: function huoqu() {
	            var _this = this;
	            (0, _fetch.GET)('weex/member/role/list.jhtml', function (mes) {
	                if (mes.type == 'success') {
	        ...
	        selectPosition: function selectPosition() {
	            ...
	            picker.pick({
	                ...
	                if (e.result == 'success') {
	                    (0, _fetch.POST)('weex/member/admin/update.jhtml?id=' + _this.id + '&roleId=' + _this.roles[e.data].id).then(function (mes) {
	                        if (mes.type == "success") {
	        ...
	        //            分配店铺
	        allotment: function allotment(id) {
	            var _this = this;
	            (0, _fetch.POST)('weex/member/admin/update.jhtml?id=' + _this.id + '&shopId=' + id).then(function (mes) {
	                if (mes.type == "success") {
	                    _this.lists.forEach(function (item) {
	                        if (item.id == mes.data.id) {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["sub_title"]
	  }, [_vm._v(_vm._s(_vm.roleName))]), _c('text', {
	    staticClass: ["arrow"],
	    style: {
	      fontFamily: 'iconfont'
	    }
