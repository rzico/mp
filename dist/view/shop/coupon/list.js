...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/coupon/list.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-4838d96d"
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        add: function add() {
	            ...
	            _weex.event.openURL(_utils2.default.locate("view/shop/coupon/add.js"), function (mes) {
	                if (mes.type == 'success') _this.lists.splice(0, 0, mes.data);
	            });
	        },
	        open: function open() {
	            var _this = this;
	            (0, _fetch.GET)('weex/member/coupon/list.jhtml?pageStart=' + this.pageStart + '&pageSize=' + this.pageSize, function (mes) {
	                if (mes.type == 'success') {
	        ...
	        gosearch: function gosearch() {
	            _weex.event.openURL(_utils2.default.locate('view/friend/search.js'), function (message) {
	                //                event.openURL('http://192.168.2.157:8081/search.weex.js',function (message) {
	                if (message.data != '') {
	                    _weex.event.closeURL(message);
	                }
	            });
	        },
	        //            触发自组件的二维码方法
	        ...
	        del: function del(id, index) {
	            ...
	            (0, _fetch.POST)('weex/member/coupon/delete.jhtml?id=' + id).then(function (mes) {
	                if (mes.type == "success") {
	                    //                            把动画收回来。
	                    if (animationPara == null || animationPara == '' || animationPara == 'undefinded') {} else {
	                        _weex.animation.transition(animationPara, {
	        ...
	        modification: function modification(id) {
	            var _this = this;
	            if (!_utils2.default.isRoles("1", _this.roles)) {
	                modal.alert({
	                    message: '暂无权限',
	            ...
	            _weex.event.openURL(_utils2.default.locate('view/shop/coupon/add.js?id=' + id), function (message) {
	                if (message.type == 'success') {
	                    _this.onrefresh();
	                }
	            });
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    }, [_vm._v(_vm._s(num.amount))])]), _c('div', {
	      staticClass: ["name"]
	    }, [_c('text', {
	      staticClass: ["scope"]
	    }, [_vm._v(_vm._s(_vm._f("judgment")(num)))])])])]), _c('div', {
	      staticClass: ["friendsName"]
	    }, [_c('div', {
	      staticClass: ["time"]
	    }, [_c('text', {
	      staticClass: ["lineTitle"]
	    }, [_vm._v(_vm._s(num.name))]), _c('text', {
	      staticClass: ["realName"]
	    }, [_vm._v(_vm._s(_vm._f("timeDatefmt")(num.beginDate)) + "至" + _vm._s(_vm._f("timeDatefmt")(num.endDate)))])]), _c('div', {
	      staticClass: ["use"]
	    }, [_c('text', {
	      staticClass: ["usetext"]
	    }, [_vm._v("剩余数:" + _vm._s(num.stock))])])])])])
	  })], 2) : _vm._e()], 1)
	},staticRenderFns: []}
	module.exports.render._withStripped = true
