...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/coupon/add.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-70e4faa2"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        if (_utils2.default.isNull(this.id)) {
	            this.id = '';
	        } else {
	            this.modification();
	        }
	    ...
	    filters: {
	        ...
	        strainer: function strainer(data) {
	            if (data == 'fullcut') {
	                return '满减';
	            }if (data == 'discount') {
	                return '满折';
	        ...
	        judgment: function judgment(data) {
	            if (data == 'all') {
	                return '全场';
	            }if (data == 'shop') {
	                return '店内';
	        ...
	        activityWatch: function activityWatch(data) {
	            if (data == 0) {
	                return '无门槛';
	            }if (data == 1) {
	                return '消费送';
	    ...
	    methods: {
	        modification: function modification() {
	            var _this = this;
	            (0, _fetch.GET)('weex/member/coupon/view.jhtml?id=' + _this.id, function (mes) {
	                if (mes.type == 'success') {
	                    ...
	                    _this.endDate = _utils2.default.ymdtimefmt(mes.data.endDate);
	                    _this.beginDate = _utils2.default.ymdtimefmt(mes.data.beginDate);
	        ...
	        //            适用范围选择
	        scopesetting: function scopesetting() {
	            var _this = this;
	            picker.pick({
	                index: _this.begin,
	                items: ['全场', '店内', '商城']
	        ...
	        //            优惠券类型选择
	        typesetting: function typesetting() {
	            var _this = this;
	            picker.pick({
	        ...
	        //            活动类型选择
	        activitysetting: function activitysetting() {
	            var _this = this;
	            picker.pick({
	        ...
	        goGoods: function goGoods() {
	            var _this = this;
	            event.openURL(_utils2.default.locate("view/shop/coupon/goodsList.js"), function (data) {
	                if (!_utils2.default.isNull(data.data) && data.type == 'success') {
	                    _this.goodsId = data.data;
	                    event.toast('选择成功');
	                    (0, _fetch.GET)('weex/member/product/view.jhtml?id=' + _this.goodsId, function (mes) {
	                        if (mes.type == 'success') {
	                            _this.goodsName = mes.data.name;
	                        } else {
	                            event.toast(res.content);
	        ...
	        complete: function complete() {
	            var _this = this;
	            if (_utils2.default.isNull(_this.condition)) {
	                _this.condition = 0;
	                //                    event.toast('使用条件未设置')
	            }
	            ...
	            if (_utils2.default.isNull(_this.number)) {
	                event.toast('新增数量未设置');
	                return;
	            }
	            ...
	            //                    }
	            //                }
	            (0, _fetch.POST)('weex/member/coupon/submit.jhtml?type=' + _this.codeName + '&scope=' + _this.scene + '&beginDate=' + _this.beginDate + '&endDate=' + _this.endDate + '&amount=' + _this.money + '&minimumPrice=' + _this.condition + '&introduction=' + encodeURI(_this.rule) + '&id=' + _this.id + '&stock=' + _this.number + '&goodsId=' + _this.goodsId + '&atveType=' + _this.activityName + '&atveMinPrice=' + _this.activitConditions + '&atveAmount=' + _this.activitynum).then(function (mes) {
	                if (mes.type == "success") {
	                    event.closeURL(mes);
	                } else {
	                    event.toast(mes.content);
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	  ...
	  }, [_vm._v(_vm._s(_vm._f("strainer")(_vm.codeName)))])]), _c('div', {
	    staticClass: ["scope"],
	    on: {
	      "click": _vm.scopesetting
	    }
	  }, [_c('text', {
	    staticClass: ["scopeText"],
	    staticStyle: {
	      fontSize: "32px"
	    }
	  }, [_vm._v("适用范围")]), _c('text', {
	  ...
	  }, [_vm._v(_vm._s(_vm._f("judgment")(_vm.scene)))])]), _c('div', {
	    staticClass: ["scope"]
	  }, [_c('text', {
	    staticClass: ["scopeText"],
	    staticStyle: {
	  ...
	  }, [_vm._v("剩余张数")]), _c('input', {
	    staticClass: ["inputMoneyTwo"],
	    attrs: {
	      "type": "number",
	      "placeholder": "请输入剩余张数",
	      "value": (_vm.number)
	    ...
	    staticClass: ["conditionsText"],
	    staticStyle: {
	      fontSize: "32px"
	    }
	  }, [_vm._v("张")])]), (_vm.codeName == 'fullcut' || _vm.codeName == 'discount') ? _c('div', {
	    staticClass: ["money"]
	  }, [_c('div', {
	    staticStyle: {
	      flexDirection: "row",
	    ...
	    staticClass: ["moneyText"],
	    staticStyle: {
	      fontSize: "32px"
	    }
	  }, [_vm._v(_vm._s(_vm.frontTransfrom))]), _c('input', {
	    staticClass: ["inputMoneyTwo"],
	    attrs: {
	      "type": "number",
	      "placeholder": _vm.bottomTransform,
	      "value": (_vm.money)
	    },
	    on: {
	      "change": function($event) {},
	  ...
	  }, [_vm._v(_vm._s(_vm.transform))])])]) : _vm._e(), (_vm.codeName == 'exchange') ? _c('div', {
	    staticClass: ["goods"],
	    on: {
	      "click": function($event) {
	        _vm.goGoods()
	  ...
	  }, [_vm._v(_vm._s(_vm.goodsName))])]), _c('text', {
	    staticClass: ["arrow"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	    ...
	    on: {
	      "input": function($event) {
	        _vm.condition = $event.target.attr.value
	      }
	    }
	  }), _c('text', {
	    staticClass: ["conditionsText"],
	  ...
	  }, [_vm._v(_vm._s(_vm.beginDate))])]), _c('text', {
	    staticClass: ["textTime"],
	    staticStyle: {
	      fontSize: "32px"
	    }
	    ...
	    staticClass: ["introduced"]
	  }, [_c('text', {
	    staticClass: ["introducedText"],
	    staticStyle: {
	      fontSize: "32px"
	    }
	  }, [_vm._v("规则介绍")]), _c('input', {
	    staticClass: ["input"],
	    attrs: {
	      "type": "text",
	      "placeholder": "请输入使用规则(不超过80个汉字)",
	      "value": (_vm.rule)
	    },
	    on: {
	      "input": function($event) {
	        _vm.rule = $event.target.attr.value
	      }
	    }
	  })]), _c('div', {
	    staticClass: ["name"],
	  ...
	  }, [_vm._v(_vm._s(_vm._f("activityWatch")(_vm.activityName)))])]), (_vm.activityName == 1) ? _c('div', {
	    staticClass: ["conditions"]
	  }, [_c('text', {
	    staticClass: ["conditionsText"],
	    staticStyle: {
	    ...
	    staticClass: ["inputMoney"],
	    attrs: {
	      "type": "number",
	      "placeholder": "",
	      "value": (_vm.activitConditions)
	    },
	    on: {
	      "input": function($event) {
	        _vm.activitConditions = $event.target.attr.value
	      }
	    }
	  }), _c('text', {
	    staticClass: ["conditionsText"],
	    ...
	    attrs: {
	      "type": "number",
	      "placeholder": "",
	      "value": (_vm.activitynum)
	    },
	    on: {
	      "input": function($event) {
	        _vm.activitynum = $event.target.attr.value
	      }
	    }
	  }), _c('text', {
	    staticClass: ["conditionsText"],
	  ...
	  }, [_vm._v("张")])]) : _vm._e(), (_vm.activityName == 2) ? _c('div', {
	    staticClass: ["conditions"]
	  }, [_c('text', {
	    staticClass: ["conditionsText"],
	    staticStyle: {
	  ...
	  }, [_vm._v("张")])]) : _vm._e()]), _c('div', {
	    staticStyle: {
	      minHeight: "900px"
	    }
	  })]), _c('div', {
	    staticClass: ["button", "bw", "bottom"],
	    on: {
	      "click": _vm.complete
	    }
	  }, [_c('text', {
	    staticClass: ["bottonText"]
	  }, [_vm._v("完成")])])], 1)
