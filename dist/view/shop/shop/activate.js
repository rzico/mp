...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* styles */
	__vue_styles__.push(__webpack_require__(727)
	)
	__vue_styles__.push(__webpack_require__(728)
	)

	/* script */
	__vue_exports__ = __webpack_require__(729)
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/shop/activate.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-7ece2a72"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        if (!_utils2.default.isNull(_utils2.default.getUrlParameter('u'))) {
	            this.u = _utils2.default.getUrlParameter('u');
	            this.prompting = '重新绑定';
	        }
	        if (!_utils2.default.isNull(_utils2.default.getUrlParameter('p'))) {
	            this.p = _utils2.default.getUrlParameter('p');
	        }
	    },
	    ...
	    methods: {
	        ...
	        //            跳过绑定二维码
	        skip: function skip() {
	            var message = _utils2.default.message('success', '成功', '');
	        ...
	        scan: function scan() {
	            ...
	            event.scan(function (message) {
	                ...
	                _this.u = _utils2.default.getUrlParameter('m', message.data);
	                _this.p = _utils2.default.getUrlParameter('p', message.data);
	                (0, _fetch.POST)('weex/member/shop/printer.jhtml?shopId=' + _this.shopId + '&p=' + _this.p + '&u=' + _this.u).then(function (mes) {
	                    if (mes.type == "success") {
	                        event.openURL(_utils2.default.locate('view/shop/shop/tradeTests.js?shopIdthree=' + _this.shopId), function (message) {
	                            _this.clicked = false;
	                            if (message.type == "success") {
	                                event.closeURL(message);
	                            }
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["text"]
	  }, [_vm._v("设置打印机")]), _c('text', {
	    staticClass: ["sweepCode"]
	  }, [_vm._v(_vm._s(_vm.u == '' ? '' : '设备号:' + _vm.u))]), _c('text', {
	    staticClass: ["sweepCodetwo"]
	  }, [_vm._v(_vm._s(_vm.p == '' ? '' : '设备密钥:' + _vm.p))])]), _c('div', {
	  ...
	  }, [_vm._v(_vm._s(_vm.prompting))])]), _c('div', {
	    staticClass: ["skipBox"]
	  }, [_c('text', {
	    staticClass: ["skipMessage"],
	    on: {
	      "click": function($event) {
	        _vm.call('13860431130')
	      }
	    }
	  }, [_vm._v("暂无打印机，购买热线 13860431130")]), _c('text', {
	    staticClass: ["skipMessage", "mt50"],
	    on: {
	      "click": function($event) {
	        _vm.skip()
	      }
