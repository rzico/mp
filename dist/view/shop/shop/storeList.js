...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* styles */
	__vue_styles__.push(__webpack_require__(739)
	)
	__vue_styles__.push(__webpack_require__(740)
	)

	/* script */
	__vue_exports__ = __webpack_require__(741)
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/shop/storeList.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-6e67eea0"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        this.open(function () {});
	        this.permissions();
	        this.screenHeight = _utils2.default.fullScreen(256);
	    },

	    filters: {
	        filterHead: function filterHead(value) {
	            return _utils2.default.filterHead(value, 250, 200);
	        }
	    ...
	    methods: {
	        modification: function modification(id) {
	            ...
	            _weex.event.openURL(_utils2.default.locate('view/shop/shop/newShop.js?shopId=' + id), function (message) {
	                if (message.type == 'success') {
	                    _this.onrefresh();
	                }
	                _this.clicked = false;
	        ...
	        open: function open() {
	            var _this = this;
	            (0, _fetch.GET)('weex/member/shop/list.jhtml?pageStart=0&pageSize=500', function (mes) {
	                if (mes.type == 'success') {
	        ...
	        add: function add() {
	            ...
	            _weex.event.openURL(_utils2.default.locate('view/shop/shop/newShop.js'), function (message) {
	                _this.clicked = false;
	                if (message.type == 'success') {
	                    _this.onrefresh();
	                }
	        ...
	        del: function del(id, index) {
	            var _this = this;
	            (0, _fetch.POST)('weex/member/shop/delete.jhtml?shopId=' + id).then(function (mes) {
	                if (mes.type == "success") {
	                    //                            把动画收回来。
	                    if (animationPara == null || animationPara == '' || animationPara == 'undefinded') {} else {
	                        _weex.animation.transition(animationPara, {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	  ...
	  }, [_vm._v("+点击添加商铺")])]), (_vm.isEmpty() && _vm.isOwner) ? _c('noData', {
	    style: {
	  ...
	  }) : _vm._e(), (_vm.isNoEmpty() && _vm.isOwner) ? _c('list', {
	    staticStyle: {
	      backgroundColor: "#eeeeee"
	    },
	    attrs: {
	    ...
	    return _c('cell', {
	      ...
	      staticClass: ["concretely"]
	    }, [_vm._v(_vm._s(num.linkman))])]), _c('div', {
	      staticClass: ["shopAddressDiv"]
	    }, [_c('text', {
	      staticClass: ["shopAddress"]
	    }, [_vm._v("收款码：")]), _c('text', {
	      staticClass: ["shopCode"]
	    }, [_vm._v(_vm._s(num.code))])])])])])
	  })], 2) : _vm._e()], 1)
	},staticRenderFns: []}
	module.exports.render._withStripped = true
