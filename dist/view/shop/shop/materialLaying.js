...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* styles */
	__vue_styles__.push(__webpack_require__(731)
	)
	__vue_styles__.push(__webpack_require__(732)
	)

	/* script */
	__vue_exports__ = __webpack_require__(733)
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/shop/materialLaying.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-46e7ef04"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        var _this = this;
	        var eleven = _utils2.default.getUrlParameter('name');
	        storage.getItem(eleven, function (e) {
	            var elevendata = JSON.parse(e.data);
	    ...
	    methods: {
	        ...
	        licenselogo: function licenselogo() {
	            var _this = this;
	            var options = {
	                isCrop: true,
	                width: 1,
	        ...
	        goComplete: function goComplete() {
	            ...
	            (0, _fetch.POST)('weex/member/shop/submit.jhtml?id=' + this.shopId + '&name=' + encodeURI(this.vendorName) + '&areaId=' + this.areaId + '&address=' + encodeURI(this.detailedAddress) + '&license=' + this.originalthree + '&scene=' + this.originaltwo + '&thedoor=' + this.originalone + '&linkman=' + encodeURI(this.contactName) + '&telephone=' + this.contactNumber + '&categoryId=' + this.category).then(function (mes) {
	                _this.clicked = false;
	                if (mes.type == "success") {
	                    event.openURL(_utils2.default.locate('view/shop/shop/activate.js?shopId=' + mes.data.id + '&p=' + mes.data.p + '&u=' + mes.data.u), function (message) {
	                        _this.clicked = false;
	                        if (message.type == "success") {
