...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* styles */
	__vue_styles__.push(__webpack_require__(735)
	)
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/shop/newShop.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-4ce4d9f2"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        this.shopId = _utils2.default.getUrlParameter('shopId');
	    ...
	    methods: {
	        ...
	        modification: function modification() {
	            var _this = this;
	            (0, _fetch.GET)('weex/member/shop/view.jhtml?shopId=' + _this.shopId, function (mes) {
	                if (mes.type == 'success') {
	        ...
	        oninput3: function oninput3(event) {
	            this.contactNumber = event.value;
	            console.log('oninput3', event.value);
	        },
	        oninput4: function oninput4(event) {
	        ...
	        industry: function industry() {
	            var _this = this;
	            event.openURL(_utils2.default.locate('widget/list.js?listId=' + this.category + '&type=category'), function (data) {
	                if (data.type == 'success') {
	        ...
	        goComplete: function goComplete() {
	            ...
	            (0, _fetch.POST)('weex/member/shop/submit.jhtml?id=' + this.shopId + '&name=' + encodeURI(this.vendorName) + '&areaId=' + this.areaId + '&address=' + encodeURI(this.detailedAddress) + '&license=' + this.licensePhoto + '&scene=' + this.palcePhoto + '&thedoor=' + this.logo + '&linkman=' + encodeURI(this.contactName) + '&telephone=' + this.contactNumber + '&categoryId=' + this.category + "&lng=" + _this.lng + "&lat=" + _this.lat).then(function (mes) {
	                _this.clicked = false;
	                if (mes.type == "success") {
	                    _this.shopId = mes.data.id;
	                    var elevendata = {
	                    ...
	                    elevendata = (0, _stringify2.default)(elevendata);
	                    storage.setItem('elevennumber', elevendata, function (e) {
	                        event.openURL(_utils2.default.locate('view/shop/shop/materialLaying.js?name=elevennumber'), function (message) {
	                            _this.clicked = false;
	                            if (message.type == "success") {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["appellation"]
	  }, [_c('text', {
	    staticClass: ["vendorName"]
	  }, [_vm._v("商家名称")]), _c('div', {
	    staticStyle: {
	      flexDirection: "row",
	      alignItems: "center"
	    ...
	    on: {
	      ...
	      "input": [function($event) {
	        _vm.vendorName = $event.target.attr.value
	      }, _vm.oninput]
	    }
	  }), _c('text', {
	    staticClass: ["fontsIcon"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	  }, [_vm._v("")])])]), _c('div', {
	    ...
	    staticClass: ["industryName"]
	  }, [_vm._v(_vm._s(_vm.industryName))]), _c('text', {
	    staticClass: ["fontsIcon"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	  }, [_vm._v("")])])]), (_vm.hasAddress) ? _c('div', {
	    ...
	    staticClass: ["generalLocation"]
	  }, [_vm._v(_vm._s(_vm.addressName))]), _c('text', {
	    staticClass: ["fontsIcon"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	  }, [_vm._v("")])])]) : _vm._e(), (_vm.hasAddress) ? _c('div', {
	    staticClass: ["appellation"]
	  }, [_c('text', {
	    staticClass: ["detailedAddress"]
	  }, [_vm._v("详细地址")]), _c('div', {
	    ...
	    on: {
	      "change": function($event) {},
	      "input": [function($event) {
	        _vm.detailedAddress = $event.target.attr.value
	      }, _vm.oninput4]
	    }
	  }), _c('text', {
	    staticClass: ["fontsIcon"],
	  ...
	  }, [_vm._v("")])])]) : _vm._e(), (!_vm.hasChange && !_vm.hasAddress) ? _c('div', {
	    staticClass: ["gpsBox"],
	    on: {
	      "click": function($event) {
	        _vm.getGps()
	  ...
	  }, [_vm._v("点击定位")])]) : _vm._e(), (_vm.hasChange) ? _c('div', {
	    staticClass: ["changeGpsBox"]
	  }, [_c('text', {
	    staticClass: ["gpsIcon"],
	    style: {
	      fontFamily: 'iconfont'
	  ...
	  }, [_vm._v(_vm._s(_vm.detailedAddress))]), _c('div', {
	    ...
	    on: {
	      "change": function($event) {},
	      "input": [function($event) {
	        _vm.contactName = $event.target.attr.value
	      }, _vm.oninput2]
	    }
	  }), _c('text', {
	    staticClass: ["fontsIcon"],
	    ...
	    on: {
	      "change": function($event) {},
	      "input": [function($event) {
	        _vm.contactNumber = $event.target.attr.value
	      }, _vm.oninput3]
	    }
	  }), _c('text', {
	    staticClass: ["fontsIcon"],
	  ...
	  return _c('div', {
	    ...
	    staticClass: ["belongIndustry"]
	  }, [_vm._v("所属行业")])])
	},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    staticClass: ["left"]
	  }, [_c('text', {
	    staticClass: ["businessLocation"]
	  }, [_vm._v("所在区位")])])
	}]}
	module.exports.render._withStripped = true
