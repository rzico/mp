...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* styles */
	__vue_styles__.push(__webpack_require__(699)
	)
	__vue_styles__.push(__webpack_require__(700)
	)

	/* script */
	__vue_exports__ = __webpack_require__(701)
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/shipping/confirm.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-33dd71c9"
	            ...
	            (0, _fetch.POST)('weex/member/shipping/lock.jhtml?sn=' + this.shippingSn).then(function (data) {
	                if (data.type == 'success') {
	                    if (data.data == true) {
	                        ...
	                        (0, _fetch.POST)('weex/member/shipping/receive.jhtml?sn=' + _this.shippingSn + '&memo=' + encodeURIComponent(_this.noteInput) + '&level=' + _this.floor + "&amountPaid=" + _this.amountPaid + "&paperPaid=" + _this.paperPaid + "&lng=0&lat=0", body).then(function (res) {
	                            _this.clicked = false;
	                            if (res.type == 'success') {
