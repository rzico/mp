...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* styles */
	__vue_styles__.push(__webpack_require__(711)
	)
	__vue_styles__.push(__webpack_require__(712)
	)

	/* script */
	__vue_exports__ = __webpack_require__(713)
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/shipping/list.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-2e97e965"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var map = weex.requireModule('map');
	...
	exports.default = {
	    ...
	    filters: {
	        watchSpec: function watchSpec(value) {
	            if (_utils2.default.isNull(value)) {
	                return '无';
	            } else {
	                return value;
	        ...
	        watchCreateDate: function watchCreateDate(value) {
	            return _utils2.default.ymdhistimefmt(value);
	        },
	        watchThumbnail: function watchThumbnail(value) {
	            //                    没过滤前是原图
	            return _utils2.default.thumbnail(value, 160, 160);
	        },
	        watchlogo: function watchlogo(value) {
	            return _utils2.default.thumbnail(value, 40, 40);
	        }
	    },
	    components: {
	        navbar: _navbar2.default, noData: _noData2.default
	    },
	    created: function created() {
	        _utils2.default.initIconFont();
	        var d = _utils2.default.getUrlParameter('index');
	        if (!_utils2.default.isNull(d)) {
	            this.whichCorpus = d;
	        }
	        var e = _utils2.default.getUrlParameter('productCategoryId');
	        if (!_utils2.default.isNull(e)) {
	    ...
	    methods: {
	        printMaskTap: function printMaskTap() {
	            return;
	        },

	        //            关闭打印
	        downPrint: function downPrint() {
	        ...
	        printData: function printData(idx) {
	            var _this = this;
	            if (idx < this.printList.length) {
	                var sn = this.printList[idx].sn;
	                var dx = idx + this.beginNumber;
	                (0, _fetch.GET)('weex/member/shipping/print.jhtml?sn=' + sn + "&seqno=" + dx, function (data) {
	                    if (data.type == 'success') {
	        ...
	        print: function print() {
	            ...
	            this.clicked = true;
	            if (!_utils2.default.isNull(this.beginNumber)) {
	                this.beginNumber = parseInt(this.beginNumber);
	            }if (!_utils2.default.isNull(this.endNumber)) {
	            ...
	            (0, _fetch.GET)('weex/member/shipping/list.jhtml?status=' + status + '&pageStart=' + pageStart + '&pageSize=' + pageSize + '&keyword=' + encodeURIComponent(this.keyword), function (res) {
	                if (res.type == "success") {
	        ...
	        goSearch: function goSearch() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('widget/search.js'), function (data) {
	                _this.clicked = false;
	        ...
	        //            是否显示导航
	        hasMap: function hasMap(lat, lng) {
	            if (!_utils2.default.isNull(lat) && !_utils2.default.isNull(lng)) {
	                return true;
	            } else {
	                return false;
	            }
	        ...
	        //            开启导航
	        goMap: function goMap(lat, lng) {
	            _weex.event.getLocation(function (res) {
	                if (res.type == 'success') {
	                    var data = {
	                        slat: res.data.lat,
	                        slon: res.data.lng,
	        ...
	        filter: function filter(e) {
	            var _this = this;
	            if (!_utils2.default.isNull(this.roles)) {
	                if (e == 'unconfirmed') {
	                    //                    派单等
	        ...
	        checkChoose: function checkChoose(index) {
	        ...
	        //            单选
	        singleChoose: function singleChoose(index, groupName) {
	            var _this = this;
	        ...
	        moreSingle: function moreSingle() {
	            var _this = this;
	            if (this.clicked) {
	                return;
	            }
	            this.clicked = true;
	            if (_utils2.default.isNull(this.shopId)) {
	                _weex.event.toast('请选择配送站');
	                _this.clicked = false;
	                return;
	            }
	            if (this.isSelf == true || this.isSelf == 'true') {
	                if (_utils2.default.isNull(this.markiId)) {
	                    _weex.event.toast('请选择配送人员');
	                    _this.clicked = false;
	                    return;
	                }
	            }
	            (0, _fetch.POST)('weex/member/shipping/batch_dispatch.jhtml?ids=' + _this.ids + '&shopId=' + _this.shopId + '&adminId=' + _this.markiId + '&memo=' + encodeURIComponent(_this.message)).then(function (data) {
	                _this.clicked = false;
	                if (data.type == 'success') {
	                    _this.isMask = false;
	                    _this.pageStart = 0;
	                    _this.open();
	                    _weex.event.toast('批量派单成功');
	                } else {
	                    _weex.event.toast(data.content);
	                }
	            }, function (err) {
	        ...
	        //            设置配送站
	        pickPattern: function pickPattern() {
	            ...
	            _weex.event.openURL(_utils2.default.locate('view/shop/shipping/station.js'), function (data) {
	                _this.clicked = false;
	                if (data.type == 'success' && data.data != '') {
	        ...
	        linkTo: function linkTo() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('widget/list.js?type=xdict'), function (data) {
	                _this.clicked = false;
	                if (data.type == 'success' && data.data != '') {
	        ...
	        goMarki: function goMarki() {
	            ...
	            var _this = this;
	            if (_utils2.default.isNull(this.shopId)) {
	                _weex.event.toast('请先选择配送站');
	                _this.clicked = false;
	                return;
	            }
	            _weex.event.openURL(_utils2.default.locate('view/shop/shipping/marki.js?shopId=' + this.shopId), function (data) {
	                _this.clicked = false;
	                if (data.type == 'success') {
	        ...
	        //            },
	        //分类切换
	        catagoryChange: function catagoryChange(index, id) {
	            _utils2.default.debug(this.whichCorpus);
	            _utils2.default.debug(index);
	            //                event.toast(id);
	            var _this = this;
	        ...
	        open: function open(type) {
	            ...
	            (0, _fetch.GET)('weex/member/shipping/list.jhtml?status=' + status + '&pageStart=' + this.pageStart + '&pageSize=' + this.pageSize + '&keyword=' + encodeURIComponent(this.keyword) + '&estimateDate=' + encodeURIComponent(this.keyDate) + '&shopId=' + this.keyShopId + '&adminId=' + this.keyAdminId, function (res) {
	        ...
	        goDetails: function goDetails(sn) {
	            if (this.clicked) {
	                return;
	            }
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/shop/shipping/details.js?sn=' + sn), function () {
	                _this.clicked = false;
	            });
	        },
	        //            前往作者主页
	        ...
	        //            跳转详情
	        info: function info(orderSn, sn) {
	            if (this.clicked) {
	                return;
	            }
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/shop/shipping/info.js?orderSn=' + orderSn + '&sn=' + sn), function (data) {
	                _this.clicked = false;
	                if (data.type == 'success') {}
	            });
	        },
	        //            跳转派单
	        sendSingle: function sendSingle(orderSn, sn, isSelf) {
	            if (this.clicked) {
	                return;
	            }
	            this.clicked = true;
	            var _this = this;
	            if (_utils2.default.isRoles("3", _this.roles)) {
	                modal.alert({
	                    message: '暂无权限',
	                    okTitle: 'OK'
	                });
	            ...
	            _weex.event.openURL(_utils2.default.locate('view/shop/shipping/sendSingle.js?orderSn=' + orderSn + '&sn=' + sn + '&isPageType=' + this.isPageType + '&isSelf=' + isSelf), function (data) {
	                _this.clicked = false;
	                if (data.type == 'success') {
	                    _this.pageStart = 0;
	                    _this.open();
	                    _weex.event.toast('派单成功');
	                } else {}
	            });
	        },
	        //            跳转转派
	        trunSend: function trunSend(orderSn, sn, isSelf) {
	            if (this.clicked) {
	                return;
	            }
	            this.clicked = true;
	        ...
	        rejected: function rejected(sn) {
	            ...
	            modal.confirm({
	                ...
	                if (value == '驳回') {
	                    (0, _fetch.POST)('weex/member/shipping/reject.jhtml?sn=' + sn).then(function (data) {
	                        if (data.type == 'success') {
	                            _this.pageStart = 0;
	                            _this.open();
	                            _weex.event.toast('驳回成功');
	                        } else {
	                            _weex.event.toast(data.content);
	                        }
	                    }, function (err) {
	        ...
	        //            跳转送达
	        delivery: function delivery(orderSn, sn, shippingId) {
	            ...
	            _weex.event.openURL(_utils2.default.locate('view/shop/shipping/delivery.js?orderSn=' + orderSn + '&sn=' + sn + '&shippingId=' + shippingId), function (data) {
	                _this.clicked = false;
	                _this.pageStart = 0;
	                _this.open();
	            });
	        ...
	        //            跳转核销
	        confirm: function confirm(orderSn, sn, shippingId) {
	            if (this.clicked) {
	                return;
	            }
	            this.clicked = true;
	            ...
	            _weex.event.openURL(_utils2.default.locate('view/shop/shipping/confirm.js?orderSn=' + orderSn + '&sn=' + sn + '&shippingId=' + shippingId), function (data) {
	                _this.clicked = false;
	                if (data.type == 'success') {
	                    _this.pageStart = 0;
	                    _this.open();
	                    _weex.event.toast('送达成功');
	                }
	            });
	        }
	    }
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["nav_CompleteIcon", "mr15"],
	    style: {
	      fontFamily: 'iconfont'
	    },
	    on: {
	  ...
	  }, _vm._l((_vm.catagoryList), function(item, index) {
	    return _c('div', {
	      ...
	      on: {
	        "click": function($event) {
	          _vm.catagoryChange(index, item.id)
	        }
	      }
	  ...
	  })]), (_vm.shippingList.length == 0) ? _c('cell', {
	    appendAsTree: true,
	    attrs: {
	      "append": "tree"
	    }
	  ...
	  })], 1) : _vm._l((_vm.shippingList), function(item, index) {
	    return _c('cell', {
	      appendAsTree: true,
	      attrs: {
	        "append": "tree"
	      ...
	      staticClass: ["goodsLine", "mt20"]
	    }, [_c('div', {
	      staticClass: ["space-between", "goodsHead"]
	    }, [_c('div', {
	      ...
	      staticClass: ["consignee", "ml20", "mr20"]
	    }, [_vm._v(_vm._s(item.consignee))]), _c('text', {
	      staticClass: ["address"]
	    }, [_vm._v(_vm._s(item.address))])])]), _c('div', [_c('text', {
	      staticClass: ["title", "red"]
	    }, [_vm._v(_vm._s(item.statusDescr))])])]), _vm._l((item.shippingItems), function(goods) {
	      return _c('div', {
	        staticClass: ["flex-row", "goodsBody"],
	        on: {
	          "click": function($event) {
	            _vm.info(item.orderSn, item.sn)
	          }
	        }
	      }, [_c('image', {
	        staticClass: ["goodsImg"],
	        attrs: {
	          "src": _vm._f("watchThumbnail")(goods.thumbnail)
	        }
	      }), _c('div', {
	        staticClass: ["goodsInfo"]
	      }, [_c('text', {
	        staticClass: ["title", "goodsName"]
	      }, [_vm._v(_vm._s(goods.name))]), _c('text', {
	        staticClass: ["sub_title"]
	      }, [_vm._v("规格:" + _vm._s(_vm._f("watchSpec")(goods.spec)))]), _c('div', {
	        staticClass: ["goodsPriceNum"]
	      }, [_c('text', {
	        staticClass: ["sub_title"]
	      }, [_vm._v("x" + _vm._s(goods.quantity))])])])])
	    }), _c('div', {
	      staticClass: ["flex-row", "goodsTotalPrice", "boder-bottom"]
	    }, [_c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("NO." + _vm._s(index + 1) + " 订单号:" + _vm._s(item.orderSn))]), _c('div', {
	      staticClass: ["flex-row"]
	    }, [_c('text', {
	      staticClass: ["sub_title", "mr20"]
	    }, [_vm._v("共" + _vm._s(item.quantity) + "件商品")])])]), (item.status == 'unconfirmed' && _vm.filter('unconfirmed')) ? _c('div', {
	      staticClass: ["flex-row", "space-between", "goodsFoot"]
	    }, [_c('div', {
	      staticClass: ["flex-row"]
	    }, [_c('text', {
	      staticClass: ["fz28"],
	      ...
	      staticClass: ["flex-row"]
	    }, [(item.isSelf == true) ? _c('div', {
	      staticClass: ["flex-row"]
	    }, [_c('text', {
	      staticClass: ["title", "footText"],
	      on: {
	        "click": function($event) {
	          _vm.trunSend(item.orderSn, item.sn, item.isSelf)
	        }
	      }
	    }, [_vm._v("转派")])]) : _c('div', {
	      staticClass: ["flex-row"]
	      ...
	      on: {
	        "click": function($event) {
	          _vm.sendSingle(item.orderSn, item.sn, item.isSelf)
	        }
	      }
	    }, [_vm._v("派单")])])])]) : (item.status == 'dispatch' && _vm.filter('dispatch')) ? _c('div', {
	      staticClass: ["flex-row", "space-between", "goodsFoot"]
	    }, [_c('div', {
	      staticClass: ["footMore"]
	    }), _c('div', {
	      staticClass: ["flex-row"]
	    }, [(_vm.hasMap(item.lat, item.lng)) ? _c('text', {
	      staticClass: ["title", "footText", "mr20"],
	      on: {
	        "click": function($event) {
	          _vm.goMap(item.lat, item.lng)
	        }
	      }
	    }, [_vm._v("一键导航")]) : _vm._e(), _c('text', {
	      staticClass: ["title", "footText"],
	      on: {
	        "click": function($event) {
	          _vm.delivery(item.orderSn, item.sn, item.id)
	        }
	      }
	    }, [_vm._v("送达")])])]) : (item.status == 'delivery' && _vm.filter('delivery')) ? _c('div', {
	      staticClass: ["flex-row", "space-between", "goodsFoot"]
	    }, [_c('div', {
	      staticClass: ["footMore"]
	    }), _c('div', {
	      ...
	      on: {
	        "click": function($event) {
	          _vm.confirm(item.orderSn, item.sn, item.id)
	        }
	      }
	    }, [_vm._v("审核")])])]) : _vm._e()], 2)])
	  })], 2), (_vm.isMask) ? _c('div', {
	  ...
	  }, [_vm._v("共  " + _vm._s(_vm.totalSingle) + "  单")]), _c('div', {
	    staticClass: ["setting"],
	    on: {
	      "click": function($event) {
	        _vm.pickPattern()
	    ...
	    staticClass: ["fz32"]
	  }, [_vm._v("配送站:  " + _vm._s(_vm.isPattern))])]), _c('div', {
	    ...
	    staticClass: ["fz32"]
	  }, [_vm._v("配送员:  " + _vm._s(_vm.isMarki))])]), _c('div', {
	    staticClass: ["flex-row", "flex-end"]
	  }, [_c('text', {
	    staticClass: ["arrow"],
	    style: {
	  ...
	  }, [_vm._v("批量派单")])])])]) : _vm._e(), (_vm.printMask) ? _c('div', {
	    staticClass: ["mask"],
	    on: {
	      "click": function($event) {
	        _vm.printMaskTap()
	    ...
	    staticClass: ["printBox"]
	  }, [_c('text', {
	    staticClass: ["maskTitle", "mt50"]
	  }, [_vm._v("打印")]), (_vm.printList.length == 0) ? _c('text', {
	    staticClass: ["fz32", "mt30"]
	  }, [_vm._v("共 " + _vm._s(_vm.recordsTotal) + " 单")]) : _vm._e(), (_vm.printList.length != 0) ? _c('text', {
	    staticClass: ["fz32", "mt30"]
	  }, [_vm._v(_vm._s(_vm.printIdx) + " / " + _vm._s(_vm.printList.length))]) : _vm._e(), _c('div', {
	    staticClass: ["flex-row", "mt20"]
	  }, [_c('text', {
	    staticClass: ["fz32"]
	  }, [_vm._v("第")]), _c('input', {
	    staticClass: ["printInput"],
	    attrs: {
	      "type": "number",
	      "placeholder": "输入数量",
	      "value": (_vm.beginNumber)
	    },
	    on: {
	      "input": function($event) {
	        _vm.beginNumber = $event.target.attr.value
	      }
	    }
	  }), _c('text', {
	    staticClass: ["fz32"]
	  }, [_vm._v("单  到  第")]), _c('input', {
	    staticClass: ["printInput"],
	    attrs: {
	      "type": "number",
	      "placeholder": "输入数量",
	    ...
	    on: {
	      "input": function($event) {
	        _vm.endNumber = $event.target.attr.value
	      }
	    }
	  }), _c('text', {
	    staticClass: ["fz32"]
	  }, [_vm._v("单")])]), _c('text', {
	    staticClass: ["printMes", "mt30"]
	  }, [_vm._v("打印单数单次不可超过一万单")]), _c('div', {
	    staticClass: ["printButton"]
	  }, [_c('div', {
	    staticClass: ["printButtonLeft"],
	    on: {
	      "click": _vm.downPrint
	    }
	  }, [_c('text', {
	    staticClass: ["printButtonText"]
	  }, [_vm._v("取消")])]), _c('div', {
	    staticClass: ["printButtonRight"],
	    on: {
	      "click": function($event) {
	        _vm.print()
	      }
