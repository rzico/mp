...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* styles */
	__vue_styles__.push(__webpack_require__(703)
	)
	__vue_styles__.push(__webpack_require__(704)
	)

	/* script */
	__vue_exports__ = __webpack_require__(705)
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/shipping/delivery.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-13d6eb8a"
...
/***/ (function(module, exports) {
	...
	module.exports = {
	  ...
	  "titile": {
	    ...
	    "paddingLeft": 30,
	    "paddingRight": 30,
	    "backgroundImage": "linear-gradient(to right, pink,#5eb0fd)",
	    "flexDirection": "row",
	    "justifyContent": "space-between",
	    "alignItems": "center",
	    "height": 100
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        this.screenHeight = _utils2.default.fullScreen(136) + 500;
	        this.orderSn = _utils2.default.getUrlParameter('orderSn');
	        this.shippingSn = _utils2.default.getUrlParameter('sn');
	        this.shippingId = _utils2.default.getUrlParameter('shippingId');
	        this.open();
	        this.load();
	    },
	    components: {
	    ...
	    methods: {
	        maskChick: function maskChick() {
	            return;
	        },
	        downCodeMask: function downCodeMask() {
	            this.isMask = false;
	            this.isButton = false;
	        },
	        ...
	        contorlList: function contorlList() {
	        ...
	        amountPay: function amountPay(w) {
	            this.amountPaid = w;
	        },
	        paperPay: function paperPay(w) {
	            this.paperPaid = w;
	        },
	        ...
	        showContol: function showContol(index) {
	        ...
	        open: function open() {
	            var _this = this;
	            (0, _fetch.GET)('weex/member/barrel/list.jhtml?shippingId=' + this.shippingId, function (res) {
	                if (res.type == "success") {
	                ...
	                if (data.type == 'success') {
	                    if (data.data == true) {
	                        ...
	                        _this.list.forEach(function (item, index) {
	                            if (_utils2.default.isNull(item.give)) {
	                                item.give = 0;
	                            }
	                            if (_utils2.default.isNull(item.take)) {
	                                item.take = 0;
	                            }
	                        ...
	                        (0, _fetch.POST)('weex/member/shipping/delivery.jhtml?sn=' + _this.shippingSn + '&memo=' + encodeURIComponent(_this.noteInput) + '&level=' + _this.floor + "&amountPaid=" + _this.amountPaid + "&paperPaid=" + _this.paperPaid + "&lng=0&lat=0", body).then(function (res) {
	                            _this.clicked = false;
	                            if (res.type == 'success') {
	                                var E = _utils2.default.message('success', '送达成功', '');
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	  ...
	  }), _c('list', [(_vm.list.length == 0) ? _c('cell', {
	    appendAsTree: true,
	    attrs: {
	      "append": "tree"
	    }
	    ...
	    return _c('div', [(c.show == true) ? _c('div', {
	      staticClass: ["setting"]
	    }, [_c('div', {
	      staticClass: ["titile"]
	    }, [_c('text', {
	      ...
	      on: {
	        "input": function($event) {
	          c.take = $event.target.attr.value
	        }
	      }
	    }), _c('text', {
	      staticClass: ["fz32"]
	    }, [_vm._v("桶")])])])]) : _vm._e(), (c.show == false && _vm.hasList) ? _c('div', {
	      staticClass: ["setting"]
	    }, [_c('div', {
	      staticClass: ["titileTwo"],
	      on: {
	        "click": function($event) {
	          _vm.showContol(index)
	        }
	      }
	    }, [_c('text', {
	      staticClass: ["fz32"]
	    }, [_vm._v(_vm._s(c.name))])])]) : _vm._e()])
	  }), (_vm.hasWater == true) ? _c('div', {
	    staticClass: ["iconBox"]
	  }, [_c('div', {
	    staticClass: ["icon"],
	    on: {
	  ...
	  }, [_vm._v("")]) : _vm._e(), (_vm.hasList) ? _c('text', {
	    staticClass: ["bigIcon"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	    ...
	    staticClass: ["info"]
	  }, [(_vm.totalAmount > 0) ? _c('div', {
	    staticClass: ["flex-column"]
	  }, [_c('text', {
	    staticClass: ["herderText"]
	  }, [_vm._v("应收现金")]), _c('div', {
	    staticClass: ["flex-row"]
	  }, [_c('text', {
	    staticStyle: {
	    ...
	    class: [_vm.amountPaid == '1' ? 'checkboxAct' : 'checkbox'],
	    on: {
	      "click": function($event) {
	        _vm.amountPay('1')
	      }
	    ...
	    class: [_vm.amountPaid == '0' ? 'checkboxAct' : 'checkbox'],
	    on: {
	      "click": function($event) {
	        _vm.amountPay('0')
	      }
	    ...
	    staticClass: ["fz28"]
	  }, [_vm._v("未收")])])])]) : _vm._e(), (_vm.totalPaper > 0) ? _c('div', {
	    staticClass: ["flex-column"]
	  }, [_c('text', {
	    staticClass: ["herderText"]
	  }, [_vm._v("应收水票")]), _c('div', {
	    ...
	    staticClass: ["herderAmount"]
	  }, [_vm._v(_vm._s(_vm.totalPaper) + "张")])]), _c('div', {
	    staticClass: ["flex-center"],
	    staticStyle: {
	      width: "590px"
	    }
	  }, [_c('div', {
	    class: [_vm.paperPaid == '1' ? 'checkboxAct' : 'checkbox'],
	    on: {
	      "click": function($event) {
	        _vm.paperPay('1')
	      }
	    ...
	    class: [_vm.paperPaid == '0' ? 'checkboxAct' : 'checkbox'],
	    on: {
	      "click": function($event) {
	        _vm.paperPay('0')
	      }
	    ...
	    staticClass: ["fz28"]
	  }, [_vm._v("未收")])])])]) : _vm._e(), (_vm.totalAmount > 0) ? _c('div', {
	    staticClass: ["flex-row"],
	    staticStyle: {
	      width: "590px",
	      marginTop: "20px"
	  ...
	  }, [_vm._v("应收现金: " + _vm._s(_vm.amountPayable) + "元")]), _c('text', {
	    staticClass: ["fz30"],
	    staticStyle: {
	      color: "#999"
	    }
	  }, [_vm._v("（上期欠款  " + _vm._s(_vm.arrears) + "元）")])]) : _vm._e(), (_vm.totalPaper > 0) ? _c('div', {
	  ...
	  }, [_vm._v("应收水票: " + _vm._s(_vm.paperPayable) + "张")]), _c('text', {
	    staticClass: ["fz30"],
	    staticStyle: {
	      color: "#999"
	    }
	  }, [_vm._v("（上期欠票  " + _vm._s(_vm.ticket) + "张）")])]) : _vm._e(), (_vm.pledgePayable > 0 || _vm.pledgeQuantity > 0) ? _c('div', {
	    staticClass: ["flex-row", "mt10"],
	    staticStyle: {
	      width: "590px"
	    }
	    ...
	    staticClass: ["fz30"],
	    class: [_vm.paperClass()]
	  }, [_vm._v("空桶押金: " + _vm._s(_vm.pledgePayable) + "元")]), _c('text', {
	    staticClass: ["fz30"],
	    staticStyle: {
	      color: "#999"
	    }
	  }, [_vm._v("（押桶数量: " + _vm._s(_vm.pledgeQuantity) + "元）")])]) : _vm._e(), _c('text', {
	    staticClass: ["herderSn", "mt10"]
	  }, [_vm._v("付款方式: " + _vm._s(_vm.paymentPluginName))]), _c('text', {
	    staticClass: ["herderSn", "mt10"]
	  }, [_vm._v("收货地址: " + _vm._s(_vm.areaName) + _vm._s(_vm.address))]), _c('text', {
	    staticClass: ["herderSn", "mt10"]
	  }, [_vm._v("收货姓名: " + _vm._s(_vm.consignee))]), _c('text', {
	    staticClass: ["herderSn", "mt10"],
	    on: {
	      "click": _vm.callPhone
	    }
	  }, [_vm._v("收货电话: " + _vm._s(_vm.phone))]), _c('div', {
	    staticClass: ["messageSetting"],
	    on: {
	      "click": _vm.chooseFloor
	    }
	  }, [_c('div', {
	    staticClass: ["flex-row"]
	  }, [_c('text', {
	  ...
	  }, [_vm._v(_vm._s(_vm._f("wacthFloor")(_vm.floor)))])]), _c('div', {
	    ...
	    on: {
	      "input": function($event) {
	        _vm.noteInput = $event.target.attr.value
	      }
	    }
	  })]), _c('div', {
	    staticClass: ["flex-row", "flex-end"],
	  ...
	  }, [_vm._m(0)])]), (_vm.isButton) ? _c('div', {
	    staticClass: ["button", "mt30"],
	    staticStyle: {
	      width: "530px"
	    },
	    on: {
	  ...
	  }, [_vm._v("确认送达")])]) : _vm._e()])], 2), _vm._m(1)]), (_vm.isMask) ? _c('div', {
	    staticClass: ["codeMask"],
	    on: {
	      "click": _vm.maskChick
	    }
	  }, [_c('div', {
	    ...
	    staticClass: ["downCode"],
	    on: {
	      "click": _vm.downCodeMask
	    }
	  }, [_c('text', {
	    staticClass: ["downCodeIcon"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	  }, [_vm._v("")])]), _c('image', {
