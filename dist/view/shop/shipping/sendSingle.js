...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* styles */
	__vue_styles__.push(__webpack_require__(719)
	)
	__vue_styles__.push(__webpack_require__(720)
	)

	/* script */
	__vue_exports__ = __webpack_require__(721)
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/shipping/sendSingle.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-2214da77"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        this.orderSn = _utils2.default.getUrlParameter('orderSn');
	        this.shippingSn = _utils2.default.getUrlParameter('sn');
	        this.isPageType = _utils2.default.getUrlParameter('isPageType');
	        this.isSelf = _utils2.default.getUrlParameter('isSelf');
	    ...
	    methods: {
	        open: function open() {
	            var _this = this;
	            (0, _fetch.GET)('weex/member/shipping/view.jhtml?sn=' + this.shippingSn, function (data) {
	                if (data.type == 'success') {
	                    _this.ordersList = [];
	                    _this.ordersList.push(data.data);
	                    if (!_utils2.default.isNull(data.data.shopId)) {
	                        _this.isPattern = data.data.shopName;
	                        _this.shopId = data.data.shopId;
	                    }
	                    if (!_utils2.default.isNull(data.data.adminId)) {
	        ...
	        complete: function complete() {
	            ...
	            (0, _fetch.POST)('weex/member/shipping/lock.jhtml?sn=' + this.shippingSn).then(function (data) {
	                if (data.type == 'success') {
	                    if (data.data == true) {
	                        (0, _fetch.POST)('weex/member/shipping/dispatch.jhtml?sn=' + _this.shippingSn + '&shopId=' + _this.shopId + '&adminId=' + _this.markiId + '&memo=' + encodeURIComponent(_this.message)).then(function (data) {
	                            _this.clicked = false;
	                            if (data.type == 'success') {
	                                var E = _utils2.default.message('success', '派单成功', '');
	                        ...
	                        _this.clicked = false;
	                        _weex.event.toast('该订单他人正在操作，请稍后...');
	                    }
	                } else {
	                    _this.clicked = false;
	                    _weex.event.toast(data.content);
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    return _c('div', {}, [_c('div', {
	      ...
	      staticClass: ["title"]
	    }, [_vm._v(_vm._s(item.receiver.consignee))]), _c('text', {
	      ...
	      staticClass: ["space-between", "goodsHead", "boder-bottom"]
	    }, [_c('div', {
	      staticClass: ["flex-row"]
	    }, [_c('image', {
	      staticClass: ["shopImg"],
	      ...
	      staticClass: ["title", "ml20", "mr20"]
	    }, [_vm._v(_vm._s(item.name))])])]), _vm._l((item.shippingItems), function(goods) {
	      return _c('div', {
	      ...
	      staticClass: ["sub_title"]
	    }, [_vm._v("订单编号: " + _vm._s(item.orderSn))]), _c('text', {
	      staticClass: ["sub_title", "copyBtn", "copyBorder", "ml20"],
	      on: {
	        "click": function($event) {
	          _vm.copyCode(item.orderSn)
	        }
	      }
	    }, [_vm._v("复制")])]), _c('div', {
	      staticClass: ["mt10"]
	      ...
	      staticClass: ["sub_title"]
	    }, [_vm._v("下单时间: " + _vm._s(_vm._f("watchCreateDate")(item.createDate)))])])]), _c('div', {
	      staticClass: ["infoLines", "pb10"]
	    }, [_c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("支付方式: " + _vm._s(_vm._f("watchPayMethod")(item.paymentMethod)))])]), _c('div', {
	      ...
	      staticClass: ["sub_title"]
	    }, [_vm._v("配送方式: " + _vm._s(_vm._f("watchShippingMethod")(item.shippingMethod)))])]), _c('div', {
	      staticClass: ["infoLines", "pt0", "pb0"]
	    }, [_c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("配送状态: " + _vm._s(_vm._f("watchShippingStatus")(item.shippingStatus)))])]), (item.hopeDate != '') ? _c('div', {
	      staticClass: ["infoLines", "boder-bottom", "pt10"]
	    }, [_c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("预约时间: " + _vm._s(_vm._f("watchCreateDate")(item.hopeDate)))])]) : _vm._e(), (item.memo != '') ? _c('div', {
	      staticClass: ["infoLines", "pb10"]
	    }, [_c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("留言: " + _vm._s(item.memo))])]) : _vm._e(), (item.orderMemo != '') ? _c('div', {
	      staticClass: ["infoLines", "boder-bottom", "pt0"]
	    }, [_c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("买家留言: " + _vm._s(item.orderMemo))])]) : _vm._e()])])
	  })], 2)], 1)
	},staticRenderFns: []}
	module.exports.render._withStripped = true
