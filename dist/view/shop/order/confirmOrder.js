...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_styles__.push(__webpack_require__(623)
	)
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/order/confirmOrder.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-7e25890e"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        submit: function submit(amount) {
	            var _this = this;
	            if (_utils2.default.isNull(this.paymentPluginId)) {
	                _weex.event.toast('请选择付款方式');
	                return;
	            }
	            if (_utils2.default.isNull(this.amount)) {
	                _weex.event.toast('请输入金额');
	                return;
	            }if (this.amount != amount) {
	                _weex.event.toast('请输入应付金额');
	                return;
	            }if (_utils2.default.isNull(this.tranSn)) {
	                _weex.event.toast('请输入凭证号');
	                return;
	            }

	            (0, _fetch.POST)('weex/member/order/payment.jhtml?sn=' + this.orderSn + '&tranSn' + encodeURIComponent(this.tranSn)).then(function (data) {
	                if (data.type == 'success') {
	                    (0, _fetch.POST)('/payment/submit.jhtml?sn=' + data.data.sn + '&paymentPluginId=' + _this.paymentPluginId).then(function (data) {
	                        if (data.type == 'success') {
	                            var E = _utils2.default.message('success', '确认成功', '');
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    return _c('div', {
	    ...
	    }, [_vm._v("¥" + _vm._s(_vm._f("currencyfmt")(item.amount)))]), _c('text', {
	      staticClass: ["herderSn"]
	      ...
	      staticClass: ["fz32"]
	    }, [_vm._v("付款方式:  " + _vm._s(_vm.paymentPluginName))])]), _c('div', {
	      ...
	      on: {
	        "input": function($event) {
	          _vm.amount = $event.target.attr.value
	        }
	      }
	    })]), _c('div', {
	      staticClass: ["flex-row", "flex-end"]
	      ...
	      on: {
	        "input": function($event) {
	          _vm.tranSn = $event.target.attr.value
	        }
	      }
	    })]), _c('div', {
	      staticClass: ["flex-row", "flex-end"]
