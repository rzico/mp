...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/order/details.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-1edc1087"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    filters: {
	        ...
	        watchPayMethod: function watchPayMethod(value) {
	            switch (value) {
	                case "online":
	                    return '在线支付';
	                    break;
	        ...
	        watchShippingMethod: function watchShippingMethod(value) {
	            switch (value) {
	                case "shipping":
	                    return '普通快递 ';
	                    break;
	        ...
	        watchStatus: function watchStatus(value) {
	            switch (value) {
	                case 'unpaid':
	                    return '需付款';
	                    break;
	        ...
	        watchPaymentStatus: function watchPaymentStatus(value) {
	            switch (value) {
	                case 'unpaid':
	                    return '未支付';
	                    break;
	        ...
	        watchShippingStatus: function watchShippingStatus(value) {
	            switch (value) {
	                case 'unshipped':
	                    return '未发货';
	                    break;
	        ...
	        watchLogDate: function watchLogDate(value) {
	            return _utils2.default.ymdhisdayfmt(value);
	        }
	    },
	    components: {
	    ...
	    created: function created() {
	        ...
	        this.orderSn = _utils2.default.getUrlParameter('sn');
	        this.open();
	        this.permissions();
	    },
	    ...
	    methods: {
	        ...
	        print: function print() {
	            ...
	            modal.confirm({
	                ...
	                if (value.result == '确认') {
	                    (0, _fetch.GET)('weex/member/shipping/print.jhtml?sn=' + _this.orderSn + "&seqno=1", function (data) {
	                        if (data.type == 'success') {
	                            _weex.event.toast('打印成功');
	                        } else {
	        ...
	        open: function open() {
	            var _this = this;
	            (0, _fetch.GET)('website/member/order/view.jhtml?sn=' + this.orderSn, function (data) {
	                if (data.type == 'success') {
	                    _this.ordersList = [];
	        ...
	        //            点击复制
	        copyCode: function copyCode(sn) {
	            clipboard.setString(sn);
	            _weex.event.toast('单号复制成功');
	        },


	        //            确认退款
	        confirmRefund: function confirmRefund(sn) {
	            var _this = this;
	            modal.confirm({
	                message: '是否确定退款?',
	                duration: 0.3,
	                ...
	                if (value == '确定') {
	                    (0, _fetch.POST)('weex/member/order/refunds.jhtml?sn=' + sn).then(function (data) {
	                        if (data.type == 'success') {
	                            _this.pageStart = 0;
	                            _this.open();
	                            _weex.event.toast('退款成功');
	                        } else {
	                            _weex.event.toast(data.content);
	                        }
	                    }, function (err) {
	        ...
	        //            关闭订单
	        closeOrder: function closeOrder(item, sn) {
	            var _this = this;
	            modal.confirm({
	                message: '确定关闭该订单?',
	                duration: 0.3,
	                ...
	                if (value == '确定') {
	                    (0, _fetch.POST)('weex/member/order/cancel.jhtml?sn=' + sn).then(function (data) {
	                        if (data.type == 'success') {
	        ...
	        //            确认订单
	        confirmOrder: function confirmOrder(sn) {
	            var _this = this;
	            //                modal.confirm({
	            //                    message: '是否确认该订单?',
	            //                    duration: 0.3,
	            ...
	            this.clicked = true;
	            _weex.event.openURL(_utils2.default.locate("view/shop/order/confirmOrder.js?sn=" + sn), function (data) {
	                _this.clicked = false;
	                if (data.type == 'success') {
	                    _this.pageStart = 0;
	                    _this.open();
	                    _weex.event.toast('确认成功');
	                }
	            });
	        },
	        //            发货
	        sendGoods: function sendGoods(sn) {
	            var _this = this;
	            //                modal.confirm({
	            //                    message: '确认发货?',
	            //                    duration: 0.3,
	            ...
	            this.clicked = true;
	            _weex.event.openURL(_utils2.default.locate("view/shop/order/delivery.js?sn=" + sn), function (data) {
	                _this.clicked = false;
	                if (data.type == 'success') {
	                    _this.pageStart = 0;
	                    _this.open();
	                    _weex.event.toast('发货成功');
	                }
	            });
	        },
	        //            退货
	        returnGoods: function returnGoods(sn) {
	            var _this = this;
	            modal.confirm({
	                message: '确定退货?',
	                duration: 0.3,
	                ...
	                if (value == '确定') {
	                    (0, _fetch.POST)('weex/member/order/returns.jhtml?sn=' + sn).then(function (data) {
	                        if (data.type == 'success') {
	                            _this.pageStart = 0;
	                            _this.open();
	                            _weex.event.toast('退货成功');
	                        } else {
	                            _weex.event.toast(data.content);
	                        }
	                    }, function (err) {
	        ...
	        //            联系收货人
	        callPhone: function callPhone(telPhone) {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	  ...
	  })]), (_vm.ordersList.length == 0) ? _c('noData', {
	    attrs: {
	      "noDataHint": _vm.noDataHint
	    }
	  }) : _vm._l((_vm.ordersList), function(item, index) {
	    return _c('div', {
	      class: [item.status == 'unpaid' || item.status == 'refunding' || item.status == 'unshipped' || item.status == 'returning' ? 'hasPb100' : '']
	    }, [_c('div', {
	      staticClass: ["header", "mt20", "flex-row"]
	    }, [_c('div', [_c('text', {
	      staticClass: ["carIcon"],
	      style: {
	        fontFamily: 'iconfont'
	      }
	    }, [_vm._v("")])]), _c('div', _vm._l((item.orderLogs), function(orderLog, index) {
	      return _c('div', {
	        staticClass: ["logBox"],
	        class: [index != 0 ? 'mt20' : '']
	      }, [_c('text', {
	        staticClass: ["title"]
	      }, [_vm._v(_vm._s(orderLog.content) + " ")]), _c('text', {
	        staticClass: ["subDate"]
	      }, [_vm._v(" " + _vm._s(_vm._f("watchLogDate")(orderLog.createDate)))])])
	    }))]), _c('div', {
	      staticClass: ["addressBox", "flex-row", "mt20"],
	      on: {
	        "click": function($event) {
	          _vm.jump(item.cardId)
	        }
	      }
	    }, [_c('div', {
	      staticStyle: {
	      ...
	      staticClass: ["title"]
	    }, [_vm._v(_vm._s(item.receiver.consignee))])]), _c('div', {
	      staticClass: ["flex-row", "mt10"]
	    }, [_c('text', {
	      staticClass: ["title"]
	    }, [_vm._v(_vm._s(item.receiver.phone))]), _c('text', {
	      staticClass: ["sub_title", "copyBtn", "copyBorder", "ml20"],
	      on: {
	        "click": function($event) {
	          _vm.callPhone(item.receiver.phone)
	        }
	      }
	    }, [_vm._v("拨号")])]), _c('div', {
	      staticClass: ["mt10"]
	    ...
	    }, [_vm._v("地址: " + _vm._s(item.receiver.areaName) + _vm._s(item.receiver.address))])])])]), _c('div', {
	      staticClass: ["goodsLine", "mt20"]
	    }, _vm._l((item.orderItems), function(goods) {
	      return _c('div', {
	        ...
	        staticClass: ["title"]
	      }, [_vm._v("¥ " + _vm._s(_vm._f("currencyfmt")(goods.price)))]), _c('text', {
	        staticClass: ["sub_title"]
	      }, [_vm._v("x" + _vm._s(goods.quantity))])])])])
	    })), _c('div', {
	      staticClass: ["mt20", "infoWhiteColor"]
	    }, [_c('div', {
	      staticClass: ["infoLines", "boder-bottom"]
	    }, [_c('div', {
	      staticClass: ["flex-row"]
	    }, [_c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("订单编号: " + _vm._s(item.sn))]), _c('text', {
	      staticClass: ["sub_title", "copyBtn", "copyBorder", "ml20"],
	      on: {
	        "click": function($event) {
	          _vm.copyCode(item.sn)
	        }
	      }
	    }, [_vm._v("复制")])]), _c('div', {
	      staticClass: ["mt10"]
	      ...
	      staticClass: ["sub_title"]
	    }, [_vm._v("下单时间: " + _vm._s(_vm._f("watchCreateDate")(item.createDate)))])]), (item.deliveryDate != '' && item.deliveryDate != null) ? _c('div', {
	      staticClass: ["mt10"]
	    }, [_c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("送达时间: " + _vm._s(_vm._f("watchCreateDate")(item.deliveryDate)))])]) : _vm._e(), (item.hopeDate != '' && item.hopeDate != null) ? _c('div', {
	      staticClass: ["mt10"]
	    }, [_c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("预约时间: " + _vm._s(_vm._f("watchCreateDate")(item.hopeDate)))])]) : _vm._e(), _c('div', {
	      staticClass: ["mt10"]
	    }, [_c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("销售站点: " + _vm._s(item.sellerName))])])]), _c('div', {
	      staticClass: ["infoLines", "pb10"]
	    }, [_c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("支付方式: " + _vm._s(item.paymentMethod))])]), _c('div', {
	      staticClass: ["infoLines", "boder-bottom", "pt0"]
	    }, [_c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("支付状态: " + _vm._s(_vm._f("watchPaymentStatus")(item.paymentStatus)))])]), _c('div', {
	      staticClass: ["infoLines", "pb10"]
	    }, [_c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("配送方式: " + _vm._s(item.shippingMethod))])]), _c('div', {
	      staticClass: ["infoLines", "pb10"]
	    }, [_c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("配送状态: " + _vm._s(_vm._f("watchShippingStatus")(item.shippingStatus)))])]), _c('div', {
	      staticClass: ["infoLines", "pt0", "pb10"]
	    }, [_c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("配送站点: " + _vm._s(item.shopName))])]), _c('div', {
	      staticClass: ["infoLines", "pt0", "pb10"]
	    }, [_c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("配送人员: " + _vm._s(item.adminName))])]), _c('div', {
	      staticClass: ["infoLines", "boder-bottom", "pt10"]
	    }, [_c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("派单留言: " + _vm._s(item.shippingMemo))])]), _c('div', {
	      staticClass: ["infoLines", "boder-bottom"]
	    }, [_c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("买家留言: " + _vm._s(item.memo))])])]), _c('div', {
	      staticClass: ["mt20", "", "infoWhiteColor"]
	    }, [_c('div', {
	      staticClass: ["priceLine", "boder-bottom"]
	    }, [_c('div', {
	      ...
	      staticClass: ["sub_title"]
	    }, [_vm._v("¥" + _vm._s(_vm._f("currencyfmt")(item.price)))])]), (_vm.filter('cost')) ? _c('div', {
	      staticClass: ["space-between", "mt10"]
	    }, [_c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("+ 运费(楼层费)")]), _c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("¥ " + _vm._s(_vm._f("currencyfmt")(item.freight)))])]) : _vm._e(), _c('div', {
	      staticClass: ["space-between", "mt10"]
	    }, [_c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("+ 空桶押金")]), _c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("¥ " + _vm._s(_vm._f("currencyfmt")(item.pledgePayable)))])]), (item.couponDiscount != 0 && item.couponDiscount != '0') ? _c('div', {
	      staticClass: ["space-between", "mt10"]
	    }, [_c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("优惠折扣")]), _c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("-" + _vm._s(_vm._f("currencyfmt")(item.couponDiscount)))])]) : _vm._e(), (item.pointDiscount != 0 && item.pointDiscount != '0') ? _c('div', {
	      staticClass: ["space-between", "mt10"]
	    }, [_c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("积分抵扣")]), _c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("-" + _vm._s(_vm._f("currencyfmt")(item.pointDiscount)))])]) : _vm._e(), (item.exchangeDiscount != 0 && item.exchangeDiscount != '0') ? _c('div', {
	      staticClass: ["space-between", "mt10"]
	    }, [_c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("电子券支付")]), _c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("-" + _vm._s(_vm._f("currencyfmt")(item.exchangeDiscount)) + "（" + _vm._s(item.exchangeQuantity) + "张）")])]) : _vm._e(), _c('div', {
	      staticClass: ["flex-row", "pb10"]
	    }, [_c('text', {
	      staticClass: ["fz28", "mr20"]
	    }, [_vm._v("订单合计:")]), _c('text', {
	      staticClass: ["fz28"],
	      staticStyle: {
	        color: "red"
	      }
	    }, [_vm._v("¥" + _vm._s(_vm._f("currencyfmt")(item.amount)))])]), _c('div', {
	      staticClass: ["space-between", "pb10"]
	    }, [_c('text', {
	      staticClass: ["fz28"]
	    }, [_vm._v("应收金额:¥" + _vm._s(_vm._f("currencyfmt")(item.amountPayable)) + "(上期欠款:¥" + _vm._s(_vm._f("currencyfmt")(item.arrears)) + ")")]), _c('text', {
	      staticClass: ["fz28"]
	    }, [_vm._v("实收金额:¥" + _vm._s(_vm._f("currencyfmt")(item.amountPaid)))])]), _c('div', {
	      staticClass: ["space-between", "pb10"]
	    }, [_c('text', {
	      staticClass: ["fz28"]
	    }, [_vm._v("应收水票:" + _vm._s(item.paperPayable) + "(上期欠票:" + _vm._s(item.ticket) + ")")]), _c('text', {
	      staticClass: ["fz28"]
	    }, [_vm._v("实收水票:" + _vm._s(item.paperPaid))])])]), _c('div', {
	      staticClass: ["priceLine"]
	    }, [(_vm.filter('shippingFreight')) ? _c('div', {
	      staticClass: ["space-between", "mt10"]
	    }, [_c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("配送运费")]), _c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("¥ " + _vm._s(_vm._f("currencyfmt")(item.shippingFreight)))])]) : _vm._e(), (_vm.filter('cost')) ? _c('div', {
	      staticClass: ["space-between", "mt10"]
	    }, [_c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("货款结算")]), _c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("¥ " + _vm._s(_vm._f("currencyfmt")(item.cost)))])]) : _vm._e(), _c('div', {
	      staticClass: ["space-between", "mt10"]
	    }, [_c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("送货工资")]), _c('text', {
	      staticClass: ["sub_title"]
	    }, [_vm._v("¥ " + _vm._s(_vm._f("currencyfmt")(item.adminFreight)))])])])]), (item.status == 'unpaid') ? _c('div', {
	      staticClass: ["flex-row", "space-between", "goodsFoot", "boder-top"]
	    }, [_c('div', {
	      ...
	      on: {
	        "click": function($event) {
	          _vm.confirmOrder(item.sn)
	        }
	      }
	    }, [_vm._v("确认订单")])])]) : (item.status == 'refunding') ? _c('div', {
	      staticClass: ["flex-row", "space-between", "goodsFoot", "boder-top"]
	    }, [_c('div', {
	      staticClass: ["footMore"]
	    }), _c('div', {
	      ...
	      staticClass: ["title", "footText", "red"],
	      on: {
	        "click": function($event) {
	          _vm.confirmRefund(item.sn)
	        }
	      }
	    }, [_vm._v("确认退款")])])]) : (item.status == 'unshipped') ? _c('div', {
	      staticClass: ["flex-row", "space-between", "goodsFoot", "boder-top"]
	    }, [_c('div', {
	      staticClass: ["footMore"]
	    }), _c('div', {
	      ...
	      on: {
	        "click": function($event) {
	          _vm.sendGoods(item.sn)
	        }
	      }
	    }, [_vm._v("发货")])])]) : (item.status == 'returning') ? _c('div', {
	      staticClass: ["flex-row", "space-between", "goodsFoot", "boder-top"]
	    }, [_c('div', {
	      staticClass: ["footMore"]
	    }), _c('div', {
