...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/order/delivery.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-da262502"
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        sendGoods: function sendGoods() {
	            ...
	            this.clicked = true;
	            if (this.isobject == 'warehouse' && !_utils2.default.isNull(this.shopId)) {
	            ...
	            (0, _fetch.POST)('weex/member/order/shipping.jhtml?sn=' + this.orderSn + '&shopId=' + this.shopId + '&adminId=' + this.markiId + '&shippingMethod=' + this.isobject + '&trackingNo=' + encodeURIComponent(this.trackingNo)).then(function (data) {
	                if (data.type == 'success') {
	                    var E = _utils2.default.message('success', '发货成功', '');
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	  ...
	  }, _vm._l((_vm.ordersList.orderItems), function(goods, index) {
	    ...
	    staticClass: ["fz32"]
	  }, [_vm._v("发货方式:  " + _vm._s(_vm._f("watchType")(_vm.isobject)))])]), _c('div', {
	    ...
	    staticClass: ["fz32"]
	  }, [_vm._v("配送站点:  " + _vm._s(_vm.shopName))])]), _c('div', {
	    staticClass: ["flex-row", "flex-end"]
	  }, [_c('text', {
	    staticClass: ["arrow"],
	    style: {
	    ...
	    staticClass: ["fz32"]
	  }, [_vm._v("配送人员:  " + _vm._s(_vm.markiName))])]), _c('div', {
	    staticClass: ["flex-row", "flex-end"]
	  }, [_c('text', {
	    staticClass: ["arrow"],
	    style: {
	    ...
	    on: {
	      "input": function($event) {
	        _vm.trackingNo = $event.target.attr.value
	      }
	    }
	  })]), _c('div', {
	    staticClass: ["flex-row", "flex-end"]
	    ...
	    staticClass: ["button", "ml30", "mr30", "mt30"],
	    on: {
	      "click": _vm.sendGoods
	    }
	  }, [_c('text', {
