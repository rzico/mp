...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/order/logistics.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-02a19ed0"
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }), _c('list', [_vm._m(0), _vm._l((_vm.logisticsList), function(item, index) {
	    return _c('cell', {
	      ...
	      staticClass: ["outsideBox", "boder-left"]
	    }, [_c('div', {
	      staticClass: ["infoLine"],
	      class: [index != _vm.logisticsList.length - 1 ? 'boder-bottom' : '']
	    }, [_c('text', {
	      class: [item.isDone ? 'subColor' : 'sub_title']
	    }, [_vm._v(_vm._s(item.content))]), _c('text', {
	      staticClass: ["sub_title", "mt20"]
	    }, [_vm._v(_vm._s(item.createDate))])])]), (index == 0 && index != _vm.logisticsList.length - 1) ? _c('text', {
	      staticClass: ["topMask"]
	    }) : _vm._e(), (index == _vm.logisticsList.length - 1) ? _c('text', {
	      staticClass: ["bottomMask"]
	    }) : _vm._e(), (item.isDone) ? _c('div', {
	      staticClass: ["doneIconBox"]
	    }, [_c('text', {
	      staticClass: ["DoneBigIcon"]
	    }), _c('text', {
	      staticClass: ["DoneSmallIcon"]
	    })]) : _c('text', {
	      staticClass: ["dotIcon"]
	    })])])
	  })], 2)], 1)
	  ...
	  }, [_vm._v("订单编号: 64805405523")]), _c('text', {
	    staticClass: ["mt20", "titleColor"]
	  }, [_vm._v("国内承运人: 京东快递")]), _c('text', {
	    staticClass: ["mt20", "titleColor"]
	  }, [_vm._v("预计送达: 11月13日")])])])
	}]}
	module.exports.render._withStripped = true
