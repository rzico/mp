...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/order/fill.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-50e2d90e"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _date = __webpack_require__(637);
	...
	exports.default = {
	    ...
	    components: {
	        navbar: _navbar2.default, date: _date2.default
	    },
	    props: {
	        title: { default: "人工报单" }
	    },
	    filters: {
	        watchSendType: function watchSendType(val) {
	            if (val == 'shipping') {
	                return '普通快递';
	        ...
	        wacthFloor: function wacthFloor(e) {
	            if (e == 0) {
	                return '有电梯';
	            } else {
	                return e;
	    ...
	    created: function created() {
	        ...
	        var _this = this;
	        this.version = _utils2.default.version;
	        _this.payName = [];
	        _this.payId = [];
	        (0, _fetch.GET)('payment/plugin.jhtml', function (mes) {
	            if (mes.type == 'success') {
	        ...
	        //            清空购物车
	        (0, _fetch.POST)('weex/cart/clear.jhtml').then(function (res) {
	            if (res.type == 'success') {} else {
	    ...
	    methods: {
	        ...
	        getInfo: function getInfo() {
	            var _this = this;
	            (0, _fetch.POST)('weex/member/order/info.jhtml?memberId=' + this.memberId + '&receiverId=' + this.addressId + '&paymentPluginId=' + _this.paymentPluginId).then(function (data) {
	                if (data.type == 'success') {
	        ...
	        jump: function jump(id) {
	            ...
	            _weex.event.openURL(_utils2.default.locate('view/shop/card/view.js?id=' + id), function () {});
	        },
	        //           获取商品合计
	        getmoneyTotal: function getmoneyTotal() {
	            var _this = this;
	            (0, _fetch.POST)('weex/member/order/calculate.jhtml?memberId=' + this.memberId + '&receiverId=' + this.addressId + '&paymentPluginId=' + _this.paymentPluginId + '&pledge=' + _this.deposit + '&pledgeQuantity=' + _this.barrel).then(function (data) {
	                if (data.type == 'success') {
	                    _this.amountPayable = data.data.amountPayable; // 应付金额
	                    _this.arrears = data.data.arrears; //  上期欠款
	                    _this.paperPayable = data.data.paperPayable; //   应收水票
	        ...
	        //            选择楼层
	        chooseFloor: function chooseFloor() {
	            var _this = this;
	            picker.pick({
	        ...
	        gocard: function gocard() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate("view/shop/card/addressList.js"), function (data) {
	                _this.clicked = false;
	                if (data.type == 'success') {
	        ...
	        goGoods: function goGoods() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate("view/shop/goods/manage.js?from=fill&pageType=true"), function (data) {
	                _this.clicked = false;
	                if (data.type == 'success') {
	                    //                        把传回来的商品名字保存起来，用来对比购物车列表是否有改商品
	                    _this.goodsName = data.data.name;
	                    //                        先请求接口获取productId
	                    (0, _fetch.GET)('applet/product/view.jhtml?id=' + data.data.id, function (mes) {
	                        if (mes.type == 'success') {
	        ...
	        cartList: function cartList() {
	            var _this = this;
	            (0, _fetch.GET)('weex/cart/list.jhtml?', function (mes) {
	                if (mes.type == 'success') {
	        ...
	        addCart: function addCart(id) {
	            ...
	            var _this = this;
	            (0, _fetch.POST)('weex/cart/add.jhtml?id=' + _this.product[0].productId + '&quantity=0' + '&memberId=' + this.memberId).then(function (res) {
	                if (res.type == 'success') {
	                    //                        当购物车列表大于3条数据时再做操作
	                    if (_this.cart.length > 3) {
	                        if (!_utils2.default.isNull(_this.goodsName)) {
	                            //                                    先把this.cart转为字符串用于indexOf比较
	                            var jsonData = (0, _stringify2.default)(_this.cart);
	                            //                                    如果该商品不在购物车列表，则滚动到最后一个cell
	                            if (jsonData.indexOf(_this.goodsName) < 0) {
	                                var cartIndex = _this.cart.length - 1;
	                                setTimeout(function () {
	                                    var el = _this.$refs.cardRef[cartIndex]; //跳转到相应的cell
	        ...
	        //            监听数量input
	        numberChange: function numberChange(c) {

	            this.numberOnInput(c.id, c.quantity);
	            //                utils.debug(c)
	        },
	        //            监听金钱input
	        moneyChange: function moneyChange(c) {

	            this.moneyOnInput(c.id, c.quantity, c.price);
	            //                utils.debug(c)
	        },
	        //            数量输入框
	        numberOnInput: function numberOnInput(id, num) {
	            var _this = this;
	            if (num < 1 || num < '1') {
	                _weex.event.toast('商品数量不能低于1件');
	                return;
	            }
	            (0, _fetch.POST)('weex/cart/edit.jhtml?id=' + id + '&quantity=' + num).then(function (res) {
	                if (res.type == 'success') {
	                    _this.cartList();
	                    _this.getmoneyTotal();
	                } else {
	        ...
	        //            金钱输入框
	        moneyOnInput: function moneyOnInput(id, num, price) {
	            var _this = this;
	            (0, _fetch.POST)('weex/cart/edit.jhtml?id=' + id + '&quantity=' + num + '&price=' + price).then(function (res) {
	                if (res.type == 'success') {
	                    _this.cartList();
	                    _this.getmoneyTotal();
	                } else {
	        ...
	        del: function del(id, index) {
	            var _this = this;
	            (0, _fetch.POST)('weex/cart/delete.jhtml?id=' + id).then(function (mes) {
	                if (mes.type == "success") {
	                    //                            把动画收回来。
	                    if (animationPara == null || animationPara == '' || animationPara == 'undefinded') {} else {
	                        _weex.animation.transition(animationPara, {
	        ...
	        beginTimer: function beginTimer() {
	            ...
	            (0, _fetch.POST)("payment/query.jhtml?sn=" + _this.paySn).then(function (res) {
	                if (res.type == 'success') {
	                    if (res.data == '0000') {
	                        modal.alert({
	                            message: '付款成功',
	        ...
	        paymentOrder: function paymentOrder(orderSn, safeKey) {
	            var _this = this;
	            ...
	            (0, _fetch.POST)('weex/member/order/payment.jhtml?sn=' + orderSn).then(function (pay) {
	                if (pay.type == 'success') {
	                    _this.paySn = pay.data.sn;
	                    (0, _fetch.POST)("payment/submit.jhtml?sn=" + _this.paySn + "&paymentPluginId=" + _this.paymentPluginId + "&safeKey=" + encodeURIComponent(safeKey)).then(function (data) {
	                        if (data.type == 'success') {
	                            _this.timer = setTimeout(function () {
	                                _this.beginTimer();
	                            }, 500);
	                    ...
	                    _weex.event.toast(pay.content);
	                }
	            }, function (fail) {
	                _weex.event.toast(fail.content);
	            });
	        },
	        createOrder: function createOrder(safeKey) {
	            var _this = this;
	            (0, _fetch.POST)('weex/member/order/create.jhtml?receiverId=' + this.addressId + '&paymentPluginId=' + _this.paymentPluginId + '&memo=' + encodeURIComponent(this.memoData) + '&memberId=' + this.memberId + '&hopeDate=' + encodeURIComponent(this.dateTime) + '&shopId=' + _this.shopId + '&adminId=' + _this.adminId + '&shippigMethod=' + _this.sendObject + '&pledge=' + _this.deposit + '&pledgeQuantity=' + _this.barrel).then(function (res) {
	                if (res.type == 'success') {
	        ...
	        confirm: function confirm() {
	            ...
	            var _this = this;
	            //                先提交订单获取sn
	            if (_utils2.default.isNull(this.addressId)) {
	                _weex.event.toast('请先设置地址');
	                _this.clicked = false;
	                return;
	            } else if (_utils2.default.isNull(this.paymentPluginId)) {
	                _weex.event.toast('请选择支付方式');
	                _this.clicked = false;
	                return;
	            }
	            if (_utils2.default.isNull(_this.deposit)) {
	                _this.deposit = 0;
	            }
	            if (_utils2.default.isNull(_this.barrel)) {
	                _this.barrel = 0;
	            }
	            if (this.version == 2) {
	                if (_utils2.default.isNull(this.shopId)) {
	                    _weex.event.toast('请选择配送站点');
	                    _this.clicked = false;
	                    return;
	                } else if (this.isSelf == true || this.isSelf == 'true') {
	                    if (_utils2.default.isNull(this.adminId)) {
	                        _weex.event.toast('请选择配送员');
	                        _this.clicked = false;
	                        return;
	                    }
	                }
	            ...
	            _this.cart.forEach(function (item) {
	                if (_utils2.default.isNull(item.quantity) || item.quantity == 0) {
	                    mesTotal = mesTotal + 1;
	                }
	            });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* styles */
	__vue_styles__.push(__webpack_require__(638)
	)
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/widget/date.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-f0cf3764"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
	...
	exports.default = {
	    data: function data() {
	        return {
	            ...
	            { id: 9, time: '08.00-09.00' }, { id: 10, time: '09.00-10.00' }, { id: 11, time: '10.00-11.00' }, { id: 12, time: '11.00-12.00' }, { id: 13, time: '12.00-13.00' }, { id: 14, time: '13.00-14.00' }, { id: 15, time: '14.00-15.00' }, { id: 16, time: '15.00-16.00' }, { id: 17, time: '16.00-17.00' }, { id: 18, time: '17.00-18.00' }, { id: 19, time: '18.00-19.00' }, { id: 20, time: '19.00-20.00' }, { id: 21, time: '20.00-21.00' }, { id: 22, time: '21.00-22.00' }, { id: 23, time: '22.00-23.00' }, { id: 24, time: '23.00-24.00' }]
	        };
	    },
	    components: {},
	    props: {
	    ...
	    created: function created() {
	        this.date = _utils2.default.ymdtimefmt(Date.parse(new Date()));
	    },

	    methods: {
	        chooseTime: function chooseTime(id) {
	            this.timeId = id;
	            //                if(id == 1){
	            //                    this.time = '00:00:00'
	            //                }else if(id == 2){
	        ...
	        chooseDate: function chooseDate(id) {
	            this.titleId = id;
	            if (id == 1) {
	                //                      先重新获取时间
	                this.date = Date.parse(new Date());
	                this.date = _utils2.default.ymdtimefmt(this.date);
	            }if (id == 2) {
	                //                    先重新获取时间
	                this.date = Date.parse(new Date());
	                //                    运算增加一天
	        ...
	        confirm: function confirm() {
	            if (_utils2.default.isNull(this.date) || _utils2.default.isNull(this.time)) {
	                modal.alert({
	                    message: '请选择时间',
	                    okTitle: 'OK'
	                });
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, _vm._l((_vm.titleDate), function(c) {
	    return _c('div', {
	      staticClass: ["titleBox"],
	      class: [_vm.titleId == c.id ? 'titleActive' : ''],
	      on: {
	        "click": function($event) {
	          _vm.chooseDate(c.id)
	        }
	      ...
	      staticClass: ["fz32"],
	      class: [_vm.titleId == c.id ? 'primary' : '']
	    }, [_vm._v(_vm._s(c.time))])])
	  })), _c('div', {
	    staticClass: ["timeContent"]
	  }, [_c('scroller', _vm._l((_vm.timeData), function(t) {
	    return _c('div', {
	      staticClass: ["timeBox"],
	      class: [_vm.timeId == t.id ? 'timeBoxActive' : ''],
	      on: {
	        "click": function($event) {
	          _vm.chooseTime(t.id)
	        }
	      ...
	      staticClass: ["fz28"]
	    }, [_vm._v(_vm._s(t.time))]), (_vm.timeId == t.id) ? _c('text', {
	      staticClass: ["active"],
	      style: {
	        fontFamily: 'iconfont'
	      }
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["header", "", "bkg-primary"],
	    ...
	    staticClass: ["addressBox", "bkg-primary", "pb30"],
	    on: {
	      "click": function($event) {
	        _vm.jump(_vm.cardId)
	      }
	    ...
	    staticClass: ["address"]
	  }, [_vm._v(_vm._s(_vm.member.areaName) + _vm._s(_vm.member.address))])]) : _vm._e(), _c('div', {
	    ...
	    staticClass: ["fz32"]
	  }, [_vm._v("点击选择会员")]) : _vm._e(), (_vm.isShow) ? _c('div', {
	    staticClass: ["flex-row"]
	  }, [_c('text', {
	    staticClass: ["fz28", "ml20"]
	  }, [_vm._v(_vm._s(_vm.member.consignee))]), _c('text', {
	    staticClass: ["fz28", "ml20"]
	  }, [_vm._v(_vm._s(_vm.member.phone))])]) : _vm._e(), _c('text', {
	    staticStyle: {
	      color: "#888",
	      fontSize: "32px"
	    },
	  ...
	  }, [_vm._v("")])]), _c('scroller', [(_vm.isShow) ? _c('div', {
	    ...
	    return _c('div', {
	    ...
	    }, [_vm._v(_vm._s(c.name))]), _c('div', {
	      staticClass: ["goodsNumberBox"]
	    }, [_c('text', {
	      staticClass: ["fz24", "mr10"]
	    }, [_vm._v("数量")]), _c('input', {
	      ...
	      on: {
	        ...
	        "input": function($event) {
	          c.quantity = $event.target.attr.value
	        }
	      }
	    })]), _c('div', {
	      staticClass: ["goodsMoneyBox"]
	    }, [_c('text', {
	      staticClass: ["fz24", "ml10", "mr10"]
	    }, [_vm._v("单价")]), _c('input', {
	      ...
	      on: {
	        ...
	        "input": function($event) {
	          c.price = $event.target.attr.value
	        }
	      }
	    })])])])
	  }), _c('div', {
	    ...
	    staticClass: ["fz32", "ml20"],
	    staticStyle: {
	      color: "#999"
	    }
	  }, [_vm._v("点击添加商品")])]), _c('div', {
	    staticClass: ["sendBox"]
	  }, [_c('div', {
	    staticClass: ["typeBox"],
	    on: {
	    ...
	    staticClass: ["typeBoxText"]
	  }, [_vm._v(_vm._s(_vm.paymentPluginName))]), _c('text', {
	    staticStyle: {
	      color: "#999",
	      fontSize: "32px"
	    },
	    ...
	    on: {
	      "change": _vm.getmoneyTotal,
	      "input": function($event) {
	        _vm.deposit = $event.target.attr.value
	      }
	    }
	  })]), _c('div', {
	    staticClass: ["flex-row"]
	    ...
	    on: {
	      "change": _vm.getmoneyTotal,
	      "input": function($event) {
	        _vm.barrel = $event.target.attr.value
	      }
	    }
	  })])]) : _vm._e(), _c('div', {
	    staticClass: ["typeBox"],
	    ...
	    staticClass: ["typeBoxText"]
	  }, [_vm._v(_vm._s(_vm.adminName))]), _c('text', {
	    staticStyle: {
	      color: "#999",
	      fontSize: "32px"
	    },
	    ...
	    staticClass: ["typeBoxText"]
	  }, [_vm._v(_vm._s(_vm.dateTime))]), _c('text', {
	    staticStyle: {
	      color: "#999",
	      fontSize: "32px"
	    },
	    ...
	    on: {
	      "input": function($event) {
	        _vm.memoData = $event.target.attr.value
	      }
	    }
	  }), _c('div', {
	    staticClass: ["flex-row", "flex-end", "ml10"],
	    on: {
	      "click": _vm.linkTo
	    }
	  }, [_vm._m(0)])])])]), _c('div', {
	    staticClass: ["moneyBox"]
	  }, [(_vm.amountPayable > 0 || _vm.arrears > 0) ? _c('div', {
	    staticClass: ["flex-row", "space-between", "pb10"]
	  }, [_c('text', {
	    staticClass: ["moneyBoxText"],
	    staticStyle: {
	      color: "red"
	    }
	  }, [_vm._v("应收金额: " + _vm._s(_vm.amountPayable) + "元(上期欠款: " + _vm._s(_vm.arrears) + "元)")])]) : _vm._e(), (_vm.paperPayable > 0 || _vm.ticket > 0) ? _c('div', {
	    staticClass: ["flex-row", "space-between", "pb10"]
	  }, [_c('text', {
	    staticClass: ["moneyBoxText"],
	    staticStyle: {
	  ...
	  }, [_vm._v("应收水票: " + _vm._s(_vm.paperPayable) + "张(上期欠票: " + _vm._s(_vm.ticket) + "张)")])]) : _vm._e(), (_vm.order != null && _vm.order.freight > 0) ? _c('div', {
	    staticClass: ["flex-row", "space-between", "pb10"]
	  }, [_c('text', {
	    staticClass: ["moneyBoxText"]
	  }, [_vm._v("运费(楼层费): " + _vm._s(_vm.order.freight) + "元")])]) : _vm._e(), (_vm.order != null && _vm.order.exchangeDiscount > 0) ? _c('div', {
	    staticClass: ["flex-row", "space-between", "pb10"]
	  }, [_c('text', {
	    staticClass: ["moneyBoxText"]
	  }, [_vm._v("电子券支付: " + _vm._s(_vm.order.exchangeDiscount) + "元")])]) : _vm._e(), (_vm.order != null && _vm.order.couponDiscount > 0) ? _c('div', {
	    staticClass: ["flex-row", "space-between", "pb10"]
	  }, [_c('text', {
	    staticClass: ["moneyBoxText"]
	  }, [_vm._v("优惠折扣: " + _vm._s(_vm.order.couponDiscount) + "元")])]) : _vm._e(), (_vm.order != null && _vm.order.pointDiscount > 0) ? _c('div', {
	    staticClass: ["flex-row", "space-between", "pb10"]
	  }, [_c('text', {
	    staticClass: ["moneyBoxText"]
	  }, [_vm._v("积分支付: " + _vm._s(_vm.order.pointDiscount) + "元")])]) : _vm._e()])], 2) : _vm._e(), (_vm.isShow) ? _c('div', {
	    staticClass: ["button", "bkg-primary"],
	    on: {
	      "click": function($event) {
	        _vm.confirm()
	      }
