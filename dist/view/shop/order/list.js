...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_styles__.push(__webpack_require__(644)
	)

	/* script */
	__vue_exports__ = __webpack_require__(645)
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/shop/order/list.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-66e6e2ae"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        if (!_utils2.default.isNull(_utils2.default.getUrlParameter('index'))) {
	            this.whichCorpus = _utils2.default.getUrlParameter('index');
	        }
	        if (!_utils2.default.isNull(_utils2.default.getUrlParameter('productCategoryId'))) {
	            this.productCategoryId = _utils2.default.getUrlParameter('productCategoryId');
	    ...
	    methods: {
	        ...
	        open: function open(type) {
	            ...
	            (0, _fetch.GET)('weex/member/order/list.jhtml?status=' + status + '&pageStart=' + this.pageStart + '&pageSize=' + this.pageSize + '&keyword=' + encodeURIComponent(this.keyword), function (res) {
	                if (res.type == "success") {
	                    if (res.data.start == 0) {
	        ...
	        goDetails: function goDetails(sn) {
	            ...
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/shop/order/details.js?sn=' + sn), function () {
	                _this.clicked = false;
	            });
	        },
	        //            确认退款
	        ...
	        //            确认订单
	        shippingConfirm: function shippingConfirm(sn) {
	            var _this = this;
	            ...
	            this.clicked = true;
	            _weex.event.openURL(_utils2.default.locate("view/shop/order/shippingConfirm.js?orderSn=" + sn), function (data) {
	                _this.clicked = false;
	                if (data.type == 'success') {
	                    _this.pageStart = 0;
	                    _this.open();
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	  ...
	  })]), (_vm.ordersList.length == 0) ? _c('cell', {
	    appendAsTree: true,
	    attrs: {
	      "append": "tree"
	    }
	  ...
	  })], 1) : _vm._l((_vm.ordersList), function(item, index) {
	    return _c('cell', {
	      appendAsTree: true,
	      attrs: {
	        "append": "tree"
	    ...
	    }, [_vm._v(_vm._s(item.statusDescr))])])]), _vm._l((item.orderItems), function(goods) {
	      return _c('div', {
	        staticClass: ["flex-row", "goodsBody"],
	        on: {
	          "click": function($event) {
	            _vm.goDetails(item.sn)
	          }
	        }
	      }, [_c('image', {
	      ...
	      staticClass: ["sub_title"]
	    }, [_vm._v(_vm._s(_vm._f("watchCreateDate")(item.createDate)))])]), _c('div', {
	      staticClass: ["flex-row"]
	    }, [_c('text', {
	      staticClass: ["title", "mr20"]
	    }, [_vm._v("共" + _vm._s(item.quantity) + "件商品")]), _c('text', {
	      staticClass: ["title"]
	    }, [_vm._v("合计:¥ " + _vm._s(_vm._f("currencyfmt")(item.amount)))])])]), (item.status == 'unpaid') ? _c('div', {
	    ...
	    }, [_vm._v("确认退货")])])]) : (item.status == 'shipped') ? _c('div', {
	      staticClass: ["flex-row", "space-between", "goodsFoot"]
	    }, [_c('div', {
	      staticClass: ["footMore"]
	    }), _c('div', {
	      staticClass: ["flex-row"]
	    }, [(item.isShipping == true) ? _c('text', {
	      staticClass: ["title", "footText"],
	      on: {
	        "click": function($event) {
	          _vm.shippingConfirm(item.sn)
	        }
	      }
	    }, [_vm._v("核销")]) : _vm._e(), (item.isShipping == false) ? _c('text', {
	      staticClass: ["title", "footText"],
	      on: {
	        "click": function($event) {
	          _vm.returnGoods(item.sn)
