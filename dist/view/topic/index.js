...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* styles */
	__vue_styles__.push(__webpack_require__(747)
	)
	__vue_styles__.push(__webpack_require__(748)
	)

	/* script */
	__vue_exports__ = __webpack_require__(749)
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/topic/index.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-46f952ba"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    components: {
	        noData: _noData2.default, topic_header: _header2.default
	    },
	    created: function created() {
	        _utils2.default.initIconFont();
	        var _this = this;
	        this.UId = _utils2.default.getUrlParameter('id');
	        this.authorId = _weex.event.getUId();

	        //            判断是iponex就动态获取底部上弹高度
	        if (_utils2.default.previewBottom() != '' && _utils2.default.previewBottom() == 'IPhoneX') {
	            this.bottomNum = parseInt(_weex.event.deviceInfo().bottomHeight) * 2;
	        }

	        //            获取屏幕的高度
	        this.screenHeight = _utils2.default.fullScreen(216);
	        (0, _fetch.GET)('weex/topic/view.jhtml?id=' + this.UId, function (data) {
	            if (data.type == 'success' && data.data != '') {
	                ...
	                if (_utils2.default.isNull(data.data.thumbnail)) {
	                    _this.topicBg = _utils2.default.locate('resources/images/background.png');
	                } else {
	                ...
	                if (_utils2.default.isNull(data.data.friendStatus)) {} else {
	                    _this.friendStatus = data.data.friendStatus;
	                }
	                //                                将文集名循环插入数组中
	                for (var i = 0; i < data.data.catalogs.length; i++) {
	    ...
	    methods: {
	        ...
	        addArticle: function addArticle() {
	            ...
	            (0, _fetch.GET)('weex/article/list.jhtml?authorId=' + this.UId + '&articleCatalogId=' + this.corpusId + '&pageStart=' + this.listCurrent + '&pageSize=' + this.listPageSize, function (data) {
	                if (data.type == 'success') {
	                    ...
	                    data.data.data.forEach(function (item) {
	                        if (_utils2.default.isNull(item.thumbnail)) {} else {
	        ...
	        goFocus: function goFocus() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/member/focus.js?id=' + this.UId + '&name=' + encodeURI(this.userName)), function (data) {
	                _this.clicked = false;
	                return;
	            });
	        },
	        ...
	        goCollect: function goCollect() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/member/collect.js?id=' + this.UId + '&name=' + encodeURI(this.userName)), function (data) {
	                _this.clicked = false;
	                return;
	            });
	        },
	        ...
	        goFans: function goFans() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/friend/fans.js?id=' + this.UId + '&name=' + encodeURI(this.userName)), function (data) {
	                _this.clicked = false;
	                return;
	            });
	        },
	        ...
	        focus: function focus() {
	            ...
	            var _this = this;
	            if (this.isFocus) {
	                (0, _fetch.POST)('weex/member/follow/delete.jhtml?authorId=' + this.UId).then(function (data) {
	                    if (data.type == 'success') {
	                        _this.isFocus = !_this.isFocus;
	                        _weex.event.sendGlobalEvent('onUserInfoChange', data);
	                    } else {
	                        _weex.event.toast(data.content);
	                    }
	                    _this.clicked = false;
	                ...
	                (0, _fetch.POST)('weex/member/follow/add.jhtml?authorId=' + this.UId).then(function (data) {
	                    if (data.type == 'success') {
	                        _this.isFocus = !_this.isFocus;
	                        _weex.event.sendGlobalEvent('onUserInfoChange', data);
	                    } else {
	        ...
	        doBlack: function doBlack() {
	            ...
	            if (this.friendStatus == 'black') {
	                (0, _fetch.POST)('weex/member/friends/delete.jhtml?friendId=' + this.UId).then(function (data) {
	                    if (data.type == 'success') {
	                        _this.friendStatus = 'ask';
	                        _weex.event.toast('已解除黑名单');
	                        _this.clicked = false;
	                    } else {
	                        _this.clicked = false;
	                        _weex.event.toast(err.content);
	                ...
	                (0, _fetch.POST)('weex/member/friends/black.jhtml?friendId=' + this.UId).then(function (data) {
	                    if (data.type == 'success') {
	                        _this.friendStatus = 'black';
	                        _weex.event.toast('已加入黑名单');
	                        _this.clicked = false;
	                    }
	                }, function (err) {
	                    _this.clicked = false;
	        ...
	        goChat: function goChat() {
	            var userId = 'u' + (10200 + parseInt(this.UId));
	        ...
	        goAddFriend: function goAddFriend() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            (0, _fetch.POST)('weex/member/friends/add.jhtml?friendId=' + this.UId).then(function (weex) {
	                if (weex.type == "success") {
	                    _weex.event.toast('请求已发送,请等待对方验证');
	                    _this.clicked = false;
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    style: {
	      ...
	      paddingBottom: _vm.bottomNum + 100
	    }
	    ...
	    staticClass: ["fz35", "gray"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	  }, [_vm._v("")]), _c('text', {
	    staticClass: ["fz35", "ml10", "gray"]
	  }, [_vm._v("已关注")])]), _c('div', {
	    staticClass: ["rightBorder"]
	  }), (_vm.friendStatus == 'adopt') ? _c('div', {
	    staticClass: ["bottomBtn"],
	    on: {
	      "click": function($event) {
	        _vm.goChat()
	    ...
	    staticClass: ["fz35", "ml10"]
	  }, [_vm._v("添加好友")])])]) : _vm._e(), (_vm.isOperation) ? _c('div', [_c('div', {
	    staticClass: ["mask"],
	    on: {
	  ...
	  }, [_vm._v("")])]), (_vm.friendStatus == 'black') ? _c('div', {
	    staticClass: ["flex-row", "pt25", "pb25", "", "textActive"],
	    staticStyle: {
	      width: "230px",
	      paddingLeft: "21px",
	      paddingRight: "21px"
