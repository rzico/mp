...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/login/index.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-10e0785d"
	    ...
	    methods: {
	        onSend: function onSend(e) {
	            ...
	            event.encrypt(_this.value, function (message) {
	                if (message.type == "success") {
	                    (0, _fetch.POST)('weex/login/send_mobile.jhtml?mobile=' + message.data).then(function (data) {
	                        if (data.type == "success") {
	                            event.openURL(_utils2.default.locate('view/login/captcha.js?mobile=' + _this.value), function (e) {
	                                event.closeURL(e);
	                            });
	                        } else {
	                            event.toast(data.content);
	        ...
	        goback: function goback(e) {
	            var E = _utils2.default.message('success', '成功', '');
	            event.closeURL(E);
	        },
