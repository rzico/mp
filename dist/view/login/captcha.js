...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/login/captcha.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-ec7be576"
	    ...
	    methods: {
	        onSend: function onSend(e) {
	            ...
	            event.encrypt(_this.mobile, function (data) {
	                (0, _fetch.POST)('weex/login/send_mobile.jhtml?mobile=' + data.data).then(function (data) {
	                    if (data.type == "success") {
	        ...
	        onEnd: function onEnd(val) {
	            ...
	            event.encrypt(val, function (data) {
	                if (data.type == "success") {
	                    (0, _fetch.POST)('weex/login/captcha.jhtml?captcha=' + data.data).then(function (data) {
	                        if (data.type == "success") {
	                            event.closeURL(data);
	                        } else {
