...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/friend/fans.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-f2bdb87c"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        //            获取所有粉丝列表
	        getAllFans: function getAllFans() {
	            var _this = this;
	            //            获取粉丝列表
	            (0, _fetch.GET)('weex/fans/list.jhtml?id=' + this.UId + '&pageStart=' + this.pageStart + '&pageSize=' + this.pageSize, function (data) {
	                if (data.type == 'success' && data.data.data != '') {
	                    if (_this.pageStart == 0) {
	                        data.data.data.forEach(function (item) {
	                            if (!_utils2.default.isNull(item.logo)) {
	                                item.logo = _utils2.default.thumbnail(item.logo, 250, 150);
	                            }
	                            //                             （配合懒加载）
	                            item.loading = false;
	                        });
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	  ...
	  })], 1) : _vm._l((_vm.userList), function(item) {
	    return _c('cell', {
	      appendAsTree: true,
	      attrs: {
	        "append": "tree"
	      ...
	      staticClass: ["friendsImage", "coverAbsoTop"]
	    }) : _vm._e(), _c('image', {
	    ...
	    }, [_vm._v(_vm._s(item.autograph))])])]), (!item.follow) ? _c('div', {
