...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/ke/mopian/GitHubMoPian/mp/src/view/friend/new.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-205caa68"
	...
	exports.default = {
	    ...
	    methods: {
	        goComplete: function goComplete() {
	            event.openURL(_utils2.default.locate("view/friends/add.js"), function (message) {
	        ...
	        gosearch: function gosearch() {
	            event.openURL(_utils2.default.locate('view/friend/search.js'), function (message) {
	        ...
	        onloading: function onloading() {
	            ...
	            (0, _fetch.GET)('weex/member/friends/list.jhtml?pageSize=20&pageStart=' + _this.start, function (data) {
	                if (data.type == "success") {
	                    var page = data.data;
	        ...
	        isRepeat: function isRepeat(index) {
	            var _this = this;
	            if (index != 0) {
	                if (_utils2.default.dayfmt(_this.friendsList[index].createDate) == _utils2.default.dayfmt(_this.friendsList[index - 1].createDate)) {
	                    return false;
	                } else {
	                    return true;
	                }
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, [_vm._v(_vm._s(_vm.refreshState))])]), _vm._l((_vm.friendsList), function(friend, index) {
	    return _c('cell', {
	      appendAsTree: true,
	      attrs: {
	        "append": "tree"
