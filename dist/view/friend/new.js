...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/friend/new.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-0d943d8e"
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        goback: function goback() {
	            var E = _utils2.default.message('success', '有新朋友', this.hadNew);
	        ...
	        dayfmt: function dayfmt(val) {
	            var res = _utils2.default.resolvetimefmt(val);
	            var tds = _utils2.default.resolvetimefmt(Math.round(new Date().getTime()));
	            var daySub = tds.d - res.d;
	            if (daySub < 1) {
	                return "今天";
	            }
	            if (daySub < 3) {
	        ...
	        //            获取所以新朋友列表
	        getNewFriends: function getNewFriends() {
	            var _this = this;
	            (0, _fetch.GET)('weex/member/friends/list.jhtml?pageSize=' + _this.pageSize + '&pageStart=' + _this.pageStart, function (data) {
	        ...
	        goMobile: function goMobile() {
	            _weex.event.openURL(_utils2.default.locate("view/friend/mobile.js"), function (message) {
	        ...
	        adopt: function adopt(id) {
	            ...
	            this.clicked = true;
	            var _this = this;
	            (0, _fetch.POST)('weex/member/friends/adopt.jhtml?friendId=' + id).then(function (data) {
	                if (data.type == "success") {
	                    _weex.event.toast(data.content);
	                    var listenData = _utils2.default.message('success', '有新朋友', '');
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    }, [_vm._v(_vm._s(_vm._f("dayfmt")(friend.createDate)))])]) : _vm._e(), _c('div', {
	      staticClass: ["addFriendsBorder"]
	    }, [_c('div', {
	      staticClass: ["friendsLine"],
	      on: {
	        "click": function($event) {
	          _vm.goAuthor(friend.id)
	        }
	      }
	    }, [_c('image', {
	    ...
	    }, [_vm._v(_vm._s(friend.nickName))]), _c('text', {
	      staticClass: ["realName"]
	    }, [_vm._v("真实姓名:" + _vm._s(_vm._f("watchName")(friend.name)))])])]), _c('div', {
