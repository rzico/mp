...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/mopian/mp/src/view/friend/new.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-44e69327"
	    ...
	    methods: {
	        ...
	        adopt: function adopt(id) {
	            ...
	            (0, _fetch.POST)('weex/member/friends/adopt.jhtml?friendId=' + id).then(function (data) {
	                if (data.type == "success") {
	                    _weex.event.toast(data.content);
	                    _weex.storage.setItem('hadNew', '1');
	                    _this.onrefresh();
	                } else {
	                    _weex.event.toast(data.content);
	                }
