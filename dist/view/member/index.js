...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/index.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-61d98b3c"
...
/***/ (function(module, exports) {
	...
	module.exports = {
	  "articleIconBox": {
	    ...
	    "borderWidth": 1,
	    "borderColor": "#cccccc",
	    "boxShadow": "10px 20px 10px -20px #ccc",
	    "backgroundColor": "#ffffff",
	    "alignItems": "center",
	    "justifyContent": "center"
	  },
	...
	exports.default = {
	    data: function data() {
	        return {
	            ...
	            bgImgUrl: _utils2.default.locate('resources/images/liveHeader.png'),
	    ...
	    components: {
	        noData: _noData2.default, topic_header: _header2.default, share: _share2.default
	    },
	    props: {
	    ...
	    methods: {
	        ...
	        openTopic: function openTopic() {
	            var _this = this;
	            (0, _fetch.GET)('weex/member/topic/view.jhtml', function (data) {
	                if (data.type == 'success') {
	                    ...
	                    if (!_utils2.default.isNull(data.data.name)) {
	        ...
	        getAllArticle: function getAllArticle() {
	            var _this = this;
	            (0, _fetch.GET)('weex/member/article/list.jhtml?authorId=' + this.UId + '&pageStart=' + this.pageStart + '&pageSize=' + this.pageSize + '&articleCatalogId=' + this.corpusId, function (data) {
	                if (data.type == "success") {
	        ...
	        jumpEditor: function jumpEditor(id, index) {
	            if (this.clicked) {
	                return;
	            }
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/member/editor/editor.js?articleId=' + id), function (mes) {
	                _this.clicked = false;
	                if (mes.type == 'success') {
	        ...
	        jumpCorpus: function jumpCorpus(item) {
	            ...
	            //                    }
	            //                );
	            _weex.event.openURL(_utils2.default.locate('view/member/editor/option.js?articleId=' + item.id), function (message) {
	                _this.clicked = false;
	                //                    _this.updateArticle();
	            });
	        },
	        ...
	        goArticle: function goArticle(item, index) {
	            ...
	            //                utils.debug(item);
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/article/preview.js?articleId=' + item.id + '&publish=' + item.articleOption.isPublish), function () {
	                _this.clicked = false;
	            });
	        },
	        ...
	        goHelpArticle: function goHelpArticle(key) {
	            ...
	            var _this = this;
	            if (key == 2) {
	                _weex.event.openURL(_utils2.default.locate('view/member/guide/index.js'), function () {
	                    _this.clicked = false;
	                });
	            } else {
	        ...
	        scrollHandler: function scrollHandler(e) {
	            ...
	            if (scrollTop >= 284) {
	                this.twoTop = true;
	                _weex.animation.transition(editorBox, {
	                    styles: {
	        ...
	        jumpDelete: function jumpDelete(item, index) {
	            ...
	            //                    return;
	            //                }
	            (0, _fetch.POST)('weex/member/article/delete.jhtml?articleId=' + item.id).then(function (e) {
	                if (e.type == 'success') {
	        ...
	        jumpTop: function jumpTop(item, index) {
	            ...
	            if (!item.articleOption.isTop) {
	                (0, _fetch.POST)('weex/member/article/update.jhtml?id=' + item.id + '&isTop=true').then(function (data) {
	                    _this.clicked = false;
	                    if (data.type == 'success') {
	                ...
	                (0, _fetch.POST)('weex/member/article/update.jhtml?id=' + item.id + '&isTop=false').then(function (data) {
	                    _this.clicked = false;
	                    if (data.type == 'success') {
	                        _this.topLocal(item, index);
	                    } else {
	        ...
	        //            本地处理sort 置顶数据
	        topLocal: function topLocal(item, index) {
	            var _this = this;
	            //                                    把动画收回来
	            if (animationPara == null || animationPara == '' || animationPara == 'undefinded') {} else {
	                _weex.animation.transition(animationPara, {
	        ...
	        openImageAlbum: function openImageAlbum() {
	            var _this = this;
	            album.openAlbumMuti(
	            //选完图片后触发回调函数
	            function (data) {
	                if (data.type == 'success') {
	                    var coverImage = data.data[0].originalPath;
	                    var paraList = [];
	                    ...
	                    _weex.storage.setItem("storageName", (0, _stringify2.default)(article), function (e) {
	                        if (e.result == 'success') {
	                            _weex.event.openURL(_utils2.default.locate("view/member/editor/editor.js?mediaType=article"), function (data) {
	                                if (data.type == 'success') {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    return _c('div', {
	      ...
	      class: [item.articleOption.isTop ? 'bd-primary' : ' ', item.articleOption.isTop ? 'primary' : ' ']
	      ...
	      attrs: {
	        "src": _vm._f("watchThumbnail")(item.thumbnail),
	        "resize": "cover"
	      }
	    })]), (item.articleOption.articleCatalog != '') ? _c('div', {
	      staticClass: ["categoryBox"]
	    }, [_c('text', {
	      staticClass: ["categoryText"]
	    }, [_vm._v(_vm._s(_vm._f("watchCatetory")(item.articleOption.articleCatalog.name)))])]) : _vm._e(), _c('div', {
	      staticClass: ["articleFoot"]
	    }, [_c('div', [_c('text', {
	      staticClass: ["articleDate"]
	    }, [_vm._v(_vm._s(_vm._f("timeDatefmt")(item.modifyDate)))])]), _c('div', {
	      ...
	      staticClass: ["relevantText"]
	    }, [_vm._v(_vm._s(item.review))])])]), _c('div', {
	      ...
	      staticClass: ["rightHiddenText"]
	    }, [_vm._v(_vm._s(item.articleOption.isTop ? '取消置顶' : '置顶'))])]) : _vm._e(), (!item.isDraft) ? _c('div', {
	      staticClass: ["rightHiddenIconBox"],
	      on: {
	        "click": function($event) {
	          _vm.jumpCorpus(item)
	    ...
	    return (_vm.corpusId == 0 && _vm.articleList.length < 10) ? _c('div', {
	      staticClass: ["articleBox"],
	      on: {
	        "click": function($event) {
