...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/blackList.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-2de91927"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    methods: {
	        //            获取黑名单列表
	        getAllBlack: function getAllBlack() {
	            var _this = this;
	            (0, _fetch.GET)('weex/member/friends/list.jhtml?status=black' + '&pageStart=' + this.pageStart + '&pageSize=' + this.pageSize, function (data) {
	        ...
	        goback: function goback() {
	            var E = _utils2.default.message('success', '成功', this.userList.length);
	        ...
	        //            解除黑名单
	        doCancel: function doCancel(id, index) {
	            var _this = this;
	            modal.confirm({
	                message: '确定要解除黑名单吗?',
	                okTitle: '确定',
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    return _c('cell', {
	      ...
	      on: {
	        "click": function($event) {
	          _vm.doCancel(item.id, _vm.index)
	        }
	      }
	    }, [_c('text', {
	      staticClass: ["focus"]
