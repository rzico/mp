...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/focus.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-19e3777c"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        //            获取所有关注列表
	        getAllFocus: function getAllFocus() {
	            var _this = this;
	            //            获取粉丝列表
	            (0, _fetch.GET)('weex/follow/list.jhtml?id=' + this.UId + '&pageStart=' + this.pageStart + '&pageSize=' + this.pageSize, function (data) {
	        ...
	        //            取消关注
	        doCancel: function doCancel(item, index) {
	            var _this = this;
	            //                判断是我的关注还是作者的关注
	            if (this.isSelf) {
	                modal.confirm({
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	  ...
	  })], 1) : _vm._l((_vm.userList), function(item, index) {
	    return _c('cell', {
	      appendAsTree: true,
	      attrs: {
	        "append": "tree"
	    ...
	    }, [_vm._v(_vm._s(item.autograph))])])]), (_vm.isSelf) ? _c('div', {
	      staticClass: ["status_panel"],
	      on: {
	        "click": function($event) {
	          _vm.doCancel(item, index)
	        }
	      }
	    }, [(item.follow && !item.followed) ? _c('text', {
	      staticClass: ["ask"]
	    }, [_vm._v("已关注")]) : _c('text', {
	      staticClass: ["ask"]
	    }, [_vm._v("互相关注")])]) : _c('div', {
