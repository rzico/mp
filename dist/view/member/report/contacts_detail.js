...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/report/contacts_detail.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-30281c30"
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        open: function open() {
	            ...
	            (0, _fetch.GET)('weex/member/report/shipping_detail_report.jhtml?type=shipping&beginDate=' + encodeURIComponent(_this.beginTime) + '&endDate=' + encodeURIComponent(_this.endTime) + '&pageStart=' + _this.pageStart + '&pageSize=' + _this.pageSize + '&sellerId=' + _this.sellerId, function (res) {
	                if (res.type == "success") {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    return _c('cell', {
	      ...
	      staticClass: ["fz32"]
	    }, [_vm._v(_vm._s(c.name) + "  " + _vm._s(c.phone) + "  " + _vm._s(c.address))])]), _c('div', {
	      ...
	      staticClass: ["fz32"]
	    }, [_vm._v("货款: ¥" + _vm._s(c.cost))])]), _c('div', {
	      staticClass: ["totalCellTwo"]
	    }, [_c('text', {
	      staticClass: ["fz32"]
	    }, [_vm._v("应收金额: ¥" + _vm._s(c.amountPayable) + "(上期欠款:¥" + _vm._s(c.arrears) + ")")]), _c('text', {
	      staticClass: ["fz32"]
	    }, [_vm._v("代收现金: ¥" + _vm._s(c.amountPaid))])]), _c('div', {
	      staticClass: ["totalCellTwo"]
	    }, [_c('text', {
	      staticClass: ["fz32"]
	    }, [_vm._v("应收水票: " + _vm._s(c.paperPayable) + "(上期欠票:" + _vm._s(c.ticket) + ")")]), _c('text', {
	      staticClass: ["fz32"]
	    }, [_vm._v("代收水票: " + _vm._s(c.paperPaid))])]), _c('div', {
	      staticClass: ["totalCellTwo"]
	    }, [_c('text', {
	      staticClass: ["fz32"]
	    }, [_vm._v("应收押金: ¥" + _vm._s(c.pledgePayable))]), _c('text', {
	      staticClass: ["fz32"]
	    }, [_vm._v("配送费用: ¥" + _vm._s(c.shippingFreight))])]), _c('div', {
	      staticClass: ["totalCellTwo"]
	    }, [_c('text', {
	      staticClass: ["fz32"]
	    }, [_vm._v("代发工资: ¥" + _vm._s(c.adminFreight) + "(楼层费:¥" + _vm._s(c.levelFreight) + ")")])])])])
	  }), _c('loading', {
	    attrs: {
