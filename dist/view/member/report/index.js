...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/report/index.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-ac6e9b86"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        order_report: function order_report() {
	            if (this.clicked == true) {
	                return;
	            }
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate("view/member/report/order_report.js"), function (e) {
	                _this.clicked = false;
	            });
	        },
	        payment_report: function payment_report() {
	            if (this.clicked == true) {
	                return;
	            }
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate("view/member/report/payment_report.js"), function (mes) {
	                _this.clicked = false;
	            });
	        },
	        contacts_report: function contacts_report() {
	            if (this.clicked == true) {
	                return;
	            }
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate("view/member/report/contacts_report.js"), function (e) {
	                _this.clicked = false;
	            });
	        },
	        sendSingle_report: function sendSingle_report() {
	            if (this.clicked == true) {
	                return;
	            }
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate("view/member/report/sendSingle_report.js"), function (e) {
	                _this.clicked = false;
	            });
	        },
	        barrel_report: function barrel_report() {
	            if (this.clicked == true) {
	                return;
	            }
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate("view/member/report/barrel_report.js"), function (e) {
	                _this.clicked = false;
	            });
	        },
	        money_report: function money_report() {
	            if (this.clicked == true) {
	                return;
	            }
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate("view/shop/deposit/deposit.js"), function (e) {
	                _this.clicked = false;
	            });
	        },
	        arrears_report: function arrears_report() {
	            if (this.clicked == true) {
	                return;
	            }
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate("view/member/report/arrears_report.js"), function (e) {
	                _this.clicked = false;
	            });
	        },
	        //            下拉刷新
