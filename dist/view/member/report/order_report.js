...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/report/order_report.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-98c4a7ac"
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        open: function open() {
	            ...
	            (0, _fetch.GET)('weex/member/report/order_summary.jhtml?beginDate=' + encodeURIComponent(_this.beginTime) + '&endDate=' + encodeURIComponent(_this.endTime) + '&pageStart=' + _this.pageStart + '&pageSize=' + _this.pageSize, function (res) {
	                if (res.type == "success") {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["fz32", "fontStrong"]
	  }, [_vm._v("商品合计: ¥" + _vm._s(_vm.summarylist[0].price))])]), _c('div', {
	    staticClass: ["bottomCellTwo"]
	  }, [_c('text', {
	    staticClass: ["fz28"]
	  }, [_vm._v("积分抵扣: ¥" + _vm._s(_vm.summarylist[0].pointDiscount))]), _c('text', {
	    staticClass: ["fz28"]
	  }, [_vm._v("优惠折扣: ¥" + _vm._s(_vm.summarylist[0].couponDiscount))])]), _c('div', {
	    staticClass: ["bottomCellTwo"]
	  }, [_c('text', {
	    staticClass: ["fz28"]
	  }, [_vm._v("电子券抵扣: ¥" + _vm._s(_vm.summarylist[0].exchangeDiscount))]), _c('text', {
	    staticClass: ["fz28"]
	  }, [_vm._v("调价: ¥" + _vm._s(_vm.summarylist[0].offsetAmount))])]), _c('div', {
	    staticClass: ["bottomCellTwo"]
	  }, [_c('text', {
	    staticClass: ["fz28"]
	  }, [_vm._v("运费: ¥" + _vm._s(_vm.summarylist[0].freight))]), _c('text', {
	    staticClass: ["fz28", "fontStrong"]
	  }, [_vm._v("营业额: ¥" + _vm._s(_vm.summarylist[0].amount))])]), _c('div', {
	    staticClass: ["bottomCellTwo"]
	  }, [_c('text', {
	    staticClass: ["fz28"]
	  }, [_vm._v("商品成本: ¥" + _vm._s(_vm.summarylist[0].cost))]), _c('text', {
	    staticClass: ["fz28"]
	  }, [_vm._v("平台佣金: ¥" + _vm._s(_vm.summarylist[0].fee))])]), _c('div', {
	    staticClass: ["bottomCellTwo"]
	  }, [_c('text', {
	    staticClass: ["fz28"]
	  }, [_vm._v("配送费: ¥" + _vm._s(_vm.summarylist[0].shippingFreight))]), _c('text', {
	    staticClass: ["fz28", "fontStrong"]
	  }, [_vm._v("净利润: ¥" + _vm._s(_vm.summarylist[0].profit))])])]) : _vm._e()], 1)
