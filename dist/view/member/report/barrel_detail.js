...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/report/barrel_detail.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-6ad51975"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    props: {},
	    filters: {
	        watchDate: function watchDate(val) {
	            return _utils2.default.ymdtimefmt(val);
	        }
	    },
	    created: function created() {
	        //              页面创建时请求数据
	        _utils2.default.initIconFont();
	        this.barrelId = _utils2.default.getUrlParameter('barrelId');
	        this.sellerId = _utils2.default.getUrlParameter('sellerId');
	        ...
	        if (!_utils2.default.isNull(_utils2.default.getUrlParameter('beginTime')) && !_utils2.default.isNull(_utils2.default.getUrlParameter('endTime'))) {
	            this.beginTime = _utils2.default.getUrlParameter('beginTime');
	            this.endTime = _utils2.default.getUrlParameter('endTime');
	            this.pageTime = _utils2.default.getUrlParameter('beginTime');
	        }
	        this.open();
	    },
	    ...
	    methods: {
	        ...
	        open: function open() {
	            ...
	            this.noLoading = true;
	            (0, _fetch.GET)('weex/member/report/barrel_detail_report.jhtml?beginDate=' + encodeURIComponent(_this.beginTime) + '&endDate=' + encodeURIComponent(_this.endTime) + '&pageStart=' + _this.pageStart + '&pageSize=' + _this.pageSize + '&barrelId=' + _this.barrelId + '&sellerId=' + _this.sellerId, function (res) {
	                if (res.type == "success") {
	        ...
	        linkToView: function linkToView(sn) {
	            if (this.clicked) {
	                return;
	            }
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/shop/shipping/info.js?sn=' + sn), function (data) {
	                _this.clicked = false;
	                if (data.type == 'success') {}
	            });
	        }
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    return _c('cell', {
	    ...
	    }, [_vm._v(_vm._s(c.name) + "  " + _vm._s(c.address) + "  " + _vm._s(c.phone))])]), _c('div', {
	      ...
	      staticClass: ["number"]
	    }, [_vm._v(_vm._s(_vm._f("watchDate")(c.completeDate)))]), _c('text', {
