...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/report/barrel_report.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-1bb82cd8"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        open: function open() {
	            var _this = this;
	            (0, _fetch.GET)('weex/member/report/barrel_summary.jhtml?beginDate=' + encodeURIComponent(_this.beginTime) + '&endDate=' + encodeURIComponent(_this.endTime) + '&pageStart=' + _this.pageStart + '&pageSize=' + _this.pageSize, function (res) {
	                if (res.type == "success") {
	        ...
	        linkToDetail: function linkToDetail(barrelId, sellerId) {
	            if (this.clicked) {
	                return;
	            }
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/member/report/barrel_detail.js?barrelId=' + barrelId + '&sellerId=' + sellerId + '&beginTime=' + encodeURIComponent(this.beginTime) + '&endTime=' + encodeURIComponent(this.endTime)), function (data) {
	                _this.clicked = false;
	            });
	        }
	    }
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    return _c('cell', {
	      ...
	      on: {
	        "click": function($event) {
	          _vm.linkToDetail(c.barrelId, c.sellerId)
	        }
	      }
	    }, [_c('div', {
	      staticClass: ["contentSmallCell"]
	    }, [_c('text', {
	      staticClass: ["number"]
	    }, [_vm._v(_vm._s(c.barrelName))]), _c('text', {
	      staticClass: ["contentCellType"]
	    }, [_vm._v("派单")]), _c('text', {
	      staticClass: ["returnMoney"]
	    }, [_vm._v(_vm._s(c.sQuantity))]), _c('text', {
	      staticClass: ["returnMoney"]
	    }, [_vm._v(_vm._s(c.sReturnQuantity))]), _c('text', {
	      staticClass: ["returnMoney"]
	    }, [_vm._v(_vm._s(c.sPledgeQuantity))]), _c('text', {
	      staticClass: ["money"]
	    }, [_vm._v(_vm._s(c.sQuantity - c.sReturnQuantity - c.sPledgeQuantity))])]), _c('div', {
	      staticClass: ["contentSmallCell"]
	    }, [_c('text', {
	      staticClass: ["number"]
	    }), _c('text', {
	      ...
	      staticClass: ["returnMoney"]
	    }, [_vm._v(_vm._s(c.returnQuantity))]), _c('text', {
	      staticClass: ["returnMoney"]
	    }, [_vm._v(_vm._s(c.pledgeQuantity))]), _c('text', {
	      staticClass: ["money"]
	    }, [_vm._v(_vm._s(c.quantity - c.returnQuantity - c.pledgeQuantity))])])])])
	  }), _c('loading', {
	    attrs: {
	  ...
	  }, [_c('noData')], 1) : _vm._e(), _vm._m(1)], 2) : _vm._e(), (_vm.summarylist != null) ? _c('div', {
	    ...
	    staticClass: ["returnMoney"]
	  }, [_vm._v(_vm._s(_vm.sQuantityTotal))]), _c('text', {
	    staticClass: ["returnMoney"]
	  }, [_vm._v(_vm._s(_vm.sReturnQuantityTotal))]), _c('text', {
	    staticClass: ["returnMoney"]
	  }, [_vm._v(_vm._s(_vm.sPledgeQuantityTotal))]), _c('text', {
	    staticClass: ["money"]
	  }, [_vm._v(_vm._s(_vm.sQuantityTotal - _vm.sReturnQuantityTotal - _vm.sPledgeQuantityTotal))])]), _c('div', {
	    staticClass: ["contentSmallCell"]
	  }, [_c('text', {
	    staticClass: ["number"]
	  }), _c('text', {
	    ...
	    staticClass: ["returnMoney"]
	  }, [_vm._v(_vm._s(_vm.quantityTotal))]), _c('text', {
	    staticClass: ["returnMoney"]
	  }, [_vm._v(_vm._s(_vm.returnQuantityTotal))]), _c('text', {
	    staticClass: ["returnMoney"]
	  }, [_vm._v(_vm._s(_vm.pledgeQuantityTotal))]), _c('text', {
	    staticClass: ["money"]
	  }, [_vm._v(_vm._s(_vm.quantityTotal - _vm.returnQuantityTotal - _vm.pledgeQuantityTotal))])])]), _c('list', {
	    staticStyle: {
	      maxHeight: "500px"
	    }
	  }, _vm._l((_vm.summarylist), function(t) {
	    return _c('cell', {
	      appendAsTree: true,
	      attrs: {
	        "append": "tree"
	      ...
	      staticClass: ["number"]
	    }, [_vm._v(_vm._s(t.barrelName))]), _c('text', {
	      staticClass: ["contentCellType"]
	    }, [_vm._v("派单")]), _c('text', {
	      staticClass: ["returnMoney"]
	    }, [_vm._v(_vm._s(t.sQuantity))]), _c('text', {
	      staticClass: ["returnMoney"]
	    }, [_vm._v(_vm._s(t.sReturnQuantity))]), _c('text', {
	      staticClass: ["returnMoney"]
	    }, [_vm._v(_vm._s(t.sPledgeQuantity))]), _c('text', {
	      staticClass: ["money"]
	    }, [_vm._v(_vm._s(t.sQuantity - t.sReturnQuantity - t.sPledgeQuantity))])]), _c('div', {
	      staticClass: ["contentSmallCell"]
	    }, [_c('text', {
	      staticClass: ["number"]
	    }), _c('text', {
	      ...
	      staticClass: ["returnMoney"]
	    }, [_vm._v(_vm._s(t.quantity))]), _c('text', {
	      staticClass: ["returnMoney"]
	    }, [_vm._v(_vm._s(t.returnQuantity))]), _c('text', {
	      staticClass: ["returnMoney"]
	    }, [_vm._v(_vm._s(t.pledgeQuantity))]), _c('text', {
	      staticClass: ["money"]
	    }, [_vm._v(_vm._s(t.quantity - t.returnQuantity - t.pledgeQuantity))])])])])
	  }))]) : _vm._e()], 1)
