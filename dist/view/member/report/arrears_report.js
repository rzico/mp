...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/report/arrears_report.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-5eabef0c"
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        open: function open() {
	            ...
	            this.noLoading = true;
	            (0, _fetch.GET)('weex/member/report/arrears_summary.jhtml?beginDate=' + encodeURIComponent(_this.beginTime) + '&endDate=' + encodeURIComponent(_this.endTime) + '&pageStart=' + _this.pageStart + '&pageSize=' + _this.pageSize, function (res) {
	                if (res.type == "success") {
	        ...
	        linkToDetail: function linkToDetail(memberId) {
	            if (this.clicked) {
	                return;
	            }
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/member/report/arrears_detail.js?memberId=' + memberId + '&beginTime=' + encodeURIComponent(this.beginTime) + '&endTime=' + encodeURIComponent(this.endTime)), function (data) {
	                _this.clicked = false;
	            });
	        }
	    }
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    return _c('cell', {
	      ...
	      staticClass: ["address"]
	    }, [_vm._v(_vm._s(c.phone) + "  " + _vm._s(c.address))])]), _c('div', {
	      staticClass: ["contentSmallCell"]
	    }, [_c('text', {
	      staticClass: ["contentCellName"]
	      ...
	      staticClass: ["contentCellType"]
	    }, [_vm._v(_vm._s(c.paper))]), _c('text', {
	      staticClass: ["contentCellTypeTwo"]
	    }, [_vm._v(_vm._s(c.arrearsBalance))]), _c('text', {
	      staticClass: ["returnMoney"]
	    }, [_vm._v(_vm._s(c.paperBalance))])])])])
	  }), _c('loading', {
	    attrs: {
