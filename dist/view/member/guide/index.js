...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/guide/index.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-64459a69"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    components: {
	        navbar: _navbar2.default, payment: _payment2.default
	    },
	    data: function data() {
	        return {
	            clicked: false,
	    ...
	    methods: {
	        ...
	        open: function open() {
	            var _this = this;
	            (0, _fetch.GET)("weex/member/guide/view.jhtml", function (res) {
	                if (res.type == 'success') {
	        ...
	        topic: function topic() {
	            ...
	            if (_this.steped1 == false) {
	                event.openURL(_utils2.default.locate('view/member/option.js'), function (message) {
	                    _this.clicked = false;
	                    _this.open();
	                });
	            } else {
	        ...
	        bindingCard: function bindingCard() {
	            ...
	            if (this.steped1 == true) {
	                ...
	                if (_this.steped2 == false) {
	                    event.openURL(_utils2.default.locate('view/member/bank/bindFirstStep.js'), function (message) {
	                        _this.clicked = false;
	                        _this.open();
	                    });
	                } else {
	        ...
	        shop: function shop() {
	            ...
	            if (this.steped1 !== true) {
	                ...
	                if (_this.steped3 == false) {
	                    event.openURL(_utils2.default.locate('view/shop/shop/newShop.js'), function (message) {
	                        _this.clicked = false;
	                        _this.open();
	                    });
	                } else {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["number"],
	    attrs: {
	      "src": "http://rzico.oss-cn-shenzhen.aliyuncs.com/weex/resources/images/number1.jpeg"
	    }
	  }), (_vm.steped1) ? _c('text', {
	    staticClass: ["icoPitch"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	  }, [_vm._v("")]) : _vm._e(), (!_vm.steped1) ? _c('text', {
	    staticClass: ["title", "ml10"]
	  }, [_vm._v("开通专栏")]) : _vm._e(), (_vm.steped1) ? _c('text', {
	    staticClass: ["complete", "ml10"]
	  }, [_vm._v("已开通专栏")]) : _vm._e()]), _c('div', {
	    staticClass: ["flex-row", "flex-end"]
	  }, [_c('text', {
	    staticClass: ["sub_title"]
	  }), _c('text', {
	    ...
	    staticClass: ["flex-row", "flex-start", "pl20"]
	  }, [_c('image', {
	    staticClass: ["number"],
	    attrs: {
	      "src": "http://rzico.oss-cn-shenzhen.aliyuncs.com/weex/resources/images/number2.jpeg"
	    }
	  }), (_vm.steped2) ? _c('text', {
	    staticClass: ["icoPitch", "pl20"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	  }, [_vm._v("")]) : _vm._e(), (!_vm.steped2) ? _c('text', {
	    staticClass: ["title", "ml10"]
	  }, [_vm._v("绑定银行卡")]) : _vm._e(), (_vm.steped2) ? _c('text', {
	    staticClass: ["complete", "ml10"]
	  }, [_vm._v("已绑定银行卡")]) : _vm._e()]), _c('div', {
	    staticClass: ["flex-row", "flex-end"]
	  }, [_c('text', {
	    staticClass: ["sub_title"]
	  }), _c('text', {
	    ...
	    staticClass: ["number"],
	    attrs: {
	      "src": "http://rzico.oss-cn-shenzhen.aliyuncs.com/weex/resources/images/number3.jpeg"
	    }
	  }), (_vm.steped3) ? _c('text', {
	    staticClass: ["icoPitch"],
	    style: {
	  ...
	  }, [_vm._v("")]) : _vm._e(), (!_vm.steped3) ? _c('text', {
	    staticClass: ["title", "ml10"]
	  }, [_vm._v("完善资料")]) : _vm._e(), (_vm.steped3) ? _c('text', {
	    staticClass: ["complete", "ml10"]
	  }, [_vm._v("已完善资料")]) : _vm._e()]), _c('div', {
	    staticClass: ["flex-row", "flex-end"]
	  }, [_c('text', {
	    staticClass: ["sub_title"]
	  }), _c('text', {
	    ...
	    staticClass: ["number"],
	    attrs: {
	      "src": "http://rzico.oss-cn-shenzhen.aliyuncs.com/weex/resources/images/number4.jpeg"
	    }
	  }), (_vm.steped4) ? _c('text', {
	    staticClass: ["icoPitch", "pl20"],
	    style: {
	  ...
	  }, [_vm._v("")]) : _vm._e(), (!_vm.steped4) ? _c('text', {
	    staticClass: ["title", "ml10"]
	  }, [_vm._v("支付费用")]) : _vm._e(), (_vm.steped4) ? _c('text', {
	    staticClass: ["complete", "ml10"]
	  }, [_vm._v("已支付费用")]) : _vm._e()]), _c('div', {
	    staticClass: ["flex-row", "flex-end"]
	  }, [_c('text', {
	    staticClass: ["sub_title"]
	  }), _c('text', {
