...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/mopian/mp/src/view/member/editor/corpus.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-20ace56d"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        var corpus = _utils2.default.getUrlParameter('name');
	        if (_utils2.default.isNull(corpus)) {
	            return;
	        } else {
	            _weex.storage.getItem(corpus, function (e) {
	                if (e.data != 'undefined') {
	                    var corpusData = JSON.parse(e.data);
	                ...
	                _weex.storage.removeItem(corpus);
	            });
	        }
	    },
	    ...
	    methods: (_methods = {
	            ...
	            modal.prompt({
	                ...
	                if (value.result == '确定') {
	                    if (_utils2.default.isNull(value.data)) {
	                        _weex.event.toast('请输入文集名');
	                    } else {
	                        var orders = _this.corpusList.length + 1;
	                        value.data = encodeURI(value.data);
	                        //                            向服务器存入文集名称
	                        (0, _fetch.POST)('weex/member/article_catalog/add.jhtml?name=' + value.data + '&orders=' + orders).then(function (res) {
	        ...
	        //            修改文集名称
	        changeName: function changeName(index, corpusName, id) {
	            var _this = this;
	            modal.prompt({
	                message: '修改文集名',
	                duration: 0.3,
	                ...
	                if (value.result == '确定') {
	                    if (value.data == '' || value.data == null) {
	                        ...
	                        (0, _fetch.POST)('weex/member/article_catalog/update.jhtml?id=' + id + '&name=' + encodeURI(value.data)).then(function (data) {
	                            if (data.type == 'success') {
	        ...
	        deleteCorpus: function deleteCorpus(index, id) {
	            ...
	            modal.confirm({
	                ...
	                if (value == '删除') {
	                    (0, _fetch.POST)('weex/member/article_catalog/delete.jhtml?id=' + id).then(function (data) {
	                        if (data.type == 'success') {
	        ...
	        cleanbgChange: function cleanbgChange() {
	            ...
	            if (this.isSort == 1) {
	                this.isSort = 0;
	                var url = 'weex/member/article_catalog/sort.jhtml?ids=';
	        ...
	        this.isSort = 1;
	        //         方法2
	        var a = this.corpusList[index].name;
	        var b = this.corpusList[index].id;
	        var c = this.corpusList[index].total;
	        var d = this.corpusList[index].bgChange;
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('scroller', {
	  ...
	  }, [_vm._v("")])])]), _vm._m(0), _vm._m(1), _c('transition-group', {
	    attrs: {
	      "name": "paraTransition",
	      "tag": "div"
	    }
	    ...
	    return _c('div', {
	      ...
	      staticClass: ["lineText"],
	      class: [item.bgChange ? 'active' : 'noActive']
	    }, [_vm._v("(" + _vm._s(item.total) + ")")])]), (!item.bgChange) ? _c('div', {
	      staticClass: ["flex-row"],
	      staticStyle: {
	        width: "200px"
	      }
	      ...
	      on: {
	        "click": function($event) {
	          _vm.changeName(index, item.name, item.id)
	        }
	      }
	    }, [_c('text', {
