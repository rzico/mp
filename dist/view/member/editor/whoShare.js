...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/editor/whoShare.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-229d388d"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    filters: {
	        ...
	        watchNickName: function watchNickName(value) {
	            if (_utils2.default.isNull(value)) {
	                ...
	                return _utils2.default.changeStrLast(value, 9);
	            }
	        },
	        //            分享的图标
	        watchImg: function watchImg(value) {
	            switch (value) {
	                case 'timeline':
	    ...
	    methods: {
	        //            获取黑名单列表
	        getAllShare: function getAllShare() {
	            var _this = this;
	            (0, _fetch.GET)('weex/share/list.jhtml?articleId=' + this.articleId + '&pageStart=' + this.pageStart + '&pageSize=' + this.pageSize, function (data) {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	  ...
	  })]), (_vm.shareList.length == 0) ? _c('cell', {
	    appendAsTree: true,
	    attrs: {
	      "append": "tree"
	    }
	  }, [(_vm.shareList.length == 0) ? _c('noData', {
	    attrs: {
	      "noDataHint": _vm.noDataHint,
	      "ndBgColor": "#fff"
	    }
	  }) : _vm._e()], 1) : _vm._e(), _vm._l((_vm.shareList), function(item) {
	    return _c('cell', {
	      staticClass: ["lineBox"],
	      appendAsTree: true,
	      attrs: {
	    ...
	    }, [_vm._v("(" + _vm._s(_vm._f("watchType")(item.shareType)) + ")")])]), _c('div', {
	      staticClass: ["flex-row"]
	    }, [_c('image', {
	      staticStyle: {
	        width: "26px",
	      ...
	      attrs: {
	        "src": _vm._f("watchImg")(item.shareType)
	      }
	    }), _c('text', {
	      staticClass: ["sub_date"]
	    }, [_vm._v(_vm._s(_vm._f("datemoretimefmt")(item.createDate)))])])])])])
	  })], 2)], 1)
	},staticRenderFns: []}
	module.exports.render._withStripped = true
