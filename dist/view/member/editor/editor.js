...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/editor/editor.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-27d74639"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        var articleId = _utils2.default.getUrlParameter("articleId");
	        var goodsId = _utils2.default.getUrlParameter("goodsId");
	        var mediaType = _utils2.default.getUrlParameter("mediaType");

	        _this.articleType = mediaType;
	        if (_utils2.default.isNull(mediaType)) {
	            _this.articleType = "article";
	        }

	        if (!_utils2.default.isNull(goodsId)) {
	            _this.articleType = "product";
	            _this.goodsId = goodsId;
	        }

	        //创建文章编辑（首次）
	        if (_utils2.default.isNull(articleId)) {
	            var articleDraft = _utils2.default.getUrlParameter("articleDraft");
	            if (_utils2.default.isNull(articleDraft)) {
	                _this.newArticle();
	            } else {
	                var draft = {
	                    type: 'articleDraft',
	                ...
	                event.find(draft, function (data) {
	                    if (data.type == 'success' && data.data != '') {
	                        var info = JSON.parse(data.data.value);
	                        _this.readData(info);
	                    } else {
	                        _this.newArticle();
	                    }
	    ...
	    methods: {
	        newArticle: function newArticle() {
	            ...
	            storage.getItem("storageName", function (e) {
	                if (e.result == 'success') {
	                    ...
	                    _this.coverImage = info.coverImage;
	                    _this.setTitle = info.title;
	                    info.paraList.forEach(function (item) {
	                        _this.paraList.push({
	                            //原图
	                            paraImage: item.paraImage,
	                            //小缩略图
	                    ...
	                    //                          把缓存删除
	                    storage.removeItem(storageName, function (e) {});
	                }
	            });
	        },
	        ...
	        //            根据数据组装成页面所需要的格式
	        templateGroup: function templateGroup(templatesData, groupCommon) {
	            var _this = this;
	            for (var i = 0; i < templatesData.length; i++) {
	                ...
	                //                    判断公众号返回的缩略图是否为空
	                if (groupCommon && !_utils2.default.isNull(templatesData[i].original) && _utils2.default.isNull(templatesData[i].thumbnail)) {
	                    templatesData[i].thumbnail = _utils2.default.isNull(templatesData[i].thumbnail) ? templatesData[i].original : templatesData[i].thumbnail;
	                }
	                //                    若是公众号获取下来的文章,将封面放上去;
	                if (groupCommon && !_utils2.default.isNull(templatesData[i].original) && (_utils2.default.isNull(_this.coverImage) || _this.coverImage == _utils2.default.locate('resources/images/background.png'))) {
	                    _this.coverImage = templatesData[i].original;
	                }
	        ...
	        //从缓存读取数据 写入界面
	        readData: function readData(articleData) {
	            var _this = this;
	            ...
	            //                        根据数据组装成页面所需要的格式
	            _this.templateGroup(templatesData);
	            //                            投票
	        ...
	        //           从服务器获取文章信息并存入缓存
	        getServerArticle: function getServerArticle() {
	            var _this = this;
	            ...
	            storage.setItem('articleTitle', textData, function (e) {
	                event.openURL(_utils2.default.locate('widget/autograph.js?name=articleTitle'), function (message) {
	                    ...
	                    if (message.type == 'success' && !_utils2.default.isNull(message.data) && !_utils2.default.isNull(message.data.text)) {
	                        _this.setTitle = _utils2.default.filteremoji(message.data.text, 'article');
	                        _this.hadChange = 1;
	                ...
	                modal.confirm({
	                    ...
	                    if (value == '存为草稿') {
	                        ...
	                        _this.deleteDraft(function () {
	                            ...
	                            var backData = _utils2.default.message('error', '取消', E);
	                            event.closeURL(backData);
	                        });
	                    }
	                });
	        ...
	        //            删除临时缓存和草稿缓存
	        deleteDraft: function deleteDraft(callback) {
	            var _this = this;
	        ...
	        realSave: function realSave() {
	            ...
	            //                网络请求，保存文章
	            (0, _fetch.POST)('weex/member/article/submit.jhtml?goodsId=' + _this.goodsId + "&articleType=" + _this.articleType, articleData).then(function (res) {
	                if (res.type == 'success') {
	                    _this.deleteDraft(function () {
	                        var backData = _utils2.default.message('success', '成功', res.data);
	                        event.closeURL(backData);
	                    });
	                    _this.clicked = false;
	                } else {
	        ...
	        addLinkPara: function addLinkPara(index) {
	            ...
	            event.openURL(_utils2.default.locate('view/shop/goods/manage.js?from=editor&pageType=true'), function (data) {
	                if (data.type == 'success') {
	                    var newPara = {
	                        //原图
	                        //                                    paraImage: data.data[i].originalPath,
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["addVote"]
	  }, [_vm._v("添加商品")])])], 2), _vm._m(0)]), (_vm.toSendArticle) ? _c('process', {
	    attrs: {
