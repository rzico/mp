...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/mopian/mp/src/view/member/editor/option.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-7b55d39a"
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        goCategory: function goCategory() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('widget/list.js?listId=' + this.category + '&type=article_category'),
	        ...
	        goDone: function goDone() {
	            ...
	            var urlData = 'weex/member/article/publish.jhtml?id=' + this.articleId + '&isPublish=' + this.contributeSwitch + '&isReview=' + this.commentsSwitch + '&isReward=' + this.rewardSwitch + '&authority=' + authorityData + '&isTop=' + this.topData + '&password=' + this.password + '&articleCatalogId=' + this.corpusId + '&articleCategoryId=' + this.category;
	            //                event.toast(urlData);
	                ...
	                if (data.type == 'success') {
	                    ...
	                    var saveData = {
	                        ...
	                        if (data.type == 'success') {
	                            ...
	                            _weex.event.openURL(_utils2.default.locate('view/article/preview.js?articleId=' + _this.articleId + '&publish=true' + '&showShare=true'), function () {
	                                var E = {
	                                    isDone: 'complete'
	                                };
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["sub_title"]
	  }, [_vm._v(_vm._s(_vm.categoryName))]), _c('text', {
	    staticClass: ["arrow"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	    ...
	    staticClass: ["switch"],
	    attrs: {
	      "checked": _vm.contributeSwitch
	    },
	    on: {
	      "change": _vm.contributeChange
	    }
	  })])])]), _vm._m(11), _c('div', {
	    staticClass: ["fill"]
	  })]), _c('div', {
