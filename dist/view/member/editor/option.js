...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/editor/option.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-530a2d7e"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        (0, _fetch.GET)('weex/member/article/option.jhtml?id=' + this.articleId, function (data) {
	            if (data.type == 'success' && data.data != '') {
	                //                    event.toast(data);
	                //                    文集
	                if (!_utils2.default.isNull(data.data.articleCatalog)) {
	                    if (!_utils2.default.isNull(data.data.articleCatalog.name)) {
	                        _this.corpusName = data.data.articleCatalog.name;
	                    }if (!_utils2.default.isNull(data.data.articleCatalog.id)) {
	                        _this.corpusId = data.data.articleCatalog.id;
	                    }
	                }
	                //                    分类
	                if (!_utils2.default.isNull(data.data.articleCategory)) {
	                    if (!_utils2.default.isNull(data.data.articleCategory.name)) {
	                        _this.categoryName = data.data.articleCategory.name;
	                    }if (!_utils2.default.isNull(data.data.articleCategory.id)) {
	                ...
	                //                    谁可以看
	                if (!_utils2.default.isNull(data.data.authority)) {
	    ...
	    filters: {
	        watchScope: function watchScope(value) {
	            switch (value) {
	                case 0:
	                    return '公开';
	                    break;
	    ...
	    components: {
	        navbar: _navbar2.default, process: _process2.default
	    },
	    props: {
	        title: { default: "选项" }
	    },
	    methods: {
	        ...
	        //            跳转至选择范围
	        goScope: function goScope() {
	            if (this.clicked) {
	                return;
	            }
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/member/editor/scope.js?checkId=' + this.scope),
	            //                event.openURL('http://192.168.2.157:8081/scope.weex.js?checkId=' + _this.scope,
	            function (data) {
	                _this.clicked = false;
	                if (data.type == 'success' && data.data != '') {
	                    _this.scope = parseInt(data.data.checkId);
	                    if (data.data.checkId == 2 && !_utils2.default.isNull(data.data.password)) {
	        ...
	        goCategory: function goCategory() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('widget/list.js?listId=' + this.category + '&type=article_category'), function (data) {
	                _this.clicked = false;
	                if (data.type == 'success' && data.data != '') {
	        ...
	        //            跳转至选择文集
	        goChooseCorpus: function goChooseCorpus() {
	            var _this = this;
	            if (this.clicked) {
	                return;
	            }
	            this.clicked = true;
	            _weex.event.openURL(_utils2.default.locate('view/member/editor/chooseCorpus.js?corpusId=' + this.corpusId + '&articleId=' + this.articleId),
	        ...
	        //            打赏开关
	        rewardChange: function rewardChange(e) {
	            this.rewardSwitch = e.value;
	        },
	        //            评论开关
	        commentsChange: function commentsChange(e) {
	            this.commentsSwitch = e.value;
	        },
	        //            投稿开关
	        contributeChange: function contributeChange(e) {
	        ...
	        //            推荐开关
	        recommendedChange: function recommendedChange(e) {
	            this.recommendedSwitch = e.value;
	        },
	        //            清楚掉假的进度条。清空假进度条，关闭定时器.
	        clearDummyProcess: function clearDummyProcess(timer) {
	            //                                        解除定时器
	            if (!_utils2.default.isNull(timer)) {
	                clearInterval(timer);
	        ...
	        goDone: function goDone() {
	            ...
	            var timer = setInterval(function () {
	                if (_this.processWidth < 500) {
	                    var middle = _this.processWidth + 70 * Math.random();
	                    if (middle > 500) {
	            ...
	            var urlData = 'weex/member/article/publish.jhtml?id=' + this.articleId + '&isPublish=' + this.contributeSwitch + '&isReview=' + this.commentsSwitch + '&isReward=' + this.rewardSwitch + '&isTag4=' + this.recommendedSwitch + '&isTag5=' + this.selectSwitch + '&authority=' + authorityData + '&isTop=' + this.topData + '&password=' + this.password + '&articleCatalogId=' + this.corpusId + '&articleCategoryId=' + this.category;
	            //                event.toast(urlData);
	            (0, _fetch.POST)(urlData).then(function (data) {
	                //                    event.toast(data);
	                //                    将服务器返回回来的最新文章信息 存入缓存。
	                if (data.type == 'success') {
	                    //            获取当前时间戳 作为唯一标识符key
	                    var timestamp = Math.round(new Date().getTime() / 1000);
	                    var resDataStr = (0, _stringify2.default)(data.data);
	                    ...
	                    var saveData = {
	                        ...
	                        if (data.type == 'success') {
	                            ...
	                            _weex.event.sendGlobalEvent('onArticleChange', listenData);
	                            //                                let E = {
	                            //                                    isDone : 'complete'
	                            //                                }
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	  ...
	  }, [_vm._v(_vm._s(_vm._f("watchScope")(_vm.scope)))]), _c('text', {
	    staticClass: ["arrow"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	    ...
	    staticClass: ["sub_title"]
	  }, [_vm._v(_vm._s(_vm.corpusName) + " ")]), _c('text', {
	    staticClass: ["arrow"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	    ...
	    staticClass: ["switch"],
	    attrs: {
	      "checked": _vm.rewardSwitch
	    },
	    on: {
	      "change": _vm.rewardChange
	    }
	  })])])]), _vm._m(5), _c('div', {
	    staticClass: ["cell-row", "cell-line"]
	  }, [_c('div', {
	    ...
	    staticClass: ["switch"],
	    attrs: {
	      "checked": _vm.commentsSwitch
	    },
	    on: {
	      "change": _vm.commentsChange
	    }
	  })])])]), _vm._m(7), _c('div', {
	    staticClass: ["cell-row", "cell-line"]
	  }, [_c('div', {
	    ...
	    staticClass: ["switch"],
	    attrs: {
	      "checked": _vm.recommendedSwitch
	    },
	    on: {
	      "change": _vm.recommendedChange
	    }
	  })])])]), _vm._m(11), _c('div', {
	    staticClass: ["fill"]
	  })]), _c('div', {
	    staticClass: ["footer", "button-panel"],
	    staticStyle: {
	      position: "absolute"
	    }
	  }, [_c('text', {
	  ...
	  }, [_vm._v("完成")])]), (_vm.toSendArticle) ? _c('process', {
	    attrs: {
	      "processWidth": _vm.processWidth,
	      "currentPro": _vm.currentPro,
	      "proTotal": _vm.proTotal
	    }
	  }) : _vm._e()], 1)
