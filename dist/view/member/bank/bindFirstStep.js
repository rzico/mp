...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/bank/bindFirstStep.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-e78eff5c"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        showAlerttwo: function showAlerttwo(event) {
	            console.log('will show alert');
	            modal.alert({
	        ...
	        goComplete: function goComplete() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            if (_utils2.default.isNull(this.txtInput)) {
	                modal.alert({
	                    message: "请输入卡号",
	                    okTitle: '知道了'
	                });
	            ...
	            if (_utils2.default.isNull(this.accountName)) {
	                modal.alert({
	                    message: "请输入开户名",
	                    okTitle: '知道了'
	                });
	            ...
	            twodata = (0, _stringify2.default)(twodata);
	            storage.setItem('twonumber', twodata, function (e) {
	                event.openURL(_utils2.default.locate('view/member/bank/bindSecondSteps.js?name=twonumber'), function (res) {
	                    if (res.type == "success") {
	                        event.closeURL(res);
	                    }
	                    _this.clicked = false;
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["textA"]
	  }, [_vm._v("智慧加密，保障你的用卡安全，")]), _c('text', {
	    staticClass: ["textB"],
	    on: {
	      "click": _vm.showAlerttwo
	    }
	  }, [_vm._v("了解安全保障")])]), _c('div', {
	    staticClass: ["A4", "bkg-primary"],
	    on: {
