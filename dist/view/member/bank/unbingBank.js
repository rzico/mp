...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/bank/unbingBank.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-148c3ad2"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        this.banknum = _utils2.default.getUrlParameter("banknum");
	    },
	    ...
	    methods: {
	        ...
	        onSend: function onSend(e) {
	            ...
	            this.clicked = true;
	            var _this = this;
	            (0, _fetch.POST)('weex/member/bankcard/send_mobile.jhtml').then(function (data) {
	                if (data.type == "success") {
	                    _this.beginTimer();
	                } else {
	                    _this.endTimer();
	        ...
	        onEnd: function onEnd() {
	            ...
	            event.encrypt(_this.captcha, function (msg) {
	                if (msg.type == "success") {
	                    (0, _fetch.POST)('weex/member/mobile/captcha.jhtml?captcha=' + msg.data).then(function (data) {
	                        if (data.type == "success") {
	                            event.openURL(_utils2.default.locate('view/member/bank/bindFirstStep.js'), function (res) {
	                                event.closeURL(res);
	                            });
	                            _this.isEnd = false;
	                        } else {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["middle", "mt20"]
	  }, [_c('text', {
	    staticClass: ["fz32"]
	  }, [_vm._v("目前已绑卡类型:  " + _vm._s(_vm.banknum))])]), _c('div', {
	    staticClass: ["middle"]
	  }, [_c('div', {
	    staticStyle: {
	      flexDirection: "row",
	  ...
	  }, [_vm._v(" " + _vm._s(_vm.time) + "秒后重新发送")])])]), _c('div', {
	    staticClass: ["button", "mt50", "ml30", "mr30"],
	    on: {
	      "click": _vm.onEnd
	    }
	  }, [_c('text', {
	  ...
	  return _c('div', {
	    staticClass: ["headPrompting"]
	  }, [_c('text', {
	    staticClass: ["fz28"],
	    staticStyle: {
	      color: "#999"
	    }
	  }, [_vm._v("如遇银行卡更换的情况，导致账号需换绑银行卡，第一步需验证已绑手机号，通过验证后，即可换绑。")])])
	}]}
	module.exports.render._withStripped = true
