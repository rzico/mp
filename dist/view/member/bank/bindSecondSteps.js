...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/bank/bindSecondSteps.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-2fa7aec9"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        var _this = this;
	        var two = _utils2.default.getUrlParameter('name');
	        storage.getItem(two, function (e) {
	            //                event.toast(e);
	            var twodata = JSON.parse(e.data);
	    ...
	    methods: {
	        binding: function binding() {
	            ...
	            event.encrypt(this.txtInput, function (message) {
	                if (message.type == "success") {
	                    (0, _fetch.POST)('weex/member/bankcard/query.jhtml?banknum=' + message.data).then(function (data) {
	        ...
	        telphone: function telphone(event) {
	            this.phone = event.value;
	            console.log('telphone', event.value);
	        },
	        idcard: function idcard(event) {
	        ...
	        goComplete: function goComplete() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            if (_utils2.default.isNull(this.phone)) {
	                modal.alert({
	                    message: "请输入手机号",
	                    okTitle: '知道了'
	                });
	            ...
	            if (_utils2.default.isNull(this.idno)) {
	                modal.alert({
	                    message: "请输入证件号",
	                    okTitle: '知道了'
	                });
	            ...
	            threedata = (0, _stringify2.default)(threedata);
	            storage.setItem('threenumber', threedata, function (e) {
	                event.openURL(_utils2.default.locate('view/member/bank/bindThirdSteps.js?name=threenumber'), function (mes) {
	                    if (mes.type == "success") {
	                        event.closeURL(mes);
	                    }
	                    _this.clicked = false;
