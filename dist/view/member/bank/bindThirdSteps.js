...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/bank/bindThirdSteps.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-4b66963a"
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["borderBottom", "mlmr60"]
	  }), _c('div', {
	    staticClass: ["mobile-row", "mlmr60"]
	  }, [_c('text', {
	  ...
	  return _c('div', {
	    staticClass: ["mobile-row", "space-between", "mlmr60"]
	  }, [_c('text', {
	    staticClass: ["title"]
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/include/mobile.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-ed4e2178"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _mobile = __webpack_require__(261);
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        var _this = this;
	        storage.getItem('mobile', function (event) {
	            if (event.data != "" && event.data != "undefined") {
	                _this.value = event.data;
	            }
	        });
	        var three = _utils2.default.getUrlParameter('name');
	        storage.getItem(three, function (e) {
	            var threedata = JSON.parse(e.data);
	    ...
	    methods: {
	        ...
	        binding: function binding(e) {
	            ...
	            this.clicked = true;
	            var _this = this;
	            if (_utils2.default.isNull(this.verification)) {
	                modal.alert({
	                    message: "请输入验证码",
	                    okTitle: '知道了'
	                });
	            ...
	            var threedatastr = (0, _stringify2.default)(threedata);
	            event.encrypt(threedatastr, function (message) {
	                if (message.type == "success") {
	                    (0, _fetch.POST)('weex/member/bankcard/submit.jhtml?captcha=' + _this.verification, message.data).then(function (data) {
	                        if (data.type == "success") {
	                            modal.alert({
	        ...
	        onSend: function onSend(e) {
	            ...
	            event.encrypt(_this.phone, function (message) {
	                if (message.type == "success") {
	                    (0, _fetch.POST)('weex/member/bankcard/send_mobile.jhtml?mobile=' + message.data).then(function (data) {
	                        if (data.type == "success") {
	                            _this.beginTimer();
	                        } else {
	                            event.toast(data.content);
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["textA"]
	  }, [_vm._v("本次操作需要短信确认，请输入")]), _c('text', {
	    staticClass: ["textA2"]
	  }, [_vm._v(" " + _vm._s(_vm.phone))]), _c('text', {
	    staticClass: ["textA3"]
	  }, [_vm._v("收到的短信验证码")])]), _c('div', {
	    staticClass: ["inputA"]
	  }, [_c('div', {
	    ...
	    staticClass: ["status", "gray", "fz28"],
	    style: _vm.statusStyle()
	  }, [_vm._v(" " + _vm._s(_vm.time) + "秒后刷新")])])]), _c('div', {
