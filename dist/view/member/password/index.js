...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/password/index.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-2091bf64"
	    ...
	    methods: {
	        onSend: function onSend(e) {
	            ...
	            event.encrypt(_this.value, function (message) {
	                if (message.type == "success") {
	                    (0, _fetch.POST)('weex/member/password/check_mobile.jhtml?mobile=' + message.data).then(function (data) {
	                        if (data.type == "success") {
	                            event.openURL(_utils2.default.locate("view/member/password/captcha.js?mobile=" + _this.value), function (resp) {
	                                event.closeURL(resp);
	                            });
	                        } else {
	                            event.toast(data.content);
