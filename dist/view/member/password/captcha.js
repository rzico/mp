...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/password/captcha.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-723dae8c"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        this.beginTimer();
	        if (!_utils2.default.isNull(_utils2.default.getUrlParameter("telNum"))) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/include/captcha.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-32f13c48"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _captcha = __webpack_require__(256);
	    ...
	    methods: {
	        onSend: function onSend(e) {
	            ...
	            event.encrypt(this.mobile, function (msg) {
	                if (msg.type === "success") {
	                    (0, _fetch.POST)('weex/member/password/send_mobile.jhtml?mobile=' + msg.data).then(function (data) {
	                        if (data.type == "success") {
	        ...
	        onEnd: function onEnd(val) {
	            ...
	            event.encrypt(val, function (msg) {
	                if (msg.type == "success") {
	                    (0, _fetch.POST)('weex/member/password/captcha.jhtml?captcha=' + msg.data).then(function (data) {
	                        if (data.type == "success") {
	                            event.openURL(_utils2.default.locate("view/member/password/update.js?captcha=" + msg.data), function (resp) {
	                                event.closeURL(resp);
	                            });
	                            _this.$refs.captcha.endTimer();
	                        } else {
