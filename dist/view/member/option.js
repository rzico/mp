...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/mopian/mp/src/view/member/option.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-50b47c7c"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        (0, _fetch.GET)('weex/member/option.jhtml', function (data) {
	            if (data.type == 'success') {
	                _this.blackNum = data.data.black;
	                if (!_utils2.default.isNull(data.data.qrcode)) {
	                    _this.setQrcode = '已设置';
	                }
	    ...
	    methods: {
	        ...
	        downloadArticle: function downloadArticle() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            (0, _fetch.GET)('weex/member/article/list.jhtml?isDraft=false' + '&timeStamp=' + _this.lastDownLoadtamp + '&pageStart=' + this.listCurrent + '&pageSize=' + this.pageSize, function (data) {
	        ...
	        //            上传二维码
	        sendQrcode: function sendQrcode() {
	            if (this.clicked) {
	                return;
	            }
	            this.clicked = true;
	                ...
	                if (data.type == 'success') {
	                    ...
	                    event.upload(data.data.originalPath, function (item) {
	                        if (item.type == 'success') {
	                            var qrcodeURL = encodeURI(item.data);
	                            (0, _fetch.POST)('weex/member/update.jhtml?qrcode=' + qrcodeURL).then(function (e) {
	                                if (e.type == 'success') {
	                                    _this.setQrcode = '已设置';
	                                    event.toast('设置成功');
	                                } else {
	        ...
	        //            黑名单列表
	        goBlackList: function goBlackList() {
	            if (this.clicked) {
	                return;
	            }
	            this.clicked = true;
	            var _this = this;
	            event.openURL(_utils2.default.locate('view/member/blackList.js'), function (data) {
	                _this.clicked = false;
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["sub_title"]
	  }, [_vm._v(_vm._s(_vm.storageNum) + "  ")]), _c('text', {
	    staticClass: ["arrow"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	    ...
	    staticClass: ["sub_title"]
	  }, [_vm._v(_vm._s(_vm.blackNum) + "人 ")]), _c('text', {
	    staticClass: ["arrow"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	    ...
	    staticClass: ["sub_title"]
	  }, [_vm._v(_vm._s(_vm.setQrcode))]), _c('text', {
	    staticClass: ["arrow"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	  }, [_vm._v("")])])])]), _vm._m(7)]), (_vm.toSendArticle) ? _c('div', {
