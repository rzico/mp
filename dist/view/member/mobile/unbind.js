...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/mobile/unbind.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-15dd9766"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        this.tel = _utils2.default.getUrlParameter("mobile");
	    },
	    ...
	    methods: {
	        ...
	        onSend: function onSend(e) {
	            var _this = this;
	            (0, _fetch.POST)('weex/member/mobile/send_mobile.jhtml').then(function (data) {
	                if (data.type == "success") {
	                    _this.beginTimer();
	                } else {
	                    _this.endTimer();
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["fz32"]
	  }, [_vm._v("目前已绑定手机尾号:  " + _vm._s(_vm.tel))])]), _c('div', {
	    staticClass: ["middle"]
	  }, [_c('div', {
	    staticStyle: {
	      flexDirection: "row",
	  ...
	  }, [_vm._v("如遇手机号更换的情况，导致账号需换绑手机号，第一步需验证原手机号，再验证新手机号，即可完成换绑。")])])
	}]}
	module.exports.render._withStripped = true
