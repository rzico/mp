...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/mobile/captcha.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-234dd593"
	    ...
	    methods: {
	        onSend: function onSend(e) {
	            ...
	            event.encrypt(this.mobile, function (msg) {
	                if (msg.type === "success") {
	                    (0, _fetch.POST)('weex/member/mobile/send_mobile.jhtml?mobile=' + msg.data).then(function (data) {
	                        if (data.type == "success") {
	        ...
	        onEnd: function onEnd(e) {
	            ...
	            event.encrypt(e, function (msg) {
	                if (msg.type == "success") {
	                    (0, _fetch.POST)('weex/member/mobile/submit.jhtml?captcha=' + msg.data).then(function (data) {
	                        if (data.type == "success") {
	                            event.closeURL(data);
	                        } else {
