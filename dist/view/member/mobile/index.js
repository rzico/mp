...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/mobile/index.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-288407aa"
	    ...
	    methods: {
	        onSend: function onSend(e) {
	            ...
	            event.encrypt(_this.value, function (message) {
	                if (message.type == "success") {
	                    (0, _fetch.POST)('weex/member/mobile/send_mobile.jhtml?mobile=' + message.data).then(function (weex) {
	                        if (weex.type == "success") {
	                            event.openURL(_utils2.default.locate("view/member/mobile/captcha.js?mobile=" + _this.value), function (res) {
	                                event.closeURL(res);
	                            });
	                        } else {
