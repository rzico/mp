...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/attribute.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-1ab75f06"
	...
	exports.default = {
	    ...
	    methods: {
	            ...
	            modal.prompt({
	                ...
	                if (value.result == '确定') {
	                    if (value.data == '' || value.data == null) {
	                        ...
	                        if (_utils2.default.getLength(value.data) > 32) {
	                        ...
	                        (0, _fetch.POST)('weex/member/update.jhtml?nickName=' + encodeURI(value.data)).then(function (mes) {
	                            if (mes.type == "success") {
	                                ...
	                                E = (0, _stringify2.default)(E);
	                                storage.setItem('userAttrInfo', E, function (e) {});
	                            } else {
	                                event.toast(mes.content);
	                            }
	                        }, function (err) {
	        ...
	        goAutograph: function goAutograph() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            var senfData = this.autograph == '未填写' ? '' : this.autograph;
	            var textData = {
	                autograph: senfData
	            };
