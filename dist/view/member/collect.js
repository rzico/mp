...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/collect.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-a20a29d8"
	...
	exports.default = {
	    ...
	    filters: {
	        ...
	        watchNickName: function watchNickName(value) {
	            if (_utils2.default.isNull(value)) {
	                ...
	                return _utils2.default.changeStrLast(value, 8);
	            }
	        }
	    },
	    props: {
	    ...
	    computed: {
	        title: function title() {
	            //              如果用户名称过长，便截取拼成名字
	            if (_utils2.default.getLength(this.userName) > 20) {
	                this.userName = _utils2.default.changeStr(this.userName);
	            }
	    ...
	    created: function created() {
	        ...
	        var selfId = _weex.event.getUId();
	        if (this.UId == selfId) {
	            this.isSelf = true;
	        } else {
	            var name = decodeURI(_utils2.default.getUrlParameter('name'));
	            this.userName = _utils2.default.isNull(name) ? '我' : name;
	        }
	        this.getAllCollect();
	    },
	    ...
	    methods: {
	        ...
	        getAllCollect: function getAllCollect() {
	            var _this = this;
	            (0, _fetch.GET)('weex/favorite/list.jhtml?id=' + this.UId + '&pageStart=' + this.pageStart + '&pageSize=' + this.pageSize, function (data) {
	                    ...
	                    if (_this.pageStart == 0) {
	                        data.data.data.forEach(function (item) {
	                            ...
	                            if (!_utils2.default.isNull(item.thumbnail)) {
	                                item.thumbnail = _utils2.default.thumbnail(item.thumbnail, 250, 150);
	                            }
	                        });
	        ...
	        deleteMessage: function deleteMessage(id, index) {
	            ...
	            this.clicked = true;
	            (0, _fetch.POST)('weex/member/favorite/delete.jhtml?articleId=' + id).then(function (data) {
	                if (data.type == 'success') {
	                    //                            把动画收回来。
	                    if (animationPara == null || animationPara == '' || animationPara == 'undefinded') {} else {
	                        _weex.animation.transition(animationPara, {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, [(_vm.collectList.length == 0) ? _c('noData', {
	    attrs: {
	      "noDataHint": _vm.noDataHint,
	      "ndBgColor": "#fff"
	    }
	  }) : _vm._e()], 1), _vm._l((_vm.collectList), function(item, index) {
	    return _c('cell', {
	      appendAsTree: true,
	      attrs: {
	        "append": "tree"
	      ...
	      on: {
	        "click": function($event) {
	          _vm.deleteMessage(item.id, index)
	        }
	      }
	    }, [_c('text', {
