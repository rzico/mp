...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/mine.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-7838ab4e"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    methods: {
	        getItemIco: function getItemIco(i) {
	            return he.decode(i);
	        },
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	  ...
	  }, [_vm._v(_vm._s(_vm.getIco))]), _c('text', {
	    ...
	    return _c('div', {
	      staticClass: ["option-cell"],
	      on: {
	        "click": function($event) {
	          _vm.onItemClick(item.id)
	        }
	      }
	    }, [_c('text', {
	      staticClass: ["ico"],
	      style: {
	        fontFamily: 'iconfont',
	        color: _vm.getColor(item.color)
	      }
	    }, [_vm._v(_vm._s(_vm.getItemIco(item.ico)))]), _c('text', {
	      staticClass: ["name", "ml10"],
	      class: [item.id == _vm.id ? 'current' : '']
	    }, [_vm._v(_vm._s(item.name))]), (item.id == _vm.id) ? _c('text', {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        show: function show(sn) {
	            var _this = this;
	            _this.sn = sn;
	            _this.isPwd = false;
	            _this.clearPwd();
	            (0, _fetch.GET)("payment/view.jhtml?sn=" + sn, function (res) {
	                //                    utils.debug(res);
	                _this.info = res.data;
	                _this.isShow = true;
	            }, function (err) {
	        ...
	        balance: function balance(pwd) {
	            var _this = this;
	            event.encrypt(pwd, function (message) {
	                if (message.type == "success") {
	                    (0, _fetch.POST)("payment/submit.jhtml?sn=" + _this.sn + "&paymentPluginId=balancePayPlugin&enPassword=" + message.data).then(function (data) {
	                        if (data.type == "success") {
	                            ...
	                            timer = setInterval(function () {
	                                (0, _fetch.POST)("payment/query.jhtml?sn=" + _this.sn).then(function (data) {
	                                    if (data.type == "success") {
	                                        if (data.data == "0000") {
	                                            _this.close(_utils2.default.message("success", "success"));
	                                        } else {
	                                            if (data.data == "0001") {
	                                                _this.close(_utils2.default.message("error", "error"));
	                                            }
	                                        }
	                                    }
	                                }, function (err) {});
	        ...
	        payment: function payment(plugId) {
	            var _this = this;
	            (0, _fetch.POST)("payment/submit.jhtml?sn=" + this.sn + "&paymentPluginId=" + plugId).then(function (data) {
	                //                        utils.debug(data);
	                if (data.type == "success") {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/include/dropdown.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-584d8e9a"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, [_vm._v("¥" + _vm._s(_vm._f("currencyfmt")(_vm.info.amount)))])]), _c('text', {
	  ...
	  }, [_vm._v(_vm._s(_vm.info.memo))])])]), _c('div', {
	    staticClass: ["cell"],
	    staticStyle: {
	  ...
	  }, [_vm._v("忘记密码？点击重置密码。")])]) : _vm._e()]) : _vm._e()
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    computed: {
	        timeLineImg: function timeLineImg() {
	            return _utils2.default.locate('resources/images/timeLine.png');
	        },
	        weChatImg: function weChatImg() {
	            return _utils2.default.locate('resources/images/weChat.png');
	        },
	        shareFriendImg: function shareFriendImg() {
	            return _utils2.default.locate('resources/images/shareFriend.png');
	        },
	        qqSpaceImg: function qqSpaceImg() {
	            return _utils2.default.locate('resources/images/qqSpace.png');
	        },
	        qqImg: function qqImg() {
	            return _utils2.default.locate('resources/images/qq.png');
	        },
	        copyLinkImg: function copyLinkImg() {
	            return _utils2.default.locate('resources/images/copyLink.png');
	        },
	        browserImg: function browserImg() {
	            return _utils2.default.locate('resources/images/browser.png');
	        },
	        publicImg: function publicImg() {
	            return _utils2.default.locate('resources/images/public.png');
	        }
	    },
	    methods: {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', [_c('div', {
	    ...
	    staticClass: ["bottomBorder", "shareLineBox"]
	  }, [_c('div', {
	    ...
	    staticClass: ["fz28", "mt20", "color444"]
	  }, [_vm._v("朋友圈")])]), _c('div', {
	    staticClass: ["singleBox"],
	    on: {
	      "click": function($event) {
	    ...
	    staticClass: ["fz28", "mt20", "color444"]
	  }, [_vm._v("浏览器打开")])]), (_vm.isSelf == 1) ? _c('div', {
	    staticClass: ["singleBox"],
	    on: {
	      "click": function($event) {
	        _vm.doShare(4)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/include/share.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-fe4936a6"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/include/payment.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-d2397458"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/widget/header.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-cfa4a4a6"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
...
/***/ (function(module, exports) {
	...
	module.exports = {
	  ...
	  "wallet": {
	    ...
	    "borderBottomWidth": 5,
	    "borderColor": "#eeeeee",
	    "backgroundImage": "linear-gradient(to right, #EB4E40,#ff700b)"
	  },
	  "walletText": {
	    "fontSize": 22,
	    "color": "#FFFFFF"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    data: function data() {
	        return {
	            img_mask: _utils2.default.locate('resources/images/topic_curveMask.png'),
	            img_heightMask: _utils2.default.locate('resources/images/topic_heightMaskf5f5f5.png')
	        };
	    },
	    props: {
	        showType: false,
	    ...
	    methods: {
	        ...
	        changeLogo: function changeLogo() {
	            ...
	            options, function (ablum) {
	                if (ablum.type == 'success') {
	                    _weex.event.upload(ablum.data.originalPath, function (message) {
	                        if (message.type == 'success') {
	                            (0, _fetch.POST)('weex/member/topic/update.jhtml?logo=' + encodeURIComponent(message.data)).then(function (mes) {
	                                if (mes.type == "success") {
	        ...
	        headerInfo: function headerInfo() {
	            var dc = _utils2.default.topicInfo();
	            return dc;
	        },
	        //            监听设备型号,控制顶部操作栏
	        operationBox: function operationBox() {
	            var dc = _utils2.default.topicOperation();
	            return dc;
	        },
	        //            监听设备型号,控制顶部人物粉丝栏
	        headerFans: function headerFans() {
	            var dc = _utils2.default.topicFans();
	            return dc;
	        },
	        //            监听设备型号,控制顶部人物信息栏背景图大小
	        headerBgImg: function headerBgImg() {
	            var dc = _utils2.default.topicBgImg();
	            return dc;
	        },
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    on: {
	      "click": _vm.changeLogo
	    }
	  }), _c('image', {
	    staticClass: ["img_heightMask"],
	    attrs: {
	      "src": _vm.img_heightMask
	    },
	    on: {
	      "click": _vm.changeLogo
	    }
	    ...
	    staticClass: ["name"]
	  }, [_vm._v(_vm._s(_vm.userName))]), (_vm.occupation != '') ? _c('div', {
	    staticClass: ["jobBox"]
	  }, [_c('text', {
	    staticClass: ["jobText", "primary"]
	  }, [_vm._v(_vm._s(_vm.occupation))])]) : _vm._e()]), _c('text', {
	    staticClass: ["signature"]
	  }, [_vm._v(_vm._s(_vm.userSign))])]), (_vm.showType) ? _c('div', {
	    staticClass: ["operationBox"],
	    class: [_vm.operationBox()]
	  }, [_c('div', {
	    ...
	    staticClass: ["walletIco", "mr10"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	  }, [_vm._v("")]), _c('text', {
	    staticClass: ["walletBoxText"],
	    staticStyle: {
	      paddingTop: "2px"
	    }
	  }, [_vm._v("钱包")])]), _c('div', {
	    ...
	    staticClass: ["shareBoxText"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	  }, [_vm._v("")])])]) : _vm._e(), _c('div', {
	    staticClass: ["fansBox"],
	    class: [_vm.headerFans()]
	  }, [_c('div', {
	    staticClass: ["mr20", "flex-row"],
	    on: {
	      "click": _vm.goCollect
	    }
	  }, [_c('text', {
	    staticClass: ["fans", "mr10"]
	  }, [_vm._v(_vm._s(_vm.collect))]), _c('text', {
	    staticClass: ["fansText"]
	  }, [_vm._v("收藏")])]), _c('div', {
	    staticClass: ["mr20", "flex-row"],
	    on: {
	      "click": _vm.goFocus
	    ...
	    staticClass: ["fans", "mr10"]
	  }, [_vm._v(_vm._s(_vm.focus))]), _c('text', {
	    staticClass: ["fansText"]
	  }, [_vm._v("关注")])]), _c('div', {
	    ...
	    staticClass: ["fans", "mr10"]
	  }, [_vm._v(_vm._s(_vm.fans))]), _c('text', {
	    staticClass: ["fansText"]
	  }, [_vm._v("粉丝")])])])])
	},staticRenderFns: []}
	module.exports.render._withStripped = true
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var livePlayer = weex.requireModule('livePlayer');
	var globalEvent = weex.requireModule('globalEvent');
	...
	exports.default = {
	    data: function data() {
	        return {
	            ...
	            circleImg: _utils2.default.locate('resources/images/liveHeader.png'),
	            showLoading: 'hide',
	            listCurrent: 0,
	            listPageSize: 10,
	            articleThree: [],
	            roles: '',
	            member: { nickName: "未登录", logo: _utils2.default.locate("logo.png"), autograph: "点击设置签名", topic: "未开通", hasTopic: false, activated: false, useCashier: false, isAgent: false, isShop: false, hasShop: false },
	            showShare: false,
	            clicked: false,
	    ...
	    components: {
	        topic_header: _header2.default, share: _share2.default, payment: _payment2.default
	    },
	    filters: {
	    ...
	    created: function created() {
	        ...
	        _utils2.default.initIconFont();
	        //            获取屏幕的高度
	        this.screenHeight = _utils2.default.fullScreen(216);
	    ...
	    methods: {
	        //            当前是水达人时关闭激活店铺
	        filterApp: function filterApp() {
	            if (_utils2.default.appType() == 'water') {
	                return false;
	            } else {
	                return true;
	            }
	        ...
	        filter: function filter(e) {
	            ...
	            if (e == 'order') {
	                //                    订单
	                if (_utils2.default.isRoles("12", _this.roles)) {
	                    return true;
	                } else {
	                    return false;
	                }
	                ...
	                //                    运单
	                if (_utils2.default.isRoles("123", _this.roles)) {
	                    return true;
	                } else {
	                    return false;
	                }
	                ...
	                //                    店铺
	                if (_utils2.default.isRoles("1", _this.roles)) {
	                    return true;
	                } else {
	                    return false;
	                }
	        ...
	        open: function open() {
	            var _this = this;
	            (0, _fetch.GET)("weex/member/manager/view.jhtml", function (data) {
	                if (data.type == "success") {
	        ...
	        permissions: function permissions() {
	            var _this = this;
	            (0, _fetch.POST)("weex/member/roles.jhtml").then(function (mes) {
	                if (mes.type == "success") {
	        ...
	        getGps: function getGps() {
	            var _this = this;
	            var uId = _weex.event.getUId();
	            _weex.event.getLocation(function (data) {
	                if (data.type == 'success') {
	                    (0, _fetch.POST)("/lbs/location.jhtml?lng=" + data.data.lng + "&lat=" + data.data.lat + '&memberId=' + uId).then(function (mes) {
	        ...
	        updateUserInfo: function updateUserInfo() {
	            ...
	            (0, _fetch.GET)('weex/member/view.jhtml', function (data) {
	                if (data.type == 'success') {
	                    ...
	                    if (!_utils2.default.isNull(data.data.backgroud)) {
	                        _this.imgBg = data.data.backgroud;
	                    }
	                    if (!_utils2.default.isNull(data.data.occupation.name)) {
	        ...
	        openArticle: function openArticle() {
	            var _this = this;
	            (0, _fetch.GET)('weex/member/article/list.jhtml?authorId=' + this.UId, function (data) {
	                if (data.type == "success") {
	                    var arr = [];
	                    data.data.data.forEach(function (item, index) {
	                        if (index <= 2) {
	                            item.thumbnail = _utils2.default.thumbnail(item.thumbnail, 150, 150);
	                            arr.push(item);
	                        }
	                    });
	        ...
	        getCount: function getCount() {
	            var _this = this;
	            (0, _fetch.POST)('weex/member/order/count.jhtml').then(function (res) {
	                if (res.type == "success") {
	        ...
	        //            获取运单数量
	        getShippingConut: function getShippingConut() {
	            var _this = this;
	            (0, _fetch.POST)('weex/member/shipping/count.jhtml').then(function (res) {
	                if (res.type == "success") {
	        ...
	        jumpEditor: function jumpEditor() {
	            if (this.clicked) {
	                return;
	            }
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/member/editor/editor.js'), function (message) {
	                _this.clicked = false;
	                _this.openArticle();
	            });
	        },
	        ...
	        goFans: function goFans() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/friend/fans.js?id=' + this.UId), function (data) {
	                _this.clicked = false;
	                if (data.type == 'success' && data.data != '') {} else {
	                    //                            return ;
	                }
	            });
	        },
	        goreport: function goreport() {
	            _weex.event.openURL(_utils2.default.locate('view/member/report/index.js'), function (data) {});
	        },
	        ...
	        goConfirm: function goConfirm() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/shop/shipping/list.js?index=0&productCategoryId=1'), function (data) {
	                _this.clicked = false;
	                _this.getCount();
	                _this.getShippingConut();
	            });
	        ...
	        goToMask: function goToMask() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/shop/shipping/list.js?index=1&productCategoryId=2'), function (data) {
	                _this.clicked = false;
	                _this.getCount();
	                _this.getShippingConut();
	            });
	        ...
	        //            配送中
	        goOnTheWay: function goOnTheWay() {
	            if (this.clicked) {
	                return;
	            }
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/shop/shipping/list.js?index=2&productCategoryId=3'), function (data) {
	                _this.clicked = false;
	                _this.getCount();
	                _this.getShippingConut();
	            });
	        ...
	        //            已送达
	        goaArive: function goaArive() {
	            if (this.clicked) {
	                return;
	            }
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/shop/shipping/list.js?index=3&productCategoryId=4'), function (data) {
	                _this.clicked = false;
	                _this.getCount();
	                _this.getShippingConut();
	            });
	        ...
	        goNoPay: function goNoPay() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/shop/order/list.js?index=0&productCategoryId=1'), function (data) {
	                _this.clicked = false;
	                _this.getCount();
	                _this.getShippingConut();
	            });
	        ...
	        //            待发货
	        goNoDelivery: function goNoDelivery() {
	            if (this.clicked) {
	                return;
	            }
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/shop/order/list.js?index=1&productCategoryId=2'), function (data) {
	                _this.clicked = false;
	                _this.getCount();
	                _this.getShippingConut();
	            });
	        ...
	        goDelivery: function goDelivery() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/shop/order/list.js?index=2&productCategoryId=3'), function (data) {
	                _this.clicked = false;
	                _this.getCount();
	                _this.getShippingConut();
	            });
	        ...
	        goRefund: function goRefund() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/shop/order/list.js?index=3&productCategoryId=4'), function (data) {
	                _this.clicked = false;
	                _this.getCount();
	                _this.getShippingConut();
	            });
	        ...
	        editor: function editor() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/member/editor/editor.js'), function (data) {
	                _this.clicked = false;
	            });
	        },
	        ...
	        goArticle: function goArticle(id) {
	            ...
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/article/preview.js?articleId=' + id + '&publish=true'), function (e) {
	                _this.clicked = false;
	            });
	        },

	        //            设置中心
	        goOption: function goOption() {
	            if (this.clicked) {
	                return;
	            }
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/member/option.js'), function (data) {
	                _this.clicked = false;
	            });
	        },
	        ...
	        gocard: function gocard() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate("view/shop/card/list.js"), function (e) {
	                _this.clicked = false;
	            });
	        },
	        //            优惠券
	        gocoupon: function gocoupon() {
	            ...
	            _weex.event.openURL(_utils2.default.locate("view/shop/coupon/list.js"), function (e) {
	                _this.clicked = false;
	            });
	        },
	        //            新营销
	        godistribution: function godistribution() {
	            if (this.clicked == true) {
	                return;
	            }
	            this.clicked = true;
	            ...
	            _weex.event.openURL(_utils2.default.locate("view/shop/goods/distribution.js"), function (e) {
	                _this.clicked = false;
	            });
	        },
	        //            管理店铺
	        shop: function shop() {
	            ...
	            _weex.event.openURL(_utils2.default.locate("view/shop/shop/storeList.js"), function (mes) {
	                if (mes.type == 'success' && mes.data == '') {
	                    _weex.event.closeURL(mes);
	                }
	                _this.clicked = false;
	            });
	        },
	        ...
	        modification: function modification() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/shop/shop/newShop.js?shopId=' + this.shopId), function (message) {
	                if (message.type == 'success') {
	                    _this.open();
	                    _this.permissions();
	                }
	        ...
	        activated: function activated() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            (0, _fetch.POST)('weex/member/topic/activate.jhtml').then(function (mes) {
	                _this.clicked = false;
	                if (mes.type == "success") {
	                    if (_utils2.default.isNull(mes.data)) {
	                        _this.open();
	                    } else {
	        ...
	        employee: function employee() {
	            ...
	            _weex.event.openURL(_utils2.default.locate("view/shop/admin/list.js"), function (e) {
	                _this.clicked = false;
	            });
	        },
	        //            补单
	        fill: function fill() {
	            ...
	            _weex.event.openURL(_utils2.default.locate("view/shop/order/fill.js"), function (e) {
	                _this.clicked = false;
	                _this.getCount();
	            });
	        },
	        ...
	        goTopic: function goTopic(e) {
	            ...
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/member/topic/index.js'), function (mes) {
	                _this.open();
	                _this.clicked = false;
	                return;
	            });
	        ...
	        store: function store() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/shop/cashier/index.js'), function (mes) {
	                _this.clicked = false;
	                if (mes.type == 'success') {
	        ...
	        goShop: function goShop() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/shop/shop/newShop.js'), function (mes) {
	                _this.clicked = false;
	                _this.open();
	                _this.permissions();
	            });
	        ...
	        //            前往运单管理
	        shippingManage: function shippingManage() {
	            if (this.clicked) {
	                return;
	            }
	            this.clicked = true;
	            ...
	            _weex.event.openURL(_utils2.default.locate('view/shop/shipping/list.js'), function (data) {
	                _this.getCount();
	                _this.getShippingConut();
	                _this.clicked = false;
	                return;
	        ...
	        //            前往商品管理
	        goodsManage: function goodsManage() {
	            if (this.clicked) {
	                return;
	            }
	            this.clicked = true;
	            ...
	            _weex.event.openURL(_utils2.default.locate('view/shop/goods/manage.js'), function (data) {
	                _this.clicked = false;
	                return;
	            });
	        },
	        //           接龙管理
	        dragon: function dragon(e) {
	            if (this.clicked) {
	                return;
	            }
	            this.clicked = true;
	            ...
	            _weex.event.openURL(_utils2.default.locate('view/member/dragon.js'), function (data) {
	                _this.clicked = false;
	                return;
	            });
	        },
	        //            评论管理
	        goReviewManage: function goReviewManage(e) {
	            if (this.clicked) {
	                return;
	            }
	            this.clicked = true;
	            ...
	            _weex.event.openURL(_utils2.default.locate('view/member/reviewManage.js'), function (data) {
	                _this.clicked = false;
	                return;
	            });
	        },
	        doShare: function doShare(id) {
	            ...
	            var option = {
	                ...
	                url: _utils2.default.website("?xuid=" + _this.member.id),
	                type: shareType
	            };
	            _this.showShare = false;
	            _weex.event.share(option, function (data) {
	                if (data.type == 'success') {
	                    if (shareType == 'copyHref') {
	                        _weex.event.toast('链接已复制到剪贴板');
	                    } else if (shareType == 'browser') {} else {
	                        _weex.event.toast('分享成功');
	                    }
	                    return;
	                }
	            });
	        ...
	        //            打开聊天
	        gmchat: function gmchat() {
	            _weex.event.navToChat("u10201");
	        },
	        //            我的关注
	        goFocus: function goFocus() {
	            if (this.clicked) {
	        ...
	        // 关注的店铺
	        goFocusTenants: function goFocusTenants() {
	            if (this.clicked) {
	                return;
	            }
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/collectTenant/collectTenant.js?id=' + this.UId), function (data) {
	                _this.clicked = false;
	                if (data.type == 'success' && data.data != '') {
	                    _this.updateUserInfo();
	                } else {
	        ...
	        goOrderList: function goOrderList() {
	            ...
	            _weex.event.openURL(_utils2.default.locate('view/shop/order/list.js'), function (data) {
	                _this.getCount();
	                _this.getShippingConut();
	                _this.clicked = false;
	                return;
	        ...
	        goMemberIndex: function goMemberIndex() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/member/index.js'), function (data) {
	                _this.clicked = false;
	                _this.updateUserInfo();
	            });
	        },
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["navText"]
	  }, [_vm._v(_vm._s(_vm._f("watchNickName")(_vm.userName)))])]) : _vm._e(), _c('div', {
	    staticStyle: {
	      width: "50px"
	    }
	  })]), _c('div', {
	    ...
	    attrs: {
	      ...
	      "userSign": _vm.userSign,
	      "occupation": _vm.occupation,
	      "imgBg": _vm.imgBg,
	      "fans": _vm.fans,
	      "focus": _vm.focusNum,
	      "collect": _vm.collectNum,
	      "showType": _vm.showType
	    },
	    on: {
	      "setting": _vm.goAttribute,
	      "goFans": _vm.goFans,
	      "goCollect": _vm.goCollect,
	      "goFocus": _vm.goFocus,
	      "goWallet": _vm.goWallet,
	      "goManage": _vm.goOption,
	      "goShare": _vm.beginShare
	    }
	  }), _c('div', {
	    staticStyle: {
	      marginTop: "410px"
	    }
	  }), (_vm.filter('topic')) ? _c('div', {
	    staticClass: ["contentBox"]
	  }, [_c('div', {
	    staticClass: ["boder-bottom", "pl20", "pr20", "space-between", "headTitle"],
	    on: {
	      "click": function($event) {
	        _vm.goMemberIndex()
	      }
	    ...
	    staticClass: ["comWrap"]
	  }, [_vm._l((_vm.articleThree), function(a) {
	    return (_vm.articleThree.length != 0) ? _c('div', [_c('div', {
	      ...
	      staticClass: ["articleImg"],
	      attrs: {
	        "src": a.thumbnail
	      }
	    }), _c('text', {
	      staticClass: ["articleImgText"]
	    }, [_vm._v(_vm._s(a.title))])])]) : _vm._e()
	  }), (_vm.articleThree.length != 0) ? _c('div', {
	    staticClass: ["articleBox"],
	    on: {
	      "click": function($event) {
	        _vm.jumpEditor()
	    ...
	    staticClass: ["articleImgText"]
	  }, [_vm._v("发表文章")])]) : _vm._e(), (_vm.articleThree.length == 0) ? _c('div', {
	    staticClass: ["unArticleBox"],
	    on: {
	      "click": function($event) {
	        _vm.jumpEditor()
	      }
	    ...
	    staticClass: ["fz26", "mt10"],
	    staticStyle: {
	      color: "#cccccc"
	    }
	  }, [_vm._v("点击发表文章")])]) : _vm._e()], 2)]) : _vm._e(), _c('div', {
	    staticClass: ["contentBox"],
	    staticStyle: {
	      marginBottom: "100px"
	    }
	  ...
	  }, [(!_vm.member.hasShop && !_vm.member.activated) ? _c('div', {
	    staticClass: ["iconBox", "flexCol", "mt20"],
	    on: {
	      "click": function($event) {
	        _vm.goShop()
	      }
	    ...
	    staticClass: ["iconfontText", "mt20"]
	  }, [_vm._v("我要开店")])]) : _vm._e(), (_vm.member.hasShop && !_vm.member.activated && _vm.filterApp()) ? _c('div', {
	    staticClass: ["iconBox", "flexCol", "mt20"],
	    on: {
	      "click": function($event) {
	        _vm.activated()
	    ...
	    staticClass: ["iconfontText", "mt20"]
	  }, [_vm._v("激活店铺")])]) : _vm._e(), (_vm.member.hasShop && !_vm.member.activated) ? _c('div', {
	    staticClass: ["iconBox", "flexCol", "mt20"],
	    on: {
	      "click": function($event) {
	        _vm.modification()
	    ...
	    staticClass: ["mask"],
	    on: {
	      "touchstart": _vm.maskTouch
	    }
	  }), _c('share', {
	    on: {
	      "doShare": _vm.doShare,
	      "doCancel": _vm.doCancel
	    }
	  })], 1) : _vm._e()], 1)
	},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
