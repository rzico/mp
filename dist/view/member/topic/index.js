...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/topic/index.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-2b7b48dc"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _music = __webpack_require__(324);
	...
	exports.default = {
	    ...
	    components: {
	        navbar: _navbar2.default, payment: _payment2.default, share: _share2.default
	    },
	    props: {
	        title: { default: "我的专栏" }
	    },
	    ...
	    methods: {
	        //            判断激活状态并且没工作
	        judgmentone: function judgmentone() {
	            var _this = this;
	            if (_this.noJob == true && _this.isActivate()) return true;
	        },
	        //            判断是否商家
	        judgmenttwo: function judgmenttwo() {
	            var _this = this;
	            if (_this.isOwner == true && _this.isStatus == true) return true;
	        },
	        //            修改模版
	        goTemplate: function goTemplate() {
	            var _this = this;
	            event.openURL(_utils2.default.locate('widget/list.js?listId=' + this.templateId + '&type=template'), function (data) {
	                if (data.type == 'success' && !_utils2.default.isNull(data.data)) {
	                    _this.templateId = data.data.listId;
	                    _this.templateName = data.data.listName;
	                    (0, _fetch.POST)('weex/member/topic/update.jhtml?templateId=' + _this.templateId).then(function (mes) {
	                        if (mes.type == "success") {
	                            event.toast(mes.content);
	                        } else {
	                            event.toast(mes.content);
	        ...
	        petname: function petname() {
	            ...
	            modal.prompt({
	                ...
	                if (value.result == '确定') {
	                    if (_utils2.default.isNull(value.data)) {
	                        ...
	                        modal.confirm({
	                            ...
	                            if (e == '确定') {
	                                (0, _fetch.POST)('weex/member/topic/update.jhtml?name=' + encodeURI(dataContent)).then(function (mes) {
	                                    if (mes.type == "success") {
	        ...
	        isNoActivate: function isNoActivate() {
	            return this.topic.status != "success";
	        },
	        isActivate: function isActivate() {
	            return this.topic.status == "success";
	        },
	        ...
	        //            申请开店
	        getShop: function getShop(e) {
	            var _this = this;
	            (0, _fetch.POST)('weex/member/topic/create_enterprise.jhtml').then(function (mes) {
	                if (mes.type == "success") {
	                    _this.load();
	                } else {
	                    event.toast(mes.content);
	        ...
	        onUseCard: function onUseCard(e) {
	            if (_utils2.default.isNull(this.topic.name) || _utils2.default.isNull(this.topic.logo)) {
	                modal.alert({
	            ...
	            var _this = this;
	            (0, _fetch.POST)('weex/member/topic/update.jhtml?useCard=' + e.value).then(function (mes) {
	                if (mes.type == "success") {
	                    setTimeout(function () {
	                        _this.load();
	                    }, 2000);
	        ...
	        createLive: function createLive() {
	            var _this = this;
	            (0, _fetch.POST)('weex/live/create.jhtml?title=' + encodeURIComponent(this.topic.name) + '&frontcover=' + this.topic.logo).then(function (data) {
	                if (data.type == 'success') {
	                    _this.load();
	                } else {
	                    event.toast(data.content);
	        ...
	        onUseCashier: function onUseCashier(e) {

	            var _this = this;
	            (0, _fetch.POST)('weex/member/topic/update.jhtml?useCashier=' + e.value).then(function (mes) {
	                if (mes.type == "success") {
	                    setTimeout(function () {
	                        _this.load();
	                    }, 2000);
	        ...
	        onUseCoupon: function onUseCoupon(e) {
	            var _this = this;
	            (0, _fetch.POST)('weex/member/topic/update.jhtml?useCoupon=' + e.value).then(function (mes) {
	                if (mes.type == "success") {
	                    setTimeout(function () {
	                        _this.load();
	                    }, 2000);
	        ...
	        doShare: function doShare(id) {
	            ...
	            (0, _fetch.GET)('share/topic.jhtml?topicId=' + this.topic.id + '&shareType=' + shareType, function (data) {
	        ...
	        copy: function copy() {
	            var _this = this;
	            (0, _fetch.GET)('weex/topic/menu.jhtml', function (data) {
	                if (data.type = 'success') {
	        ...
	        //            小程序点击复制
	        appletCopy: function appletCopy() {
	            var _this = this;
	            (0, _fetch.GET)('weex/topic/menu.jhtml?type=applet', function (data) {
	                if (data.type = 'success') {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["sub_title"]
	  }, [_vm._v(_vm._s(_vm.topic.name))]), _c('text', {
	    staticClass: ["arrow"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	    ...
	    staticClass: ["sub_title"]
	  }, [_vm._v(_vm._s(_vm.templateName))]), _c('text', {
	    staticClass: ["arrow"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	  }, [_vm._v("")])])])]), _vm._m(3), (_vm.judgmenttwo()) ? _c('div', [_c('div', {
	    staticClass: ["cell-row", "cell-line"]
	  }, [_c('div', {
	    staticClass: ["cell-panel", "space-between", "cell-clear"]
	  }, [_vm._m(4), _c('div', {
	    ...
	    staticClass: ["switch"],
	    attrs: {
	      "disabled": _vm.isBottomLive,
	      "checked": _vm.topic.useLive
	    },
	    on: {
	      "change": _vm.createLive
	    }
	  })])])]), _vm._m(5), _c('div', {
	    staticClass: ["cell-row", "cell-line"]
	  }, [_c('div', {
	    ...
	    staticClass: ["switch"],
	    attrs: {
	      "disabled": _vm.isBottomCard,
	      "checked": _vm.topic.useCard
	    },
	    on: {
	      "change": _vm.onUseCard
	    }
