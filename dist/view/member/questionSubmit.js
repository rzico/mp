...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/questionSubmit.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-a9690ab8"
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        sendImage: function sendImage(sendIndex) {
	            var _this = this;
	            var sendLength = _this.imageList.length; //获取图片数组总长度
	            var frontUrl = '';
	            if (!_utils2.default.isNull(_this.imageList[sendIndex].paraImage)) {
	            ...
	            if (frontUrl == 'http') {
	                ...
	                _weex.event.upload(_this.imageList[sendIndex].paraImage, function (data) {
	                    if (data.type == 'success') {
	        ...
	        realSave: function realSave() {
	            ...
	            (0, _fetch.POST)('weex/member/feedback/add.jhtml?content=' + encodeURIComponent(this.questionContent) + '&imgs=' + imgsList).then(function (data) {
	                if (data.type == 'success') {
	                    _utils2.default.debug('提交成功');
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    attrs: {
	      ...
	      "rows": "10",
	      "returnKeyType": "next",
	      "placeholder": "请描述您的问题，以便我们更好地解决问题。",
	      "value": (_vm.questionContent)
	    },
	    on: {
	      "input": [function($event) {
	        _vm.questionContent = $event.target.attr.value
	      }, _vm.onInput]
	    }
	  }), _c('div', {
	    staticClass: ["numBox"]
	    ...
	    staticClass: ["fz28"]
	  }, [_vm._v(_vm._s(_vm.contentLength))]), _c('text', {
	    staticClass: ["fz28"],
	    staticStyle: {
	      color: "#999"
	    }
	  }, [_vm._v("/100")])])], 1), (_vm.hasImage()) ? _c('div', {
	    staticClass: ["imageBox", "mt40", "ml30"]
	    ...
	    return _c('div', [_c('image', {
	      ...
	      staticClass: ["paraClose", "bkg-primary"],
	      on: {
	        "click": function($event) {
	          _vm.delImage(index)
	        }
	  ...
	  })) : _vm._e(), (_vm.imageLength()) ? _c('div', {
	    staticClass: ["flex-row", "ml30", "pt40"],
	    on: {
	      "click": function($event) {
	        _vm.addPhotos()
	      }
	  ...
	  }, [_vm._v("添加照片")])]) : _vm._e(), _c('div', {
	    staticClass: ["button", "bw", "bkg-primary", "ml30", "mr30", "mt40"],
	    on: {
	      "click": function($event) {
	        _vm.submitNow()
	      }
	    ...
	    staticClass: ["buttonText", "fz32", "white"]
	  }, [_vm._v("立即提交")])])]), (_vm.toSendArticle) ? _c('div', {
	    staticClass: ["sendMask"],
	    on: {
	      "click": function($event) {
	        _vm.maskClick()
	    ...
	    staticClass: ["processTotal"]
	  }, [_vm._v(_vm._s(_vm.currentPro) + "/" + _vm._s(_vm.proTotal))])])]) : _vm._e(), (_vm.toSendArticle) ? _c('process', {
	    attrs: {
