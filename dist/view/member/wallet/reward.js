...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/wallet/reward.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-a4e27e22"
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        open: function open(callback) {
	            var _this = this;
	            (0, _fetch.GET)('weex/member/reward/list.jhtml?pageStart=' + this.pageStart + '&pageSize=' + this.pageSize, function (res) {
	                if (res.type == 'success') {
	                    if (res.data.start == 0) {
	        ...
	        summary: function summary() {
	            var _this = this;
	            (0, _fetch.GET)('weex/member/reward/summary.jhtml', function (res) {
	                if (res.type == 'success') {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	  ...
	  }, [_vm._v("累计赏金：" + _vm._s(_vm.total) + "元")])]), (_vm.noData()) ? _c('noData', {
	    attrs: {
	      "ndBgColor": '#fff'
	    }
	    ...
	    return _c('cell', {
	    ...
	    }, [_vm._v(_vm._s(_vm._f("hitimefmt")(num.createDate)))]), _c('text', {
	      staticClass: ["font"],
	      style: {
	        fontFamily: 'iconfont'
	      }
	      ...
	      staticClass: ["name"]
	    }, [_vm._v("来自" + _vm._s(num.nickName) + "的打赏")])])])])
