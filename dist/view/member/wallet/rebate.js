...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* styles */
	__vue_styles__.push(__webpack_require__(428)
	)
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/wallet/rebate.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-2b8ddb63"
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        open: function open(callback) {
	            var _this = this;
	            (0, _fetch.GET)('weex/member/rebate/list.jhtml?pageStart=' + this.pageStart + '&pageSize=' + this.pageSize, function (res) {
	                //                    utils.debug(res);
	                if (res.type == 'success') {
	                    if (res.data.start == 0) {
	        ...
	        summary: function summary() {
	            var _this = this;
	            (0, _fetch.GET)('weex/member/rebate/summary.jhtml?type=rebate', function (res) {
	                if (res.type == 'success') {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["cumulative"]
	  }, [_c('text', {
	    staticClass: ["cumulativeMoney", "primary"]
	  }, [_vm._v("累计奖励：" + _vm._s(_vm.total) + "元")])]), (_vm.noData()) ? _c('noData', {
	    attrs: {
	      "ndBgColor": '#fff'
	    }
	  }) : _vm._e()], 1), _vm._l((_vm.lists), function(num, index) {
	    return _c('cell', {
	      ref: "adoptPull",
	      refInFor: true,
	      staticClass: ["cell"],
	    ...
	    }, [_vm._v(_vm._s(_vm._f("datefmt")(num.createDate)))])]) : _vm._e(), _c('div', {
	      staticClass: ["panel"]
	    }, [_c('div', {
	      staticClass: ["monthFont"]
	    }, [_c('text', {
	      staticClass: ["textMonth"]
	    }, [_vm._v(_vm._s(_vm._f("hitimefmt")(num.createDate)))]), _c('image', {
	      staticClass: ["font"],
	      attrs: {
	        "src": num.logo
	      }
	      ...
	      staticClass: ["money"]
	    }, [_vm._v(_vm._s(_vm._f("currencyfmt")(num.amount)))]), _c('text', {
	      staticClass: ["name"]
	    }, [_vm._v(_vm._s(num.memo))])])])])
