...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/wallet/transfer.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-47873caa"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    computed: {
	        creditedAmount: function creditedAmount() {
	            if (this.quota == 0) {
	                return 0;
	            } else {
	    ...
	    methods: {
	        ...
	        bankmessage: function bankmessage() {
	            var self = this;
	        ...
	        wechatmessage: function wechatmessage(event) {
	            var self = this;
	        ...
	        withdrawals: function withdrawals() {
	            ...
	            this.clicked = true;
	            (0, _fetch.POST)('weex/member/transfer/submit.jhtml?type=' + this.bankWithdrawals + '&amount=' + this.quota).then(function (data) {
	                if (data.type == "success") {
	        ...
	        serviceCharge: function serviceCharge() {
	            ...
	            if (this.quota == 0) {
	                ...
	                (0, _fetch.POST)('weex/member/transfer/calculate.jhtml?amount=' + this.quota).then(function (data) {
	                    if (data.type == "success") {
	        ...
	        load: function load() {
	            var _this = this;
	            (0, _fetch.GET)("weex/member/transfer/view.jhtml", function (res) {
	                if (res.type == 'success') {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["bankWechat"]
	  }, [_c('div', {
	    staticClass: ["bank", "bd-primary"],
	    on: {
	      "click": function($event) {
	        _vm.bankmessage()
	      }
	    ...
	    staticClass: ["bankIconFont", "primary"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	  }, [_vm._v("")]), _c('div', {
	    staticClass: ["bankInformation"]
	  }, [_c('text', {
	    staticClass: ["bankName"]
	  }, [_vm._v(_vm._s(_vm.wdata.bankName))]), _c('text', {
	    staticClass: ["bankTailnumber"]
	  }, [_vm._v(_vm._s(_vm.wdata.cardNo))])])]), _c('div', {
	    staticClass: ["wechat"],
	    on: {
	      "click": _vm.wechatmessage
	    }
	  }, [_c('text', {
	    staticClass: ["wechatIconFont"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	  }, [_vm._v("")]), _c('div', {
	    staticClass: ["wechatInformation"]
	  }, [_c('text', {
	    staticClass: ["wechatFont"]
	  }, [_vm._v("微信提现")]), _c('text', {
	    staticClass: ["wechatName"]
	  }, [_vm._v(_vm._s(_vm.wdata.nickName))])])])]), _c('div', {
	    staticClass: ["money"]
	  }, [_c('text', {
	    ...
	    staticClass: ["maxQuotaServicefee"]
	  }, [_c('div', {
	    staticClass: ["servicefeeText"],
	    style: {
	      visibility: _vm.hide
	    }
	  }, [_c('text', {
	    staticClass: ["servicefee"]
	  }, [_vm._v("手续费 " + _vm._s(_vm._f("currencyfmt")(_vm.service)) + "元")])]), _c('div', {
	    staticClass: ["serviceArrival"]
	  }, [_c('text', {
	    staticClass: ["arrival"]
	  }, [_vm._v("实际到账 " + _vm._s(_vm._f("currencyfmt")(_vm.creditedAmount)) + "元")])])])]), _c('div', {
	    staticClass: ["botton", "bkg-primary"],
	    on: {
	      "click": _vm.withdrawals
	    }
	  }, [_c('text', {
