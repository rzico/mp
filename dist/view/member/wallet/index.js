...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/wallet/index.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-19a2827c"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    filters: {
	        watchBalance: function watchBalance(e) {
	            e = parseFloat(e);
	            if (e == 0 || e == '0') {
	                return '0.00';
	            } else {
	    ...
	    methods: {
	            ...
	            if (this.wallet.binded == false) {
	                ...
	                event.openURL(_utils2.default.locate('view/member/bank/bindFirstStep.js'), function (message) {
	                    ...
	                    if (message.type == 'success') {
	                        ...
	                        event.openURL(_utils2.default.locate('view/member/wallet/transfer.js'), function () {
	                            _this.clicked = false;
	                            _this.load();
	                        });
	                    }
	                ...
	                _this.clicked = false;
	                event.openURL(_utils2.default.locate('view/member/wallet/transfer.js'), function (message) {
	                    _this.load();
	                });
	            }
	        },
	        bindingCard: function bindingCard() {
	            ...
	            if (_this.wallet.bankinfo != '未绑定') {
	                event.openURL(_utils2.default.locate("view/member/bank/unbingBank.js?banknum=" + encodeURI(_this.bankinfo)), function (message) {
	                    if (message.type == 'success') {
	                        _this.load();
	                    }
	                    _this.clicked = false;
	        ...
	        filling: function filling() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            event.openURL(_utils2.default.locate('view/member/wallet/filling.js'), function (message) {
	                _this.clicked = false;
	                _this.load();
	            });
	        },
	        ...
	        reward: function reward() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            event.openURL(_utils2.default.locate('view/member/wallet/reward.js'), function (message) {
	                _this.clicked = false;
	            });
	        },
	        rebate: function rebate() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            event.openURL(_utils2.default.locate('view/member/wallet/rebate.js'), function (message) {
	                _this.clicked = false;
	            });
	        },
	        deposit: function deposit() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            event.openURL(_utils2.default.locate('view/member/wallet/deposit.js'), function (message) {
	                _this.clicked = false;
	            });
	        },
	        load: function load() {
	            var _this = this;
	            (0, _fetch.GET)("weex/member/wallet/view.jhtml", function (res) {
	                if (res.type == 'success') {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	  ...
	  }, [_vm._v("钱包余额（元）")]), _c('text', {
	    staticClass: ["balance"]
	  }, [_vm._v(_vm._s(_vm._f("watchBalance")(_vm.wallet.balance)))])]), (_vm.hasCashier) ? _c('div', {
	    staticClass: ["cashierBox"]
	  }, [_c('div', {
	    staticClass: ["cashier", "bkg-primary"]
	  }, [_vm._v("收银台")])]) : _vm._e(), _c('div', {
	  ...
	  }, [_vm._v(_vm._s(_vm.wallet.bankinfo))]), _c('text', {
	    staticClass: ["arrow"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	    ...
	    staticClass: ["cell-row", "boder-top"]
	  }, [_c('div', {
	    staticClass: ["cell-panel", "space-between"],
	    on: {
	      "click": function($event) {
	    ...
	    staticClass: ["noBorderCell", "space-between"],
	    on: {
	      "click": function($event) {
	        _vm.rebate()
	      }
