...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/mopian/mp/src/view/member/manage.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-1a71deb2"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    data: function data() {
	        return {
	            member: { nickName: "未登录", logo: _utils2.default.locate("logo.png"), autograph: "点击设置签名", topic: "未开通", hasTopic: false, useCashier: false },
	            showShare: false,
	            clicked: false,
	            isuseCashier: false,
	            roles: ''
	    ...
	    methods: {
	        ...
	        //            判断是否开启商户模式
	        hasuseCashier: function hasuseCashier() {
	            ...
	            event.openURL(_utils2.default.locate('view/member/attribute.js'), function (data) {
	                ...
	                if (data.type == 'success' && data.data != '') {
	                    if (!_utils2.default.isNull(data.data.logo)) {
	                        _this.member.logo = _utils2.default.thumbnail(data.data.logo, 120, 120);
	                    }
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, [_vm._v("")])])]) : _vm._e()]), (_vm.hastopic()) ? _c('div', {
	    staticClass: ["cell-row", "cell-line"]
	  }, [_c('div', {
	    staticClass: ["cell-panel", "space-between", "cell-clear"],
	    on: {
	  ...
	  }, [_vm._v("")])])]) : _vm._e(), (_vm.hasuseCashier()) ? _c('div', {
	    staticClass: ["cell-panel", "space-between"],
	    on: {
	      "click": function($event) {
	        _vm.goodsManage()
