...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/manage.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-441ac6eb"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    components: {
	        navbar: _navbar2.default, share: _share2.default
	    },
	    data: function data() {
	        return {
	            member: { nickName: "未登录", logo: _utils2.default.locate("logo.png"), autograph: "点击设置签名", occupation: '', topic: "未开通", hasTopic: false, useCashier: false, isAgent: false, isShop: false, hasShop: false },
	            showShare: false,
	            clicked: false,
	            isuseCashier: false,
	            roles: ''
	    ...
	    methods: {
	        ...
	        store: function store() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            event.openURL(_utils2.default.locate('view/shop/cashier/index.js'), function (mes) {
	                _this.clicked = false;
	                if (mes.type == 'success') {
	        ...
	        goShop: function goShop() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            event.openURL(_utils2.default.locate('view/shop/shop/newShop.js'), function (mes) {
	                _this.clicked = false;
	                _this.open();
	            });
	        },
	        ...
	        attribute: function attribute(e) {
	            if (this.clicked) {
	                return;
	            }
	            this.clicked = true;
	            var _this = this;
	            event.openURL(_utils2.default.locate('view/member/attribute.js'), function (data) {
	                _this.clicked = false;
	        ...
	        option: function option(e) {
	            ...
	            this.clicked = true;
	            var _this = this;
	            event.openURL(_utils2.default.locate('view/member/option.js'), function (data) {
	                _this.clicked = false;
	                _this.open();
	                return;
	            });
	        ...
	        topic: function topic(e) {
	            ...
	            this.clicked = true;
	            var _this = this;
	            event.openURL(_utils2.default.locate('view/member/topic/index.js'), function (mes) {
	                _this.open();
	                _this.clicked = false;
	                return;
	            });
	        ...
	        goReviewManage: function goReviewManage(e) {
	            ...
	            this.clicked = true;
	            var _this = this;
	            event.openURL(_utils2.default.locate('view/member/reviewManage.js'), function (data) {
	                _this.clicked = false;
	                return;
	            });
	        },
	        ...
	        dragon: function dragon(e) {
	            ...
	            this.clicked = true;
	            var _this = this;
	            event.openURL(_utils2.default.locate('view/member/dragon.js'), function (data) {
	                _this.clicked = false;
	                return;
	            });
	        },
	        ...
	        goodsManage: function goodsManage() {
	            ...
	            event.openURL(_utils2.default.locate('view/shop/goods/manage.js'), function (data) {
	                _this.clicked = false;
	                return;
	            });
	        },
	        ...
	        shippingManage: function shippingManage() {
	            ...
	            event.openURL(_utils2.default.locate('view/shop/shipping/list.js'), function (data) {
	                _this.clicked = false;
	                return;
	            });
	        },
	        //            前往订单管理
	        orderManage: function orderManage() {
	            if (this.clicked) {
	                return;
	            }
	            this.clicked = true;
	            var _this = this;
	            if (!_utils2.default.isRoles("125", _this.roles)) {
	                modal.alert({
	                    message: '暂无权限',
	                    okTitle: 'OK'
	                });
	            ...
	            event.openURL(_utils2.default.locate('view/shop/order/list.js'), function (data) {
	                _this.clicked = false;
	                return;
	            });
	        },
	        ...
	        doLive: function doLive() {
	            ...
	            (0, _fetch.GET)('weex/live/check.jhtml?memberId=' + event.getUId(), function (data) {
	                if (data.type == 'success' && !_utils2.default.isNull(data.data)) {
	                    ...
	                    event.openURL(_utils2.default.locate('view/live/apply.js'), function (message) {
	                        if (message.type == 'success') {
	                            //                                  开始直播
	        ...
	        seeLive: function seeLive() {
	            ...
	            event.openURL(_utils2.default.locate('view/live/index.js'), function (data) {});
	        }
	    }
	};
	module.exports = exports['default'];
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["title"]
	  }, [_vm._v(_vm._s(_vm.member.nickName))]), _c('text', {
	    staticClass: ["autograph"]
	  }, [_vm._v(_vm._s(_vm.member.autograph))])])]), _c('div', {
	    ...
	    class: [_vm.member.hasTopic ? '' : 'cell-clear'],
	    on: {
	      "click": function($event) {
	        _vm.option()
	      }
	  ...
	  }, [_vm._v("")])])]), (_vm.member.hasTopic) ? _c('div', {
	  ...
	  }, [_vm._v(_vm._s(_vm.member.topic))]), _c('text', {
	    staticClass: ["arrow"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	  }, [_vm._v("")])])]) : _vm._e()]), (_vm.member.isShop && _vm.member.hasShop) ? _c('div', {
	    staticClass: ["cell-row", "cell-line"]
	  }, [_c('div', {
	    staticClass: ["cell-panel", "space-between", "cell-clear"],
	    on: {
	  ...
	  }, [_vm._v("")])])])]) : _vm._e(), (!_vm.member.hasShop) ? _c('div', {
	    staticClass: ["cell-row", "cell-line"]
	  }, [_c('div', {
	    staticClass: ["cell-panel", "space-between", "cell-clear"],
	    on: {
	  ...
	  }, [_vm._v("")])])]) : _vm._e(), (_vm.member.isShop) ? _c('div', {
	    staticClass: ["cell-panel", "space-between"],
	    on: {
	      "click": function($event) {
	        _vm.shippingManage()
