...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/member/dragon.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-e9a63ece"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    components: {
	        navbar: _navbar2.default, noData: _noData2.default, share: _share2.default
	    },
	    ...
	    filters: {
	        wacthType: function wacthType(val) {
	            if (val == 'buying') {
	                return '团购';
	            } else {
	                return '报名';
	        ...
	        wacthStatus: function wacthStatus(mes) {
	            if (mes == 'normal') {
	                return '进行中';
	            } else {
	                return '已结束';
	    ...
	    methods: {
	        ...
	        //            打开分享
	        goShare: function goShare(articleId) {
	            this.showShare = true;
	        ...
	        //            获取所有接龙列表
	        getAllReview: function getAllReview() {
	            var _this = this;
	            if (this.loading == true) {
	                return;
	            }
	            this.loading = true;
	            (0, _fetch.GET)('weex/member/dragon/list.jhtml?pageStart=' + this.pageStart + '&pageSize=' + this.pageSize, function (data) {
	                if (data.type == 'success') {
	        ...
	        //            删除
	        delReview: function delReview(id, index) {
	            var _this = this;
	            modal.confirm({
	                ...
	                if (value == '删除') {
	                    (0, _fetch.POST)('weex/member/dragon/delete.jhtml?id=' + id).then(function (data) {
	                        if (data.type == 'success') {
	                            _this.onrefresh();
	        ...
	        //            关闭接龙
	        OnDragon: function OnDragon(id, index) {
	            var _this = this;
	            modal.confirm({
	                message: '确定要关闭该条接龙吗？',
	                duration: 0.3,
	                ...
	                if (value == '确定') {
	                    (0, _fetch.POST)('weex/member/dragon/ended.jhtml?id=' + id).then(function (data) {
	                        if (data.type == 'success') {
	                            _weex.event.toast(data.content);
	                            _this.onrefresh();
	                        } else {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	  ...
	  })]), (_vm.reviewList.length == 0) ? _c('cell', {
	    appendAsTree: true,
	    attrs: {
	      "append": "tree"
	    }
	  ...
	  })], 1) : _vm._l((_vm.reviewList), function(item, index) {
	    return _c('cell', {
	      appendAsTree: true,
	      attrs: {
	        "append": "tree"
	      ...
	      staticClass: ["fz32", "nameColor"]
	    }, [_vm._v(_vm._s(item.nickName))]), _c('text', {
	      staticClass: ["infoText"],
	      staticStyle: {
	        marginTop: "5px"
	      }
	    }, [_vm._v("（" + _vm._s(_vm._f("wacthType")(item.type)) + _vm._s(_vm._f("wacthStatus")(item.status)) + "）")])]), _c('div', {
	      staticStyle: {
	        flexDirection: "row",
	        width: "615px"
	      }
	      ...
	      staticClass: ["fz28", "pb15", "articleTitle", "pr30", "", "ml10"],
	      staticStyle: {
	        color: "#999"
	      }
	      ...
	      staticClass: ["sub_date", "mt20", "pb15"]
	    }, [_vm._v(_vm._s(_vm._f("timeDatefmtMinutes")(item.createDate)))])]), _c('div', {
	      staticClass: ["buttonBox"]
	    }, [(item.status == 'closed') ? _c('div', {
	      staticClass: ["OnButton"],
	      on: {
	        "click": function($event) {
	          _vm.delReview(item.id, index)
	        }
	      }
	    }, [_c('text', {
	      staticClass: ["fz26"],
	    ...
	    }, [_vm._v("删除")])]) : _vm._e(), (item.status == 'normal') ? _c('div', {
	      staticClass: ["deleteButton"],
	      on: {
	        "click": function($event) {
	          _vm.OnDragon(item.id, index)
	        }
	      }
	    }, [_c('text', {
	      staticClass: ["fz26"],
	    ...
	    }, [_vm._v("关闭")])]) : _vm._e(), (item.status == 'normal') ? _c('div', {
	      staticClass: ["shareButton"],
	      on: {
	        "click": function($event) {
	          _vm.goShare(item.articleId)
	        }
	      }
	    }, [_c('text', {
	      staticClass: ["fz26", "primary"]
	    }, [_vm._v("分享")])]) : _vm._e()])])]) : _vm._e(), _c('div', {
	      staticClass: ["child"]
	    }, [_c('text', {
	      staticClass: ["childName"]
	    }, [_vm._v(_vm._s(item.nickName) + ":")]), _c('text', {
	      staticClass: ["childNumber"]
	    }, [_vm._v(_vm._s(item.orderCount) + " 单")])])])])
	  })], 2), (_vm.showShare) ? _c('div', {
	    key: "share"
	  }, [_c('div', {
