...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/mopian/mp/src/view/home/index.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-bac662cc"
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', [_c('div', {
	    ...
	    staticClass: ["ico_small", "gray", "mr5"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	  }, [_vm._v("")]), _c('text', {
	    staticClass: ["sub_title", "ml5"]
	  }, [_vm._v("搜索用户和文章")])]), _c('div', {
	    staticClass: ["flex-center", "flex1", "ml10"],
	    staticStyle: {
	      justifyContent: "flex-end"
	    },
	    on: {
	    ...
	    staticClass: ["scan", "fz40", "flex-row"],
	    staticStyle: {
	      width: "59px"
	    },
	    style: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/mopian/mp/src/view/home/header.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-06193f16"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _hotCategory = __webpack_require__(199);

	var _hotCategory2 = _interopRequireDefault(_hotCategory);

	var _tabNav = __webpack_require__(200);
	...
	exports.default = {
	    ...
	    components: {
	        headerNav: _header2.default, tabNav: _tabNav2.default, hotCategory: _hotCategory2.default
	    },
	    props: {
	        corpusList: {
	    ...
	    methods: {
	        //            监听设备型号,控制导航栏高度
	        pageTop: function pageTop() {
	            var dc = _utils2.default.pageTop();
	            return dc;
	        },
	        data: function data() {},
	        back: function back() {},
	        ...
	        onpanmove: function onpanmove(e) {
	            ...
	            if (e == 'left') {
	                ...
	                _this.whichCorpus++;
	                var loca = this.whichCorpus - 3;
	                if (loca < 0) {} else {
	                    //                            控制顶部导航的滑动
	                    var el = this.$refs.testRef.$refs['corpus' + loca][0];
	                    dom.scrollToElement(el, { offset: 0 });
	                }
	                //                        滑到才渲染页面
	                _this.corpusList[_this.whichCorpus].load = 1;
	                var leftDistance = _this.whichCorpus * 750;
	                animation.transition(this.$refs.contentBox, {
	                    styles: {
	                ...
	                if (this.whichCorpus == 0) {
	                    ...
	                    _this.canScroll = false;
	                    this.whichCorpus--;
	                    var _loca = this.whichCorpus - 3;
	                    if (_loca < 0) {} else {
	                        //                            控制顶部导航的滑动
	                        var _el = this.$refs.testRef.$refs['corpus' + _loca][0];
	                        dom.scrollToElement(_el, { offset: 0 });
	                    }
	                    //                        滑到才渲染页面
	                    _this.corpusList[_this.whichCorpus].load = 1;
	                    var rightDistance = _this.whichCorpus * 750;
	                    animation.transition(this.$refs.contentBox, {
	                        styles: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/mopian/mp/src/view/home/hotCategory.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-7d5865b3"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
