...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/home/index.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-6b4a7901"
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        corpusChange: function corpusChange(index, id) {
	            ...
	            if (loca < 0) {
	                //                            控制顶部导航的滑动
	                var el = this.$refs['corpus0'][0];
	                dom.scrollToElement(el, { offset: 0 });
	            } else {
	                //                            控制顶部导航的滑动
	                var _el = this.$refs['corpus' + loca][0];
	                dom.scrollToElement(_el, { offset: 0 });
	            }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _transverseList = __webpack_require__(188);

	var _transverseList2 = _interopRequireDefault(_transverseList);

	var _tabNav = __webpack_require__(193);
	...
	exports.default = {
	    ...
	    components: {
	        noData: _noData2.default, transverse: _transverseList2.default, tabNav: _tabNav2.default
	    },
	    props: {
	        //            whichCorpus:{default:0}
	    ...
	    filters: {
	        watchThumbnail: function watchThumbnail(value) {
	            //                    没过滤前是原图
	            return _utils2.default.thumbnail(value, 750, 375);
	        },
	        watchlogo: function watchlogo(value) {
	            return _utils2.default.thumbnail(value, 60, 60);
	        }
	    },
	    ...
	    methods: {
	        hideTopLine: function hideTopLine() {
	            if (this.hadUpdate) {
	                return;
	            }
	            this.hadUpdate = true;
	            if (!_utils2.default.isIosSystem()) {
	                var el = this.$refs.listSlide; //跳转到相应的cell
	                _weex.dom.scrollToElement(el, {
	                    offset: 1 //要为1， 为0时 向下小拉一下会出现白线
	                });
	            }
	        },
	        hasImageList: function hasImageList() {
	            if (_utils2.default.isNull(this.imageList) && this.isInit) {
	                return false;
	            } else {
	                return true;
	            }
	        ...
	        getUserList: function getUserList() {
	            var _this = this;
	            (0, _fetch.GET)('weex/circle/list.jhtml?id=' + this.UId, function (data) {
	                if (data.type == 'success') {
	                    data.data.forEach(function (item) {
	                        item.loading = false;
	                        if (!_utils2.default.isNull(item.logo)) {
	                            item.logo = _utils2.default.thumbnail(item.logo, 100, 100);
	                        }
	                    });
	        ...
	        getAllArticle: function getAllArticle() {
	            var _this = this;
	            (0, _fetch.GET)('weex/article/circle.jhtml?id=' + this.UId + '&pageStart=' + this.pageStart + '&pageSize=' + this.pageSize, function (data) {
	                if (data.type == 'success' && data.data.data != '') {
	                    ...
	                    data.data.data.forEach(function (item, index) {
	                        ...
	                        if (!_utils2.default.isNull(item.logo)) {
	                            ...
	                            item.logo = _utils2.default.thumbnail(item.logo, 60, 60);
	                        } else {
	                            item.logo = _utils2.default.locate('resources/images/background.png');
	                        }
	                        if (_utils2.default.isNull(item.nickName)) {
	                            item.nickName = 'author';
	                        }
	                        //                          填充轮播图
	                        if (!_utils2.default.isNull(item.tags) && _this.imageList.length < 5) {
	                        ...
	                        //                                <!--不能用过滤器,在上啦加载push时 会渲染不出来，具体原因还得分析-->
	                        if (!_utils2.default.isNull(item.thumbnail)) {
	                            item.thumbnail = _utils2.default.thumbnail(item.thumbnail, 370, 370);
	                        }
	                    ...
	                    if (_this.pageStart == 0) {
	                        while (_this.imageList.length < 5) {
	                            ...
	                            //                                获取原图
	                            data.data.data[0].thumbnail = _utils2.default.filterThumbnail(data.data.data[0].thumbnail);
	                            //                                获取需要的比例缩略图
	                            data.data.data[0].thumbnail = _utils2.default.thumbnail(data.data.data[0].thumbnail, 750, 375);
	        ...
	        goArticle: function goArticle(id) {
	            ...
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('view/article/preview.js?articleId=' + id + '&publish=true'), function () {
	                _this.clicked = false;
	            });
	        },
	        ...
	        onrefresh: function onrefresh() {
	            ...
	            if (!_utils2.default.isNull(this.imageList)) {
	                this.isInit = false;
	            } else {
	                this.isInit = true;
	            }
	        ...
	        //            头像加载出来
	        onSlideImageLoad: function onSlideImageLoad(item) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/widget/transverseList.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-31a8f9eb"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    return _c('div', [_c('div', {
	      ...
	      staticClass: ["aboutUserImg", "coverAbsoTop"]
	    }) : _vm._e(), _c('image', {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/include/tabNav.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-757ef5f0"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('waterfall', {
	  ...
	  }), (_vm.hasImageList()) ? _c('header', [_c('div', {
	    staticClass: ["bt10"]
	  }, [_c('slider', {
	    staticClass: ["slider"],
	    attrs: {
	    ...
	    return _c('div', {
	      staticClass: ["frame"]
	    }, [(!img.slideLoading) ? _c('div', {
	      staticClass: ["slideImage", "coverAbsoTop"]
	    }) : _vm._e(), _c('image', {
	      ...
	      on: {
	        "load": function($event) {
	          _vm.onSlideImageLoad(img)
	        },
	        "click": function($event) {
	          _vm.goArticle(img.id)
	        }
	      }
	    })])
	  }), _c('indicator', {
	    staticClass: ["indicatorSlider"]
	  })], 2)])]) : _vm._e(), (_vm.userList.length > 3) ? _c('header', [_c('transverse', {
	    attrs: {
	      "userList": _vm.userList,
	      "title": "我的圈子"
	    },
	    on: {
	      "goAuthor": _vm.goAuthor
	    }
	  })], 1) : _vm._e(), _c('header', [(_vm.articleList.length == 0) ? _c('noData', {
	    style: {
	  ...
	  }) : _vm._e()], 1), _vm._l((_vm.articleList), function(item, index) {
	    return _c('cell', {
	      key: index,
	      appendAsTree: true,
	      attrs: {
	      ...
	      staticClass: ["articleCover", "coverAbsoTop"]
	    }) : _vm._e(), _c('image', {
	      staticClass: ["articleCover", "bt45"],
	      attrs: {
	        "src": item.thumbnail,
	        "resize": "cover"
	      },
	      on: {
	        "load": function($event) {
	          _vm.onImageLoad(item)
	        }
	      }
	    })]), _c('image', {
	      staticClass: ["authorImg"],
	      attrs: {
	        "src": item.logo,
	        "resize": "cover"
	      }
	    }), _c('div', {
	      staticClass: ["flex-row", "bt15"]
	    }, [_c('text', {
	      staticClass: ["articleTitle", "tempOneWidth"]
	    }, [_vm._v(_vm._s(item.title))])]), (item.htmlTag != '' && item.htmlTag != null && item.htmlTag != undefined) ? _c('div', {
	      staticClass: ["flex-row", "bt15"]
	    }, [_c('text', {
	      staticClass: ["articleContent", "tempOneWidth"]
	    }, [_vm._v(_vm._s(item.htmlTag))])]) : _vm._e(), (item.articleSign != '样例') ? _c('div', {
	    ...
	    }, [_vm._v(_vm._s(item.hits))])]) : _vm._e()])])])
	  })], 2)
	},staticRenderFns: []}
	module.exports.render._withStripped = true
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    data: function data() {
	        return {
	            logoImg: _utils2.default.locate('resources/logo.png')
	        };
	    },
	    created: function created() {},
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', [_c('div', {
	    staticClass: ["header", "cell-bottom-clear"],
	    ...
	    staticClass: ["flex-center", "logoBox"]
	  }, [_c('image', {
	    staticClass: ["logo"],
	    attrs: {
	      "src": _vm.logoImg
	    ...
	    staticClass: ["ico_small", "gray", "searchMLMR", "fzz24"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	  }, [_vm._v("")]), _c('text', {
	    staticClass: ["sub_title", "", "fzz24"]
	  }, [_vm._v("搜索用户和文章")])])])])])
	},staticRenderFns: []}
	module.exports.render._withStripped = true
	...
	exports.default = {
	    data: function data() {
	        return {
	            ...
	            //                isInit:true,
	            loadingImg: _utils2.default.locate('resources/images/loading1.gif'),
	            hadUpdate: false
	        };
	    },
	    ...
	    methods: {
	        ...
	        getAllArticle: function getAllArticle() {
	            var _this = this;
	            (0, _fetch.GET)('weex/article/hot.jhtml?pageStart=' + this.pageStart + '&pageSize=' + this.pageSize, function (data) {
	                if (data.type == 'success' && data.data.data != '') {
	                    var dataLength = data.data.data.length;
	                    ...
	                    data.data.data.forEach(function (item, index) {
	                        ...
	                        if (_utils2.default.isNull(item.author)) {
	                            item.author = 'author';
	                        } else {
	                            item.author = _utils2.default.changeStrLast(item.author);
	                        }
	                        ////                          填充轮播图
	                        if (_this.pageStart == 0 && !_utils2.default.isNull(item.tags) && _this.imageList.length < 5) {
	                            for (var i = 0; i < item.tags.length; i++) {
	                                if (item.tags[i].id == 5) {
	                        ...
	                        if (!_utils2.default.isNull(item.thumbnail)) {
	                            switch (item.templateIndex) {
	                                case 0:
	                                    item.thumbnail = _utils2.default.thumbnail(item.thumbnail, 200, 200);
	                                    break;
	                                case 1:
	                                    item.thumbnail = _utils2.default.thumbnail(item.thumbnail, 750, 500);
	                                    break;
	                                case 2:
	                                    item.thumbnail = _utils2.default.thumbnail(item.thumbnail, 230, 230);
	                                    break;
	                                case 3:case 4:
	                                    item.thumbnail = _utils2.default.thumbnail(item.thumbnail, 372, 372);
	                                    break;
	                                default:
	                                    item.thumbnail = _utils2.default.thumbnail(item.thumbnail, 750, 375);
	                                    break;
	                            }
	                        }
	                        if (_this.pageStart != 0) {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('list', {
	  ...
	  }, [(_vm.articleList.length == 0) ? _c('noData', {
	    style: {
	      minHeight: _vm.screenHeight + 'px'
	    },
	    attrs: {
	    ...
	    return _c('cell', {
	    ...
	    }, [(item.templateIndex == 0) ? _c('div', {
	      staticClass: ["tempPdBox"]
	    }, [_c('div', {
	      staticClass: ["flex-row"]
	    }, [_c('div', {
	      staticClass: ["bt20", "flex-row"],
	      on: {
	        "click": function($event) {
	          _vm.goAuthor(item.authorId)
	        }
	      }
	    }, [_c('image', {
	      staticClass: ["authorImg"],
	    ...
	    }, [_vm._v(_vm._s(item.author))])])]), _c('div', {
	      staticClass: ["flex-row"]
	    }, [_c('div', {
	      staticClass: ["tempOneContent"]
	    }, [_c('div', {
	      staticClass: ["flex-row"]
	    }, [_c('text', {
	      staticClass: ["articleTitle", "tempOneWidth"]
	      ...
	      staticClass: ["relevantText"]
	    }, [_vm._v(_vm._s(item.hits))]), _c('text', {
	      staticClass: ["relevantImage"],
	      staticStyle: {
	        paddingBottom: "2px"
	      },
	      ...
	      staticClass: ["relevantText"]
	    }, [_vm._v(_vm._s(item.laud))]), _c('text', {
	      staticClass: ["relevantImage"],
	      style: {
	        fontFamily: 'iconfont'
	      }
	      ...
	      staticClass: ["relevantText"]
	    }, [_vm._v(_vm._s(item.review))])]) : _vm._e()]), _c('div', {
	      staticStyle: {
	        position: "relative"
	      }
	    }, [(!item.loading) ? _c('div', {
	      staticClass: ["tempOneImg", "coverAbsoTop"]
	    }) : _vm._e(), _c('image', {
	      staticClass: ["tempOneImg"],
	      attrs: {
	        "src": item.thumbnail,
	        "resize": "cover"
	      },
	    ...
	    })])])]) : (item.templateIndex == 1) ? _c('div', {
	      staticClass: ["bt10", "positionRelative"]
	    }, [_c('div', {
	      staticClass: ["positionRelative"]
	    }, [(!item.loading) ? _c('div', {
	      staticClass: ["tempTwoCover", "coverAbsoTop"]
	    }) : _vm._e(), _c('image', {
	      staticClass: ["tempTwoCover"],
	      attrs: {
	        "src": item.thumbnail,
	        "resize": "cover"
	      },
	      ...
	      staticClass: ["tempTwoMask"]
	    }), _c('div', {
	      staticClass: ["tempTwoAuthor"],
	      on: {
	        "click": function($event) {
	          _vm.goAuthor(item.authorId)
	        }
	      ...
	      staticClass: ["authorName", "white"]
	    }, [_vm._v(_vm._s(item.author))])]), _c('div', {
	      staticClass: ["tempTwoContent"],
	      on: {
	        "click": function($event) {
	          _vm.goArticle(item.id)
	        }
	      ...
	      staticClass: ["articleContent", "white"]
	    }, [_vm._v(_vm._s(item.htmlTag))])]) : _vm._e()])])])]) : (item.templateIndex == 5) ? _c('div', {
	      staticClass: ["articleBox"]
	    }, [_c('div', {
	      staticClass: ["flex-row"]
	    }, [_c('div', {
	      staticClass: ["flex-row", "ml20"],
	      on: {
	        "click": function($event) {
	          _vm.goAuthor(item.authorId)
	        }
	      ...
	      staticClass: ["tempThreeContent", "ml20"]
	    }, [_c('div', {
	      staticClass: ["flex-row", "bt20"]
	    }, [_c('text', {
	      staticClass: ["articleTitle"]
	    ...
	    }, [_vm._v(_vm._s(item.htmlTag))])]) : _vm._e(), _c('div', {
	      staticClass: ["space-between"]
	    }, [_c('div', [_c('text', {
	      staticClass: ["relevantText"]
	    }, [_vm._v(_vm._s(_vm._f("dateweektimefmt")(item.createDate)))])]), (item.articleSign != '样例') ? _c('div', {
	      staticClass: ["relevantInfo"]
	    }, [_c('text', {
	      staticClass: ["relevantImage"],
	      style: {
	      ...
	      staticClass: ["relevantText"]
	    }, [_vm._v(_vm._s(item.review))])]) : _vm._e()])])]) : (item.templateIndex == 6) ? _c('div', {
	      staticClass: ["articleBox"]
	    }, [_c('div', {
	      staticClass: ["flex-row", "bt20"]
	    }, [_c('div', {
	      ...
	      staticClass: ["flex-row", "bt20", "ml20"]
	    }, [_c('text', {
	      staticClass: ["articleTitle"]
	    }, [_vm._v(_vm._s(item.title))])]), (item.htmlTag != '' && item.htmlTag != null && item.htmlTag != undefined) ? _c('div', {
	      staticClass: ["flex-row", "ml20"]
	      ...
	      staticClass: ["relevantText"]
	    }, [_vm._v(_vm._s(item.review))])]) : _vm._e()])])]) : (item.templateIndex == 7) ? _c('div', {
	      staticClass: ["bt10"]
	    }, [_c('div', {
	      staticClass: ["positionRelative"]
	    }, [(!item.loading) ? _c('div', {
	      staticClass: ["tempEightCover", "coverAbsoTop"]
	    }) : _vm._e(), _c('image', {
	      staticClass: ["tempEightCover"],
	      attrs: {
	        "src": item.thumbnail,
	        "resize": "cover"
	      },
	      ...
	      staticClass: ["authorName"]
	    }, [_vm._v(_vm._s(item.author))])]), (item.articleSign != '样例') ? _c('div', {
	      staticClass: ["relevantInfo"]
	    }, [_c('text', {
	      staticClass: ["relevantImage"],
	      style: {
	      ...
	      staticClass: ["relevantText"]
	    }, [_vm._v(_vm._s(item.review))])]) : _vm._e()])])])
	  })], 2)
	},staticRenderFns: []}
	module.exports.render._withStripped = true
...
/***/ (function(module, exports) {
	...
	module.exports = {
	  ...
	  "addressBox": {
	    ...
	    "height": 60,
	    "borderRadius": 80,
	    "backgroundColor": "rgba(42,42,44,0.2)"
	  },
	  "moreBox": {
	    "flexDirection": "row",
	    "alignItems": "center",
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _liveHeader = __webpack_require__(211);

	var _liveHeader2 = _interopRequireDefault(_liveHeader);

	var _choose = __webpack_require__(216);
	...
	var _others = __webpack_require__(222);

	var _others2 = _interopRequireDefault(_others);

	var _hots = __webpack_require__(227);
	...
	exports.default = {
	    ...
	    components: {
	        choose: _choose2.default, liveHeader: _liveHeader2.default, headerNav: _header2.default, tabNav: _tabNav2.default, othersCategory: _others2.default, hotsCategory: _hots2.default, circleCategory: _circle2.default
	    },
	    props: {
	        corpusList: {
	    ...
	    created: function created() {
	        _utils2.default.initIconFont();
	        this.pageBoxTop = _utils2.default.getHeaderHeight() + 80;
	        this.uId = event.getUId();
	        var _this = this;
	        this.getGps();
	        (0, _fetch.GET)('article_category/list.jhtml', function (data) {
	    ...
	    methods: {
	        ...
	        onSliderChange: function onSliderChange(e) {
	            ...
	            if (loca < 0) {
	                //                            控制顶部导航的滑动
	                var el = this.$refs.tabRef.$refs['corpus0'][0];
	                dom.scrollToElement(el, { offset: 0 });
	            } else {
	                //                            控制顶部导航的滑动
	                var _el = this.$refs.tabRef.$refs['corpus' + loca][0];
	                dom.scrollToElement(_el, { offset: 0 });
	            }
	        },
	        //            点击顶部分类时。
	        corpusChange: function corpusChange(index) {
	        ...
	        gosearch: function gosearch() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            event.openURL(_utils2.default.locate('view/home/search.js'), function () {
	                _this.clicked = false;
	            });
	        },
	        ...
	        goAddFriend: function goAddFriend() {
	            this.showMenu = false;
	            event.openURL(_utils2.default.locate("view/friend/add.js"), function (message) {});
	        },
	        ...
	        scan: function scan() {
	            ...
	            var _this = this;
	            event.scan(function (message) {
	                (0, _fetch.GET)('/q/scan.jhtml?code=' + encodeURIComponent(message.data), function (res) {
	                    if (res.type == "success") {
	        ...
	        //            扫码搜索会员
	        scanFindCard: function scanFindCard(code) {
	            (0, _fetch.GET)('weex/member/card/infobycode.jhtml?code=' + code, function (mes) {
	                if (mes.type == 'success') {
	                    var id = mes.data.card.id;
	                    event.openURL(_utils2.default.locate('view/shop/card/view.js?id=' + id), function (message) {});
	                } else {
	                    event.toast(mes.content);
	                }
	            }, function (err) {
	        ...
	        //            扫码核销优惠券
	        scanCoupon: function scanCoupon(code, captcha) {
	            (0, _fetch.GET)('weex/member/couponCode/use.jhtml?code=' + code + '&captcha=' + captcha, function (mes) {
	                if (mes.type == 'success') {
	                    modal.alert({
	                        message: mes.content,
	                        okTitle: 'OK'
	        ...
	        //            扫码送达
	        scanSend: function scanSend(sn) {
	            var _this = this;
	            var uId = event.getUId();
	            event.getLocation(function (data) {
	                if (data.type == 'success') {
	                    (0, _fetch.GET)('weex/member/shipping/receive.jhtml?sn=' + sn + '&lat=' + data.data.lat + '&lng=' + data.data.lng + '&memo=' + encodeURIComponent('扫码送达'), function (mes) {
	                        if (mes.type == 'success') {
	                            modal.alert({
	                                message: mes.content,
	                                okTitle: 'OK'
	                    ...
	                    (0, _fetch.GET)('weex/member/shipping/receive.jhtml?sn=' + sn + '&lat=0' + '&lng=0' + '&memo=' + encodeURIComponent('扫码送达'), function (mes) {
	                        if (mes.type == 'success') {
	                            modal.alert({
	                                message: mes.content,
	                                okTitle: 'OK'
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/home/header.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-49fb02ee"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/home/liveHeader.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-211f0c7a"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    data: function data() {
	        return {
	            imageUrl: _utils2.default.locate('resources/images/liveHeader.png'),
	            clicked: false
	        };
	    },
	    created: function created() {},
	    ...
	    methods: {
	        ...
	        doLive: function doLive() {
	            ...
	            (0, _fetch.GET)('weex/live/check.jhtml?memberId=' + event.getUId(), function (data) {
	                if (data.type == 'success' && !_utils2.default.isNull(data.data)) {
	                    //                            开始直播
	                    //                        event.toast("当前APP版本不支持直播");
	                    livePlayer.toPlayLiveRoom(data.data.liveId, false, false, function (mes) {});
	                } else if (data.type == 'success' && _utils2.default.isNull(data.data)) {
	                    (0, _fetch.POST)('weex/member/topic/submit.jhtml').then(function (data) {
	                        if (data.type == 'success') {
	                            //                                            跳转专栏
	                            event.openURL(_utils2.default.locate('view/member/topic/index.js'), function (data) {});
	                        } else {
	                            event.toast(err.content);
	                        }
	                    }, function (err) {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', [_c('div', {
	    staticClass: ["headers", "cell-bottom-clear"]
	  }, [_c('div', {
	    ...
	    staticClass: ["image"],
	    attrs: {
	      "src": "http://rzico.oss-cn-shenzhen.aliyuncs.com/weex/resources/images/liveHeader.png"
	    }
	  }), _c('div', {
	    staticClass: ["imageContent"],
	    class: [_vm.classTop()]
	  }, [_c('text', {
	    staticClass: ["titleOne"]
	  }, [_vm._v("芸店VIP")]), _c('text', {
	    staticClass: ["titleTwo"]
	  }, [_vm._v("VIP直播商城")]), _c('div', {
	    staticClass: ["button"],
	    on: {
	      "click": function($event) {
	        _vm.doLive()
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/live/choose.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-68de296a"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        chooseCover: function chooseCover() {
	            ...
	            options, function (data) {
	                if (data.type == 'success') {
	                    ...
	                    //                            上传原图
	                    _weex.event.upload(data.data.originalPath, function (data) {
	                        if (data.type == 'success') {
	                            _weex.event.toast(data.content);
	                        } else {
	                            _weex.event.toast(data.content);
	        ...
	        recording: function recording(e) {
	        ...
	        complete: function complete() {
	            ...
	            (0, _fetch.POST)('weex/live/create.jhtml?title=' + encodeURIComponent(this.titleWord) + '&frontcover=' + this.coverParaImage).then(function (res) {
	                if (res.type == 'success') {
	                    (0, _fetch.GET)('weex/live/check.jhtml?memberId=' + _weex.event.getUId(), function (data) {
	                        if (data.type == 'success' && !_utils2.default.isNull(data.data)) {
	                            //                            开始直播
	        ...
	        sendImage: function sendImage() {
	            ...
	            this.proTotal = 1;
	            var _this = this;
	            _weex.event.upload(_this.coverParaImage, function (data) {
	                if (data.type == 'success') {
	        ...
	        //            创建直播
	        createLive: function createLive() {
	            var _this = this;
	            (0, _fetch.POST)('weex/live/create.jhtml?title=' + encodeURIComponent(this.titleWord) + '&frontcover=' + this.coverParaImage).then(function (data) {
	                if (data.type == 'success') {
	                    var backData = {
	                    ...
	                    _weex.event.closeURL(_utils2.default.message('success', '申请成功', backData));
	                } else {
	                    _weex.event.toast(data.content);
	                }
	            }, function (err) {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["allWidth", "bt20"]
	  }, [_c('div', {
	    staticClass: ["flex-center", "", "bt20"]
	  }, [_c('image', {
	    staticClass: ["coverImg", "allWidth"],
	    attrs: {
	      "src": _vm.coverThumbnail,
	      "resize": "cover"
	    },
	    on: {
	      "click": function($event) {
	  ...
	  }), (_vm.coverThumbnail == '') ? _c('div', {
	    staticClass: ["addCover", "flex-row", "allWidth"],
	    on: {
	      "click": function($event) {
	        _vm.chooseCover()
	      }
	    ...
	    staticClass: ["fzz50", "grayY", "btt3"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	  }, [_vm._v(" ")]), _c('text', {
	    staticClass: ["fz35", "grayY"]
	  }, [_vm._v("设置封面图")])]) : _vm._e()]), _c('div', {
	    staticClass: ["borderBottom"]
	  }, [_c('input', {
	    staticClass: ["titleInput", "allWidth"],
	    attrs: {
	      "type": "text",
	      "returnKeyType": "done",
	      "placeholder": "请输入直播标题...",
	    ...
	    on: {
	      "input": function($event) {
	        _vm.titleWord = $event.target.attr.value
	      }
	    }
	  })])]), _c('div', {
	    ...
	    staticClass: ["fz32"]
	  }, [_vm._v("开启录播")]), _c('switch', {
	    staticClass: ["switch"],
	    on: {
	      "change": _vm.recording
	    }
	  })]), _c('div', {
	    staticClass: ["switchBox"]
	  }, [_c('text', {
	    staticClass: ["fz32"]
	  }, [_vm._v("VIP专场")]), _c('switch', {
	    staticClass: ["switch"],
	    attrs: {
	      "disabled": "true"
	    },
	    ...
	    staticClass: ["switchBox", "cell-clear"]
	  }, [_c('text', {
	    staticClass: ["fz32"]
	  }, [_vm._v("付费直播")]), _c('switch', {
	    staticClass: ["switch"],
	    attrs: {
	      "disabled": "true"
	    },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/home/circle.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-dc33f89e"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/home/others.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-6b69ae78"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    filters: {
	        ...
	        watchNickName: function watchNickName(value) {
	            if (_utils2.default.isNull(value)) {
	                ...
	                return _utils2.default.changeStrLast(value);
	            }
	        }
	    },
	    created: function created() {
	    ...
	    methods: {
	        ...
	        getAllArticle: function getAllArticle() {
	            var _this = this;
	            (0, _fetch.GET)('weex/article/list.jhtml?articleCategoryId=' + this.articleCategoryId + '&pageStart=' + this.pageStart + '&pageSize=' + this.pageSize, function (data) {
	                if (data.type == 'success' && data.data.data != '') {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('list', {
	    ...
	    return _c('cell', {
	      ...
	      staticClass: ["authorName"]
	    }, [_vm._v(_vm._s(_vm._f("watchNickName")(item.author)))])]), (item.articleSign != '样例') ? _c('div', {
	      staticClass: ["relevantInfo"]
	    }, [_c('text', {
	      staticClass: ["relevantImage"],
	      style: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/home/hots.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-27256032"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["headerCenter", "bkg-primary"],
	    class: [_vm.classHeader()]
	  }, [_c('div', {
	    ...
	    ref: "tabRef",
	    attrs: {
	      "corpusList": _vm.corpusList,
	      "whichCorpus": _vm.whichCorpus
	    },
	    on: {
	      "corpusChange": _vm.corpusChange
	    }
	  }), _c('slider', {
	    staticClass: ["pageBox"],
	    style: {
	      top: _vm.pageBoxTop + 'px'
	    },
	    attrs: {
	      "infinite": "false",
	      "index": _vm.whichCorpus
	    },
	    on: {
	    ...
	    }, [(item.name == '热点' && item.load == 1) ? _c('hotsCategory', {
	      attrs: {
	        "articleCategoryId": item.id
	      }
	    }) : (item.name == '关注' && _vm.uId != 0 && item.load == 1) ? _c('circleCategory', {
	      attrs: {
	        "articleCategoryId": item.id
	      }
	    }) : _vm._e()], 1)
	  })), (_vm.showMenu) ? _c('div', [_c('div', {
	    staticClass: ["maskLayer"],
	    on: {
	    ...
	    staticClass: ["flex-row", "pt25", "pb25", "pl35", "pr35", "textActive"],
	    staticStyle: {
	      width: "230px"
	    },
	    on: {
	    ...
	    staticClass: ["fz28", "pl10"]
	  }, [_vm._v("扫一扫")])])])]) : _vm._e(), (_vm.isMask) ? _c('choose', {
	    on: {
	      "cancelBox": _vm.cancelBox
	    }
	  }) : _vm._e()], 1)
	},staticRenderFns: []}
	module.exports.render._withStripped = true
