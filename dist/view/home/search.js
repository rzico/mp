...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/home/search.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-ac78feee"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/include/searchNav.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-0a61b629"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _searchNav = __webpack_require__(183);
	...
	exports.default = {
	    components: {
	        searchNav: _searchNav2.default, noData: _noData2.default
	    },
	    data: function data() {
	        return {
	            refreshing: false,
	    ...
	    filters: {
	        watchThumbnail: function watchThumbnail(value) {
	            return _utils2.default.thumbnail(value, 250, 150);
	        },
	        ...
	        watchFriendLogo: function watchFriendLogo(value) {
	            return _utils2.default.thumbnail(value, 100, 100);
	        }
	    },
	    props: {
	    ...
	    created: function created() {
	        ...
	        //            获取屏幕的高度
	        this.screenHeight = _utils2.default.fullScreen(236);
	        this.getHistory();
	    },

	    methods: (_methods = {
	        watchTypeFunc: function watchTypeFunc(value) {
	            switch (value) {
	                case 'friend':
	                    return '联系人';
	                    break;
	        ...
	        getHistory: function getHistory() {
	            var _this = this;
	            storage.getItem('searchHistory', function (e) {
	                if (e.result == 'success') {
	        ...
	        search: function search(keyword) {
	            ...
	            storage.getItem('searchHistory', function (e) {
	                if (e.result == 'success') {
	                    ...
	                    //                        存入缓存钱要将json转为字符串
	                    b = (0, _stringify2.default)(b);
	                    storage.setItem('searchHistory', b, function (e) {});
	                } else {
	                    //                        如果没有历史记录就新添加一个缓存
	                    var searchHistory = [{
	                        history: keyword
	                    }];
	                    searchHistory = (0, _stringify2.default)(searchHistory);
	                    storage.setItem('searchHistory', searchHistory, function (e) {});
	                }
	            });
	        },
	        //            用户专栏搜索
	        userSearch: function userSearch() {
	            var _this = this;
	            (0, _fetch.GET)('weex/topic/search.jhtml.jhtml?keyword=' + encodeURI(this.keyword) + '&pageStart=' + this.pageStart + '&pageSize=' + this.pageSize, function (data) {
	        ...
	        articleSearch: function articleSearch() {
	            var _this = this;
	            (0, _fetch.GET)('weex/article/search.jhtml?keyword=' + encodeURI(this.keyword) + '&pageStart=' + this.pageStart + '&pageSize=' + this.pageSize, function (data) {
	                if (data.type == 'success' && data.data.data != '') {
	        ...
	        //            判断更多时是否渲染
	        isMoreRepeat: function isMoreRepeat(index) {
	            var _this = this;
	            if (index >= 14) {
	                return true;
	            } else {
	        ...
	        goAuthor: function goAuthor(id) {
	            event.openURL(_utils2.default.locate("view/member/author.js?id=" + id), function (message) {});
	        },
	        //            前往聊天
	        goChat: function goChat(userId) {
	            event.navToChat(userId);
	        },
	        //                      前往文章
	        goArticle: function goArticle(id) {
	            event.openURL(_utils2.default.locate('view/member/editor/preview.js?articleId=' + id + '&publish=true'), function () {});
	        },

	        //            更多记录
	        goMoreSearch: function goMoreSearch(itemType) {
	        ...
	        cleanHistory: function cleanHistory() {
	            this.historyList = [];
	            storage.removeItem('searchHistory', function (e) {});
	        },

	        //            修改搜索分类时触发
	        typeChange: function typeChange(index, id) {
	            ...
	            switch (index) {
	                ...
	                case 1:
	                    //                        避免数据闪屏 刷新
	                    if (_utils2.default.isNull(this.searchList.article)) {
	                        this.pageStart = 0;
	                        this.articleSearch();
	                    } else {
	                    ...
	                    break;
	                case 2:
	                    if (_utils2.default.isNull(this.searchList.friend)) {
	                        this.pageStart = 0;
	                        this.userSearch();
	                    } else {
	                        this.pageStart = this.searchList.article.length;
	        ...
	        //            点击搜索历史或者热点时触发
	        helpSearch: function helpSearch(val) {
	            var _this = this;
	            this.keyword = val;
	            setTimeout(function () {
	                _this.search(val);
	        ...
	        doFocus: function doFocus(item) {
	            if (item.follow) {
	                modal.confirm({
	                    ...
	                    if (value == '确定') {
	                        (0, _fetch.POST)('weex/member/follow/delete.jhtml?authorId=' + item.id).then(function (data) {
	                            if (data.type == 'success') {
	                                item.follow = false;
	                            } else {
	                                event.toast(err.content);
	                ...
	                (0, _fetch.POST)('weex/member/follow/add.jhtml?authorId=' + item.id).then(function (data) {
	                    if (data.type == 'success') {
	                        item.follow = true;
	                    } else {
	                        event.toast(err.content);
	        ...
	        onloading: function onloading() {
	            ...
	            var _this = this;
	            setTimeout(function () {
	                if (_this.whichCorpus == 0) {} else if (_this.whichCorpus == 1) {
	                    //文章的上啦加载
	                    (0, _fetch.GET)('weex/article/search.jhtml?keyword=' + encodeURI(_this3.keyword) + '&pageStart=' + _this.pageStart + '&pageSize=' + _this.pageSize, function (data) {
	                        if (data.type == 'success' && data.data.data != '') {
	                            data.data.data.forEach(function (item) {
	                ...
	                } else if (_this.whichCorpus == 2) {
	                    //专栏的上啦加载
	                    (0, _fetch.GET)('weex/topic/search.jhtml.jhtml?keyword=' + encodeURI(_this3.keyword) + '&pageStart=' + _this.pageStart + '&pageSize=' + _this.pageSize, function (data) {
	                        if (data.type == 'success' && data.data.data != '') {
	                            data.data.data.forEach(function (item) {
	    ...
	    }, (0, _defineProperty3.default)(_methods, 'goArticle', function goArticle(id) {
	        event.openURL(_utils2.default.locate('view/article/preview.js?articleId=' + id + '&publish=true'), function () {});
	    }), (0, _defineProperty3.default)(_methods, 'goAuthor', function goAuthor(id) {
	        event.openURL(_utils2.default.locate("view/topic/index.js?id=" + id), function (message) {});
	    }), (0, _defineProperty3.default)(_methods, 'onImageLoad', function onImageLoad(item) {
	        item.loading = true;
	    }), _methods)
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	  ...
	  }), (_vm.isInput() && !_vm.isSearch) ? _c('div', {
	    staticClass: ["confm", "", "bt20"],
	    on: {
	      "click": function($event) {
	    ...
	    staticClass: ["title"]
	  }, [_vm._v("搜索: " + _vm._s(_vm.keyword) + " ")])]) : _c('div', [(_vm.keyword == '') ? _c('div', [(_vm.historyList != '') ? _c('div', {
	    staticClass: ["searchBox", "bt20"]
	  }, [_c('div', {
	    staticClass: ["space-between", "searchHead"]
	  }, [_c('text', {
	    staticClass: ["gray", "fz26"]
	  }, [_vm._v("搜索历史")]), _c('text', {
	    staticClass: ["ico", "gray", "cleanHistory", "fz28"],
	    style: {
	      fontFamily: 'iconfont'
	    },
	    on: {
	      "click": _vm.cleanHistory
	    }
	  }, [_vm._v("")])]), _c('div', {
	    staticClass: ["borderBottom", "searchBorder"]
	  }), _c('div', {
	    staticClass: ["searchContentBox", "flex-row"]
	    ...
	    return _c('div', {
	      ...
	      class: [index % 2 == 0 ? 'pl25' : ''],
	      on: {
	        "click": function($event) {
	          _vm.helpSearch(item.history)
	        }
	      }
	    }, [_c('text', {
	      staticClass: ["searchContentText", "boder-bottom", "fz28"],
	      class: [index % 2 != 0 ? 'pl25' : '']
	    }, [_vm._v(_vm._s(item.history))])])])
	  }))]) : _vm._e(), (_vm.hotList != '') ? _c('div', {
	    ...
	    return _c('div', {
	      ...
	      staticClass: ["boder-bottom", "searchContentText", "fz28"],
	      class: [index % 2 != 0 ? 'pl25' : '']
	    }, [_vm._v(_vm._s(item.history))])])])
	  }))]) : _vm._e()]) : _vm._e(), (_vm.isSearch) ? _c('div', {
	    staticStyle: {
	      backgroundColor: "#fff",
	      width: "750px"
	    }
	  }, [_c('div', {
	    staticClass: ["flex-row", "boder-bottom", "pl25", "pr25"],
	    staticStyle: {
	      height: "80px",
	      backgroundColor: "#fff",
	      width: "750px"
	    ...
	    return _c('div', {
	      staticClass: ["flex1", "", "", "centerStyle"],
	      class: [_vm.whichCorpus == index ? 'corpusActive' : 'noActive'],
	      on: {
	        "click": function($event) {
	          _vm.typeChange(index, item.id)
	        }
	      }
	    }, [_c('text', {
	      staticClass: ["fz32", "titleColor"],
	      class: [_vm.whichCorpus == index ? 'primary' : ''],
	      staticStyle: {
	        height: "80px",
	        lineHeight: "80px"
	      }
	    }, [_vm._v(_vm._s(item.name))])])
	  }))]) : _vm._e()]), (_vm.isSearch) ? _c('scroller', {
	    attrs: {
	      "loadmoreoffset": "50"
	    },
	    on: {
	  ...
	  }, [(_vm.isEmpty() && _vm.keyword != '' && _vm.isSearch) ? _c('noData', {
	    attrs: {
	      "noDataHint": _vm.noDataHint
	    }
	  }) : _vm._e(), (this.searchList.friend.length != 0 && this.whichCorpus == 0) ? _c('div', {
	    staticClass: ["bt30"]
	  }, [_c('div', {
	    staticClass: ["pl30", "pr30", "", "bgWhite"]
	  }, [_c('div', {
	    staticClass: ["typeTextBox", "", "space-between"]
	  }, [_c('text', {
	    staticClass: ["title", "fz28", "pb15"]
	  }, [_vm._v("相关专栏")]), (_vm.searchList.length > 10) ? _c('text', {
	    staticClass: ["sub_title", "pb10", "fz28"],
	    style: {
	      fontFamily: 'iconfont'
	    },
	    on: {
	  ...
	  }, [_vm._v("更多")]) : _vm._e()])]), _c('div', {
	    staticClass: ["cell-line"]
	  }, [_c('div', {
	    staticClass: ["contentBox", "pb15"]
	  }, _vm._l((_vm.searchList.friend), function(item, index) {
	    return (index <= 9) ? _c('div', {
	      staticClass: ["singleUserBox"],
	      on: {
	        "click": function($event) {
	      ...
	      staticClass: ["logo"],
	      attrs: {
	        "src": _vm._f("watchFriendLogo")(item.logo)
	      }
	    }), _c('div', [_c('text', {
	      staticClass: ["title", "fz28", "bt15"]
	    }, [_vm._v(_vm._s(_vm._f("watchNickName")(item.name)))])])]) : _vm._e()
	  }))])]) : _vm._e(), (this.searchList.friend.length != 0 && this.whichCorpus == 2) ? _c('div', {
	    staticClass: ["bt30"]
	  }, _vm._l((_vm.searchList.friend), function(item, index) {
	    return _c('div', [(_vm.isRepeat(index)) ? _c('div', {
	      staticClass: ["pl30", "pr30", "", "bgWhite"]
	    ...
	    }, [_vm._v(_vm._s(_vm._f("watchNickName")(item.nickName)))]), _c('text', {
	      staticClass: ["sub_title", "ml20", "mt20", "autoLimit"]
	    }, [_vm._v(_vm._s(item.autograph))])]), _c('div', {
	      staticStyle: {
	        width: "130px"
	      }
	    }, [(!item.follow) ? _c('div', {
	      ...
	      staticClass: ["focus", "bkg-primary", "bd-primary"]
	    }, [_vm._v("关注")])]) : _vm._e(), (item.follow && !item.followed) ? _c('div', {
	      staticClass: ["status_panel"],
	      on: {
	        "click": function($event) {
	          _vm.doFocus(item)
	      ...
	      staticClass: ["ask"]
	    }, [_vm._v("已关注")])]) : _vm._e(), (item.follow && item.followed) ? _c('div', {
	      staticClass: ["status_panel"],
	      on: {
	        "click": function($event) {
	          _vm.doFocus(item)
	  ...
	  })) : _vm._e(), _vm._l((_vm.searchList.article), function(item, index) {
	    return _c('div', [(_vm.isRepeat(index)) ? _c('div', {
	      staticClass: ["pl30", "pr30", "bgWhite"]
	      ...
	      staticClass: ["authorName", "ml10"]
	    }, [_vm._v(_vm._s(_vm._f("watchNickName")(item.author)))])]), _c('text', {
	      staticClass: ["authorName"]
	    }, [_vm._v(_vm._s(_vm._f("timeDatefmt")(item.createDate)))])]), _c('div', {
	      staticClass: ["flex-row"]
	    }, [(!item.loading) ? _c('div', {
	      staticClass: ["articleImg", "coverAbsoTop"]
	    }) : _vm._e(), _c('image', {
	      ...
	      staticClass: ["relevantImage", "ml20"],
	      staticStyle: {
	        paddingBottom: "2px"
	      },
	      style: {
	      ...
	      staticClass: ["relevantText"]
	    }, [_vm._v(_vm._s(item.review))])])])])]), (_vm.isMoreRepeat(index) && _vm.whichCorpus == 0) ? _c('div', {
	      staticClass: ["borderTop", "moreArticle"],
	      on: {
	        "click": function($event) {
	          _vm.goMoreSearch(1)
	        }
	      ...
	      staticClass: ["fz35", "pt30", "pb30", "nameColor"],
	      style: {
	        fontFamily: 'iconfont'
	      }
	    }, [_vm._v(" 更多文章")])]) : _vm._e()])])
	  ...
	  return _c('div', {
	    staticClass: ["typeTextBox", "borderBottom"]
	  }, [_c('text', {
	    staticClass: ["sub_title", "fz32", "pb10"]
	  }, [_vm._v("相关专栏")])])
	},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    staticClass: ["typeTextBox"]
	  }, [_c('text', {
	    staticClass: ["sub_title", "fz32", "pb10"]
	  }, [_vm._v("相关文章")])])
	}]}
