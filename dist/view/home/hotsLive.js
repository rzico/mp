...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/home/hotsLive.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-5b3a611a"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    data: function data() {
	        return {
	            image: _utils2.default.locate('resources/images/loading1.gif'),
	            clicked: false
	        };
	    },
	    ...
	    filters: {
	        watchThumbnail: function watchThumbnail(value) {
	            return _utils2.default.thumbnail(value, 223, 300);
	        }
	    },
	    props: {
	        lives: { default: [] }
	    ...
	    methods: {
	        ...
	        liveIndexLinkTo: function liveIndexLinkTo(e) {
	            var _this = this;
	            if (this.clicked) {
	                return;
	            }
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    staticClass: ["flex-column", "bt10"],
	    staticStyle: {
	      backgroundColor: "white"
	    }
	  }, [_c('div', {
	    staticClass: ["hotsTitle"],
	    on: {
	    ...
	    staticClass: ["hotsContent"]
	  }, _vm._l((_vm.lives), function(h) {
	    return _c('div', {
	      staticClass: ["hotsInfo"],
	      on: {
	        "click": function($event) {
	          _vm.goLive(h.liveId)
	        }
