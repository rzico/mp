...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/article/delete.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-73bef47a"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        this.screenHeight = _utils2.default.fullScreen(237);
	        //            获取该文章的模版
	        (0, _fetch.POST)('weex/article/template.jhtml?id=' + this.articleId).then(function (data) {
	            if (data.type == 'success') {
	                var templateId = 't' + data.data;
	                _this.webUrl = _utils2.default.articleUrl(templateId, _this.articleId);
	    ...
	    methods: {
	        ...
	        jumpRestore: function jumpRestore() {
	            var E = _utils2.default.message('success', '成功', 'restore');
	            event.closeURL(E);
	        },
	        jumpDelAll: function jumpDelAll() {
	            modal.confirm({
	                message: '彻底删除后将无法恢复',
	                duration: 0.3,
	                okTitle: '删除',
	                ...
	                if (value == '删除') {
	                    var E = _utils2.default.message('success', '成功', 'delete');
	                    event.closeURL(E);
	                }
	            });
	        }
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["fz35", "redColor"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	  }, [_vm._v("")]), _c('text', {
	    staticClass: ["fz35", "ml10", "redColor"]
	  }, [_vm._v("彻底删除")])])])], 1)], 1)
	},staticRenderFns: []}
	module.exports.render._withStripped = true
