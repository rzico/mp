...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/article/preview.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-13109140"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    components: {
	        navbar: _header2.default, share: _share2.default
	    },
	    props: {
	        title: { default: "" },
	        complete: { default: '' }
	    ...
	    created: function created() {
	        ...
	        if (_utils2.default.previewBottom() != '' && _utils2.default.previewBottom() == 'IPhoneX') {
	            this.bottomNum = parseInt(event.deviceInfo().bottomHeight) * 2;
	        }

	        //            this.screenHeight = utils.fullScreen(305 );
	        this.screenHeight = _utils2.default.fullScreen(237 + this.bottomNum);
	        this.scrollHeight = _utils2.default.fullScreen(137);
	        var isPublish = _utils2.default.getUrlParameter('publish');
	        //            如果不传就是null
	        if (!_utils2.default.isNull(isPublish)) {
	            this.publish = isPublish;
	        }

	        //            获取该文章的模版
	        (0, _fetch.POST)('weex/article/template.jhtml?id=' + this.articleId).then(function (data) {
	            if (data.type == 'success') {
	                _this.templateId = 't' + data.data;
	                _this.initTemplateSn = data.data;
	                _this.templateSn = data.data;
	                _this.webUrl = _utils2.default.articleUrl(_this.templateId, _this.articleId);
	        ...
	        (0, _fetch.GET)('weex/article/preview.jhtml?id=' + this.articleId, function (data) {
	            ...
	            if (data.type == 'success' && data.data != '') {
	                ...
	                if (uId == _this.memberId || data.data.canEdit == true) {
	                    ...
	                    _this.relaseShare();
	                    //获取所有的文章模版
	                    (0, _fetch.GET)('weex/member/template/list.jhtml?type=template', function (data) {
	    ...
	    methods: {
	        //            打开接龙设置
	        goDragon: function goDragon() {
	            this.isOperation = false;
	            this.isDragonMask = true;
	        },
	        //            关闭接龙设置
	        OnDragon: function OnDragon() {
	            this.isDragonMask = false;
	        },

	        //            设置接龙类型
	        pickdragon: function pickdragon() {
	            var _this = this;
	            picker.pick({
	                index: _this.begin,
	                items: ['团购', '报名']
	        ...
	        //            点击接龙确认按钮
	        dragonComplete: function dragonComplete() {
	            if (this.dragonTitle == '') {
	                event.toast('请输入标题');
	                return;
	            }
	            ...
	            (0, _fetch.POST)('weex/member/dragon/create.jhtml?articleId=' + this.articleId + '&title=' + encodeURIComponent(this.dragonTitle) + '&type=' + this.dragonType).then(function (data) {
	                if (data.type == 'success') {
	                    event.toast(data.content);
	        ...
	        articleOutBoxTop: function articleOutBoxTop() {
	            var dc = _utils2.default.artOutTop();
	            return dc;
	        },
	        //            发布后直接跳出分享
	        relaseShare: function relaseShare() {
	            var doneEdit = _utils2.default.getUrlParameter('showShare');
	            if (!_utils2.default.isNull(doneEdit)) {
	                this.showShare = doneEdit;
	            }
	        },
	        //            点击 图片 更换模版的触发
	        tickImage: function tickImage(itemSn, itemId, thumName) {
	            this.templateSn = itemSn;
	            this.templateId = 't' + itemSn;
	            this.templateSaveId = itemId;
	            this.templateSaveName = thumName;
	            this.webUrl = _utils2.default.articleUrl(this.templateId, this.articleId);
	        },
	        thumImgAppear: function thumImgAppear(name) {
	            if (this.noAppear) {
	                return;
	            }
	        ...
	        //            点击 标题 更换模版类型的触发
	        tickTitle: function tickTitle(name) {
	            var _this = this;
	            this.noAppear = true;
	            this.templateName = name;
	            this.scrollerToTemp();
	        ...
	        scrollerToTemp: function scrollerToTemp(hasAnimation) {
	            switch (this.templateName) {
	                case '热门':
	                    if (_utils2.default.isNull(this.$refs.热门)) {
	                        break;
	                    }
	                    var el = this.$refs.热门[0];
	                    break;
	                case '经典':
	                    if (_utils2.default.isNull(this.$refs.经典)) {
	                        break;
	                    }
	                    var el = this.$refs.经典[0];
	                    break;
	                case '节日':
	                    if (_utils2.default.isNull(this.$refs.节日)) {
	                        break;
	                    }
	                    var el = this.$refs.节日[0];
	                    break;
	                case '四季':
	                    if (_utils2.default.isNull(this.$refs.四季)) {
	                        break;
	                    }
	                    var el = this.$refs.四季[0];
	                    break;
	                case '摄影':
	                    if (_utils2.default.isNull(this.$refs.摄影)) {
	                        break;
	                    }
	                    var el = this.$refs.摄影[0];
	                    break;
	                case '朦胧':
	                    if (_utils2.default.isNull(this.$refs.朦胧)) {
	                        break;
	                    }
	                    var el = this.$refs.朦胧[0];
	                    break;
	                case '请柬':
	                    if (_utils2.default.isNull(this.$refs.请柬)) {
	                        break;
	                    }
	                    var el = this.$refs.请柬[0];
	                    break;
	                case '可爱':
	                    if (_utils2.default.isNull(this.$refs.可爱)) {
	                        break;
	                    }
	                    var el = this.$refs.可爱[0];
	                    break;
	                case '活动':
	                    if (_utils2.default.isNull(this.$refs.活动)) {
	                        break;
	                    }
	                    var el = this.$refs.活动[0];
	                    break;
	                case '购物':
	                    if (_utils2.default.isNull(this.$refs.购物)) {
	                        break;
	                    }
	                    var el = this.$refs.购物[0];
	                    break;
	                case '政企':
	                    if (_utils2.default.isNull(this.$refs.政企)) {
	                        break;
	                    }
	                    var el = this.$refs.政企[0];
	                    break;
	                case '赏花':
	                    if (_utils2.default.isNull(this.$refs.赏花)) {
	                        break;
	                    }
	                    var el = this.$refs.赏花[0];
	                    break;
	                case '动态':
	                    if (_utils2.default.isNull(this.$refs.动态)) {
	                        break;
	                    }
	                    var el = this.$refs.动态[0];
	                    break;
	                case '旅行':
	                    if (_utils2.default.isNull(this.$refs.旅行)) {
	                        break;
	                    }
	                    var el = this.$refs.旅行[0];
	                    break;
	                case '假期':
	                    if (_utils2.default.isNull(this.$refs.假期)) {
	                        break;
	                    }
	                    var el = this.$refs.假期[0];
	                    break;
	                case '拼接':
	                    if (_utils2.default.isNull(this.$refs.拼接)) {
	                        break;
	                    }
	                    var el = this.$refs.拼接[0];
	                    break;
	                case '新春':
	                    if (_utils2.default.isNull(this.$refs.新春)) {
	                        break;
	                    }
	            ...
	            if (!_utils2.default.isNull(hasAnimation)) {
	                this.noScrollAnimation(el);
	                return;
	            }
	            dom.scrollToElement(el, {});
	        },
	        noScrollAnimation: function noScrollAnimation(el) {
	            dom.scrollToElement(el, {
	                animated: false
	            });
	        },
	        ...
	        //            点击模版完成按钮时
	        chooseComplete: function chooseComplete() {
	            var _this = this;
	            this.noAppear = true;
	            this.templateChoose = !this.templateChoose;
	            this.templateName = this.initTemplateName;
	            if (this.initTemplateSn != this.templateSn) {
	                //                    上传文章模版
	                (0, _fetch.POST)('weex/member/article/update.jhtml?id=' + this.articleId + '&templateId=' + this.templateSaveId).then(function (data) {
	                    //                            utils.debug(data);
	                    if (data.type == 'success') {
	        ...
	        //            点击操作里的编辑
	        operationEditor: function operationEditor() {
	            var _this = this;
	            this.isOperation = false;
	            event.openURL(_utils2.default.locate('view/member/editor/editor.js?articleId=' + this.articleId), function (data) {
	                if (data.type == 'success') {
	                    _this.webUrl = _utils2.default.articleUrl(_this.templateId, _this.articleId);
	                }
	            });
	        ...
	        //            点击操作里的设置
	        operationSet: function operationSet() {
	            var _this = this;
	            this.isOperation = false;
	            //                event.openURL(utils.locate('view/member/editor/option.js),
	            event.openURL(_utils2.default.locate('view/member/editor/option.js?articleId=' + this.articleId + '&publish=1'), function (data) {
	        ...
	        goOption: function goOption() {
	            ...
	            event.openURL(_utils2.default.locate('view/member/editor/option.js?articleId=' + this.articleId), function (data) {
	                if (!_utils2.default.isNull(data.data.isDone) && data.data.isDone == 'complete') {
	                    var E = {
	                        isDone: 'complete'
	                    };
	        ...
	        //            判断是否有模版，控制是否显示模版标题
	        isNoTemplates: function isNoTemplates(value) {
	            if (_utils2.default.isNull(value)) {
	                return false;
	            } else {
	                return true;
	        ...
	        goLaud: function goLaud() {
	            ...
	            if (this.isSelf == 0) {
	                if (this.isLaud) {
	                    (0, _fetch.POST)('weex/member/laud/delete.jhtml?articleId=' + this.articleId).then(function (data) {
	                        if (data.type == 'success') {
	                            _this.isLaud = false;
	                            _this.laudNum--;
	                        } else {
	                    ...
	                    (0, _fetch.POST)('weex/member/laud/add.jhtml?articleId=' + this.articleId).then(function (data) {
	                        if (data.type == 'success') {
	                            _this.laudNum++;
	                            _this.isLaud = true;
	                        } else {
	                ...
	                event.openURL(_utils2.default.locate('view/member/editor/whoLaud.js?articleId=' + this.articleId), function (data) {});
	            }
	        },

	        //            分享
	        goShare: function goShare(type) {
	            if (this.isSelf == 0 || type == 1) {
	                ...
	                event.openURL(_utils2.default.locate('view/member/editor/whoShare.js?articleId=' + this.articleId), function (data) {});
	            }
	        },
	        ...
	        goReview: function goReview() {
	            ...
	            event.openURL(_utils2.default.locate('view/member/editor/review.js?articleId=' + this.articleId + '&authorId=' + this.memberId), function (data) {});
	        },

	        //            收藏文章
	        collectArticle: function collectArticle() {
	            var _this = this;
	            if (this.clicked) {
	                return;
	            }
	            ...
	            (0, _fetch.POST)('weex/member/favorite/add.jhtml?articleId=' + this.articleId).then(function (data) {
	                if (data.type == 'success') {
	                    event.toast('收藏成功');
	        ...
	        goAuthor: function goAuthor() {
	            ...
	            event.openURL(_utils2.default.locate("view/topic/index.js?id=" + this.memberId), function (message) {
	        ...
	        doShare: function doShare(id) {
	            ...
	            //                分享到公众号
	            if (id == 4) {
	                (0, _fetch.POST)('weex/member/share/platform.jhtml?articleId=' + this.articleId).then(function (data) {
	            ...
	            (0, _fetch.GET)('share/article.jhtml?articleId=' + this.articleId + '&shareType=' + shareType, function (data) {
	                ...
	                if (data.type == 'success' && data.data != '') {
	                    ...
	                    event.share(option, function (data) {
	                        if (data.type == 'success') {
	                            ...
	                            (0, _fetch.POST)('weex/member/share/add.jhtml?articleId=' + _this.articleId + '&shareType=' + shareType).then(function (data) {
	                                if (data.type == 'success') {
	                                    if (shareType == 'copyHref') {
	                                        event.toast('文章链接已复制到剪贴板');
	                                    } else if (shareType == 'browser') {} else {
	                    ...
	                    event.find(findData, function (item) {
	                        if (item.type == 'success' && item.data != '') {
	                            ...
	                            var saveData = {
	                                type: item.data.type,
	                                key: item.data.key,
	                                value: (0, _stringify2.default)(item.data.value),
	                                sort: '0,0000000000',
	        ...
	        doFocus: function doFocus() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            (0, _fetch.POST)('weex/member/follow/add.jhtml?authorId=' + this.memberId).then(function (data) {
	                if (data.type == 'success') {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["articleOutBox"],
	    class: [_vm.articleOutBoxTop()]
	  }, [_c('web', {
	    ref: "webView",
	    staticClass: ["webView"],
	    style: {
	      bottom: _vm.bottomNum + 100
	    },
	    attrs: {
	      "src": _vm.webUrl
	    }
	  }), (_vm.publish) ? _c('div', {
	    staticClass: ["footBox", "bkg-white"],
	    style: {
	    ...
	    staticClass: ["fz26fff"],
	    class: [_vm.isLaud ? 'primary' : '']
	  }, [_vm._v("点赞 " + _vm._s(_vm.laudNum))])]), _c('div', {
	    staticClass: ["bottomBtnBox"],
	    style: {
	      height: _vm.bottomNum + 100
	    },
	    ...
	    staticClass: ["fz26fff"]
	  }, [_vm._v("分享 " + _vm._s(_vm.shareNum))])]), _c('div', {
	    staticClass: ["bottomBtnBox"],
	    style: {
	      height: _vm.bottomNum + 100
	    },
	    ...
	    staticClass: ["fz26fff"]
	  }, [_vm._v("评论 " + _vm._s(_vm.reviewNum))])])]) : _vm._e(), (!_vm.templateChoose && _vm.isSelf == 1) ? _c('div', [_c('text', {
	    staticClass: ["templateText", "templateIcon", "textTemplateIcon"],
	    style: {
	      bottom: _vm.bottomNum + 135
	    },
	    on: {
	      "click": function($event) {
	        _vm.chooseTemplate()
	  ...
	  }, [_vm._v("模版")])]) : _vm._e(), (_vm.isSelf == 0 && !_vm.isCollect) ? _c('div', {
	    key: "collectIcon",
	    staticClass: ["templateIcon", "templateIconWH"],
	    style: {
	      bottom: _vm.bottomNum + 135
	    },
	    on: {
	    ...
	    staticClass: ["templateText", "collectIcon"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	  }, [_vm._v("")]), _c('text', {
	    staticClass: ["templateText", "collectText"]
	  }, [_vm._v("收藏")])]) : _vm._e(), _c('transition', {
	    attrs: {
	      "name": "slide-fade",
	      "mode": "out-in"
	    }
	  }, [(_vm.isSelf == 1 && _vm.templateChoose) ? _c('div', {
	    key: "templateContent",
	    ...
	    style: {
	      bottom: _vm.bottomNum + 300
	    }
	  }, [_c('text', {
	    staticClass: ["btnTextBox", "btnTextSize", "btnTextColor"],
	    style: {
	      fontFamily: 'iconfont'
	    },
	    on: {
	  ...
	  }, [_vm._v(" 完成")])]), _c('div', [_c('div', [_c('scroller', {
	    staticClass: ["templateImgBox"],
	    attrs: {
	      "scrollDirection": "horizontal"
	    }
	  }, _vm._l((_vm.templateList), function(thumImg, index) {
	    return _c('div', {
	      ref: thumImg.name,
	      refInFor: true,
	      staticStyle: {
	    ...
	    }, _vm._l((thumImg.templates), function(item, index) {
	      return _c('image', {
	        class: [item.sn == _vm.templateSn ? 'imgActive' : '', 'templateImg'],
	        attrs: {
	          "src": item.thumbnial,
	          "resize": "cover"
	        },
	        on: {
	          "appear": function($event) {
	            _vm.thumImgAppear(thumImg.name)
	          },
	          "click": function($event) {
	            _vm.tickImage(item.sn, item.id, thumImg.name)
	          }
	        }
	      })
	    }))
	    ...
	    return (_vm.isNoTemplates(item.templates)) ? _c('text', {
	      class: [item.name == _vm.templateName ? 'titleActive' : '', 'templateTitle'],
	      on: {
	        "click": function($event) {
	          _vm.tickTitle(item.name)
	        }
	      }
	    }, [_vm._v(_vm._s(item.name))]) : _vm._e()
	  }))])])]) : _vm._e()]), (_vm.isOperation && _vm.isSelf == 1) ? _c('div', [_c('div', {
	    ...
	    staticClass: ["fz40", "primary"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	  }, [_vm._v("")]), _c('text', {
	    staticClass: ["fz28", "pl10", "primary"]
	  }, [_vm._v("删除")])]), _c('div', {
	    staticClass: ["boder-bottom"],
	    staticStyle: {
	      position: "absolute",
	      left: "25px",
	      right: "25px"
	    ...
	    staticClass: ["fz28", "pl10"]
	  }, [_vm._v("分享")])])])]) : _vm._e(), (_vm.isOperation && _vm.isSelf == 0) ? _c('div', [_c('div', {
	    staticClass: ["maskLayer"],
	    on: {
	      "touchstart": _vm.maskTouch
	    }
	    ...
	    staticClass: ["fz28", "pl10"]
	  }, [_vm._v("分享")])])])]) : _vm._e(), (_vm.showShare) ? _c('div', {
	    key: "share"
	  }, [_c('div', {
	    staticClass: ["maskLayer"],
	    on: {
