...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/view/index.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-73558b7a"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    data: function data() {
	        return {
	            imageList: [{ src: _utils2.default.remote('resources/images/flash1.jpg') }, { src: _utils2.default.remote('resources/images/flash2.jpg') }, { src: _utils2.default.remote('resources/images/flash3.jpg') }, { src: _utils2.default.remote('resources/images/flash4.jpg') }]
	        };
	    },
	    ...
	    methods: {
	        //    登录主页的轮播图slider控制
	        indexSliderMt: function indexSliderMt() {
	            var dc = _utils2.default.indexMtSlider();
	            return dc;
	        },
	        //    登录主页的轮播图控制
	        indexMt: function indexMt() {
	            var dc = _utils2.default.indexMt();
	            return dc;
	        },
	        isNoPos: function isNoPos() {
	            return _utils2.default.device() != "V1";
	        },
	        weixin: function weixin(e) {
	            event.wxAuth(function (message) {
	                if (message.type == "success") {
	                    (0, _fetch.POST)('weex/login/weixin.jhtml?code=' + message.data).then(function (data) {
	                        if (data.type == "success") {
	                            event.closeURL(data);
	                        } else {
	                            event.toast(data.content);
	        ...
	        login: function login(e) {
	            event.openURL(_utils2.default.locate('view/login/index.js'), function (data) {
	                if (data.type == 'success') {
	                    event.closeURL();
	                }
	            });
	        ...
	        scan: function scan() {
	            event.scan(function (message) {
	                if (message.type == 'success') {
	                    _utils2.default.readScan(message.data, function (res) {
	                        if (res.type == 'success') {
	                            if (res.data.type != '818804') {
	                                event.toast("请扫收钱码");
	                                return;
	                            }
	                            (0, _fetch.POST)('weex/login/code_captcha.jhtml?code=' + res.data.code).then(function (data) {
	                                if (data.type == "success") {
	                                    event.closeURL(data);
	                                } else {
	                                    event.toast(data.content);
