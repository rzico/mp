...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* styles */
	__vue_styles__.push(__webpack_require__(779)
	)
	__vue_styles__.push(__webpack_require__(780)
	)

	/* script */
	__vue_exports__ = __webpack_require__(781)
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/widget/friMsgSearch.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-f9f394e8"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    filters: {
	        watchType: function watchType(value) {
	            switch (value) {
	                case 'friend':
	                    return '联系人';
	                    break;
	    ...
	    methods: {
	                ...
	                event.findList(option, function (message) {
	                    if (message.type == 'success' && message.data != '') {
	                        ...
	                        message.data.forEach(function (item) {
	                            ...
	                            switch (item.type) {
	                                case 'friend':
	                                    if (_this.searchList.friend.length >= 5) {} else {
	                                        _this.searchList.friend.push(item);
	                                    }
	                                    break;
	                                case 'message':
	                                    if (_this.searchList.message.length >= 5) {} else {
	                                        _this.searchList.message.push(item);
	                                    }
	                                    break;
	                                case 'article':
	                                    if (_this.searchList.article.length >= 5) {} else {
	        ...
	        goMoreSearch: function goMoreSearch(itemType) {
	            ...
	            this.clicked = true;
	            var _this = this;
	            event.openURL(_utils2.default.locate('widget/moreSearch.js?type=' + itemType + '&keyword=' + encodeURI(this.keyword)), function () {
	                _this.clicked = false;
	            });
	        }
	    }
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	  ...
	  }) : _c('scroller', [(this.searchList.friend.length != 0) ? _c('div', {
	    staticClass: ["bt30"]
	    ...
	    }, [_vm._v(_vm._s(_vm._f("watchType")(item.type)))])])]) : _vm._e(), _c('div', {
	      staticClass: ["contentBox"]
	    }, [_c('div', {
	      staticClass: ["flex-row"],
	      on: {
	        "click": function($event) {
	          _vm.goAuthor(item.value.id)
	        }
	      }
	    }, [_c('image', {
	      staticClass: ["logo"],
	    ...
	    }, [_vm._v(_vm._s(item.value.nickName))])])]), (_vm.isMoreRepeat(index)) ? _c('div', {
	      staticClass: ["borderTop"],
	      on: {
	        "click": function($event) {
	          _vm.goMoreSearch(item.type)
	        }
	      }
	    }, [_c('text', {
	    ...
	    }, [_vm._v(" 更多" + _vm._s(_vm._f("watchType")(item.type)))])]) : _vm._e()])])
	  })) : _vm._e(), (this.searchList.message.length != 0) ? _c('div', {
	    staticClass: ["bt30"]
	  }, _vm._l((_vm.searchList.message), function(item, index) {
	    return _c('div', [(_vm.isRepeat(index)) ? _c('div', {
	      staticClass: ["pl30", "pr30", "", "bgWhite"]
	    }, [_c('div', {
	      staticClass: ["typeTextBox", "borderBottom"]
	      ...
	      staticClass: ["friendsLine", "borderTop"],
	      on: {
	        "click": function($event) {
	          _vm.goChat(item.value.userId)
	        }
	      }
	    }, [_c('div', {
	    ...
	    }, [_vm._v(_vm._s(_vm._f("watchName")(item.value)))])]), _c('div', {
	      staticClass: ["messageTimeBox"]
	    }, [_c('text', {
	      staticClass: ["messageTime"]
	    }, [_vm._v(_vm._s(_vm._f("timefmt")(item.value.createDate)))])])]), _c('div', {
	      staticStyle: {
	        flex: "2",
	        height: "50px",
	        justifyContent: "center"
	    ...
	    }, [_vm._v(_vm._s(item.value.content))])])])]), (_vm.isMoreRepeat(index)) ? _c('div', {
	      staticClass: ["borderTop"],
	      on: {
	        "click": function($event) {
	          _vm.goMoreSearch(item.type)
	    ...
	    return _c('div', [(_vm.isRepeat(index)) ? _c('div', {
	      ...
	      staticClass: ["collectBox", "borderTop"],
	      on: {
	        "click": function($event) {
	          _vm.goArticle(item.value.id)
	        }
	      }
	    }, [_c('div', {
	      staticClass: ["flex-row"]
	      ...
	      staticClass: ["relevantText"]
	    }, [_vm._v(_vm._s(item.value.review))])])])])]), (_vm.isMoreRepeat(index)) ? _c('div', {
	      staticClass: ["borderTop"],
	      on: {
	        "click": function($event) {
	          _vm.goMoreSearch(item.type)
