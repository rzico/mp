...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* styles */
	__vue_styles__.push(__webpack_require__(783)
	)
	__vue_styles__.push(__webpack_require__(784)
	)

	/* script */
	__vue_exports__ = __webpack_require__(785)
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/widget/list.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-6cf22d3e"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        var _this = this;
	        this.listId = _utils2.default.getUrlParameter('listId');
	        var urlType = _utils2.default.getUrlParameter('type');
	        ...
	        (0, _fetch.GET)(urlType + '/list.jhtml', function (data) {
	    ...
	    methods: {
	        goback: function goback(e) {
	            var E = '';
	            if (!_utils2.default.isNull(this.listId)) {
	                E = {
	                    listId: this.listId,
	        ...
	        //            选择相应数据时触发。
	        checkChange: function checkChange(id, name) {
	            var _this = this;
	            this.listId = id;
	            this.listName = name;
	            var E = {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    return _c('div', {
	      ...
	      on: {
	        "click": function($event) {
	          _vm.checkChange(item.id, item.name)
	        }
	      }
	    }, [_c('div', {
	    ...
	    }, [_vm._v(_vm._s(item.name))])]), (_vm.listId == item.id && item.id != null && item.id != '') ? _c('div', [_c('text', {
	      staticClass: ["check"],
	      style: {
	        fontFamily: 'iconfont'
	      }
