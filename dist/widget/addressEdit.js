...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* styles */
	__vue_styles__.push(__webpack_require__(755)
	)
	__vue_styles__.push(__webpack_require__(756)
	)
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/widget/addressEdit.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-4c93d5ae"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        var c = _utils2.default.getUrlParameter('addressData');
	    ...
	    methods: {
	        chooseArea: function chooseArea() {
	            ...
	            this.clicked = true;
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('widget/city.js?type=0'), function (data) {
	                _this.clicked = false;
	                if (data.type == 'success' && !_utils2.default.isNull(data.data)) {
	        ...
	        activateConfirm: function activateConfirm() {
	            if (this.name == '') {
	                _weex.event.toast('请填写收货人');
	            } else if (this.number == '') {
	                _weex.event.toast('请填写手机号码');
	            } else if (this.regionName == '') {
	                _weex.event.toast('请选择收货区域');
	            } else if (this.address == '') {
	                _weex.event.toast('请填写收货地址');
	            } else {
	                var _this = this;
	                //                    id为空为创建，不为空走修改接口
	                if (_utils2.default.isNull(this.id)) {
	                    (0, _fetch.POST)('website/member/receiver/add.jhtml?areaId=' + this.regionId + '&address=' + encodeURIComponent(this.address) + '&consignee=' + encodeURIComponent(this.name) + '&phone=' + this.number + '&isDefault=' + this.isDefault).then(function (res) {
	                        if (res.type == "success") {
	                    ...
	                    (0, _fetch.POST)('website/member/receiver/update.jhtml?id=' + this.id + '&areaId=' + this.regionId + '&address=' + encodeURIComponent(this.address) + '&consignee=' + encodeURIComponent(this.name) + '&phone=' + this.number + '&isDefault=' + this.isDefault).then(function (res) {
	                        if (res.type == "success") {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["font-size", "pl20"]
	  }, [_vm._v(_vm._s(_vm.regionName))])]), _c('div', [_c('text', {
	    staticClass: ["arrow", "primary", "fz40"],
	    style: {
	      fontFamily: 'iconfont'
	    }
	  }, [_vm._v("")])])]), _c('div', {
	    ...
	    staticClass: ["isDefault"]
	  }, [_c('text', {
	    staticClass: ["font-size"]
	  }, [_vm._v("是否默认")]), _c('div', {
	    staticClass: ["xiaoyuan"],
	    style: _vm.yesColor(),
	    on: {
	      "click": function($event) {
	        _vm.yes()
	    ...
	    staticClass: ["bottomBox", "bkg-primary"],
	    on: {
	      "click": function($event) {
	        _vm.activateConfirm()
	      }
