...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* styles */
	__vue_styles__.push(__webpack_require__(759)
	)
	__vue_styles__.push(__webpack_require__(760)
	)

	/* script */
	__vue_exports__ = __webpack_require__(761)
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/widget/addressList.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-3d4bae42"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    filters: {
	        watchPrice: function watchPrice(value) {
	            return _utils2.default.currencyfmt(value);
	        }
	    },
	    created: function created() {

	        if (!_utils2.default.isNull(_utils2.default.getUrlParameter('id'))) {
	            this.addressId = _utils2.default.getUrlParameter('id');
	        }
	    },
	    ...
	    methods: {
	        ...
	        selectAddress: function selectAddress(address) {
	            address = (0, _stringify2.default)(address);
	        ...
	        //      对话框新增地址
	        activateConfirm: function activateConfirm() {
	            this.isShow = false;
	        ...
	        open: function open() {
	            var _this = this;
	            (0, _fetch.GET)('website/member/receiver/list.jhtml', function (res) {
	                if (res.type == "success") {
	        ...
	        goAddress: function goAddress(item) {
	            var _this = this;
	            if (_utils2.default.getUrlParameter('from') == 'buyGoods') {
	                _this.addressId = item.id;
	                _weex.event.closeURL(_utils2.default.message('success', '', item));
	                return;
	            } else {
	                _weex.event.openURL(_utils2.default.locate('widget/addressEdit.js?id=' + item.id + '&c=' + item), function (data) {});
	            }
	        },
	        addAddress: function addAddress() {
	            //                receiverList
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('widget/addressEdit.js'), function (data) {
	        ...
	        delAddress: function delAddress(id, index) {
	            ...
	            //                }
	            var _this = this;
	            (0, _fetch.POST)('website/member/receiver/delete.jhtml?id=' + id).then(function (mes) {
	                if (mes.type == "success") {
	        ...
	        editAddress: function editAddress(item, index) {
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('widget/addressEdit.js?id=' + item.id + '&addressData=' + encodeURIComponent((0, _stringify2.default)(item))), function (data) {
	                if (data.type == 'success' && data.data != '') {
	                    //                        if(data.data.default){
	                    //                            _this.addressId = data.data.id;
	                    //                        }
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }), _c('list', [_vm._l((_vm.receiverList), function(item, index) {
	    return (_vm.hasReceiver()) ? _c('cell', {
	      appendAsTree: true,
	      attrs: {
	        "append": "tree"
	      },
	      ...
	      staticClass: ["borderBottom", "borderBox"]
	    }, [_c('div', [_c('text', {
	      staticClass: ["fontSize18"],
	      staticStyle: {
	        fontWeight: "600"
	      }
	    }, [_vm._v(_vm._s(item.areaName))]), _c('text', {
	      staticClass: ["fontSize18", "", "fzz29", "addressTextBox"]
	    }, [_vm._v(_vm._s(item.address))]), _c('div', {
	      staticClass: ["space-between", "pt10", "bottomBox"]
	    }, [_c('text', {
	      staticClass: ["fontSize18", "fz28", "", "grayColor"]
	    }, [_vm._v(_vm._s(item.consignee) + " " + _vm._s(item.phone))])])]), (_vm.addressId == item.id) ? _c('div', [_c('text', {
	      staticClass: ["check"],
	      style: {
	        fontFamily: 'iconfont'
	      }
	    }, [_vm._v("")])]) : _vm._e()]), _c('div', {
	      staticClass: ["flex-end", "pr20"]
	    }, [_c('text', {
	      staticClass: ["fz30", "grayColor", "mr15", "pt15", "pb15"],
	      style: {
	        fontFamily: 'iconfont'
	      },
	      on: {
	        "click": function($event) {
	          _vm.editAddress(item, index)
	        }
	      }
	    }, [_vm._v("编辑")]), _c('text', {
	      staticClass: ["fz30", "grayColor", "pt15", "pb15"],
	      style: {
	        fontFamily: 'iconfont'
	      },
	      on: {
	        "click": function($event) {
	          _vm.delAddress(item.id, index)
	        }
	      }
	    }, [_vm._v("删除")])])])]) : _vm._e()
	  }), (_vm.receiverList.length == 0) ? _c('cell', {
	    appendAsTree: true,
	    attrs: {
	      "append": "tree"
	    }
