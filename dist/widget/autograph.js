...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* styles */
	__vue_styles__.push(__webpack_require__(763)
	)

	/* script */
	__vue_exports__ = __webpack_require__(764)
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/widget/autograph.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-54a7500f"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        var _this = this;
	        var autotext = _utils2.default.getUrlParameter('name');
	        if (autotext == 'articleTitle') {
	            this.title = '修改标题';
	        }
	        storage.getItem(autotext, function (e) {
	            //                event.toast(e)
	            var textData = JSON.parse(e.data);
	  ...
	  return _c('div', {
	    ...
	    on: {
	      "input": [function($event) {
	        _vm.autograph = $event.target.attr.value
	      }, _vm.oninput]
	    }
	  })], 1)])
	},staticRenderFns: []}
