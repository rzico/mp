...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* styles */
	__vue_styles__.push(__webpack_require__(766)
	)

	/* script */
	__vue_exports__ = __webpack_require__(767)
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/widget/buyGoods.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-4ab0cc10"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _waiting = __webpack_require__(768);
	...
	exports.default = {
	    ...
	    filters: {
	        watchGoodsImg: function watchGoodsImg(value) {
	    ...
	    methods: {
	        hasReceiver: function hasReceiver() {
	            if (_utils2.default.isNull(this.receiverList) || _utils2.default.isNull(this.receiverList[0].id)) {
	                return false;
	            } else {
	                return true;
	            }
	        ...
	        //      确认购买
	        completeBuy: function completeBuy() {
	            var _this = this;
	            if (this.clicked) {
	                return;
	            }
	            ...
	            if (_utils2.default.isNull(this.buyNum) || this.buyNum <= 0) {
	                _weex.event.toast('请添加数量');
	                return;
	            }
	            if (this.hasSpecOne && _utils2.default.isNull(this.spec1Name)) {
	                _weex.event.toast('请选择规格1');
	                return;
	            }
	            if (this.hasSpecTwo && _utils2.default.isNull(this.spec2Name)) {
	                _weex.event.toast('请选择规格2');
	                return;
	            }
	            if (_utils2.default.isNull(this.receiverList[0].id) || _utils2.default.isNull(this.receiverList[0].id)) {
	                _weex.event.toast('请选择地址');
	                return;
	            }
	            this.waitShow = true;
	            (0, _fetch.POST)("website/member/order/create.jhtml?id=" + this.productId + '&quantity=' + this.buyNum + '&receiverId=' + this.receiverList[0].id).then(function (data) {
	                if (data.type == "success") {
	        ...
	        goPay: function goPay(sn) {
	            ...
	            (0, _fetch.POST)('website/member/order/payment.jhtml?sn=' + sn).then(function (data) {
	                if (data.type == "success") {
	                    ...
	                    } else if (data.data.paymentPluginId == 'balancePayPlugin') {
	                        //余额支付
	                        //                var payInfo2 = {
	                        //                  way:'余额支付',
	                        //                  price:_this.finallPrice,
	        ...
	        activate: function activate() {
	            var _this = this;
	            (0, _fetch.POST)('payment/submit.jhtml?sn=' + this.sn + '&paymentPluginId=' + this.paymentId + '&safeKey=free').then(function (data) {
	                if (data.type == "success") {
	        ...
	        //      选择规格2时触发
	        spec2Choose: function spec2Choose(spec2) {
	            var _this = this;
	            ...
	            if (_utils2.default.isNull(this.spec1Name)) {
	                return;
	            } else {
	                var _this2 = this;
	                //          更改图片和价格
	                this.goodsData[0].products.forEach(function (item) {
	                    if (item.spec1 == _this2.spec1Name && item.spec2 == _this2.spec2Name) {
	                        //          更改商品规格
	                        _this2.productId = item.productId;
	                        _this2.goodsData[0].price = item.price;
	                        _this2.goodsData[0].thumbnail = item.thumbnail;
	                    }
	                });
	                this.calcPrice();
	            }
	        },
	        spec2Change: function spec2Change(spec2) {
	            var _this = this;
	            this.goodsData[0].products.forEach(function (item) {
	                if (item.spec2 == spec2) {
	                    _this.goodsData[0].products.forEach(function (data) {
	                        if (!_utils2.default.isNull(item.spec1) && !_utils2.default.isNull(data.spec1) && item.spec1 == data.spec1) {
	                            _this.$set(data, 'isSpec1', '2');
	                        }
	                    });
	                } else {
	        ...
	        //      选择规格1时触发
	        spec1Choose: function spec1Choose(spec1, products) {
	            var _this = this;
	            ...
	            if (this.hasSpecTwo && _utils2.default.isNull(this.spec2Name)) {
	                ...
	                //          更改图片和价格
	                this.goodsData[0].products.forEach(function (item) {
	                    if (item.spec1 == _this3.spec1Name && item.spec2 == _this3.spec2Name) {
	                        //          更改商品规格
	                        _this3.productId = item.productId;
	                        _this3.goodsData[0].price = item.price;
	                        _this3.goodsData[0].thumbnail = item.thumbnail;
	                    }
	                });
	                this.calcPrice();
	            }
	        },
	        spec1Change: function spec1Change(spec1) {
	            var _this = this;
	            this.goodsData[0].products.forEach(function (item) {
	                if (item.spec1 == spec1) {
	                    _this.goodsData[0].products.forEach(function (data) {
	                        if (!_utils2.default.isNull(item.spec2) && !_utils2.default.isNull(data.spec2) && item.spec2 == data.spec2) {
	                            _this.$set(data, 'isSpec2', '2');
	                        }
	                    });
	                } else {
	        ...
	        calcPrice: function calcPrice() {
	            var _this = this;
	            //          计算价格信息
	            (0, _fetch.POST)('website/member/order/calculate.jhtml?id=' + this.productId + '&quantity=' + this.buyNum).then(function (data) {
	                if (data.type == 'success') {
	                    if (data.type == 'success') {
	        ...
	        //      判断是否有规格2
	        hasSpec2: function hasSpec2(products) {
	            var spec2Num = 0;
	            products.forEach(function (item, index) {
	                if (!_utils2.default.isNull(item.spec2)) {
	                    spec2Num++;
	                }
	            });
	            if (spec2Num > 0) {
	        ...
	        //判断规格1重复
	        isSpec1Rrepeat: function isSpec1Rrepeat(index, item) {
	            //        return true;
	            var _this = this;
	            if (index != 0) {
	        ...
	        //判断规格2重复
	        isSpec2Rrepeat: function isSpec2Rrepeat(index, item) {
	            //        return true;
	            var _this = this;
	            if (index != 0) {
	                for (var i = index; i > 0; i--) {
	        ...
	        //      图片预览
	        imgPreview: function imgPreview(original, previewList) {
	        ...
	        //      设置预览图片的列表
	        setPreviewList: function setPreviewList(product) {
	            var _this = this;
	            for (var index = 0; index < product.length; index++) {
	                ...
	                _this.previewList.push({
	                    src: _utils2.default.filterThumbnail(product[index].thumbnail),
	                    w: 900,
	                    h: 1000
	                });
	                //            }
	        ...
	        //       开始时触发
	        show: function show(id, articleId) {
	            id = this.goodId;
	            var _this = this;
	            (0, _fetch.GET)('website/product/view.jhtml?id=' + id, function (data) {
	                if (data.type == 'success') {
	                    _this.goodsData = [];
	                    ...
	                    var sp1 = data.data.products[0].spec1;
	                    if (!_utils2.default.isNull(sp1)) {
	                        _this.spec1Name = sp1;
	                    ...
	                    //              判断该商品是否有规格1
	                    if (_utils2.default.isNull(data.data.products[0].spec1)) {
	        ...
	        goback: function goback() {
	            this.close(_utils2.default.message("error", "取消支付"));
	        },
	        ...
	        goAddress: function goAddress() {
	            var _this = this;
	            _weex.event.openURL(_utils2.default.locate('widget/addressList.js?from=buyGoods&id=' + this.receiverList[0].id), function (data) {
	        ...
	        toastShow: function toastShow(msg) {
	            ...
	            _weex.event.toast(msg);
	        },
	        returnFunc: function returnFunc() {
	            return;
	        }
	        //methods 方法到此为止
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* styles */
	__vue_styles__.push(__webpack_require__(769)
	)
	__vue_styles__.push(__webpack_require__(770)
	)

	/* script */
	__vue_exports__ = __webpack_require__(771)
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/widget/waiting.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-45c7145d"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    data: function data() {
	        return {
	            waitImg: _utils2.default.locate('resources/images/waiting.gif')
	        };
	    },
	    mounted: function mounted() {
	        var _this = this;
	        _weex.animation.transition(_this.$refs.whiteBallOne, {
	            styles: {
	                transform: 'scale(0.1)'
	            },
	            duration: 0, //ms
	        ...
	        _weex.animation.transition(_this.$refs.whiteBallTwo, {
	            styles: {
	                transform: 'scale(0.1)'
	            },
	            duration: 0, //ms
	        ...
	        _weex.animation.transition(_this.$refs.whiteBallThree, {
	            styles: {
	                transform: 'scale(0.1)'
	            },
	            duration: 0, //ms
	    ...
	    methods: {
	        ...
	        oneToSmall: function oneToSmall() {
	            var _this = this;
	            _weex.animation.transition(_this.$refs.whiteBallOne, {
	                styles: {
	                    transform: 'scale(0.1)'
	        ...
	        twoToSmall: function twoToSmall() {
	            var _this = this;
	            _weex.animation.transition(_this.$refs.whiteBallTwo, {
	                styles: {
	                    transform: 'scale(0.1)'
	        ...
	        threeToSmall: function threeToSmall() {
	            var _this = this;
	            _weex.animation.transition(_this.$refs.whiteBallThree, {
	                styles: {
	                    transform: 'scale(0.1)'
	        ...
	        threeToBig: function threeToBig() {
	            var _this = this;
	            _weex.animation.transition(_this.$refs.whiteBallThree, {
	                styles: {
	                    transform: 'scale(1)'
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["flex-row", "ballBox"]
	  }, [_c('text', {
	    ref: "whiteBallOne",
	    staticClass: ["whiteBall"]
	  }), _c('text', {
	    ref: "whiteBallTwo",
	    staticClass: ["whiteBall"]
	  }), _c('text', {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    return _c('div', {
	      ...
	      staticClass: ["specScrollBox"]
	    }, [_c('div', {
	      staticClass: ["flexRow", "buyNumberBox"]
	    }, [_vm._m(0, true), _c('div', {
	      staticClass: ["flexRow", "addSubBox"]
	    }, [_c('text', {
	      staticClass: ["addSub"],
	      class: [_vm.buyNum <= 1 ? 'grayColor' : ''],
	      style: {
	        fontFamily: 'iconfont'
	      },
	      on: {
	      ...
	      on: {
	        "input": [function($event) {
	          _vm.buyNum = $event.target.attr.value
	        }, function($event) {
	          _vm.numInput()
	        }]
	      }
	      ...
	      staticClass: ["flexRow", "specAllWith"]
	    }, _vm._l((item.products), function(spec1, index) {
	      return (_vm.isSpec1Rrepeat(index, item.products)) ? _c('text', {
	        staticClass: ["specStyle"],
	        class: [_vm.spec1Name == spec1.spec1 ? 'specChoose' : '', spec1.isSpec1 != '1' ? '' : 'grayColor'],
	        on: {
	          "click": function($event) {
	            _vm.spec1Choose(spec1, item.products)
	          }
	        }
	      }, [_vm._v(_vm._s(spec1.spec1))]) : _vm._e()
	    }))]), (_vm.hasSpecTwo) ? _c('div', {
	      staticClass: ["flexRow"],
	      staticStyle: {
	        alignItems: "flex-start"
	      }
	      ...
	      staticClass: ["flexRow", "specAllWith"]
	    }, _vm._l((item.products), function(spec2, index) {
	      return (_vm.isSpec2Rrepeat(index, item.products)) ? _c('text', {
	        staticClass: ["specStyle"],
	        class: [_vm.spec2Name == spec2.spec2 ? 'specChoose' : '', spec2.isSpec2 != '1' ? '' : 'grayColor'],
	        on: {
	          "click": function($event) {
	            _vm.spec2Choose(spec2)
	          }
	        }
	      }, [_vm._v(_vm._s(spec2.spec2))]) : _vm._e()
	    }))]) : _vm._e()]) : _vm._e(), _vm._l((_vm.receiverList), function(item, index) {
	      return (_vm.hasReceiver()) ? _c('div', {
	        staticClass: ["address"],
	        on: {
	          "click": function($event) {
	            _vm.goAddress()
	        ...
	        staticClass: ["fontSize18", "pb10"]
	      }, [_vm._v(_vm._s(item.consignee) + " " + _vm._s(item.phone))]), _c('text', {
	        staticClass: ["fontSize18", "fz28", "pt10"]
	      }, [_vm._v(_vm._s(item.areaName) + _vm._s(item.address))])]), _c('text', {
	        staticClass: ["arrow"],
	        style: {
	          fontFamily: 'iconfont'
	        }
	      }, [_vm._v("")])]) : _c('div', {
	        staticClass: ["address", "noAddress"],
	        on: {
	          "click": function($event) {
	            _vm.goAddress()
	          }
	        ...
	        staticClass: ["fontSize18", "fontSize14"]
	      }, [_vm._v("点击选择收货地址")]), _c('text', {
	        staticClass: ["arrow"],
	        style: {
	          fontFamily: 'iconfont'
	        }
	      }, [_vm._v("")])])
	    }), (_vm.couponName != '' && _vm.couponName != null && _vm.couponName != undefined) ? _c('div', {
	      staticClass: ["flexRow", "preferentialBox"]
	    }, [_c('text', {
	      staticClass: ["preferential"]
	    }, [_vm._v(_vm._s(_vm.couponName))])]) : _vm._e()], 2), _c('div', {
	      staticClass: ["footer"],
	      staticStyle: {
	        zIndex: "1"
	      },
	      ...
	      staticClass: ["footerLeftSize"]
	    }, [_vm._v("实付金额 ¥ " + _vm._s(_vm._f("currencyfmt")(_vm.finallPrice)))]), _c('text', {
	      staticClass: ["promtText"]
	    }, [_vm._v("(含运费)")])]), _c('div', {
	      ...
	      staticClass: ["footerRightSize"]
	    }, [_vm._v("确认购买")])])])]), _c('div', {
	      staticClass: ["headerBox"]
	    }, [_c('div', {
	      staticClass: ["goodsImgBox"]
	    }, [_c('image', {
	      staticClass: ["goodsImg", "preview-img"],
	      attrs: {
	        "src": _vm._f("watchGoodsImg")(item.thumbnail)
	      },
	      on: {
	        "click": function($event) {
	          _vm.imgPreview(item.thumbnail, _vm.previewList)
	        }
	      }
	    })]), _c('div', {
	      staticClass: ["goodsInfo"]
	    }, [_c('text', {
	      staticClass: ["priceNow"]
	    }, [_vm._v("¥ " + _vm._s(_vm._f("currencyfmt")(item.price)))]), _c('text', {
	      staticClass: ["goodsName"]
	    }, [_vm._v(_vm._s(item.name))])])])])
	  }), (_vm.waitShow) ? _c('waiting') : _vm._e()], 2)
