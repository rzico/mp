...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* styles */
	__vue_styles__.push(__webpack_require__(787)
	)
	__vue_styles__.push(__webpack_require__(788)
	)

	/* script */
	__vue_exports__ = __webpack_require__(789)
	...
	__vue_options__.__file = "/Users/leistercheung/Documents/weex/mp/src/widget/moreSearch.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-2662187d"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        //            获取屏幕的高度
	        this.screenHeight = _utils2.default.fullScreen(136);
	        this.singeType = _utils2.default.getUrlParameter('type');
	        this.keyword = decodeURI(_utils2.default.getUrlParameter('keyword'));
	    ...
	    methods: {
	        ...
	        oninput: function oninput(val) {
	            ...
	            if (val.length == 0) {
	                ...
	                _weex.event.findList(option, function (message) {
	        ...
	        onloading: function onloading() {
	            ...
	            setTimeout(function () {
	                _this2.listCurrent = _this2.listCurrent + _this2.pageSize;
	                var option = {
	                    type: _this2.singeType, //类型
	                    keyword: _this2.keyword, //关键址
	                    orderBy: 'desc', //"desc"降序 ,"asc"升序
	                    current: _this2.listCurrent, //当前有几页
	                    pageSize: _this2.pageSize //一页显示几行
	                };
	                _weex.event.findList(option, function (message) {
	                    if (message.type == 'success' && message.data != '') {
	                        message.data.forEach(function (item) {
	                    ...
	                    } else if (message.type == 'success' && message.data == '') {} else {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    }, [_vm._v(_vm._s(item.value.nickName))])])])])])
	    ...
	    }, [_vm._v(_vm._s(item.value.content))])])])])])])
	  }), _vm._l((_vm.searchList.article), function(item, index) {
	    return _c('div', [(_vm.isRepeat(index)) ? _c('div', {
	      staticClass: ["pl30", "pr30", "bgWhite"]
	    }, [_c('div', {
	      staticClass: ["typeTextBox", "borderBottom"]
	      ...
	      staticClass: ["relevantText"]
	    }, [_vm._v(_vm._s(item.value.review))])])])])])])])
	  })], 2)])], 1)
	},staticRenderFns: []}
	module.exports.render._withStripped = true
